...
grant all on analysis_parameter to alert_inter;
...
grant SELECT on ALERT.ANALYSIS_PARAMETER to ALERT_APEX_TOOLS;
...
grant select, insert, update on alert.analysis_parameter to alert_core_cnt with grant option;
