...
GRANT SELECT ON unit_measure_subtype TO alert_viewer;
...
grant select on alert.unit_measure_subtype to alert_apex_tools_content;
...
grant select, insert, update on alert.unit_measure_subtype to alert_core_cnt with grant option;
...
-- CHANGED DATE: 2021-4-28
-- CHANGED REASON: EMR-5629

grant select on UNIT_MEASURE_SUBTYPE to ALERT_DEFAULT;
