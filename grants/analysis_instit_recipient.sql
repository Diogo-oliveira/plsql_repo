...
grant SELECT on ALERT.ANALYSIS_INSTIT_RECIPIENT to ALERT_APEX_TOOLS;
...
grant select, insert, update, delete on alert.analysis_instit_recipient to alert_core_cnt with grant option;
