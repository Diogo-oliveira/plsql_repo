...
grant references on WF_WORKFLOW_ACTION to alert_product_tr;
...
grant references, select on WF_WORKFLOW_ACTION to alert_product_tr;
-- CHANGE END: Pedro Quinteiro

-- CHANGED BY: Alexis Nascimento
-- CHANGE DATE: 23/09/2014 16:56
-- CHANGE REASON: [ALERT-296372] ALERT® PHARMACY: New pharmacist profile
GRANT SELECT ON WF_WORKFLOW_ACTION TO alert_pharmacy_func;
