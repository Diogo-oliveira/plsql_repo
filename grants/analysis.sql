...
-- CHANGE DATE: 09/05/2014 04:01
-- CHANGE REASON: [ALERT-284198]
grant all on analysis to alert_inter;
...
grant select, insert, update on alert.analysis to alert_core_cnt with grant option;
