...
grant SELECT on ALERT.ANALYSIS_UNIT_MEASURE to ALERT_APEX_TOOLS;
...
grant select, insert, update on alert.analysis_unit_measure to alert_core_cnt with grant option;
