/*-- Last Change Revision: $Rev: 2029160 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:50:08 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE ts_epis_interv_plan IS


  -- Collection of %ROWTYPE records based on "EPIS_INTERV_PLAN"
     TYPE EPIS_INTERV_PLAN_tc IS TABLE OF EPIS_INTERV_PLAN%ROWTYPE INDEX BY BINARY_INTEGER;
     TYPE epis_interv_plan_ntt IS TABLE OF EPIS_INTERV_PLAN%ROWTYPE;
     TYPE epis_interv_plan_vat IS VARRAY(100) OF EPIS_INTERV_PLAN%ROWTYPE;

  -- Same type structure, with a static name.
     TYPE aat IS TABLE OF EPIS_INTERV_PLAN%ROWTYPE INDEX BY BINARY_INTEGER;
     TYPE ntt IS TABLE OF EPIS_INTERV_PLAN%ROWTYPE;
     TYPE vat IS VARRAY(100) OF EPIS_INTERV_PLAN%ROWTYPE;

   -- Column Collection based on column "ID_EPIS_INTERV_PLAN"
   TYPE ID_EPIS_INTERV_PLAN_cc IS TABLE OF EPIS_INTERV_PLAN.ID_EPIS_INTERV_PLAN%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_INTERV_PLAN"
   TYPE ID_INTERV_PLAN_cc IS TABLE OF EPIS_INTERV_PLAN.ID_INTERV_PLAN%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_EPISODE"
   TYPE ID_EPISODE_cc IS TABLE OF EPIS_INTERV_PLAN.ID_EPISODE%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_PROFESSIONAL"
   TYPE ID_PROFESSIONAL_cc IS TABLE OF EPIS_INTERV_PLAN.ID_PROFESSIONAL%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "FLG_STATUS"
   TYPE FLG_STATUS_cc IS TABLE OF EPIS_INTERV_PLAN.FLG_STATUS%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "NOTES"
   TYPE NOTES_cc IS TABLE OF EPIS_INTERV_PLAN.NOTES%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "DT_CREATION"
   TYPE DT_CREATION_cc IS TABLE OF EPIS_INTERV_PLAN.DT_CREATION%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "DT_BEGIN"
   TYPE DT_BEGIN_cc IS TABLE OF EPIS_INTERV_PLAN.DT_BEGIN%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "DT_END"
   TYPE DT_END_cc IS TABLE OF EPIS_INTERV_PLAN.DT_END%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_CANCEL_INFO_DET"
   TYPE ID_CANCEL_INFO_DET_cc IS TABLE OF EPIS_INTERV_PLAN.ID_CANCEL_INFO_DET%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "FLG_AVAILABLE"
   TYPE FLG_AVAILABLE_cc IS TABLE OF EPIS_INTERV_PLAN.FLG_AVAILABLE%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "DESC_OTHER_INTERV_PLAN"
   TYPE DESC_OTHER_INTERV_PLAN_cc IS TABLE OF EPIS_INTERV_PLAN.DESC_OTHER_INTERV_PLAN%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_USER"
   TYPE CREATE_USER_cc IS TABLE OF EPIS_INTERV_PLAN.CREATE_USER%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_TIME"
   TYPE CREATE_TIME_cc IS TABLE OF EPIS_INTERV_PLAN.CREATE_TIME%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_INSTITUTION"
   TYPE CREATE_INSTITUTION_cc IS TABLE OF EPIS_INTERV_PLAN.CREATE_INSTITUTION%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_USER"
   TYPE UPDATE_USER_cc IS TABLE OF EPIS_INTERV_PLAN.UPDATE_USER%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_TIME"
   TYPE UPDATE_TIME_cc IS TABLE OF EPIS_INTERV_PLAN.UPDATE_TIME%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_INSTITUTION"
   TYPE UPDATE_INSTITUTION_cc IS TABLE OF EPIS_INTERV_PLAN.UPDATE_INSTITUTION%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_TASK_GOAL_DET"
   TYPE ID_TASK_GOAL_DET_cc IS TABLE OF EPIS_INTERV_PLAN.ID_TASK_GOAL_DET%TYPE INDEX BY BINARY_INTEGER;
...
-- Delete one row by primary key
   ...
   -- Delete all rows for this EIP_P_FK foreign key value
   ...
   -- Delete all rows for this EIP_TSKGD_FK foreign key value
