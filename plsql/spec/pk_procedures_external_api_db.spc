/*-- Last Change Revision: $Rev: 2028881 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:48:31 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE pk_procedures_external_api_db IS
    ...
    * @param     i_lang         Language id
    * @param     i_prof         Professional
    * @param     i_id_task      Procedure requisition detail id
    ...
    */
    ...
    /*
    * Returns th procedure information (procedure description, status, instructions)
    *
    * @param     i_lang               Language id
    * @param     i_prof               Professional
