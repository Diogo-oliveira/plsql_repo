...
CREATE OR REPLACE PACKAGE ts_epis_prognosis_hist
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on epis_prognosis_hist
    TYPE epis_prognosis_hist_tc IS TABLE OF epis_prognosis_hist%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE epis_prognosis_hist_ntt IS TABLE OF epis_prognosis_hist%ROWTYPE;
    TYPE epis_prognosis_hist_vat IS VARRAY(100) OF epis_prognosis_hist%ROWTYPE;

    -- Column Collection based on column ID_EPIS_PROGNOSIS_HIST
    TYPE id_epis_prognosis_hist_cc IS TABLE OF epis_prognosis_hist.id_epis_prognosis_hist%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_EPIS_PROGNOSIS_HIST
    TYPE dt_epis_prognosis_hist_cc IS TABLE OF epis_prognosis_hist.dt_epis_prognosis_hist%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EPIS_PROGNOSIS
    TYPE id_epis_prognosis_cc IS TABLE OF epis_prognosis_hist.id_epis_prognosis%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EPISODE
    TYPE id_episode_cc IS TABLE OF epis_prognosis_hist.id_episode%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_STATUS
    TYPE flg_status_cc IS TABLE OF epis_prognosis_hist.flg_status%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column PROGNOSIS_NOTES
    TYPE prognosis_notes_cc IS TABLE OF epis_prognosis_hist.prognosis_notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_CREATE
    TYPE id_prof_create_cc IS TABLE OF epis_prognosis_hist.id_prof_create%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_CREATE
    TYPE dt_create_cc IS TABLE OF epis_prognosis_hist.dt_create%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_LAST_UPDATE
    TYPE id_prof_last_update_cc IS TABLE OF epis_prognosis_hist.id_prof_last_update%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_LAST_UPDATE
    TYPE dt_last_update_cc IS TABLE OF epis_prognosis_hist.dt_last_update%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_CANCEL
    TYPE id_prof_cancel_cc IS TABLE OF epis_prognosis_hist.id_prof_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CANCEL_REASON
    TYPE id_cancel_reason_cc IS TABLE OF epis_prognosis_hist.id_cancel_reason%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CANCEL_NOTES
    TYPE cancel_notes_cc IS TABLE OF epis_prognosis_hist.cancel_notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_CANCEL
    TYPE dt_cancel_cc IS TABLE OF epis_prognosis_hist.dt_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF epis_prognosis_hist.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF epis_prognosis_hist.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF epis_prognosis_hist.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF epis_prognosis_hist.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF epis_prognosis_hist.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF epis_prognosis_hist.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROGNOSIS
    TYPE id_prognosis_cc IS TABLE OF epis_prognosis_hist.id_prognosis%TYPE INDEX BY BINARY_INTEGER;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_prognosis_hist.id_epis_prognosis_hist%TYPE;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN epis_prognosis_hist.id_epis_prognosis_hist%TYPE;
    ...
    PROCEDURE initrec(epis_prognosis_hist_inout IN OUT epis_prognosis_hist%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_prognosis_hist%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_prognosis_hist_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_prognosis_hist_tc;
