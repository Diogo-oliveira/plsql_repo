/*-- Last Change Revision: $Rev: 2028773 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:47:50 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE pk_lab_tests_external_api_db IS
    ...
    */
    ...
    /*    
    * Get all lab tests results for the given analysis_parameter and patient on dates greater than the
    * supplied date.     
    *     
    * @param     i_lang                 Language id
    * @param     i_prof                 Professional
    ...
    * @param     i_date                 Date
    *    
    * @param     o_result               Lab test result
    * @param     o_unit_measure         Lab test unit measure id
    * @param     o_error                Error message
    ...
    */
    ...
    /*    
    * Checks if a given patient has lab tests orders     
    *     
    * @param     i_lang               Language id
    * @param     i_prof               Professional
    * @param     i_patient            Patient id
    * @param     i_analysis           String with Analysis|Parameter|Sample
    * @param     i_date               Date    
    *    
    * @param     o_analysis_req_det   True if conditions were meet. False otherwise.
    * @param     o_error              Error message
    ...
    * @param     i_lang           Language id
    * @param     i_prof           Professional
    * @param     i_analysis_req   Lab test detail order id
    * @param     o_flg_status     Lab test status
    ...
    */
    ...
    /*
    * Get the lab alias code translation
    * 
    * @param     i_lang             Language id
    * @param     i_prof             Professional
    * @param     i_code_analysis    Code analysis
    * @param     i_dep_clin_serv    Dep_clin_serv id    
    *
    * @return    Alias code translation
    *                                                                            
    * @author    Sofia Mendes
    * @version   v2.6.1.2
    * @since     29-Set-2011
    */
    ...
    /*
    * Get the last lab test result param by date
    * 
    * @param     i_lang                Language id
    * @param     i_prof                Professional
    ...
    * @return    Y/N on success, otherwise NULL
    *                                                                            
    * @author    Vanessa Barsottelli
    * @version   v2.6.2.0.6
    * @since     2012/03/15
    ...
    */
    ...
    PROCEDURE hie______________________;

    /*
    * Returns a list of lab tests' results for a patient (timeline view)
    *
    * @param     i_lang                 Language id
    * @param     i_prof                 Professional
    * @param     i_patient              Patient id
    * @param     i_start_column         First column
    * @param     i_end_column           Last column
    * @param     i_last_column_number   Last column number
    * @param     o_serialized_results   Cursor
    * @param     o_serialized_columns   Cursor
    * @param     o_error                Error message
