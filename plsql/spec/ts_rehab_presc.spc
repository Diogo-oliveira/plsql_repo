/*-- Last Change Revision: $Rev: 2029352 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:51:12 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE ts_rehab_presc
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on rehab_presc
    TYPE rehab_presc_tc IS TABLE OF rehab_presc%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE rehab_presc_ntt IS TABLE OF rehab_presc%ROWTYPE;
    TYPE rehab_presc_vat IS VARRAY(100) OF rehab_presc%ROWTYPE;

    -- Column Collection based on column ID_REHAB_PRESC
    TYPE id_rehab_presc_cc IS TABLE OF rehab_presc.id_rehab_presc%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_REHAB_PRESC
    TYPE dt_rehab_presc_cc IS TABLE OF rehab_presc.dt_rehab_presc%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROFESSIONAL
    TYPE id_professional_cc IS TABLE OF rehab_presc.id_professional%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_INSTITUTION
    TYPE id_institution_cc IS TABLE OF rehab_presc.id_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_REHAB_AREA_INTERV
    TYPE id_rehab_area_interv_cc IS TABLE OF rehab_presc.id_rehab_area_interv%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_REHAB_SCH_NEED
    TYPE id_rehab_sch_need_cc IS TABLE OF rehab_presc.id_rehab_sch_need%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXEC_INSTITUTION
    TYPE id_exec_institution_cc IS TABLE OF rehab_presc.id_exec_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column EXEC_PER_SESSION
    TYPE exec_per_session_cc IS TABLE OF rehab_presc.exec_per_session%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_STATUS
    TYPE flg_status_cc IS TABLE OF rehab_presc.flg_status%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES
    TYPE notes_cc IS TABLE OF rehab_presc.notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CANCEL_REASON
    TYPE id_cancel_reason_cc IS TABLE OF rehab_presc.id_cancel_reason%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_CANCEL
    TYPE notes_cancel_cc IS TABLE OF rehab_presc.notes_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_CANCEL
    TYPE dt_cancel_cc IS TABLE OF rehab_presc.dt_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CANCEL_PROFESSIONAL
    TYPE id_cancel_professional_cc IS TABLE OF rehab_presc.id_cancel_professional%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_PRESC_STATUS
    TYPE flg_presc_status_cc IS TABLE OF rehab_presc.flg_presc_status%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF rehab_presc.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF rehab_presc.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF rehab_presc.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF rehab_presc.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF rehab_presc.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF rehab_presc.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_CHANGE
    TYPE notes_change_cc IS TABLE OF rehab_presc.notes_change%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CODIFICATION
    TYPE id_codification_cc IS TABLE OF rehab_presc.id_codification%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_REFERRAL
    TYPE flg_referral_cc IS TABLE OF rehab_presc.flg_referral%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_LATERALITY
    TYPE flg_laterality_cc IS TABLE OF rehab_presc.flg_laterality%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_NOT_ORDER_REASON
    TYPE id_not_order_reason_cc IS TABLE OF rehab_presc.id_not_order_reason%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PAT_HEALTH_PLAN
    TYPE id_pat_health_plan_cc IS TABLE OF rehab_presc.id_pat_health_plan%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PAT_EXEMPTION
    TYPE id_pat_exemption_cc IS TABLE OF rehab_presc.id_pat_exemption%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DIAGNOSIS_NOTES
    TYPE diagnosis_notes_cc IS TABLE OF rehab_presc.diagnosis_notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CLINICAL_PURPOSE
    TYPE id_clinical_purpose_cc IS TABLE OF rehab_presc.id_clinical_purpose%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CLINICAL_PURPOSE_NOTES
    TYPE clinical_purpose_notes_cc IS TABLE OF rehab_presc.clinical_purpose_notes%TYPE INDEX BY BINARY_INTEGER;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN rehab_presc.id_rehab_presc%TYPE;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN rehab_presc.id_rehab_presc%TYPE;
    ...
    PROCEDURE initrec(rehab_presc_inout IN OUT rehab_presc%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN rehab_presc%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN rehab_presc_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN rehab_presc_tc;
