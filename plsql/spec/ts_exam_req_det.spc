/*-- Last Change Revision: $Rev: 2029189 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:50:17 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE ts_exam_req_det
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on exam_req_det
    TYPE exam_req_det_tc IS TABLE OF exam_req_det%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE exam_req_det_ntt IS TABLE OF exam_req_det%ROWTYPE;
    TYPE exam_req_det_vat IS VARRAY(100) OF exam_req_det%ROWTYPE;

    -- Column Collection based on column ID_EXAM_REQ_DET
    TYPE id_exam_req_det_cc IS TABLE OF exam_req_det.id_exam_req_det%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_ERD_PARENT
    TYPE id_erd_parent_cc IS TABLE OF exam_req_det.id_erd_parent%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXAM_REQ
    TYPE id_exam_req_cc IS TABLE OF exam_req_det.id_exam_req%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXAM
    TYPE id_exam_cc IS TABLE OF exam_req_det.id_exam%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_STATUS
    TYPE flg_status_cc IS TABLE OF exam_req_det.flg_status%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES
    TYPE notes_cc IS TABLE OF exam_req_det.notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_PRE_REQ
    TYPE flg_pre_req_cc IS TABLE OF exam_req_det.flg_pre_req%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_MOVEMENT
    TYPE id_movement_cc IS TABLE OF exam_req_det.id_movement%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_CANCEL
    TYPE id_prof_cancel_cc IS TABLE OF exam_req_det.id_prof_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_CANCEL
    TYPE notes_cancel_cc IS TABLE OF exam_req_det.notes_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column BARCODE
    TYPE barcode_cc IS TABLE OF exam_req_det.barcode%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_ROOM
    TYPE id_room_cc IS TABLE OF exam_req_det.id_room%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_TECH
    TYPE notes_tech_cc IS TABLE OF exam_req_det.notes_tech%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PAT_PREGNANCY
    TYPE id_pat_pregnancy_cc IS TABLE OF exam_req_det.id_pat_pregnancy%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_TARGET_TSTZ
    TYPE dt_target_tstz_cc IS TABLE OF exam_req_det.dt_target_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_FINAL_TARGET_TSTZ
    TYPE dt_final_target_tstz_cc IS TABLE OF exam_req_det.dt_final_target_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_FINAL_RESULT_TSTZ
    TYPE dt_final_result_tstz_cc IS TABLE OF exam_req_det.dt_final_result_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_CANCEL_TSTZ
    TYPE dt_cancel_tstz_cc IS TABLE OF exam_req_det.dt_cancel_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_PERFORMED
    TYPE id_prof_performed_cc IS TABLE OF exam_req_det.id_prof_performed%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column START_TIME
    TYPE start_time_cc IS TABLE OF exam_req_det.start_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column END_TIME
    TYPE end_time_cc IS TABLE OF exam_req_det.end_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_REFERRAL
    TYPE flg_referral_cc IS TABLE OF exam_req_det.flg_referral%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CANCEL_REASON
    TYPE id_cancel_reason_cc IS TABLE OF exam_req_det.id_cancel_reason%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF exam_req_det.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF exam_req_det.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF exam_req_det.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF exam_req_det.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF exam_req_det.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF exam_req_det.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_CLINICAL_PURPOSE
    TYPE flg_clinical_purpose_cc IS TABLE OF exam_req_det.flg_clinical_purpose%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_LOCATION
    TYPE flg_location_cc IS TABLE OF exam_req_det.flg_location%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXEC_INSTITUTION
    TYPE id_exec_institution_cc IS TABLE OF exam_req_det.id_exec_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXAM_CODIFICATION
    TYPE id_exam_codification_cc IS TABLE OF exam_req_det.id_exam_codification%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_TASK_DEPENDENCY
    TYPE id_task_dependency_cc IS TABLE OF exam_req_det.id_task_dependency%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_REQ_ORIGIN_MODULE
    TYPE flg_req_origin_module_cc IS TABLE OF exam_req_det.flg_req_origin_module%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_PERFORMED_REG
    TYPE id_prof_performed_reg_cc IS TABLE OF exam_req_det.id_prof_performed_reg%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_PERFORMED_REG
    TYPE dt_performed_reg_cc IS TABLE OF exam_req_det.dt_performed_reg%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_ORDER_RECURRENCE
    TYPE id_order_recurrence_cc IS TABLE OF exam_req_det.id_order_recurrence%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_FASTING
    TYPE flg_fasting_cc IS TABLE OF exam_req_det.flg_fasting%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_PRN
    TYPE flg_prn_cc IS TABLE OF exam_req_det.flg_prn%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column PRN_NOTES
    TYPE prn_notes_cc IS TABLE OF exam_req_det.prn_notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PAT_HEALTH_PLAN
    TYPE id_pat_health_plan_cc IS TABLE OF exam_req_det.id_pat_health_plan%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CDR
    TYPE id_cdr_cc IS TABLE OF exam_req_det.id_cdr%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column PROF_DEP_CLIN_SERV
    TYPE prof_dep_clin_serv_cc IS TABLE OF exam_req_det.prof_dep_clin_serv%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_LATERALITY
    TYPE flg_laterality_cc IS TABLE OF exam_req_det.flg_laterality%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CLINICAL_PURPOSE_NOTES
    TYPE clinical_purpose_notes_cc IS TABLE OF exam_req_det.clinical_purpose_notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EXAM_GROUP
    TYPE id_exam_group_cc IS TABLE OF exam_req_det.id_exam_group%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_PRIORITY
    TYPE flg_priority_cc IS TABLE OF exam_req_det.flg_priority%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_PATIENT
    TYPE notes_patient_cc IS TABLE OF exam_req_det.notes_patient%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_LAST_UPDATE
    TYPE id_prof_last_update_cc IS TABLE OF exam_req_det.id_prof_last_update%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_LAST_UPDATE_TSTZ
    TYPE dt_last_update_tstz_cc IS TABLE OF exam_req_det.dt_last_update_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PAT_EXEMPTION
    TYPE id_pat_exemption_cc IS TABLE OF exam_req_det.id_pat_exemption%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EPIS_DOC_PERFORM
    TYPE id_epis_doc_perform_cc IS TABLE OF exam_req_det.id_epis_doc_perform%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CO_SIGN_ORDER
    TYPE id_co_sign_order_cc IS TABLE OF exam_req_det.id_co_sign_order%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CO_SIGN_CANCEL
    TYPE id_co_sign_cancel_cc IS TABLE OF exam_req_det.id_co_sign_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_SCHEDULER
    TYPE notes_scheduler_cc IS TABLE OF exam_req_det.notes_scheduler%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CLINICAL_PURPOSE
    TYPE id_clinical_purpose_cc IS TABLE OF exam_req_det.id_clinical_purpose%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DIAGNOSIS_NOTES
    TYPE diagnosis_notes_cc IS TABLE OF exam_req_det.diagnosis_notes%TYPE INDEX BY BINARY_INTEGER;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN exam_req_det.id_exam_req_det%TYPE;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN exam_req_det.id_exam_req_det%TYPE;
    ...
    PROCEDURE initrec(exam_req_det_inout IN OUT exam_req_det%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN exam_req_det%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN exam_req_det_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN exam_req_det_tc;
