/*-- Last Change Revision: $Rev: 2029023 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:49:21 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE pk_trauma_core IS

    -- Author  : JOSE.BRITO
    -- Created : 22-06-2009 15:34:37
    -- Purpose : Trauma registration functions
    ...
    * @since   08-09-2010
    */
    FUNCTION get_triss_id_score(i_lang IN language.id_language%TYPE) RETURN NUMBER;
