...
CREATE OR REPLACE PACKAGE ts_pn_dblock_mkt
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on pn_dblock_mkt
    TYPE pn_dblock_mkt_tc IS TABLE OF pn_dblock_mkt%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE pn_dblock_mkt_ntt IS TABLE OF pn_dblock_mkt%ROWTYPE;
    TYPE pn_dblock_mkt_vat IS VARRAY(100) OF pn_dblock_mkt%ROWTYPE;

    -- Column Collection based on column ID_MARKET
    TYPE id_market_cc IS TABLE OF pn_dblock_mkt.id_market%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PN_NOTE_TYPE
    TYPE id_pn_note_type_cc IS TABLE OF pn_dblock_mkt.id_pn_note_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PN_DATA_BLOCK
    TYPE id_pn_data_block_cc IS TABLE OF pn_dblock_mkt.id_pn_data_block%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_SOFTWARE
    TYPE id_software_cc IS TABLE OF pn_dblock_mkt.id_software%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PN_SOAP_BLOCK
    TYPE id_pn_soap_block_cc IS TABLE OF pn_dblock_mkt.id_pn_soap_block%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_IMPORT
    TYPE flg_import_cc IS TABLE OF pn_dblock_mkt.flg_import%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SELECT
    TYPE flg_select_cc IS TABLE OF pn_dblock_mkt.flg_select%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SCOPE
    TYPE flg_scope_cc IS TABLE OF pn_dblock_mkt.flg_scope%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column RANK
    TYPE rank_cc IS TABLE OF pn_dblock_mkt.rank%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF pn_dblock_mkt.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF pn_dblock_mkt.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF pn_dblock_mkt.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF pn_dblock_mkt.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF pn_dblock_mkt.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF pn_dblock_mkt.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_ACTIONS_AVAILABLE
    TYPE flg_actions_available_cc IS TABLE OF pn_dblock_mkt.flg_actions_available%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_LINE_ON_BOXES
    TYPE flg_line_on_boxes_cc IS TABLE OF pn_dblock_mkt.flg_line_on_boxes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column GENDER
    TYPE gender_cc IS TABLE OF pn_dblock_mkt.gender%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column AGE_MIN
    TYPE age_min_cc IS TABLE OF pn_dblock_mkt.age_min%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column AGE_MAX
    TYPE age_max_cc IS TABLE OF pn_dblock_mkt.age_max%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_PREGNANT
    TYPE flg_pregnant_cc IS TABLE OF pn_dblock_mkt.flg_pregnant%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_OUTSIDE_PERIOD
    TYPE flg_outside_period_cc IS TABLE OF pn_dblock_mkt.flg_outside_period%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DAYS_AVAILABLE_PERIOD
    TYPE days_available_period_cc IS TABLE OF pn_dblock_mkt.days_available_period%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_MANDATORY
    TYPE flg_mandatory_cc IS TABLE OF pn_dblock_mkt.flg_mandatory%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_CP_NO_CHANGES_IMPORT
    TYPE flg_cp_no_changes_import_cc IS TABLE OF pn_dblock_mkt.flg_cp_no_changes_import%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_IMPORT_DATE
    TYPE flg_import_date_cc IS TABLE OF pn_dblock_mkt.flg_import_date%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_GROUP_ON_IMPORT
    TYPE flg_group_on_import_cc IS TABLE OF pn_dblock_mkt.flg_group_on_import%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PNDB_PARENT
    TYPE id_pndb_parent_cc IS TABLE OF pn_dblock_mkt.id_pndb_parent%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_STRUCT_TYPE
    TYPE flg_struct_type_cc IS TABLE OF pn_dblock_mkt.flg_struct_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SHOW_TITLE
    TYPE flg_show_title_cc IS TABLE OF pn_dblock_mkt.flg_show_title%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SHOW_SUB_TITLE
    TYPE flg_show_sub_title_cc IS TABLE OF pn_dblock_mkt.flg_show_sub_title%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_DATA_REMOVABLE
    TYPE flg_data_removable_cc IS TABLE OF pn_dblock_mkt.flg_data_removable%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column AUTO_POP_EXEC_PROF_CAT
    TYPE auto_pop_exec_prof_cat_cc IS TABLE OF pn_dblock_mkt.auto_pop_exec_prof_cat%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_FOCUS
    TYPE flg_focus_cc IS TABLE OF pn_dblock_mkt.flg_focus%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_EDITABLE
    TYPE flg_editable_cc IS TABLE OF pn_dblock_mkt.flg_editable%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_GROUP_SELECT_FILTER
    TYPE flg_group_select_filter_cc IS TABLE OF pn_dblock_mkt.flg_group_select_filter%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_TASK_TYPE
    TYPE id_task_type_cc IS TABLE OF pn_dblock_mkt.id_task_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_ORDER_TYPE
    TYPE flg_order_type_cc IS TABLE OF pn_dblock_mkt.flg_order_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SIGNATURE
    TYPE flg_signature_cc IS TABLE OF pn_dblock_mkt.flg_signature%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_MIN_VALUE
    TYPE flg_min_value_cc IS TABLE OF pn_dblock_mkt.flg_min_value%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_DEFAULT_VALUE
    TYPE flg_default_value_cc IS TABLE OF pn_dblock_mkt.flg_default_value%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_MAX_VALUE
    TYPE flg_max_value_cc IS TABLE OF pn_dblock_mkt.flg_max_value%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_FORMAT
    TYPE flg_format_cc IS TABLE OF pn_dblock_mkt.flg_format%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_VALIDATION
    TYPE flg_validation_cc IS TABLE OF pn_dblock_mkt.flg_validation%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PNDB_RELATED
    TYPE id_pndb_related_cc IS TABLE OF pn_dblock_mkt.id_pndb_related%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_SWF_FILE_VIEWER
    TYPE id_swf_file_viewer_cc IS TABLE OF pn_dblock_mkt.id_swf_file_viewer%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column VALUE_VIEWER
    TYPE value_viewer_cc IS TABLE OF pn_dblock_mkt.value_viewer%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column MIN_DAYS_PERIOD
    TYPE min_days_period_cc IS TABLE OF pn_dblock_mkt.min_days_period%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column MAX_DAYS_PERIOD
    TYPE max_days_period_cc IS TABLE OF pn_dblock_mkt.max_days_period%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DEFAULT_DAYS_PERIOD
    TYPE default_days_period_cc IS TABLE OF pn_dblock_mkt.default_days_period%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_EXC_SUM_PAGE_DA
    TYPE flg_exc_sum_page_da_cc IS TABLE OF pn_dblock_mkt.flg_exc_sum_page_da%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_GROUP_TYPE
    TYPE flg_group_type_cc IS TABLE OF pn_dblock_mkt.flg_group_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DESC_FUNCTION
    TYPE desc_function_cc IS TABLE OF pn_dblock_mkt.desc_function%TYPE INDEX BY BINARY_INTEGER;
    ...
    PROCEDURE initrec(pn_dblock_mkt_inout IN OUT pn_dblock_mkt%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN pn_dblock_mkt%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_dblock_mkt_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_dblock_mkt_tc;
