/*-- Last Change Revision: $Rev: 2029319 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:51:00 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE ts_production_target_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {1BD37A66-EA60-4927-9A64-F6DD89237236}
| Created On: Junho 29, 2009 18:32:10
| Created By: ALERT
*/
 IS

    -- Collection of %ROWTYPE records based on "PRODUCTION_TARGET_HIST"
    TYPE production_target_hist_tc IS TABLE OF production_target_hist%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE production_target_hist_ntt IS TABLE OF production_target_hist%ROWTYPE;
    TYPE production_target_hist_vat IS VARRAY(100) OF production_target_hist%ROWTYPE;

    -- Same type structure, with a static name.
    TYPE aat IS TABLE OF production_target_hist%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE ntt IS TABLE OF production_target_hist%ROWTYPE;
    TYPE vat IS VARRAY(100) OF production_target_hist%ROWTYPE;

    -- Column Collection based on column "ID_PRODUCTION_TARGET_HIST"
    TYPE id_production_target_hist_cc IS TABLE OF production_target_hist.id_production_target_hist%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_PRODUCTION_TARGET"
    TYPE id_production_target_cc IS TABLE OF production_target_hist.id_production_target%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_PROFESSIONAL_SUBJECT"
    TYPE id_professional_subject_cc IS TABLE OF production_target_hist.id_professional_subject%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_DCS_SUBJECT"
    TYPE id_dcs_subject_cc IS TABLE OF production_target_hist.id_dcs_subject%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_DCS_TYPE_SLOT"
    TYPE id_dcs_type_slot_cc IS TABLE OF production_target_hist.id_dcs_type_slot%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_SCH_EVENT"
    TYPE id_sch_event_cc IS TABLE OF production_target_hist.id_sch_event%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_SCH_DEP_TYPE"
    TYPE id_sch_dep_type_cc IS TABLE OF production_target_hist.id_sch_dep_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_INSTITUTION"
    TYPE id_institution_cc IS TABLE OF production_target_hist.id_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "ID_SOFTWARE"
    TYPE id_software_cc IS TABLE OF production_target_hist.id_software%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "DT_START"
    TYPE dt_start_cc IS TABLE OF production_target_hist.dt_start%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "DT_END"
    TYPE dt_end_cc IS TABLE OF production_target_hist.dt_end%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "TARGET"
    TYPE target_cc IS TABLE OF production_target_hist.target%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "NOTES"
    TYPE notes_cc IS TABLE OF production_target_hist.notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "FLG_AVAILABLE"
    TYPE flg_available_cc IS TABLE OF production_target_hist.flg_available%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "DT_CREATE"
    TYPE dt_create_cc IS TABLE OF production_target_hist.dt_create%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "PROF_CREATE"
    TYPE prof_create_cc IS TABLE OF production_target_hist.prof_create%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "CREATE_USER"
    TYPE create_user_cc IS TABLE OF production_target_hist.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "CREATE_TIME"
    TYPE create_time_cc IS TABLE OF production_target_hist.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "CREATE_INSTITUTION"
    TYPE create_institution_cc IS TABLE OF production_target_hist.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "UPDATE_USER"
    TYPE update_user_cc IS TABLE OF production_target_hist.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "UPDATE_TIME"
    TYPE update_time_cc IS TABLE OF production_target_hist.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column "UPDATE_INSTITUTION"
    TYPE update_institution_cc IS TABLE OF production_target_hist.update_institution%TYPE INDEX BY BINARY_INTEGER;
    ...
    (
       ...
       ,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN production_target_hist.id_production_target_hist%TYPE;
    ...
    -- Delete all rows for this PTTHDCSS_FK foreign key value
    ...
    -- Delete all rows for this PTTHDCSTS_FK foreign key value
    ...
    -- Delete all rows for this PTTHI_FK foreign key value
    ...
    -- Delete all rows for this PTTHPRC_FK foreign key value
    ...
    -- Delete all rows for this PTTHPRF_FK foreign key value
    ...
    -- Delete all rows for this PTTHSDT_FK foreign key value
    ...
    -- Delete all rows for this PTTHSE_FK foreign key value
    ...
    -- Delete all rows for this PTTHST_FK foreign key value
    ...
    PROCEDURE initrec(production_target_hist_inout IN OUT production_target_hist%ROWTYPE);

    FUNCTION initrec RETURN production_target_hist%ROWTYPE;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN production_target_hist_tc;

    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN production_target_hist_tc;
