...
CREATE OR REPLACE PACKAGE ts_task_goal_det_hist IS

    -- Author  : JOAO.ALMEIDA
    -- Created : 13-04-2010 15:21:27
    -- Purpose : 

  -- Collection of %ROWTYPE records based on "TASK_GOAL_DET_HIST"
     TYPE TASK_GOAL_DET_HIST_tc IS TABLE OF TASK_GOAL_DET_HIST%ROWTYPE INDEX BY BINARY_INTEGER;
     TYPE task_goal_det_hist_ntt IS TABLE OF TASK_GOAL_DET_HIST%ROWTYPE;
     TYPE task_goal_det_hist_vat IS VARRAY(100) OF TASK_GOAL_DET_HIST%ROWTYPE;

  -- Same type structure, with a static name.
     TYPE aat IS TABLE OF TASK_GOAL_DET_HIST%ROWTYPE INDEX BY BINARY_INTEGER;
     TYPE ntt IS TABLE OF TASK_GOAL_DET_HIST%ROWTYPE;
     TYPE vat IS VARRAY(100) OF TASK_GOAL_DET_HIST%ROWTYPE;

   -- Column Collection based on column "ID_TASK_GOAL_DET_HIST"
   TYPE ID_TASK_GOAL_DET_HIST_cc IS TABLE OF TASK_GOAL_DET_HIST.ID_TASK_GOAL_DET_HIST%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_TASK_GOAL_DET"
   TYPE ID_TASK_GOAL_DET_cc IS TABLE OF TASK_GOAL_DET_HIST.ID_TASK_GOAL_DET%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "ID_TASK_GOAL"
   TYPE ID_TASK_GOAL_cc IS TABLE OF TASK_GOAL_DET_HIST.ID_TASK_GOAL%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "DESC_TASK_GOAL"
   TYPE DESC_TASK_GOAL_cc IS TABLE OF TASK_GOAL_DET_HIST.DESC_TASK_GOAL%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_USER"
   TYPE CREATE_USER_cc IS TABLE OF TASK_GOAL_DET_HIST.CREATE_USER%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_TIME"
   TYPE CREATE_TIME_cc IS TABLE OF TASK_GOAL_DET_HIST.CREATE_TIME%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "CREATE_INSTITUTION"
   TYPE CREATE_INSTITUTION_cc IS TABLE OF TASK_GOAL_DET_HIST.CREATE_INSTITUTION%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_USER"
   TYPE UPDATE_USER_cc IS TABLE OF TASK_GOAL_DET_HIST.UPDATE_USER%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_TIME"
   TYPE UPDATE_TIME_cc IS TABLE OF TASK_GOAL_DET_HIST.UPDATE_TIME%TYPE INDEX BY BINARY_INTEGER;
   -- Column Collection based on column "UPDATE_INSTITUTION"
   TYPE UPDATE_INSTITUTION_cc IS TABLE OF TASK_GOAL_DET_HIST.UPDATE_INSTITUTION%TYPE INDEX BY BINARY_INTEGER;
...
-- Delete one row by primary key
   ...
   -- Delete all rows for this TGLDH_TGLD_FK foreign key value
   ...
   -- Delete all rows for this TGLDH_TGL_FK foreign key value
