...
CREATE OR REPLACE PACKAGE pk_bodystructure_PRM is
		...
		FUNCTION load_body_structure_def(i_lang       IN language.id_language%TYPE,
		...
		FUNCTION set_body_structure_freq(i_lang              IN language.id_language%TYPE,
