/*-- Last Change Revision: $Rev: 2028689 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:47:20 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE pk_exams_external_api_db IS
    ...
    * @param     i_prof         Professional
    * @param     i_patient      Patient id
    * @param     o_num_occur    Number of exams for the given patient
    ...
    */
    ...
    /*
    * Gets images and other exams for CDA section that are pending and future scheduled
    *
    * @param     i_lang         Language id
    * @param     i_prof         Professional
    * @param     i_scope        ID for scope type
    * @param     i_scope_type   Scope type (E)pisode/(V)isit/(P)atient
    * @param     o_exam_cda     Cursor
    * @param     o_error        Error message
