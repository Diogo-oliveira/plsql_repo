/*-- Last Change Revision: $Rev: 2012125 $*/
/*-- Last Change by: $Author: elisabete.bugalho $*/
/*-- Date of last change: $Date: 2022-04-05 14:46:27 +0100 (ter, 05 abr 2022) $*/

CREATE OR REPLACE PACKAGE pk_paramedical_ux IS

    -- Author  : NUNO.COELHO
    -- Created : 15-11-2018 10:27:26
    -- Purpose : Package for psychologist used by UX

    /*
    *******************************************************************************************
      * Get all parametrizations for the psychologist software
      *
    ...
    *******************************************************************************************
    ...
    /* *******************************************************************************************
    *  Get current state of psychology diagnoses for viewer checklist 
    *             
    * @param    i_lang           Language ID
    * @param    i_prof           Logged professional structure
    * @param    i_scope_type     Scope flag | 'P' - Patient, 'E' - Episode, 'V' - Visit 
