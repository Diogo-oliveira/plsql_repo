...
CREATE OR REPLACE PACKAGE ts_comm_order_plan
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on comm_order_plan
    TYPE comm_order_plan_tc IS TABLE OF comm_order_plan%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE comm_order_plan_ntt IS TABLE OF comm_order_plan%ROWTYPE;
    TYPE comm_order_plan_vat IS VARRAY(100) OF comm_order_plan%ROWTYPE;

    -- Column Collection based on column ID_COMM_ORDER_PLAN
    TYPE id_comm_order_plan_cc IS TABLE OF comm_order_plan.id_comm_order_plan%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_COMM_ORDER_REQ
    TYPE id_comm_order_req_cc IS TABLE OF comm_order_plan.id_comm_order_req%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_TAKE
    TYPE id_prof_take_cc IS TABLE OF comm_order_plan.id_prof_take%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES
    TYPE notes_cc IS TABLE OF comm_order_plan.notes%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_STATUS
    TYPE flg_status_cc IS TABLE OF comm_order_plan.flg_status%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_CANCEL
    TYPE id_prof_cancel_cc IS TABLE OF comm_order_plan.id_prof_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column NOTES_CANCEL
    TYPE notes_cancel_cc IS TABLE OF comm_order_plan.notes_cancel%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_WOUND_TREAT
    TYPE id_wound_treat_cc IS TABLE OF comm_order_plan.id_wound_treat%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EPISODE_WRITE
    TYPE id_episode_write_cc IS TABLE OF comm_order_plan.id_episode_write%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_PLAN_TSTZ
    TYPE dt_plan_tstz_cc IS TABLE OF comm_order_plan.dt_plan_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_TAKE_TSTZ
    TYPE dt_take_tstz_cc IS TABLE OF comm_order_plan.dt_take_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_CANCEL_TSTZ
    TYPE dt_cancel_tstz_cc IS TABLE OF comm_order_plan.dt_cancel_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_PERFORMED
    TYPE id_prof_performed_cc IS TABLE OF comm_order_plan.id_prof_performed%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column START_TIME
    TYPE start_time_cc IS TABLE OF comm_order_plan.start_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column END_TIME
    TYPE end_time_cc IS TABLE OF comm_order_plan.end_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_COMM_ORDER_PLAN
    TYPE dt_comm_order_plan_cc IS TABLE OF comm_order_plan.dt_comm_order_plan%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF comm_order_plan.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF comm_order_plan.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF comm_order_plan.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF comm_order_plan.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF comm_order_plan.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF comm_order_plan.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SUPPLIES_REG
    TYPE flg_supplies_reg_cc IS TABLE OF comm_order_plan.flg_supplies_reg%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CANCEL_REASON
    TYPE id_cancel_reason_cc IS TABLE OF comm_order_plan.id_cancel_reason%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_CDR_EVENT
    TYPE id_cdr_event_cc IS TABLE OF comm_order_plan.id_cdr_event%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_EPIS_DOCUMENTATION
    TYPE id_epis_documentation_cc IS TABLE OF comm_order_plan.id_epis_documentation%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column EXEC_NUMBER
    TYPE exec_number_cc IS TABLE OF comm_order_plan.exec_number%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PROF_LAST_UPDATE
    TYPE id_prof_last_update_cc IS TABLE OF comm_order_plan.id_prof_last_update%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DT_LAST_UPDATE_TSTZ
    TYPE dt_last_update_tstz_cc IS TABLE OF comm_order_plan.dt_last_update_tstz%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PO_PARAM_REG
    TYPE id_po_param_reg_cc IS TABLE OF comm_order_plan.id_po_param_reg%TYPE INDEX BY BINARY_INTEGER;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN comm_order_plan.id_comm_order_plan%TYPE;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN comm_order_plan.id_comm_order_plan%TYPE;
    ...
    PROCEDURE initrec(comm_order_plan_inout IN OUT comm_order_plan%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN comm_order_plan%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN comm_order_plan_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN comm_order_plan_tc;
