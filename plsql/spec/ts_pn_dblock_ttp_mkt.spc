...
CREATE OR REPLACE PACKAGE ts_pn_dblock_ttp_mkt
/*
...
*/
 IS
    ...
    -- Collection of %ROWTYPE records based on pn_dblock_ttp_mkt
    TYPE pn_dblock_ttp_mkt_tc IS TABLE OF pn_dblock_ttp_mkt%ROWTYPE INDEX BY BINARY_INTEGER;
    TYPE pn_dblock_ttp_mkt_ntt IS TABLE OF pn_dblock_ttp_mkt%ROWTYPE;
    TYPE pn_dblock_ttp_mkt_vat IS VARRAY(100) OF pn_dblock_ttp_mkt%ROWTYPE;

    -- Column Collection based on column ID_PN_SOAP_BLOCK
    TYPE id_pn_soap_block_cc IS TABLE OF pn_dblock_ttp_mkt.id_pn_soap_block%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PN_NOTE_TYPE
    TYPE id_pn_note_type_cc IS TABLE OF pn_dblock_ttp_mkt.id_pn_note_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_TASK_TYPE
    TYPE id_task_type_cc IS TABLE OF pn_dblock_ttp_mkt.id_task_type%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_PN_DATA_BLOCK
    TYPE id_pn_data_block_cc IS TABLE OF pn_dblock_ttp_mkt.id_pn_data_block%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_SOFTWARE
    TYPE id_software_cc IS TABLE OF pn_dblock_ttp_mkt.id_software%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_MARKET
    TYPE id_market_cc IS TABLE OF pn_dblock_ttp_mkt.id_market%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_AUTO_POPULATED
    TYPE flg_auto_populated_cc IS TABLE OF pn_dblock_ttp_mkt.flg_auto_populated%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_USER
    TYPE create_user_cc IS TABLE OF pn_dblock_ttp_mkt.create_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_TIME
    TYPE create_time_cc IS TABLE OF pn_dblock_ttp_mkt.create_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column CREATE_INSTITUTION
    TYPE create_institution_cc IS TABLE OF pn_dblock_ttp_mkt.create_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_USER
    TYPE update_user_cc IS TABLE OF pn_dblock_ttp_mkt.update_user%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_TIME
    TYPE update_time_cc IS TABLE OF pn_dblock_ttp_mkt.update_time%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column UPDATE_INSTITUTION
    TYPE update_institution_cc IS TABLE OF pn_dblock_ttp_mkt.update_institution%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SELECTED
    TYPE flg_selected_cc IS TABLE OF pn_dblock_ttp_mkt.flg_selected%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_IMPORT_FILTER
    TYPE flg_import_filter_cc IS TABLE OF pn_dblock_ttp_mkt.flg_import_filter%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column LAST_N_RECORDS_NR
    TYPE last_n_records_nr_cc IS TABLE OF pn_dblock_ttp_mkt.last_n_records_nr%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SHORTCUT_FILTER
    TYPE flg_shortcut_filter_cc IS TABLE OF pn_dblock_ttp_mkt.flg_shortcut_filter%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_SYNCHRONIZED
    TYPE flg_synchronized_cc IS TABLE OF pn_dblock_ttp_mkt.flg_synchronized%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column REVIEW_CAT
    TYPE review_cat_cc IS TABLE OF pn_dblock_ttp_mkt.review_cat%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_REVIEW_AVAIL
    TYPE flg_review_avail_cc IS TABLE OF pn_dblock_ttp_mkt.flg_review_avail%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column FLG_DESCRIPTION
    TYPE flg_description_cc IS TABLE OF pn_dblock_ttp_mkt.flg_description%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column DESCRIPTION_CONDITION
    TYPE description_condition_cc IS TABLE OF pn_dblock_ttp_mkt.description_condition%TYPE INDEX BY BINARY_INTEGER;
-- Column Collection based on column FLG_DT_TASK
TYPE FLG_DT_TASK_CC IS TABLE OF pn_dblock_ttp_mkt.FLG_DT_TASK%TYPE INDEX BY BINARY_INTEGER;
    -- Column Collection based on column ID_TASK_RELATED
    TYPE id_task_related_cc IS TABLE OF pn_dblock_ttp_mkt.id_task_related%TYPE INDEX BY BINARY_INTEGER;
...
FLG_DT_TASK_in IN PN_DBLOCK_TTP_MKT.FLG_DT_TASK%TYPE DEFAULT NULL,
    ...
    PROCEDURE initrec(pn_dblock_ttp_mkt_inout IN OUT pn_dblock_ttp_mkt%ROWTYPE);

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN pn_dblock_ttp_mkt%ROWTYPE;

    -- Get data rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_dblock_ttp_mkt_tc;

    -- Get data rowid pragma autonomous transaccion
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_dblock_ttp_mkt_tc;
