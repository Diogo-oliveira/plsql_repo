...
CREATE OR REPLACE PACKAGE BODY ts_pn_area_mkt
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Novembro 13, 2014 15:52:2
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_software_in            IN pn_area_mkt.id_software%TYPE,
        id_market_in              IN pn_area_mkt.id_market%TYPE,
        id_pn_area_in             IN pn_area_mkt.id_pn_area%TYPE,
        nr_rec_page_summary_in    IN pn_area_mkt.nr_rec_page_summary%TYPE DEFAULT 5,
        data_sort_summary_in      IN pn_area_mkt.data_sort_summary%TYPE DEFAULT 'DESC',
        nr_rec_page_hist_in       IN pn_area_mkt.nr_rec_page_hist%TYPE DEFAULT 5,
        flg_report_title_type_in  IN pn_area_mkt.flg_report_title_type%TYPE DEFAULT 'B',
        create_user_in            IN pn_area_mkt.create_user%TYPE DEFAULT NULL,
        create_time_in            IN pn_area_mkt.create_time%TYPE DEFAULT NULL,
        create_institution_in     IN pn_area_mkt.create_institution%TYPE DEFAULT NULL,
        update_user_in            IN pn_area_mkt.update_user%TYPE DEFAULT NULL,
        update_time_in            IN pn_area_mkt.update_time%TYPE DEFAULT NULL,
        update_institution_in     IN pn_area_mkt.update_institution%TYPE DEFAULT NULL,
        summary_default_filter_in IN pn_area_mkt.summary_default_filter%TYPE DEFAULT 'N',
        time_to_close_note_in     IN pn_area_mkt.time_to_close_note%TYPE DEFAULT NULL,
        time_to_start_docum_in    IN pn_area_mkt.time_to_start_docum%TYPE DEFAULT NULL,
        id_report_in              IN pn_area_mkt.id_report%TYPE DEFAULT NULL,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO pn_area_mkt
            (id_pn_area,
             id_software,
             id_market,
             nr_rec_page_summary,
    ...
    PROCEDURE ins
    (
        rec_in          IN pn_area_mkt%ROWTYPE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec pn_area_mkt%ROWTYPE := rec_in;
    BEGIN
    ...
    (
        ...
        id_market_in               IN pn_area_mkt.id_market%TYPE,
        id_pn_area_in              IN pn_area_mkt.id_pn_area%TYPE,
        nr_rec_page_summary_in     IN pn_area_mkt.nr_rec_page_summary%TYPE DEFAULT NULL,
        nr_rec_page_summary_nin    IN BOOLEAN := TRUE,
        data_sort_summary_in       IN pn_area_mkt.data_sort_summary%TYPE DEFAULT NULL,
        data_sort_summary_nin      IN BOOLEAN := TRUE,
        nr_rec_page_hist_in        IN pn_area_mkt.nr_rec_page_hist%TYPE DEFAULT NULL,
        nr_rec_page_hist_nin       IN BOOLEAN := TRUE,
        flg_report_title_type_in   IN pn_area_mkt.flg_report_title_type%TYPE DEFAULT NULL,
        ...
        summary_default_filter_in  IN pn_area_mkt.summary_default_filter%TYPE DEFAULT NULL,
    ...
    (
        ...
        l_time_to_start_docum_n    NUMBER(1);
        l_id_report_n              NUMBER(1);
        id_software_in             pn_area_mkt.id_software%TYPE;
        id_market_in               pn_area_mkt.id_market%TYPE;
        id_pn_area_in              pn_area_mkt.id_pn_area%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PN_AREA_MKT SET ' || ' NR_REC_PAGE_SUMMARY = decode (' || l_nr_rec_page_summary_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN nr_rec_page_summary_in, data_sort_summary_in, nr_rec_page_hist_in, flg_report_title_type_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, summary_default_filter_in, time_to_close_note_in, time_to_start_docum_in, id_report_in, OUT l_rows_out;
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PN_AREA_MKT
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PN_AREA_MKT set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PN_AREA_MKT set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM pn_area_mkt
         WHERE id_market = del_pnam_mrk_fk.id_market_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pnam_mrk_fk(id_market_in => id_market_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pnam_mrk_fk;

    PROCEDURE del_pnam_pna_fk
    (
        id_pn_area_in   IN pn_area_mkt.id_pn_area%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    BEGIN
        DELETE FROM pn_area_mkt
         WHERE id_pn_area = del_pnam_pna_fk.id_pn_area_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pnam_pna_fk(id_pn_area_in => id_pn_area_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pnam_pna_fk;

    PROCEDURE del_pnam_s_fk
    (
        id_software_in  IN pn_area_mkt.id_software%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    BEGIN
        DELETE FROM pn_area_mkt
         WHERE id_software = del_pnam_s_fk.id_software_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pnam_s_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pnam_s_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PN_AREA_MKT';
        ELSE
            RETURN 'DELETE FROM PN_AREA_MKT WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pn_area_mkt_inout IN OUT pn_area_mkt%ROWTYPE) IS
    BEGIN
        pn_area_mkt_inout.id_pn_area             := NULL;
        pn_area_mkt_inout.id_software            := NULL;
        pn_area_mkt_inout.id_market              := NULL;
        pn_area_mkt_inout.nr_rec_page_summary    := 5;
        pn_area_mkt_inout.data_sort_summary      := 'DESC';
        pn_area_mkt_inout.nr_rec_page_hist       := 5;
        pn_area_mkt_inout.flg_report_title_type  := 'B';
        pn_area_mkt_inout.create_user            := NULL;
        pn_area_mkt_inout.create_time            := NULL;
        pn_area_mkt_inout.create_institution     := NULL;
        pn_area_mkt_inout.update_user            := NULL;
        pn_area_mkt_inout.update_time            := NULL;
        pn_area_mkt_inout.update_institution     := NULL;
        pn_area_mkt_inout.summary_default_filter := 'N';
        pn_area_mkt_inout.time_to_close_note     := NULL;
        pn_area_mkt_inout.time_to_start_docum    := NULL;
        pn_area_mkt_inout.id_report              := NULL;
    END initrec;

    FUNCTION initrec RETURN pn_area_mkt%ROWTYPE IS
        l_pn_area_mkt pn_area_mkt%ROWTYPE;
    BEGIN
        l_pn_area_mkt.nr_rec_page_summary    := 5;
        l_pn_area_mkt.data_sort_summary      := 'DESC';
        l_pn_area_mkt.nr_rec_page_hist       := 5;
        l_pn_area_mkt.flg_report_title_type  := 'B';
        l_pn_area_mkt.summary_default_filter := 'N';
        RETURN l_pn_area_mkt;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_area_mkt_tc IS
        data pn_area_mkt_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_area_mkt_tc IS
