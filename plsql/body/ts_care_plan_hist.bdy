/*-- Last Change Revision: $Rev: 2027976 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:51 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_care_plan_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Fevereiro 21, 2011 15:16:47
| Created By: ALERT
*/
 IS
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'CARE_PLAN_HIST');
                    IF l_name = 'CPNH_CPN_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_CARE_PLAN',
                                                        value_in           => id_care_plan_in);
                    END IF;
                    IF l_name = 'CPNH_CPY_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
    ...
    BEGIN
        ...
        ins(dt_care_plan_hist_in   => dt_care_plan_hist_in,
            id_care_plan_in        => id_care_plan_in,
    ...
    (
        ...
        l_rec care_plan_hist%ROWTYPE := rec_in;
    BEGIN
        ins(dt_care_plan_hist_in   => l_rec.dt_care_plan_hist,
            id_care_plan_in        => l_rec.id_care_plan,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_CARE_PLAN_HIST _' || indx,
                                                        value_in           => rows_in(indx).dt_care_plan_hist,
                                                        validate_in        => FALSE);
    ...
    BEGIN
        ...
        UPDATE care_plan_hist
         ...
         WHERE dt_care_plan_hist = dt_care_plan_hist_in
           AND id_care_plan = id_care_plan_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(dt_care_plan_hist_in    => dt_care_plan_hist_in,
            id_care_plan_in         => id_care_plan_in,
            id_prof_in              => id_prof_in,
    ...
    (
        ...
        l_update_institution_n  NUMBER(1);
        l_id_cancel_reason_n    NUMBER(1);
        dt_care_plan_hist_in    care_plan_hist.dt_care_plan_hist%TYPE;
        id_care_plan_in         care_plan_hist.id_care_plan%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE CARE_PLAN_HIST SET ' || ' ID_PROF = decode (' || l_id_prof_n ||
    ...
    BEGIN
        upd(dt_care_plan_hist_in   => rec_in.dt_care_plan_hist,
            id_care_plan_in        => rec_in.id_care_plan,
    ...
    (
        ...
        l_dt_care_plan_hist   dt_care_plan_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_dt_care_plan_hist(i) := col_in(i).dt_care_plan_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE care_plan_hist
                 ...
                 WHERE dt_care_plan_hist = l_dt_care_plan_hist(i)
                   AND id_care_plan = l_id_care_plan(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE care_plan_hist
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE CARE_PLAN_HIST
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE CARE_PLAN_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE CARE_PLAN_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(dt_care_plan_hist_in => dt_care_plan_hist_in,
            id_care_plan_in      => id_care_plan_in,
            handle_error_in      => handle_error_in,
            rows_out             => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dt_care_plan_hist(dt_care_plan_hist_in => dt_care_plan_hist_in,
                              handle_error_in      => handle_error_in,
                              rows_out             => rows_out);
    END del_dt_care_plan_hist;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_care_plan = del_cpnh_cpn_fk.id_care_plan_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_cpn_fk(id_care_plan_in => id_care_plan_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cpnh_cpn_fk;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_care_plan_type = del_cpnh_cpy_fk.id_care_plan_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_cpy_fk(id_care_plan_type_in => id_care_plan_type_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_cpnh_cpy_fk;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_episode = del_cpnh_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cpnh_epis_fk;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_patient = del_cpnh_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cpnh_pat_fk;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_prof = del_cpnh_prl_fk.id_prof_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_prl_fk(id_prof_in => id_prof_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cpnh_prl_fk;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_prof_coordinator = del_cpnh_prl_fk2.id_prof_coordinator_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_prl_fk2(id_prof_coordinator_in => id_prof_coordinator_in,
                         handle_error_in        => handle_error_in,
                         rows_out               => rows_out);
    END del_cpnh_prl_fk2;
    ...
    BEGIN
        DELETE FROM care_plan_hist
         WHERE id_prof_cancel = del_cpnh_prl_fk3.id_prof_cancel_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cpnh_prl_fk3(id_prof_cancel_in => id_prof_cancel_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_cpnh_prl_fk3;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM CARE_PLAN_HIST';
        ELSE
            RETURN 'DELETE FROM CARE_PLAN_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(care_plan_hist_inout IN OUT care_plan_hist%ROWTYPE) IS
    BEGIN
        care_plan_hist_inout.dt_care_plan_hist   := NULL;
        care_plan_hist_inout.id_care_plan        := NULL;
        care_plan_hist_inout.id_prof             := NULL;
        care_plan_hist_inout.dt_care_plan        := NULL;
        care_plan_hist_inout.id_patient          := NULL;
        care_plan_hist_inout.flg_status          := NULL;
        care_plan_hist_inout.name                := NULL;
        care_plan_hist_inout.id_care_plan_type   := NULL;
        care_plan_hist_inout.dt_begin            := NULL;
        care_plan_hist_inout.dt_end              := NULL;
        care_plan_hist_inout.subject_type        := NULL;
        care_plan_hist_inout.id_subject          := NULL;
        care_plan_hist_inout.id_prof_coordinator := NULL;
        care_plan_hist_inout.goals               := NULL;
        care_plan_hist_inout.notes               := NULL;
        care_plan_hist_inout.id_prof_cancel      := NULL;
        care_plan_hist_inout.dt_cancel           := NULL;
        care_plan_hist_inout.notes_cancel        := NULL;
        care_plan_hist_inout.id_episode          := NULL;
        care_plan_hist_inout.create_user         := NULL;
        care_plan_hist_inout.create_time         := NULL;
        care_plan_hist_inout.create_institution  := NULL;
        care_plan_hist_inout.update_user         := NULL;
        care_plan_hist_inout.update_time         := NULL;
        care_plan_hist_inout.update_institution  := NULL;
        care_plan_hist_inout.id_cancel_reason    := NULL;
    END initrec;

    FUNCTION initrec RETURN care_plan_hist%ROWTYPE IS
        l_care_plan_hist care_plan_hist%ROWTYPE;
    BEGIN
        RETURN l_care_plan_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN care_plan_hist_tc IS
        data care_plan_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM care_plan_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN care_plan_hist_tc IS
