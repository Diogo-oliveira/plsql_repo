/*-- Last Change Revision: $Rev: 2028334 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:11 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_production_target
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 29, 2009 18:32:0
| Created By: ALERT
*/
 IS
                ...
                BEGIN
                    ...
                    THEN
                        pk_alert_exceptions.register_error(error_name_in       => 'DUPLICATE-VALUE',
                                                           ...
                                                           text_in             => 'Violation of unique index "PTT_UK"');
    ...
    (
        ...
        l_rec production_target%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_production_target := next_key(sequence_in);
        END IF;
        ins(id_production_target_in    => l_rec.id_production_target,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN production_target.id_production_target%TYPE
     ...
     IS
        retval production_target.id_production_target%TYPE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_PRODUCTION_TARGET'));
    END next_key;
    ...
    (
        ...
        l_pky production_target.id_production_target%TYPE := next_key;
    BEGIN
        ins(id_production_target_in    => l_pky,
            id_professional_subject_in => id_professional_subject_in,
            id_dcs_subject_in          => id_dcs_subject_in,
            id_dcs_type_slot_in        => id_dcs_type_slot_in,
            id_sch_event_in            => id_sch_event_in,
            ...
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
        id_production_target_out := l_pky;
    END ins;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_professional_subject_in => id_professional_subject_in,
            id_dcs_subject_in          => id_dcs_subject_in,
            id_dcs_type_slot_in        => id_dcs_type_slot_in,
            id_sch_event_in            => id_sch_event_in,
            id_sch_dep_type_in         => id_sch_dep_type_in,
            ...
            update_time_in             => update_time_in,
            update_institution_in      => update_institution_in,
            id_production_target_out   => id_production_target_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in            IN BOOLEAN := TRUE,
        rows_out                   OUT table_varchar
    ) RETURN production_target.id_production_target%TYPE IS
        l_pky production_target.id_production_target%TYPE := next_key;
    BEGIN
        ins(id_production_target_in    => l_pky,
            id_professional_subject_in => id_professional_subject_in,
    ...
    BEGIN
        ...
        UPDATE production_target
           SET id_professional_subject = decode(l_id_professional_subject_n,
                                                0,
                                                id_professional_subject_in,
         ...
         WHERE id_production_target = id_production_target_in
    ...
    (
        ...
        l_update_time_n             NUMBER(1);
        l_update_institution_n      NUMBER(1);
        id_production_target_in     production_target.id_production_target%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PRODUCTION_TARGET SET ' || ' ID_PROFESSIONAL_SUBJECT = decode (' ||
                 l_id_professional_subject_n ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_professional_subject_in  => id_professional_subject_in,
            id_professional_subject_nin => id_professional_subject_nin,
            id_dcs_subject_in           => id_dcs_subject_in,
            id_dcs_subject_nin          => id_dcs_subject_nin,
            id_dcs_type_slot_in         => id_dcs_type_slot_in,
    ...
    BEGIN
        upd(id_production_target_in    => rec_in.id_production_target,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_production_target_in,
                id_professional_subject_in,
                id_dcs_subject_in,
                id_dcs_type_slot_in,
                id_sch_event_in,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE production_target
                   SET id_professional_subject = nvl(l_id_professional_subject(i), id_professional_subject),
                 ...
                 WHERE id_production_target = l_id_production_target(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE production_target
                   SET id_professional_subject = l_id_professional_subject(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PRODUCTION_TARGET
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PRODUCTION_TARGET
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PRODUCTION_TARGET set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PRODUCTION_TARGET set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_production_target_in => id_production_target_in,
            handle_error_in         => handle_error_in,
            rows_out                => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_production_target(id_production_target_in => id_production_target_in,
                                 handle_error_in         => handle_error_in,
                                 rows_out                => rows_out);
    END del_id_production_target;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptt_uk(id_professional_subject_in => id_professional_subject_in,
                   id_dcs_subject_in          => id_dcs_subject_in,
                   id_dcs_type_slot_in        => id_dcs_type_slot_in,
                   id_sch_event_in            => id_sch_event_in,
                   id_sch_dep_type_in         => id_sch_dep_type_in,
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_dcs_subject = del_pttdcss_fk.id_dcs_subject_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttdcss_fk(id_dcs_subject_in => id_dcs_subject_in,
                       handle_error_in   => handle_error_in,
                       rows_out          => rows_out);
    END del_pttdcss_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_dcs_type_slot = del_pttdcsts_fk.id_dcs_type_slot_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttdcsts_fk(id_dcs_type_slot_in => id_dcs_type_slot_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_pttdcsts_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_institution = del_ptti_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptti_fk(id_institution_in => id_institution_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ptti_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE prof_create = del_pttprc_fk.prof_create_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttprc_fk(prof_create_in => prof_create_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pttprc_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_professional_subject = del_pttprf_fk.id_professional_subject_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttprf_fk(id_professional_subject_in => id_professional_subject_in,
                      handle_error_in            => handle_error_in,
                      rows_out                   => rows_out);
    END del_pttprf_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_sch_dep_type = del_pttsdt_fk.id_sch_dep_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttsdt_fk(id_sch_dep_type_in => id_sch_dep_type_in,
                      handle_error_in    => handle_error_in,
                      rows_out           => rows_out);
    END del_pttsdt_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_sch_event = del_pttse_fk.id_sch_event_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttse_fk(id_sch_event_in => id_sch_event_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pttse_fk;
    ...
    BEGIN
        DELETE FROM production_target
         WHERE id_software = del_pttst_fk.id_software_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pttst_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pttst_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PRODUCTION_TARGET';
        ELSE
            RETURN 'DELETE FROM PRODUCTION_TARGET WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(production_target_inout IN OUT production_target%ROWTYPE) IS
    BEGIN
        production_target_inout.id_production_target    := NULL;
        production_target_inout.id_professional_subject := NULL;
        production_target_inout.id_dcs_subject          := NULL;
        production_target_inout.id_dcs_type_slot        := NULL;
        production_target_inout.id_sch_event            := NULL;
        production_target_inout.id_sch_dep_type         := NULL;
        production_target_inout.id_institution          := NULL;
        production_target_inout.id_software             := NULL;
        production_target_inout.dt_start                := NULL;
        production_target_inout.dt_end                  := NULL;
        production_target_inout.target                  := NULL;
        production_target_inout.notes                   := NULL;
        production_target_inout.flg_available           := NULL;
        production_target_inout.dt_create               := NULL;
        production_target_inout.prof_create             := NULL;
        production_target_inout.create_user             := NULL;
        production_target_inout.create_time             := NULL;
        production_target_inout.create_institution      := NULL;
        production_target_inout.update_user             := NULL;
        production_target_inout.update_time             := NULL;
        production_target_inout.update_institution      := NULL;
    END initrec;

    FUNCTION initrec RETURN production_target%ROWTYPE IS
        l_production_target production_target%ROWTYPE;
    BEGIN
        RETURN l_production_target;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN production_target_tc IS
        data production_target_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN production_target_tc IS
