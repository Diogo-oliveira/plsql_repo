/*-- Last Change Revision: $Rev: 2028378 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:25 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY TS_ROOM_TYPE
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 4, 2010 15:36:10
| Created By: ALERT
*/
IS
   ...
   PROCEDURE ins (
      id_room_type_in IN ROOM_TYPE.ID_ROOM_TYPE%TYPE
      ,
      flg_available_in IN ROOM_TYPE.FLG_AVAILABLE%TYPE DEFAULT NULL,
      create_user_in IN ROOM_TYPE.CREATE_USER%TYPE DEFAULT NULL,
      create_time_in IN ROOM_TYPE.CREATE_TIME%TYPE DEFAULT NULL,
      create_institution_in IN ROOM_TYPE.CREATE_INSTITUTION%TYPE DEFAULT NULL,
      update_user_in IN ROOM_TYPE.UPDATE_USER%TYPE DEFAULT NULL,
      update_time_in IN ROOM_TYPE.UPDATE_TIME%TYPE DEFAULT NULL,
      update_institution_in IN ROOM_TYPE.UPDATE_INSTITUTION%TYPE DEFAULT NULL,
      id_institution_in IN ROOM_TYPE.ID_INSTITUTION%TYPE DEFAULT NULL,
      code_room_type_in IN ROOM_TYPE.CODE_ROOM_TYPE%TYPE DEFAULT NULL,
      flg_status_in IN ROOM_TYPE.FLG_STATUS%TYPE DEFAULT NULL,
      flg_parameterization_type_in IN ROOM_TYPE.FLG_PARAMETERIZATION_TYPE%TYPE DEFAULT 'C',
      id_professional_in IN ROOM_TYPE.ID_PROFESSIONAL%TYPE DEFAULT NULL,
      dt_creation_in IN ROOM_TYPE.DT_CREATION%TYPE DEFAULT NULL,
      dt_last_update_in IN ROOM_TYPE.DT_LAST_UPDATE%TYPE DEFAULT NULL,
      desc_room_type_in IN ROOM_TYPE.DESC_ROOM_TYPE%TYPE DEFAULT NULL
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'ROOM_TYPE');
           IF l_name = 'RTY_INST_FK'
           THEN
   ...
   BEGIN
     ...
     ins (
      ...
      code_room_type_in => code_room_type_in,
      ...
      desc_room_type_in => desc_room_type_in
   ...
   IS
      l_rec ROOM_TYPE%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_ROOM_TYPE := next_key (sequence_in);
      END IF;
      ins (
         ...
         code_room_type_in => l_rec.CODE_ROOM_TYPE,
         ...
         desc_room_type_in => l_rec.DESC_ROOM_TYPE
         ,handle_error_in => handle_error_in
         , rows_out => rows_out
         );
   END ins;
  ...
  ins (
   ...
   FUNCTION next_key (sequence_in IN VARCHAR2 := NULL) RETURN ROOM_TYPE.ID_ROOM_TYPE%TYPE

   IS
     retval ROOM_TYPE.ID_ROOM_TYPE%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_ROOM_TYPE.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_ROOM_TYPE')
           );
   END next_key;
   ...
   PROCEDURE ins (
      ...
      dt_last_update_in IN ROOM_TYPE.DT_LAST_UPDATE%TYPE DEFAULT NULL,
      desc_room_type_in IN ROOM_TYPE.DESC_ROOM_TYPE%TYPE DEFAULT NULL,
      id_room_type_out IN OUT ROOM_TYPE.ID_ROOM_TYPE%TYPE
      ,handle_error_in IN BOOLEAN := TRUE
      , rows_out OUT TABLE_VARCHAR
   )
   IS
        l_pky ROOM_TYPE.ID_ROOM_TYPE%TYPE := next_key;
   BEGIN
      ins (
         id_room_type_in => l_pky,
         flg_available_in => flg_available_in,
         create_user_in => create_user_in,
         create_time_in => create_time_in,
         create_institution_in => create_institution_in,
   ...
   BEGIN
      ...
      dt_last_update_in => dt_last_update_in,
      desc_room_type_in => desc_room_type_in,
      id_room_type_out => id_room_type_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO ROOM_TYPE VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'CODE_ROOM_TYPE _' || indx
                  ,value_in => rows_in(indx).CODE_ROOM_TYPE
                  ,validate_in => FALSE
                );
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'DESC_ROOM_TYPE _' || indx
                  ,value_in => rows_in(indx).DESC_ROOM_TYPE
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
      ...
      code_room_type_in IN ROOM_TYPE.CODE_ROOM_TYPE%TYPE DEFAULT NULL,
      CODE_ROOM_TYPE_nin IN BOOLEAN := TRUE,
      flg_status_in IN ROOM_TYPE.FLG_STATUS%TYPE DEFAULT NULL,
      FLG_STATUS_nin IN BOOLEAN := TRUE,
      flg_parameterization_type_in IN ROOM_TYPE.FLG_PARAMETERIZATION_TYPE%TYPE DEFAULT NULL,
      ...
      desc_room_type_in IN ROOM_TYPE.DESC_ROOM_TYPE%TYPE DEFAULT NULL,
      DESC_ROOM_TYPE_nin IN BOOLEAN := TRUE,
     handle_error_in IN BOOLEAN := TRUE
   ...
   l_CODE_ROOM_TYPE_n := sys.diutil.bool_to_int(CODE_ROOM_TYPE_nin);
   ...
   l_DESC_ROOM_TYPE_n := sys.diutil.bool_to_int(DESC_ROOM_TYPE_nin);
     ...
     CODE_ROOM_TYPE = decode (l_CODE_ROOM_TYPE_n,0,code_room_type_in, NVL (code_room_type_in, CODE_ROOM_TYPE)),
     ...
     DESC_ROOM_TYPE = decode (l_DESC_ROOM_TYPE_n,0,desc_room_type_in, NVL (desc_room_type_in, DESC_ROOM_TYPE))
          WHERE
             ID_ROOM_TYPE = id_room_type_in
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      ...
      code_room_type_in => code_room_type_in,
      CODE_ROOM_TYPE_nin => CODE_ROOM_TYPE_nin,
      flg_status_in => flg_status_in,
      ...
      desc_room_type_in => desc_room_type_in,
      DESC_ROOM_TYPE_nin => DESC_ROOM_TYPE_nin,
     handle_error_in => handle_error_in
     , rows_out => rows_out
      );
   END upd;
...
PROCEDURE upd (
   ...
   l_DT_LAST_UPDATE_n NUMBER(1);
   l_DESC_ROOM_TYPE_n NUMBER(1);
      id_room_type_in ROOM_TYPE.ID_ROOM_TYPE%TYPE;
   BEGIN
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         ...
         code_room_type_in => rec_in.CODE_ROOM_TYPE,
         ...
         desc_room_type_in => rec_in.DESC_ROOM_TYPE
   ...
   IS
      ...
      l_CODE_ROOM_TYPE CODE_ROOM_TYPE_cc;
      ...
      l_DESC_ROOM_TYPE DESC_ROOM_TYPE_cc;
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         ...
         l_CODE_ROOM_TYPE(i) := col_in(i).CODE_ROOM_TYPE;
         ...
         l_DESC_ROOM_TYPE(i) := col_in(i).DESC_ROOM_TYPE;
      END LOOP;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE ROOM_TYPE SET
               ...
               CODE_ROOM_TYPE = NVL (l_CODE_ROOM_TYPE(i), CODE_ROOM_TYPE),
               ...
               DESC_ROOM_TYPE = NVL (l_DESC_ROOM_TYPE(i), DESC_ROOM_TYPE)
             WHERE
      ...
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE ROOM_TYPE SET
               ...
               CODE_ROOM_TYPE = l_CODE_ROOM_TYPE(i),
               ...
               DESC_ROOM_TYPE = l_DESC_ROOM_TYPE(i)
             WHERE
                ID_ROOM_TYPE = l_ID_ROOM_TYPE(i)
         ;
      END IF;
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE ROOM_TYPE set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE ROOM_TYPE set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
...
, rows_out => rows_out
   ...
   -- Delete all rows for primary key column ID_ROOM_TYPE
   PROCEDURE del_ID_ROOM_TYPE (
      id_room_type_in IN ROOM_TYPE.ID_ROOM_TYPE%TYPE
     ,handle_error_in IN BOOLEAN := TRUE
     , rows_out OUT TABLE_VARCHAR
     )
...
, rows_out => rows_out
   ...
   PROCEDURE del_RTY_INST_FK (
      id_institution_in IN ROOM_TYPE.ID_INSTITUTION%TYPE
     ,handle_error_in IN BOOLEAN := TRUE
     , rows_out OUT TABLE_VARCHAR
      )
   IS
   BEGIN
      DELETE FROM ROOM_TYPE
       WHERE
          ID_INSTITUTION = del_RTY_INST_FK.id_institution_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_RTY_INST_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM ROOM_TYPE';
      ELSE
         RETURN
            'DELETE FROM ROOM_TYPE WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   PROCEDURE initrec (
      room_type_inout IN OUT ROOM_TYPE%ROWTYPE
   )
   IS
   BEGIN
      room_type_inout.ID_ROOM_TYPE := NULL;
      room_type_inout.FLG_AVAILABLE := NULL;
      room_type_inout.CREATE_USER := NULL;
      room_type_inout.CREATE_TIME := NULL;
      room_type_inout.CREATE_INSTITUTION := NULL;
      room_type_inout.UPDATE_USER := NULL;
      room_type_inout.UPDATE_TIME := NULL;
      room_type_inout.UPDATE_INSTITUTION := NULL;
      room_type_inout.ID_INSTITUTION := NULL;
      room_type_inout.CODE_ROOM_TYPE := NULL;
      room_type_inout.FLG_STATUS := NULL;
      room_type_inout.FLG_PARAMETERIZATION_TYPE := 'C';
      room_type_inout.ID_PROFESSIONAL := NULL;
      room_type_inout.DT_CREATION := NULL;
      room_type_inout.DT_LAST_UPDATE := NULL;
      room_type_inout.DESC_ROOM_TYPE := NULL;
   END initrec;

   FUNCTION initrec RETURN ROOM_TYPE%ROWTYPE
   IS
      l_room_type ROOM_TYPE%ROWTYPE;
   BEGIN
      l_room_type.FLG_PARAMETERIZATION_TYPE := 'C';
      RETURN l_room_type;
   END initrec;
   ...
   IS
        data ROOM_TYPE_tc;
   BEGIN
        select * bulk collect into data from ROOM_TYPE where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
