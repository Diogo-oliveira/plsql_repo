/*-- Last Change Revision: $Rev: 2028243 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:37 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_interv_presc_det
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN interv_presc_det.id_interv_presc_det%TYPE IS
        retval interv_presc_det.id_interv_presc_det%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_interv_presc_det.nextval;
        ELSE
    ...
    (
        ...
        l_pky interv_presc_det.id_interv_presc_det%TYPE := next_key;
    BEGIN
        ins(id_interv_presc_det_in     => l_pky,
    ...
    BEGIN
        ins(id_interv_prescription_in  => id_interv_prescription_in,
            ...
            flg_location_in            => flg_location_in,
            diagnosis_notes_in         => diagnosis_notes_in,
            id_interv_presc_det_out    => id_interv_presc_det_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN interv_presc_det.id_interv_presc_det%TYPE IS
        l_pky interv_presc_det.id_interv_presc_det%TYPE := next_key;
    BEGIN
        ins(id_interv_presc_det_in     => l_pky,
            id_interv_prescription_in  => id_interv_prescription_in,
    ...
    (
        ...
        l_rec interv_presc_det%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_interv_presc_det := next_key(sequence_in);
        END IF;
    ...
    BEGIN
        ...
        l_sql                       := 'UPDATE interv_presc_det SET' || ' ID_INTERV_PRESCRIPTION = decode (' ||
                                       ...
                                       ',0,:NUM_TAKE_in, NVL (:NUM_TAKE_in, NUM_TAKE)) ' || ',' || ' DOSAGE = decode (' ||
                                       l_dosage_n || ',0,:DOSAGE_in, NVL (:DOSAGE_in, DOSAGE)) ' || ',' ||
                                       ' ID_DRUG_PRESC_DET = decode (' || l_id_drug_presc_det_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_interv_prescription_in, id_intervention_in, id_movement_in, flg_interv_type_in, flg_status_in, notes_in, id_prof_cancel_in, notes_cancel_in, interval_in, num_take_in, dosage_in, id_drug_presc_det_in, id_nurse_actv_req_det_in, num_freq_in, flg_freq_in, num_sess_in, flg_prty_in, dt_end_tstz_in, dt_begin_tstz_in, dt_cancel_tstz_in, dt_interv_presc_det_in, code_intervention_alias_in, dt_pend_req_tstz_in, flg_referral_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_interv_codification_in, id_exec_institution_in, id_cancel_reason_in, id_cdr_event_in, flg_laterality_in, flg_clinical_purpose_in, id_not_order_reason_in, id_presc_plan_task_in, id_co_sign_order_in, id_co_sign_cancel_in, id_prof_last_update_in, dt_last_update_tstz_in, id_order_recurrence_in, flg_fasting_in, flg_prn_in, prn_notes_in, id_pat_health_plan_in, id_pat_exemption_in, flg_req_origin_module_in, dt_order_tstz_in, id_clinical_purpose_in, clinical_purpose_notes_in, flg_location_in, diagnosis_notes_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        RETURN 'BEGIN UPDATE interv_presc_det
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE interv_presc_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE interv_presc_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM interv_presc_det
         WHERE id_interv_codification = id_interv_codification_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    END del_ipd_id_order_recurrence_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_crn_fk(id_cancel_reason_in => id_cancel_reason_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ipd_crn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_csc_fk(id_co_sign_cancel_in => id_co_sign_cancel_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_ipd_csc_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_csho_fk(id_co_sign_order_in => id_co_sign_order_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_ipd_csho_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_icod_fk(id_interv_codification_in => id_interv_codification_in,
                        handle_error_in           => handle_error_in,
                        rows_out                  => rows_out);
    END del_ipd_icod_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_id_order_recurrence_fk(id_order_recurrence_in => id_order_recurrence_in,
                                       handle_error_in        => handle_error_in,
                                       rows_out               => rows_out);
    END del_ipd_id_order_recurrence_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_inn_fk(id_exec_institution_in => id_exec_institution_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ipd_inn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_int_fk(id_intervention_in => id_intervention_in,
                       handle_error_in    => handle_error_in,
                       rows_out           => rows_out);
    END del_ipd_int_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_mop_fk(id_clinical_purpose_in => id_clinical_purpose_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ipd_mop_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_mov_fk(id_movement_in => id_movement_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ipd_mov_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_nard_fk(id_nurse_actv_req_det_in => id_nurse_actv_req_det_in,
                        handle_error_in          => handle_error_in,
                        rows_out                 => rows_out);
    END del_ipd_nard_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_nor_fk(id_not_order_reason_in => id_not_order_reason_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ipd_nor_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_phn_fk(id_pat_health_plan_in => id_pat_health_plan_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_ipd_phn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_pio_fk(id_pat_exemption_in => id_pat_exemption_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ipd_pio_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_presc_fk(id_interv_prescription_in => id_interv_prescription_in,
                         handle_error_in           => handle_error_in,
                         rows_out                  => rows_out);
    END del_ipd_presc_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipd_prof_fk(id_prof_cancel_in => id_prof_cancel_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_ipd_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipn_dpdt_fk(id_drug_presc_det_in => id_drug_presc_det_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_ipn_dpdt_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM interv_presc_det';
        ELSE
            RETURN 'DELETE FROM interv_presc_det WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(interv_presc_det_inout IN OUT interv_presc_det%ROWTYPE) IS
    BEGIN
        interv_presc_det_inout.id_interv_presc_det     := NULL;
        interv_presc_det_inout.id_interv_prescription  := NULL;
        interv_presc_det_inout.id_intervention         := NULL;
        interv_presc_det_inout.id_movement             := NULL;
        interv_presc_det_inout.flg_interv_type         := NULL;
        interv_presc_det_inout.flg_status              := NULL;
        interv_presc_det_inout.notes                   := NULL;
        interv_presc_det_inout.id_prof_cancel          := NULL;
        interv_presc_det_inout.notes_cancel            := NULL;
        interv_presc_det_inout.interval                := NULL;
        interv_presc_det_inout.num_take                := NULL;
        interv_presc_det_inout.dosage                  := NULL;
        interv_presc_det_inout.id_drug_presc_det       := NULL;
        interv_presc_det_inout.id_nurse_actv_req_det   := NULL;
        interv_presc_det_inout.num_freq                := NULL;
        interv_presc_det_inout.flg_freq                := NULL;
        interv_presc_det_inout.num_sess                := NULL;
        interv_presc_det_inout.flg_prty                := NULL;
        interv_presc_det_inout.dt_end_tstz             := NULL;
        interv_presc_det_inout.dt_begin_tstz           := NULL;
        interv_presc_det_inout.dt_cancel_tstz          := NULL;
        interv_presc_det_inout.dt_interv_presc_det     := NULL;
        interv_presc_det_inout.code_intervention_alias := NULL;
        interv_presc_det_inout.dt_pend_req_tstz        := NULL;
        interv_presc_det_inout.flg_referral            := NULL;
        interv_presc_det_inout.create_user             := NULL;
        interv_presc_det_inout.create_time             := NULL;
        interv_presc_det_inout.create_institution      := NULL;
        interv_presc_det_inout.update_user             := NULL;
        interv_presc_det_inout.update_time             := NULL;
        interv_presc_det_inout.update_institution      := NULL;
        interv_presc_det_inout.id_interv_codification  := NULL;
        interv_presc_det_inout.id_exec_institution     := NULL;
        interv_presc_det_inout.id_cancel_reason        := NULL;
        interv_presc_det_inout.id_cdr_event            := NULL;
        interv_presc_det_inout.flg_laterality          := NULL;
        interv_presc_det_inout.flg_clinical_purpose    := NULL;
        interv_presc_det_inout.id_not_order_reason     := NULL;
        interv_presc_det_inout.id_presc_plan_task      := NULL;
        interv_presc_det_inout.id_co_sign_order        := NULL;
        interv_presc_det_inout.id_co_sign_cancel       := NULL;
        interv_presc_det_inout.id_prof_last_update     := NULL;
        interv_presc_det_inout.dt_last_update_tstz     := NULL;
        interv_presc_det_inout.id_order_recurrence     := NULL;
        interv_presc_det_inout.flg_fasting             := NULL;
        interv_presc_det_inout.flg_prn                 := NULL;
        interv_presc_det_inout.prn_notes               := NULL;
        interv_presc_det_inout.id_pat_health_plan      := NULL;
        interv_presc_det_inout.id_pat_exemption        := NULL;
        interv_presc_det_inout.flg_req_origin_module   := NULL;
        interv_presc_det_inout.dt_order_tstz           := NULL;
        interv_presc_det_inout.id_clinical_purpose     := NULL;
        interv_presc_det_inout.clinical_purpose_notes  := NULL;
        interv_presc_det_inout.flg_location            := NULL;
        interv_presc_det_inout.diagnosis_notes         := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN interv_presc_det%ROWTYPE IS
        l_interv_presc_det interv_presc_det%ROWTYPE;
    BEGIN
        RETURN l_interv_presc_det;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN interv_presc_det_tc IS
        data interv_presc_det_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN interv_presc_det_tc IS
        data interv_presc_det_tc;
