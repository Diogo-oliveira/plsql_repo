...
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO vs_read_hist_attribute
                ...
                BEGIN
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'VS_READ_HIST_ATTRIBUTE');
                    END IF;
                END;
            END IF;
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'VSRHA_VSR_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_VITAL_SIGN_READ_HIST',
                                                        value_in           => id_vital_sign_read_hist_in);
                    END IF;
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_vital_sign_read_hist_in => id_vital_sign_read_hist_in,
                              id_vs_attribute_in         => id_vs_attribute_in,
                              create_user_in             => create_user_in,
                              create_time_in             => create_time_in,
                              create_institution_in      => create_institution_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_vital_sign_read_hist_in => id_vital_sign_read_hist_in,
                                  id_vs_attribute_in         => id_vs_attribute_in,
                                  create_user_in             => create_user_in,
                                  create_time_in             => create_time_in,
                                  create_institution_in      => create_institution_in,
    ...
    */
    ...
    (
        ...
        l_rec vs_read_hist_attribute%ROWTYPE := rec_in;
    BEGIN
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_VITAL_SIGN_READ_HIST _' || indx,
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'VS_READ_HIST_ATTRIBUTE',
                                                name2_in      => 'ROW_COUNT',
    ...
    (
        ...
        l_update_time_n            NUMBER(1);
        l_update_institution_n     NUMBER(1);
        id_vital_sign_read_hist_in vs_read_hist_attribute.id_vital_sign_read_hist%TYPE;
        id_vs_attribute_in         vs_read_hist_attribute.id_vs_attribute%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE VS_READ_HIST_ATTRIBUTE SET ' || ' FREE_TEXT = decode (' || l_free_text_n ||
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE VS_READ_HIST_ATTRIBUTE
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE VS_READ_HIST_ATTRIBUTE
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE VS_READ_HIST_ATTRIBUTE set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE VS_READ_HIST_ATTRIBUTE set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM vs_read_hist_attribute
         WHERE id_vital_sign_read_hist = id_vital_sign_read_hist_in
           AND id_vs_attribute = id_vs_attribute_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_id_vital_sign_read_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_vital_sign_read_hist(id_vital_sign_read_hist_in => id_vital_sign_read_hist_in,
                                    handle_error_in            => handle_error_in,
                                    rows_out                   => rows_out);
    END del_id_vital_sign_read_hist;
    ...
    BEGIN
        DELETE FROM vs_read_hist_attribute
         WHERE id_vs_attribute = del_vsrha_vsa_fk.id_vs_attribute_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_vsrha_vsa_fk(id_vs_attribute_in => id_vs_attribute_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_vsrha_vsa_fk;
    ...
    BEGIN
        DELETE FROM vs_read_hist_attribute
         WHERE id_vital_sign_read_hist = del_vsrha_vsr_fk.id_vital_sign_read_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_vsrha_vsr_fk(id_vital_sign_read_hist_in => id_vital_sign_read_hist_in,
                         handle_error_in            => handle_error_in,
                         rows_out                   => rows_out);
    END del_vsrha_vsr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM VS_READ_HIST_ATTRIBUTE';
        ELSE
            RETURN 'DELETE FROM VS_READ_HIST_ATTRIBUTE WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(vs_read_hist_attribute_inout IN OUT vs_read_hist_attribute%ROWTYPE) IS
    BEGIN
        vs_read_hist_attribute_inout.id_vital_sign_read_hist := NULL;
        vs_read_hist_attribute_inout.id_vs_attribute         := NULL;
        vs_read_hist_attribute_inout.free_text               := NULL;
        vs_read_hist_attribute_inout.create_user             := NULL;
        vs_read_hist_attribute_inout.create_time             := NULL;
        vs_read_hist_attribute_inout.create_institution      := NULL;
        vs_read_hist_attribute_inout.update_user             := NULL;
        vs_read_hist_attribute_inout.update_time             := NULL;
        vs_read_hist_attribute_inout.update_institution      := NULL;
    END initrec;

    FUNCTION initrec RETURN vs_read_hist_attribute%ROWTYPE IS
        l_vs_read_hist_attribute vs_read_hist_attribute%ROWTYPE;
    BEGIN
        RETURN l_vs_read_hist_attribute;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN vs_read_hist_attribute_tc IS
        data vs_read_hist_attribute_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM vs_read_hist_attribute
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN vs_read_hist_attribute_tc IS
