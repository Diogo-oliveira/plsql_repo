...
CREATE OR REPLACE PACKAGE BODY ts_pat_past_hist_free_text
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 9, 2011 11:3:28
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_pat_ph_ft_in       IN pat_past_hist_free_text.id_pat_ph_ft%TYPE,
        text_in               IN pat_past_hist_free_text.text%TYPE DEFAULT NULL,
        id_patient_in         IN pat_past_hist_free_text.id_patient%TYPE DEFAULT NULL,
        id_episode_in         IN pat_past_hist_free_text.id_episode%TYPE DEFAULT NULL,
        id_visit_in           IN pat_past_hist_free_text.id_visit%TYPE DEFAULT NULL,
        id_professional_in    IN pat_past_hist_free_text.id_professional%TYPE DEFAULT NULL,
        dt_register_in        IN pat_past_hist_free_text.dt_register%TYPE DEFAULT NULL,
        flg_type_in           IN pat_past_hist_free_text.flg_type%TYPE DEFAULT NULL,
        flg_status_in         IN pat_past_hist_free_text.flg_status%TYPE DEFAULT NULL,
        id_prof_canceled_in   IN pat_past_hist_free_text.id_prof_canceled%TYPE DEFAULT NULL,
        dt_cancel_in          IN pat_past_hist_free_text.dt_cancel%TYPE DEFAULT NULL,
        id_cancel_reason_in   IN pat_past_hist_free_text.id_cancel_reason%TYPE DEFAULT NULL,
        cancel_notes_in       IN pat_past_hist_free_text.cancel_notes%TYPE DEFAULT NULL,
        create_user_in        IN pat_past_hist_free_text.create_user%TYPE DEFAULT NULL,
        create_time_in        IN pat_past_hist_free_text.create_time%TYPE DEFAULT NULL,
        create_institution_in IN pat_past_hist_free_text.create_institution%TYPE DEFAULT NULL,
        update_user_in        IN pat_past_hist_free_text.update_user%TYPE DEFAULT NULL,
        update_time_in        IN pat_past_hist_free_text.update_time%TYPE DEFAULT NULL,
        update_institution_in IN pat_past_hist_free_text.update_institution%TYPE DEFAULT NULL,
        id_doc_area_in        IN pat_past_hist_free_text.id_doc_area%TYPE DEFAULT NULL,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    THEN
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'TABLE_NAME',
                                                        value_in           => 'PAT_PAST_HIST_FREE_TEXT',
                                                        validate_in        => FALSE);
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_PATIENT',
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'PAT_PAST_HIST_FREE_TEXT');
                    END IF;
                END;
            END IF;
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'PAT_PAST_HIST_FREE_TEXT');
                    IF l_name = 'PPH_FT_CANCEL_REASON_FK'
                    THEN
                    ...
                    THEN
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        ...
                                                        value_in           => id_patient_in);
                    END IF;
                    IF l_name = 'PPH_FT_PROF_CANCEL_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROF_CANCELED',
                                                        value_in           => id_prof_canceled_in);
                    END IF;
                    IF l_name = 'PPH_FT_PROF_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROFESSIONAL',
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_pat_ph_ft_in       => id_pat_ph_ft_in,
                              id_patient_in         => id_patient_in,
                              id_episode_in         => id_episode_in,
                              id_visit_in           => id_visit_in,
                              id_professional_in    => id_professional_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_pat_ph_ft_in       => id_pat_ph_ft_in,
                                  id_patient_in         => id_patient_in,
                                  id_episode_in         => id_episode_in,
                                  id_visit_in           => id_visit_in,
                                  id_professional_in    => id_professional_in,
    ...
    */
    ...
    PROCEDURE ins
    (
        rec_in          IN pat_past_hist_free_text%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec pat_past_hist_free_text%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_pat_ph_ft := next_key(sequence_in);
        END IF;
        ins(id_pat_ph_ft_in       => l_rec.id_pat_ph_ft,
            text_in               => l_rec.text,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN pat_past_hist_free_text.id_pat_ph_ft%TYPE
    
     IS
        retval pat_past_hist_free_text.id_pat_ph_ft%TYPE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_PAT_PAST_HIST_FREE_TEXT'));
    END next_key;
    ...
    (
        ...
        update_institution_in IN pat_past_hist_free_text.update_institution%TYPE DEFAULT NULL,
        id_doc_area_in        IN pat_past_hist_free_text.id_doc_area%TYPE DEFAULT NULL,
        id_pat_ph_ft_out      IN OUT pat_past_hist_free_text.id_pat_ph_ft%TYPE,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
        l_pky pat_past_hist_free_text.id_pat_ph_ft%TYPE := next_key;
    BEGIN
        ins(id_pat_ph_ft_in       => l_pky,
            text_in               => text_in,
            id_patient_in         => id_patient_in,
            id_episode_in         => id_episode_in,
            id_visit_in           => id_visit_in,
    ...
    BEGIN
        ins(text_in               => text_in,
            ...
            update_institution_in => update_institution_in,
            id_doc_area_in        => id_doc_area_in,
            id_pat_ph_ft_out      => id_pat_ph_ft_out,
            handle_error_in       => handle_error_in,
            rows_out              => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN pat_past_hist_free_text.id_pat_ph_ft%TYPE IS
        l_pky pat_past_hist_free_text.id_pat_ph_ft%TYPE := next_key;
    BEGIN
        ins(id_pat_ph_ft_in       => l_pky,
            text_in               => text_in,
    ...
    PROCEDURE ins
    (
        rows_in         IN pat_past_hist_free_text_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'PAT_PAST_HIST_FREE_TEXT',
                                                name2_in      => 'ROW_COUNT',
    ...
    BEGIN
        ...
        UPDATE pat_past_hist_free_text
           SET text               = decode(l_text_n, 0, text_in, nvl(text_in, text)),
         ...
         WHERE id_pat_ph_ft = id_pat_ph_ft_in
    ...
    (
        ...
        l_update_institution_n NUMBER(1);
        l_id_doc_area_n        NUMBER(1);
        id_pat_ph_ft_in        pat_past_hist_free_text.id_pat_ph_ft%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PAT_PAST_HIST_FREE_TEXT SET ' || ' TEXT = decode (' || l_text_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN text_in, id_patient_in, id_episode_in, id_visit_in, id_professional_in, dt_register_in, flg_type_in, flg_status_in, id_prof_canceled_in, dt_cancel_in, id_cancel_reason_in, cancel_notes_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_doc_area_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_pat_ph_ft_in       => rec_in.id_pat_ph_ft,
            text_in               => rec_in.text,
    ...
    PROCEDURE upd
    (
        col_in            IN pat_past_hist_free_text_tc,
        ignore_if_null_in IN BOOLEAN := TRUE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          IN OUT table_varchar
    ) IS
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE pat_past_hist_free_text
                 ...
                 WHERE id_pat_ph_ft = l_id_pat_ph_ft(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE pat_past_hist_free_text
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PAT_PAST_HIST_FREE_TEXT
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PAT_PAST_HIST_FREE_TEXT
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PAT_PAST_HIST_FREE_TEXT set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PAT_PAST_HIST_FREE_TEXT set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_pat_ph_ft = id_pat_ph_ft_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
    ...
    BEGIN
        ...
        del(id_pat_ph_ft_in => id_pat_ph_ft_in, handle_error_in => handle_error_in, rows_out => rows_out);
    
    END del;

    -- Delete all rows for primary key column ID_PAT_PH_FT
    PROCEDURE del_id_pat_ph_ft
    (
        id_pat_ph_ft_in IN pat_past_hist_free_text.id_pat_ph_ft%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_pat_ph_ft(id_pat_ph_ft_in => id_pat_ph_ft_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_id_pat_ph_ft;

    -- Delete for unique value of PPH_FT_UK
    PROCEDURE del_pph_ft_uk
    (
        id_patient_in      IN pat_past_hist_free_text.id_patient%TYPE,
        id_episode_in      IN pat_past_hist_free_text.id_episode%TYPE,
        dt_register_in     IN pat_past_hist_free_text.dt_register%TYPE,
        flg_type_in        IN pat_past_hist_free_text.flg_type%TYPE,
        id_professional_in IN pat_past_hist_free_text.id_professional%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_patient = id_patient_in
           ...
           AND dt_register = dt_register_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_uk(id_patient_in      => id_patient_in,
                      id_episode_in      => id_episode_in,
                      dt_register_in     => dt_register_in,
                      flg_type_in        => flg_type_in,
                      id_professional_in => id_professional_in,
    ...
    PROCEDURE del_pph_ft_cancel_reason_fk
    (
        id_cancel_reason_in IN pat_past_hist_free_text.id_cancel_reason%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_cancel_reason = del_pph_ft_cancel_reason_fk.id_cancel_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_pph_ft_cancel_reason_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_cancel_reason_fk(id_cancel_reason_in => id_cancel_reason_in,
                                    handle_error_in     => handle_error_in,
                                    rows_out            => rows_out);
    END del_pph_ft_cancel_reason_fk;

    PROCEDURE del_pph_ft_epis_fk
    (
        id_episode_in   IN pat_past_hist_free_text.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_episode = del_pph_ft_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pph_ft_epis_fk;

    PROCEDURE del_pph_ft_pat_fk
    (
        id_patient_in   IN pat_past_hist_free_text.id_patient%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_patient = del_pph_ft_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pph_ft_pat_fk;

    PROCEDURE del_pph_ft_prof_cancel_fk
    (
        id_prof_canceled_in IN pat_past_hist_free_text.id_prof_canceled%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_prof_canceled = del_pph_ft_prof_cancel_fk.id_prof_canceled_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_prof_cancel_fk(id_prof_canceled_in => id_prof_canceled_in,
                                  handle_error_in     => handle_error_in,
                                  rows_out            => rows_out);
    END del_pph_ft_prof_cancel_fk;

    PROCEDURE del_pph_ft_prof_fk
    (
        id_professional_in IN pat_past_hist_free_text.id_professional%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ...
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_professional = del_pph_ft_prof_fk.id_professional_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_prof_fk(id_professional_in => id_professional_in,
                           handle_error_in    => handle_error_in,
                           rows_out           => rows_out);
    END del_pph_ft_prof_fk;

    PROCEDURE del_pph_ft_visit_fk
    (
        id_visit_in     IN pat_past_hist_free_text.id_visit%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM pat_past_hist_free_text
         WHERE id_visit = del_pph_ft_visit_fk.id_visit_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pph_ft_visit_fk(id_visit_in => id_visit_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pph_ft_visit_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PAT_PAST_HIST_FREE_TEXT';
        ELSE
            RETURN 'DELETE FROM PAT_PAST_HIST_FREE_TEXT WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pat_past_hist_free_text_inout IN OUT pat_past_hist_free_text%ROWTYPE) IS
    BEGIN
        pat_past_hist_free_text_inout.id_pat_ph_ft       := NULL;
        pat_past_hist_free_text_inout.text               := NULL;
        pat_past_hist_free_text_inout.id_patient         := NULL;
        pat_past_hist_free_text_inout.id_episode         := NULL;
        pat_past_hist_free_text_inout.id_visit           := NULL;
        pat_past_hist_free_text_inout.id_professional    := NULL;
        pat_past_hist_free_text_inout.dt_register        := NULL;
        pat_past_hist_free_text_inout.flg_type           := NULL;
        pat_past_hist_free_text_inout.flg_status         := NULL;
        pat_past_hist_free_text_inout.id_prof_canceled   := NULL;
        pat_past_hist_free_text_inout.dt_cancel          := NULL;
        pat_past_hist_free_text_inout.id_cancel_reason   := NULL;
        pat_past_hist_free_text_inout.cancel_notes       := NULL;
        pat_past_hist_free_text_inout.create_user        := NULL;
        pat_past_hist_free_text_inout.create_time        := NULL;
        pat_past_hist_free_text_inout.create_institution := NULL;
        pat_past_hist_free_text_inout.update_user        := NULL;
        pat_past_hist_free_text_inout.update_time        := NULL;
        pat_past_hist_free_text_inout.update_institution := NULL;
        pat_past_hist_free_text_inout.id_doc_area        := NULL;
    END initrec;

    FUNCTION initrec RETURN pat_past_hist_free_text%ROWTYPE IS
        l_pat_past_hist_free_text pat_past_hist_free_text%ROWTYPE;
    BEGIN
        RETURN l_pat_past_hist_free_text;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pat_past_hist_free_text_tc IS
        data pat_past_hist_free_text_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM pat_past_hist_free_text
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pat_past_hist_free_text_tc IS
...
BEGIN
    NULL;
END ts_pat_past_hist_free_text;
/
