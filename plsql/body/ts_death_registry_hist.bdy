/*-- Last Change Revision: $Rev: 2027999 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:54 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_death_registry_hist
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN death_registry_hist.id_death_registry_hist%TYPE IS
        retval death_registry_hist.id_death_registry_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_death_registry_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky death_registry_hist.id_death_registry_hist%TYPE := next_key;
    BEGIN
        ins(id_death_registry_hist_in => l_pky,
    ...
    BEGIN
        ins(id_death_registry_hist_in => l_pky,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_death_registry_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_death_registry_in       => id_death_registry_in,
            ...
            update_institution_in      => update_institution_in,
            death_date_format_in       => death_date_format_in,
            id_death_registry_hist_out => id_death_registry_hist_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN death_registry_hist.id_death_registry_hist%TYPE IS
        l_pky death_registry_hist.id_death_registry_hist%TYPE := next_key;
    BEGIN
        ins(id_death_registry_hist_in => l_pky,
            id_death_registry_in      => id_death_registry_in,
    ...
    BEGIN
        INSERT INTO death_registry_hist
    ...
    (
        ...
        l_rec death_registry_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_death_registry_hist := next_key(sequence_in);
        END IF;
    ...
    BEGIN
        ...
        UPDATE death_registry_hist
           SET id_death_registry      = decode(l_id_death_registry_n,
                                               0,
                                               id_death_registry_in,
    ...
    BEGIN
        ...
        l_sql                      := 'UPDATE death_registry_hist SET' || ' ID_DEATH_REGISTRY = decode (' ||
                                      l_id_death_registry_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_death_registry_in, id_episode_in, dt_death_in, id_prof_verified_death_in, id_sl_natural_cause_in, id_sl_coroner_warned_in, id_sl_autopsy_in, id_prof_death_registry_in, dt_death_registry_in, id_cancel_reason_in, notes_cancel_in, flg_status_in, id_susp_action_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, death_date_format_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE death_registry_hist
                   SET id_death_registry      = nvl(l_id_death_registry(i), id_death_registry),
        ...
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE death_registry_hist
                   SET id_death_registry      = l_id_death_registry(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE death_registry_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE death_registry_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE death_registry_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM death_registry_hist
         WHERE id_death_registry_hist = id_death_registry_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dtrh_dthr_fk(id_death_registry_in => id_death_registry_in,
                         handle_error_in      => handle_error_in,
                         rows_out             => rows_out);
    END del_dtrh_dthr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM death_registry_hist';
        ELSE
            RETURN 'DELETE FROM death_registry_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(death_registry_hist_inout IN OUT death_registry_hist%ROWTYPE) IS
    BEGIN
        death_registry_hist_inout.id_death_registry_hist := NULL;
        death_registry_hist_inout.id_death_registry      := NULL;
        death_registry_hist_inout.id_episode             := NULL;
        death_registry_hist_inout.dt_death               := NULL;
        death_registry_hist_inout.id_prof_verified_death := NULL;
        death_registry_hist_inout.id_sl_natural_cause    := NULL;
        death_registry_hist_inout.id_sl_coroner_warned   := NULL;
        death_registry_hist_inout.id_sl_autopsy          := NULL;
        death_registry_hist_inout.id_prof_death_registry := NULL;
        death_registry_hist_inout.dt_death_registry      := NULL;
        death_registry_hist_inout.id_cancel_reason       := NULL;
        death_registry_hist_inout.notes_cancel           := NULL;
        death_registry_hist_inout.flg_status             := NULL;
        death_registry_hist_inout.id_susp_action         := NULL;
        death_registry_hist_inout.create_user            := NULL;
        death_registry_hist_inout.create_time            := NULL;
        death_registry_hist_inout.create_institution     := NULL;
        death_registry_hist_inout.update_user            := NULL;
        death_registry_hist_inout.update_time            := NULL;
        death_registry_hist_inout.update_institution     := NULL;
        death_registry_hist_inout.death_date_format      := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN death_registry_hist%ROWTYPE IS
        l_death_registry_hist death_registry_hist%ROWTYPE;
    BEGIN
        RETURN l_death_registry_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN death_registry_hist_tc IS
        data death_registry_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM death_registry_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN death_registry_hist_tc IS
        data death_registry_hist_tc;
