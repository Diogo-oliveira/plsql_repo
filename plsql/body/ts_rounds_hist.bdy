/*-- Last Change Revision: $Rev: 2028380 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:26 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_rounds_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Julho 9, 2009 12:20:45
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        ins(id_round_hist_in      => id_round_hist_in,
            id_round_in           => id_round_in,
    ...
    (
        ...
        l_rec rounds_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_round_hist := next_key(sequence_in);
        END IF;
        ins(id_round_hist_in      => l_rec.id_round_hist,
            id_round_in           => l_rec.id_round,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN rounds_hist.id_round_hist%TYPE
     ...
     IS
        retval rounds_hist.id_round_hist%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_rounds_hist.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_ROUNDS_HIST'));
    END next_key;
    ...
    (
        ...
        l_pky rounds_hist.id_round_hist%TYPE := next_key;
    BEGIN
        ins(id_round_hist_in      => l_pky,
            id_round_in           => id_round_in,
            area_code_in          => area_code_in,
            desc_round_in         => desc_round_in,
            sample_time_in        => sample_time_in,
    ...
    BEGIN
        ins(id_round_in           => id_round_in,
            ...
            update_institution_in => update_institution_in,
            flg_edit_in           => flg_edit_in,
            id_round_hist_out     => id_round_hist_out,
            handle_error_in       => handle_error_in,
            rows_out              => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN rounds_hist.id_round_hist%TYPE IS
        l_pky rounds_hist.id_round_hist%TYPE := next_key;
    BEGIN
        ins(id_round_hist_in      => l_pky,
            id_round_in           => id_round_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_ROUND_HIST _' || indx,
                                                        value_in           => rows_in(indx).id_round_hist,
                                                        validate_in        => FALSE);
    ...
    BEGIN
        ...
        l_id_round_n           := sys.diutil.bool_to_int(id_round_nin);
        ...
        UPDATE rounds_hist
           SET id_round           = decode(l_id_round_n, 0, id_round_in, nvl(id_round_in, id_round)),
               area_code          = decode(l_area_code_n, 0, area_code_in, nvl(area_code_in, area_code)),
         ...
         WHERE id_round_hist = id_round_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_round_hist_in       => id_round_hist_in,
            id_round_in            => id_round_in,
            id_round_nin           => id_round_nin,
            area_code_in           => area_code_in,
    ...
    (
        ...
        l_update_institution_n NUMBER(1);
        l_flg_edit_n           NUMBER(1);
        id_round_hist_in       rounds_hist.id_round_hist%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE ROUNDS_HIST SET ' || ' ID_ROUND = decode (' || l_id_round_n ||
                 ',0,:id_round_in, NVL (:id_round_in, ID_ROUND)) ' || ',' || ' AREA_CODE = decode (' || l_area_code_n ||
    ...
    BEGIN
        upd(id_round_hist_in      => rec_in.id_round_hist,
            id_round_in           => rec_in.id_round,
    ...
    (
        ...
        l_id_round_hist      id_round_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_round_hist(i) := col_in(i).id_round_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE rounds_hist
                   SET id_round           = nvl(l_id_round(i), id_round),
                       area_code          = nvl(l_area_code(i), area_code),
                 ...
                 WHERE id_round_hist = l_id_round_hist(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE rounds_hist
                   SET id_round           = l_id_round(i),
                       area_code          = l_area_code(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE ROUNDS_HIST
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE ROUNDS_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE ROUNDS_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_round_hist_in => id_round_hist_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_round_hist(id_round_hist_in => id_round_hist_in,
                          handle_error_in  => handle_error_in,
                          rows_out         => rows_out);
    END del_id_round_hist;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM ROUNDS_HIST';
        ELSE
            RETURN 'DELETE FROM ROUNDS_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(rounds_hist_inout IN OUT rounds_hist%ROWTYPE) IS
    BEGIN
        rounds_hist_inout.id_round_hist      := NULL;
        rounds_hist_inout.id_round           := NULL;
        rounds_hist_inout.area_code          := NULL;
        rounds_hist_inout.desc_round         := NULL;
        rounds_hist_inout.sample_time        := NULL;
        rounds_hist_inout.trigger_time       := NULL;
        rounds_hist_inout.default_days       := NULL;
        rounds_hist_inout.available_holidays := NULL;
        rounds_hist_inout.id_institution     := NULL;
        rounds_hist_inout.id_software        := NULL;
        rounds_hist_inout.valid_from         := NULL;
        rounds_hist_inout.valid_to           := NULL;
        rounds_hist_inout.flg_available      := NULL;
        rounds_hist_inout.cancel_notes       := NULL;
        rounds_hist_inout.dt_cancel_notes    := NULL;
        rounds_hist_inout.prof_create        := NULL;
        rounds_hist_inout.dt_create          := NULL;
        rounds_hist_inout.create_user        := NULL;
        rounds_hist_inout.create_time        := NULL;
        rounds_hist_inout.create_institution := NULL;
        rounds_hist_inout.update_user        := NULL;
        rounds_hist_inout.update_time        := NULL;
        rounds_hist_inout.update_institution := NULL;
        rounds_hist_inout.flg_edit           := NULL;
    END initrec;

    FUNCTION initrec RETURN rounds_hist%ROWTYPE IS
        l_rounds_hist rounds_hist%ROWTYPE;
    BEGIN
        RETURN l_rounds_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN rounds_hist_tc IS
        data rounds_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN rounds_hist_tc IS
