/*-- Last Change Revision: $Rev: 1769872 $*/
/*-- Last Change by: $Author: carlos.ferreira $*/
/*-- Date of last change: $Date: 2017-02-02 12:28:18 +0000 (qui, 02 fev 2017) $*/

CREATE OR REPLACE PACKAGE BODY ts_death_registry_det
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2017-02-02 11:11:28
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN death_registry_det.id_death_registry_det%TYPE IS
        retval death_registry_det.id_death_registry_det%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_death_registry_det.nextval;
        ELSE
    ...
    PROCEDURE ins
    (
        id_death_registry_in  IN death_registry_det.id_death_registry%TYPE DEFAULT NULL,
        id_ds_component_in    IN death_registry_det.id_ds_component%TYPE DEFAULT NULL,
        value_n_in            IN death_registry_det.value_n%TYPE DEFAULT NULL,
        value_tz_in           IN death_registry_det.value_tz%TYPE DEFAULT NULL,
        value_vc2_in          IN death_registry_det.value_vc2%TYPE DEFAULT NULL,
        unit_measure_value_in IN death_registry_det.unit_measure_value%TYPE DEFAULT NULL,
        create_user_in        IN death_registry_det.create_user%TYPE DEFAULT NULL,
        create_time_in        IN death_registry_det.create_time%TYPE DEFAULT NULL,
        create_institution_in IN death_registry_det.create_institution%TYPE DEFAULT NULL,
        update_user_in        IN death_registry_det.update_user%TYPE DEFAULT NULL,
        update_time_in        IN death_registry_det.update_time%TYPE DEFAULT NULL,
        update_institution_in IN death_registry_det.update_institution%TYPE DEFAULT NULL,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_pky death_registry_det.id_death_registry_det%TYPE := next_key;
    BEGIN
        ins(id_death_registry_det_in => l_pky,
    ...
    (
        ...
        update_time_in            IN death_registry_det.update_time%TYPE DEFAULT NULL,
        update_institution_in     IN death_registry_det.update_institution%TYPE DEFAULT NULL,
        id_death_registry_det_out IN OUT death_registry_det.id_death_registry_det%TYPE,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    ...
    BEGIN
        ins(id_death_registry_det_in => l_pky,
            ...
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
        id_death_registry_det_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_death_registry_in      => id_death_registry_in,
            ...
            update_time_in            => update_time_in,
            update_institution_in     => update_institution_in,
            id_death_registry_det_out => id_death_registry_det_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN death_registry_det.id_death_registry_det%TYPE IS
        l_pky death_registry_det.id_death_registry_det%TYPE := next_key;
    BEGIN
        ins(id_death_registry_det_in => l_pky,
            id_death_registry_in     => id_death_registry_in,
    ...
    PROCEDURE ins
    (
        id_death_registry_det_in IN death_registry_det.id_death_registry_det%TYPE,
        id_death_registry_in     IN death_registry_det.id_death_registry%TYPE DEFAULT NULL,
        id_ds_component_in       IN death_registry_det.id_ds_component%TYPE DEFAULT NULL,
        value_n_in               IN death_registry_det.value_n%TYPE DEFAULT NULL,
        value_tz_in              IN death_registry_det.value_tz%TYPE DEFAULT NULL,
    ...
    BEGIN
        INSERT INTO death_registry_det
            (id_death_registry_det,
             id_death_registry,
             id_ds_component,
             value_n,
             value_tz,
 ...
 VALUES
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_death_registry_det_in => id_death_registry_det_in,
            id_death_registry_in     => id_death_registry_in,
            id_ds_component_in       => id_ds_component_in,
            value_n_in               => value_n_in,
            value_tz_in              => value_tz_in,
    ...
    PROCEDURE ins
    (
        rec_in          IN death_registry_det%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec death_registry_det%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_death_registry_det := next_key(sequence_in);
        END IF;

        ins(id_death_registry_det_in => l_rec.id_death_registry_det,
    ...
    PROCEDURE ins
    (
        rows_in         IN death_registry_det_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
    ...
    BEGIN
        ...
        UPDATE death_registry_det
         ...
         WHERE id_death_registry_det = id_death_registry_det_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_death_registry_det_in => id_death_registry_det_in,
            id_death_registry_in     => id_death_registry_in,
    ...
    BEGIN
        ...
        l_sql                  := 'UPDATE death_registry_det SET' || ' ID_DEATH_REGISTRY = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_death_registry_in, id_ds_component_in, value_n_in, value_tz_in, value_vc2_in, unit_measure_value_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_death_registry_det_in,
                id_death_registry_in,
                id_ds_component_in,
                value_n_in,
                value_tz_in,
    ...
    BEGIN
        upd(id_death_registry_det_in => rec_in.id_death_registry_det,
    ...
    PROCEDURE upd
    (
        col_in            IN death_registry_det_tc,
        ignore_if_null_in IN BOOLEAN := TRUE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          IN OUT table_varchar
    ) IS
        l_id_death_registry_det id_death_registry_det_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_death_registry_det(i) := col_in(i).id_death_registry_det;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE death_registry_det
                 ...
                 WHERE id_death_registry_det = l_id_death_registry_det(i)
 returning rowid bulk collect into rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE death_registry_det
 ...
 returning rowid bulk collect into rows_out;
    ...
    BEGIN
        RETURN 'BEGIN UPDATE death_registry_det
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE death_registry_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE death_registry_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM death_registry_det
         WHERE id_death_registry_det = id_death_registry_det_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_death_registry_det_in => id_death_registry_det_in,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    END del;

    -- Delete all rows for this DRD_DR_FK foreign key value
    PROCEDURE del_drd_dr_fk
    (
        id_death_registry_in IN death_registry_det.id_death_registry%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_drd_dr_fk(id_death_registry_in => id_death_registry_in,
                      handle_error_in      => handle_error_in,
                      rows_out             => rows_out);
    END del_drd_dr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM death_registry_det';
        ELSE
            RETURN 'DELETE FROM death_registry_det WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(death_registry_det_inout IN OUT death_registry_det%ROWTYPE) IS
    BEGIN
        death_registry_det_inout.id_death_registry_det := NULL;
        death_registry_det_inout.id_death_registry     := NULL;
        death_registry_det_inout.id_ds_component       := NULL;
        death_registry_det_inout.value_n               := NULL;
        death_registry_det_inout.value_tz              := NULL;
        death_registry_det_inout.value_vc2             := NULL;
        death_registry_det_inout.unit_measure_value    := NULL;
        death_registry_det_inout.create_user           := NULL;
        death_registry_det_inout.create_time           := NULL;
        death_registry_det_inout.create_institution    := NULL;
        death_registry_det_inout.update_user           := NULL;
        death_registry_det_inout.update_time           := NULL;
        death_registry_det_inout.update_institution    := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN death_registry_det%ROWTYPE IS
        l_death_registry_det death_registry_det%ROWTYPE;
    BEGIN
        RETURN l_death_registry_det;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN death_registry_det_tc IS
        data death_registry_det_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN death_registry_det_tc IS
        data death_registry_det_tc;
