/*-- Last Change Revision: $Rev: 2028037 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:01 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_epis_addendum
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Dezembro 14, 2010 16:50:32
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO epis_addendum
            (id_epis_addendum,
             id_epis_sign_off,
             id_professional,
             dt_event,
             id_professional_sign_off,
             dt_sign_off,
             notes,
             flg_status,
             id_prof_cancel,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_EPIS_SIGN_OFF',
                                                        value_in           => id_epis_sign_off_in);
                    END IF;
                    IF l_name = 'EA_PC_FK'
                    THEN
                        -- Add a context value for each column
                    ...
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROFESSIONAL_SIGN_OFF',
                                                        value_in           => id_professional_sign_off_in);
                    END IF;
    ...
    BEGIN
        ...
        ins(id_epis_addendum_in         => id_epis_addendum_in,
            id_epis_sign_off_in         => id_epis_sign_off_in,
            id_professional_in          => id_professional_in,
            dt_event_in                 => dt_event_in,
            id_professional_sign_off_in => id_professional_sign_off_in,
            dt_sign_off_in              => dt_sign_off_in,
            notes_in                    => notes_in,
    ...
    */
    ...
    BEGIN
        ...
        upd(id_epis_addendum_in         => id_epis_addendum_in,
            id_epis_sign_off_in         => id_epis_sign_off_in,
            id_professional_in          => id_professional_in,
            dt_event_in                 => dt_event_in,
            id_professional_sign_off_in => id_professional_sign_off_in,
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_epis_addendum_in         => id_epis_addendum_in,
                              id_epis_sign_off_in         => id_epis_sign_off_in,
                              id_professional_in          => id_professional_in,
                              dt_event_in                 => dt_event_in,
                              id_professional_sign_off_in => id_professional_sign_off_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_epis_addendum_in         => id_epis_addendum_in,
                                  id_epis_sign_off_in         => id_epis_sign_off_in,
                                  id_professional_in          => id_professional_in,
                                  dt_event_in                 => dt_event_in,
                                  id_professional_sign_off_in => id_professional_sign_off_in,
    ...
    */
    ...
    (
        ...
        l_rec epis_addendum%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_addendum := next_key(sequence_in);
        END IF;
        ins(id_epis_addendum_in         => l_rec.id_epis_addendum,
            id_epis_sign_off_in         => l_rec.id_epis_sign_off,
            id_professional_in          => l_rec.id_professional,
            dt_event_in                 => l_rec.dt_event,
            id_professional_sign_off_in => l_rec.id_professional_sign_off,
            dt_sign_off_in              => l_rec.dt_sign_off,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_addendum.id_epis_addendum%TYPE
     ...
     IS
        retval epis_addendum.id_epis_addendum%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_epis_addendum.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_EPIS_ADDENDUM'));
    END next_key;
    ...
    (
        ...
        l_pky epis_addendum.id_epis_addendum%TYPE := next_key;
    BEGIN
        ins(id_epis_addendum_in         => l_pky,
            id_epis_sign_off_in         => id_epis_sign_off_in,
            id_professional_in          => id_professional_in,
            dt_event_in                 => dt_event_in,
            id_professional_sign_off_in => id_professional_sign_off_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_epis_sign_off_in         => id_epis_sign_off_in,
            id_professional_in          => id_professional_in,
            dt_event_in                 => dt_event_in,
            id_professional_sign_off_in => id_professional_sign_off_in,
            dt_sign_off_in              => dt_sign_off_in,
            ...
            update_time_in              => update_time_in,
            update_institution_in       => update_institution_in,
            id_epis_addendum_out        => id_epis_addendum_out,
            handle_error_in             => handle_error_in,
            rows_out                    => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in             IN BOOLEAN := TRUE,
        rows_out                    OUT table_varchar
    ) RETURN epis_addendum.id_epis_addendum%TYPE IS
        l_pky epis_addendum.id_epis_addendum%TYPE := next_key;
    BEGIN
        ins(id_epis_addendum_in         => l_pky,
            id_epis_sign_off_in         => id_epis_sign_off_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_EPIS_ADDENDUM _' || indx,
                                                        value_in           => rows_in(indx).id_epis_addendum,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_EPIS_SIGN_OFF _' || indx,
                                                        value_in           => rows_in(indx).id_epis_sign_off,
                                                        validate_in        => FALSE);
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_EVENT _' || indx,
                                                        value_in           => rows_in(indx).dt_event,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_PROFESSIONAL_SIGN_OFF _' || indx,
                                                        value_in           => rows_in(indx).id_professional_sign_off,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_SIGN_OFF _' || indx,
                                                        value_in           => rows_in(indx).dt_sign_off,
                                                        validate_in        => FALSE);
    ...
    (
        ...
        l_id_epis_sign_off_n         NUMBER(1);
        l_id_professional_n          NUMBER(1);
        l_dt_event_n                 NUMBER(1);
        l_id_professional_sign_off_n NUMBER(1);
        l_dt_sign_off_n              NUMBER(1);
        l_notes_n                    NUMBER(1);
    ...
    BEGIN
        ...
        l_id_epis_sign_off_n         := sys.diutil.bool_to_int(id_epis_sign_off_nin);
        l_id_professional_n          := sys.diutil.bool_to_int(id_professional_nin);
        l_dt_event_n                 := sys.diutil.bool_to_int(dt_event_nin);
        l_id_professional_sign_off_n := sys.diutil.bool_to_int(id_professional_sign_off_nin);
        l_dt_sign_off_n              := sys.diutil.bool_to_int(dt_sign_off_nin);
        ...
        UPDATE epis_addendum
           SET id_epis_sign_off         = decode(l_id_epis_sign_off_n,
                                                 0,
                                                 id_epis_sign_off_in,
                                                 nvl(id_epis_sign_off_in, id_epis_sign_off)),
               id_professional          = decode(l_id_professional_n,
                                                 0,
                                                 id_professional_in,
                                                 nvl(id_professional_in, id_professional)),
               dt_event                 = decode(l_dt_event_n, 0, dt_event_in, nvl(dt_event_in, dt_event)),
               id_professional_sign_off = decode(l_id_professional_sign_off_n,
                                                 0,
                                                 id_professional_sign_off_in,
                                                 nvl(id_professional_sign_off_in, id_professional_sign_off)),
               dt_sign_off              = decode(l_dt_sign_off_n, 0, dt_sign_off_in, nvl(dt_sign_off_in, dt_sign_off)),
         ...
         WHERE id_epis_addendum = id_epis_addendum_in
    ...
    BEGIN
        upd(id_epis_addendum_in          => id_epis_addendum_in,
            id_epis_sign_off_in          => id_epis_sign_off_in,
            id_epis_sign_off_nin         => id_epis_sign_off_nin,
            id_professional_in           => id_professional_in,
            id_professional_nin          => id_professional_nin,
            dt_event_in                  => dt_event_in,
            dt_event_nin                 => dt_event_nin,
            id_professional_sign_off_in  => id_professional_sign_off_in,
            id_professional_sign_off_nin => id_professional_sign_off_nin,
            dt_sign_off_in               => dt_sign_off_in,
            dt_sign_off_nin              => dt_sign_off_nin,
            notes_in                     => notes_in,
            notes_nin                    => notes_nin,
            flg_status_in                => flg_status_in,
    ...
    (
        ...
        l_update_time_n              NUMBER(1);
        l_update_institution_n       NUMBER(1);
        id_epis_addendum_in          epis_addendum.id_epis_addendum%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EPIS_ADDENDUM SET ' || ' ID_EPIS_SIGN_OFF = decode (' || l_id_epis_sign_off_n ||
                 ',0,:id_epis_sign_off_in, NVL (:id_epis_sign_off_in, ID_EPIS_SIGN_OFF)) ' || ',' ||
                 ' ID_PROFESSIONAL = decode (' || l_id_professional_n ||
                 ',0,:id_professional_in, NVL (:id_professional_in, ID_PROFESSIONAL)) ' || ',' ||
                 ' DT_EVENT = decode (' || l_dt_event_n || ',0,:dt_event_in, NVL (:dt_event_in, DT_EVENT)) ' || ',' ||
                 ' ID_PROFESSIONAL_SIGN_OFF = decode (' || l_id_professional_sign_off_n ||
                 ',0,:id_professional_sign_off_in, NVL (:id_professional_sign_off_in, ID_PROFESSIONAL_SIGN_OFF)) ' || ',' ||
                 ' DT_SIGN_OFF = decode (' || l_dt_sign_off_n ||
                 ',0,:dt_sign_off_in, NVL (:dt_sign_off_in, DT_SIGN_OFF)) ' || ',' || ' NOTES = decode (' || l_notes_n ||
                 ',0,:notes_in, NVL (:notes_in, NOTES)) ' || ',' || ' FLG_STATUS = decode (' || l_flg_status_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_epis_sign_off_in, id_professional_in, dt_event_in, id_professional_sign_off_in, dt_sign_off_in, notes_in, flg_status_in, id_prof_cancel_in, notes_cancel_in, dt_cancel_in, id_cancel_reason_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_sign_off_in          => id_epis_sign_off_in,
            id_epis_sign_off_nin         => id_epis_sign_off_nin,
            id_professional_in           => id_professional_in,
            id_professional_nin          => id_professional_nin,
            dt_event_in                  => dt_event_in,
    ...
    BEGIN
        upd(id_epis_addendum_in         => rec_in.id_epis_addendum,
            id_epis_sign_off_in         => rec_in.id_epis_sign_off,
            id_professional_in          => rec_in.id_professional,
            dt_event_in                 => rec_in.dt_event,
            id_professional_sign_off_in => rec_in.id_professional_sign_off,
            dt_sign_off_in              => rec_in.dt_sign_off,
    ...
    (
        ...
        l_id_epis_addendum         id_epis_addendum_cc;
        l_id_epis_sign_off         id_epis_sign_off_cc;
        l_id_professional          id_professional_cc;
        l_dt_event                 dt_event_cc;
        l_id_professional_sign_off id_professional_sign_off_cc;
        l_dt_sign_off              dt_sign_off_cc;
        l_notes                    notes_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_epis_addendum(i) := col_in(i).id_epis_addendum;
            l_id_epis_sign_off(i) := col_in(i).id_epis_sign_off;
            l_id_professional(i) := col_in(i).id_professional;
            l_dt_event(i) := col_in(i).dt_event;
            l_id_professional_sign_off(i) := col_in(i).id_professional_sign_off;
            l_dt_sign_off(i) := col_in(i).dt_sign_off;
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE epis_addendum
                   SET id_epis_sign_off         = nvl(l_id_epis_sign_off(i), id_epis_sign_off),
                       id_professional          = nvl(l_id_professional(i), id_professional),
                       dt_event                 = nvl(l_dt_event(i), dt_event),
                       id_professional_sign_off = nvl(l_id_professional_sign_off(i), id_professional_sign_off),
                       dt_sign_off              = nvl(l_dt_sign_off(i), dt_sign_off),
                 ...
                 WHERE id_epis_addendum = l_id_epis_addendum(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE epis_addendum
                   SET id_epis_sign_off         = l_id_epis_sign_off(i),
                       id_professional          = l_id_professional(i),
                       dt_event                 = l_dt_event(i),
                       id_professional_sign_off = l_id_professional_sign_off(i),
                       dt_sign_off              = l_dt_sign_off(i),
                       notes                    = l_notes(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EPIS_ADDENDUM
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_ADDENDUM set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EPIS_ADDENDUM set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_epis_addendum_in => id_epis_addendum_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_epis_addendum(id_epis_addendum_in => id_epis_addendum_in,
                             handle_error_in     => handle_error_in,
                             rows_out            => rows_out);
    END del_id_epis_addendum;
    ...
    BEGIN
        DELETE FROM epis_addendum
         WHERE id_cancel_reason = del_ea_cr_fk.id_cancel_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ea_cr_fk(id_cancel_reason_in => id_cancel_reason_in,
                     handle_error_in     => handle_error_in,
                     rows_out            => rows_out);
    END del_ea_cr_fk;
    ...
    BEGIN
        DELETE FROM epis_addendum
         WHERE id_epis_sign_off = del_ea_eso_fk.id_epis_sign_off_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ea_eso_fk(id_epis_sign_off_in => id_epis_sign_off_in,
                      handle_error_in     => handle_error_in,
                      rows_out            => rows_out);
    END del_ea_eso_fk;
    ...
    BEGIN
        DELETE FROM epis_addendum
         WHERE id_prof_cancel = del_ea_pc_fk.id_prof_cancel_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ea_pc_fk(id_prof_cancel_in => id_prof_cancel_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ea_pc_fk;
    ...
    BEGIN
        DELETE FROM epis_addendum
         WHERE id_professional = del_ea_p_fk.id_professional_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ea_p_fk(id_professional_in => id_professional_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ea_p_fk;
    ...
    BEGIN
        DELETE FROM epis_addendum
         WHERE id_professional_sign_off = del_ea_pso_fk.id_professional_sign_off_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ea_pso_fk(id_professional_sign_off_in => id_professional_sign_off_in,
                      handle_error_in             => handle_error_in,
                      rows_out                    => rows_out);
    END del_ea_pso_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EPIS_ADDENDUM';
        ELSE
            RETURN 'DELETE FROM EPIS_ADDENDUM WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_addendum_inout IN OUT epis_addendum%ROWTYPE) IS
    BEGIN
        epis_addendum_inout.id_epis_addendum         := NULL;
        epis_addendum_inout.id_epis_sign_off         := NULL;
        epis_addendum_inout.id_professional          := NULL;
        epis_addendum_inout.dt_event                 := NULL;
        epis_addendum_inout.id_professional_sign_off := NULL;
        epis_addendum_inout.dt_sign_off              := NULL;
        epis_addendum_inout.notes                    := NULL;
        epis_addendum_inout.flg_status               := 'A';
        epis_addendum_inout.id_prof_cancel           := NULL;
        epis_addendum_inout.notes_cancel             := NULL;
        epis_addendum_inout.dt_cancel                := NULL;
        epis_addendum_inout.id_cancel_reason         := NULL;
        epis_addendum_inout.create_user              := NULL;
        epis_addendum_inout.create_time              := NULL;
        epis_addendum_inout.create_institution       := NULL;
        epis_addendum_inout.update_user              := NULL;
        epis_addendum_inout.update_time              := NULL;
        epis_addendum_inout.update_institution       := NULL;
    END initrec;

    FUNCTION initrec RETURN epis_addendum%ROWTYPE IS
        l_epis_addendum epis_addendum%ROWTYPE;
    BEGIN
        l_epis_addendum.flg_status := 'A';
        RETURN l_epis_addendum;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_addendum_tc IS
        data epis_addendum_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM epis_addendum
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_addendum_tc IS
