/*-- Last Change Revision: $Rev: 2028219 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:31 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY TS_ICNP_EPIS_INTERVENTION
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Novembro 11, 2011 11:57:4
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO ICNP_EPIS_INTERVENTION (
         ID_ICNP_EPIS_INTERV,
         ID_PATIENT,
         ID_EPISODE,
         ID_COMPOSITION,
        ...
        BEGIN
           ...
           ELSE
              pk_alert_exceptions.raise_error (
                    ...
                    ,value2_in => l_name
                    ,name3_in => 'TABLE_NAME'
                    ,value3_in => 'ICNP_EPIS_INTERVENTION');
           END IF;
        END;
        END IF;
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'ICNP_EPIS_INTERVENTION');
           IF l_name = 'EIPI_CRE_FK'
           THEN
           ...
           END IF;
           IF l_name = 'EIPI_PROF_CANCELS_FK'
           THEN
              -- Add a context value for each column
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_id
   ...
   */
   ...
   IS
      l_rec ICNP_EPIS_INTERVENTION%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_ICNP_EPIS_INTERV := next_key (sequence_in);
      END IF;
      ins (
  ...
  ins (
   ...
   IS
     retval ICNP_EPIS_INTERVENTION.ID_ICNP_EPIS_INTERV%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_ICNP_EPIS_INTERVENTION.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_ICNP_EPIS_INTERVENTION')
           );
   END next_key;
   ...
   IS
        l_pky ICNP_EPIS_INTERVENTION.ID_ICNP_EPIS_INTERV%TYPE := next_key;
   BEGIN
      ins (
         id_icnp_epis_interv_in => l_pky,
         id_patient_in => id_patient_in,
         id_episode_in => id_episode_in,
         id_composition_in => id_composition_in,
         flg_status_in => flg_status_in,
   ...
   BEGIN
      ...
      prn_notes_in => prn_notes_in,
      id_icnp_epis_interv_parent_in => id_icnp_epis_interv_parent_in,
      id_icnp_epis_interv_out => id_icnp_epis_interv_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO ICNP_EPIS_INTERVENTION VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
     ...
     THEN
       ...
       pk_alert_exceptions.raise_error(
          error_name_in => 'FORALL-INSERT-FAILURE'
          ,name1_in => 'TABLE_NAME'
          ,value1_in => 'ICNP_EPIS_INTERVENTION'
          ,name2_in => 'ROW_COUNT'
...
PROCEDURE upd (
   ...
   l_ID_ICNP_EPIS_INTERV_PARENT_n := sys.diutil.bool_to_int(ID_ICNP_EPIS_INTERV_PARENT_nin);
         ...
         UPDATE ICNP_EPIS_INTERVENTION SET
     ...
     ID_ICNP_EPIS_INTERV_PARENT = decode (l_ID_ICNP_EPIS_INTERV_PARENT_n,0,id_icnp_epis_interv_parent_in, NVL (id_icnp_epis_interv_parent_in, ID_ICNP_EPIS_INTERV_PARENT))
          WHERE
             ID_ICNP_EPIS_INTERV = id_icnp_epis_interv_in
...
PROCEDURE upd (
   ...
   l_PRN_NOTES_n NUMBER(1);
   l_ID_ICNP_EPIS_INTERV_PARENT_n NUMBER(1);
      id_icnp_epis_interv_in ICNP_EPIS_INTERVENTION.ID_ICNP_EPIS_INTERV%TYPE;
   BEGIN
...
l_sql := 'UPDATE ICNP_EPIS_INTERVENTION SET '
     || ' ID_PATIENT = decode (' || l_ID_PATIENT_n || ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) '|| ','
     || ' ID_EPISODE = decode (' || l_ID_EPISODE_n || ',0,:id_episode_in, NVL (:id_episode_in, ID_EPISODE)) '|| ','
     || ' ID_COMPOSITION = decode (' || l_ID_COMPOSITION_n || ',0,:id_composition_in, NVL (:id_composition_in, ID_COMPOSITION)) '|| ','
     || ' FLG_STATUS = decode (' || l_FLG_STATUS_n || ',0,:flg_status_in, NVL (:flg_status_in, FLG_STATUS)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      RETURN
         'BEGIN UPDATE ICNP_EPIS_INTERVENTION
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE ICNP_EPIS_INTERVENTION set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE ICNP_EPIS_INTERVENTION set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
   ...
   IS
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_ICNP_EPIS_INTERV = id_icnp_epis_interv_in
       RETURNING ROWID BULK COLLECT INTO rows_out
         ;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_CANCEL_REASON = del_EIPI_CRE_FK.id_cancel_reason_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_CRE_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_SUSPEND_REASON = del_EIPI_CRE_SUSP_FK.id_suspend_reason_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_CRE_SUSP_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          FORWARD_INTERV = del_EIPI_EIPI_FK.forward_interv_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_EIPI_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_EPISODE = del_EIPI_EPIS_FK.id_episode_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_EPIS_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_PATIENT = del_EIPI_PAT_FK.id_patient_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PAT_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_CANCEL_PROF = del_EIPI_PROF_CANCELS_FK.id_cancel_prof_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PROF_CANCELS_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_PROF_CLOSE = del_EIPI_PROF_CANC_FK.id_prof_close_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PROF_CANC_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_PROF = del_EIPI_PROF_FK.id_prof_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PROF_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_SUSPEND_PROF = del_EIPI_PROF_SUSP_FK.id_suspend_prof_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PROF_SUSP_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_PROF_LAST_UPDATE = del_EIPI_PROF_UPD_FK.id_prof_last_update_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EIPI_PROF_UPD_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_EPISODE_DESTINATION = del_IEI_EPIS_DEST_FK.id_episode_destination_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_IEI_EPIS_DEST_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_EPISODE_ORIGIN = del_IEI_EPIS_ORIGIN_FK.id_episode_origin_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_IEI_EPIS_ORIGIN_FK (
   ...
   BEGIN
      DELETE FROM ICNP_EPIS_INTERVENTION
       WHERE
          ID_ORDER_RECURR_PLAN = del_IEI_ORP_FK.id_order_recurr_plan_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_IEI_ORP_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM ICNP_EPIS_INTERVENTION';
      ELSE
         RETURN
            'DELETE FROM ICNP_EPIS_INTERVENTION WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      icnp_epis_intervention_inout.ID_ICNP_EPIS_INTERV := NULL;
      icnp_epis_intervention_inout.ID_PATIENT := NULL;
      icnp_epis_intervention_inout.ID_EPISODE := NULL;
      icnp_epis_intervention_inout.ID_COMPOSITION := NULL;
      icnp_epis_intervention_inout.FLG_STATUS := NULL;
      icnp_epis_intervention_inout.FREQ := NULL;
      icnp_epis_intervention_inout.NOTES := NULL;
      icnp_epis_intervention_inout.ID_PROF := NULL;
      icnp_epis_intervention_inout.NOTES_CLOSE := NULL;
      icnp_epis_intervention_inout.ID_PROF_CLOSE := NULL;
      icnp_epis_intervention_inout.FORWARD_INTERV := NULL;
      icnp_epis_intervention_inout.NOTES_ITERACTION := NULL;
      icnp_epis_intervention_inout.NOTES_CLOSE_ITERACTION := NULL;
      icnp_epis_intervention_inout.FLG_TIME := NULL;
      icnp_epis_intervention_inout.FLG_TYPE := NULL;
      icnp_epis_intervention_inout.INTERVAL := NULL;
      icnp_epis_intervention_inout.NUM_TAKE := NULL;
      icnp_epis_intervention_inout.DT_ICNP_EPIS_INTERV_TSTZ := NULL;
      icnp_epis_intervention_inout.DT_BEGIN_TSTZ := NULL;
      icnp_epis_intervention_inout.DT_END_TSTZ := NULL;
      icnp_epis_intervention_inout.DT_NEXT_TSTZ := NULL;
      icnp_epis_intervention_inout.DT_CLOSE_TSTZ := NULL;
      icnp_epis_intervention_inout.FLG_INTERVAL_UNIT := NULL;
      icnp_epis_intervention_inout.ID_EPISODE_ORIGIN := NULL;
      icnp_epis_intervention_inout.ID_EPISODE_DESTINATION := NULL;
      icnp_epis_intervention_inout.DURATION := NULL;
      icnp_epis_intervention_inout.FLG_DURATION_UNIT := NULL;
      icnp_epis_intervention_inout.CREATE_USER := NULL;
      icnp_epis_intervention_inout.CREATE_TIME := NULL;
      icnp_epis_intervention_inout.CREATE_INSTITUTION := NULL;
      icnp_epis_intervention_inout.UPDATE_USER := NULL;
      icnp_epis_intervention_inout.UPDATE_TIME := NULL;
      icnp_epis_intervention_inout.UPDATE_INSTITUTION := NULL;
      icnp_epis_intervention_inout.ID_PROF_LAST_UPDATE := NULL;
      icnp_epis_intervention_inout.DT_LAST_UPDATE := NULL;
      icnp_epis_intervention_inout.ID_SUSPEND_REASON := NULL;
      icnp_epis_intervention_inout.ID_SUSPEND_PROF := NULL;
      icnp_epis_intervention_inout.SUSPEND_NOTES := NULL;
      icnp_epis_intervention_inout.DT_SUSPEND := NULL;
      icnp_epis_intervention_inout.ID_CANCEL_REASON := NULL;
      icnp_epis_intervention_inout.ID_CANCEL_PROF := NULL;
      icnp_epis_intervention_inout.CANCEL_NOTES := NULL;
      icnp_epis_intervention_inout.DT_CANCEL := NULL;
      icnp_epis_intervention_inout.ID_ORDER_RECURR_PLAN := NULL;
      icnp_epis_intervention_inout.FLG_PRN := NULL;
      icnp_epis_intervention_inout.PRN_NOTES := NULL;
      icnp_epis_intervention_inout.ID_ICNP_EPIS_INTERV_PARENT := NULL;
   END initrec;

   FUNCTION initrec RETURN ICNP_EPIS_INTERVENTION%ROWTYPE
   IS
      l_icnp_epis_intervention ICNP_EPIS_INTERVENTION%ROWTYPE;
   BEGIN
      RETURN l_icnp_epis_intervention;
   END initrec;
   ...
   IS
        data ICNP_EPIS_INTERVENTION_tc;
   BEGIN
        select * bulk collect into data from ICNP_EPIS_INTERVENTION where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
