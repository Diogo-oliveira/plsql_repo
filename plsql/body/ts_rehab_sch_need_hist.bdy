/*-- Last Change Revision: $Rev: 2028374 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:24 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_rehab_sch_need_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Julho 14, 2010 15:42:3
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_rehab_sch_need_hist_in IN rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE,
        dt_rehab_sch_need_hist_in IN rehab_sch_need_hist.dt_rehab_sch_need_hist%TYPE DEFAULT NULL,
        id_professional_hist_in   IN rehab_sch_need_hist.id_professional_hist%TYPE DEFAULT NULL,
        id_rehab_sch_need_in      IN rehab_sch_need_hist.id_rehab_sch_need%TYPE DEFAULT NULL,
        id_rehab_session_type_in  IN rehab_sch_need_hist.id_rehab_session_type%TYPE DEFAULT NULL,
        dt_rehab_sch_need_in      IN rehab_sch_need_hist.dt_rehab_sch_need%TYPE DEFAULT NULL,
        id_episode_origin_in      IN rehab_sch_need_hist.id_episode_origin%TYPE DEFAULT NULL,
        id_professional_in        IN rehab_sch_need_hist.id_professional%TYPE DEFAULT NULL,
        sessions_in               IN rehab_sch_need_hist.sessions%TYPE DEFAULT NULL,
        frequency_in              IN rehab_sch_need_hist.frequency%TYPE DEFAULT NULL,
        flg_frequency_in          IN rehab_sch_need_hist.flg_frequency%TYPE DEFAULT NULL,
        flg_priority_in           IN rehab_sch_need_hist.flg_priority%TYPE DEFAULT NULL,
        dt_begin_in               IN rehab_sch_need_hist.dt_begin%TYPE DEFAULT NULL,
        flg_status_in             IN rehab_sch_need_hist.flg_status%TYPE DEFAULT NULL,
        id_resp_professional_in   IN rehab_sch_need_hist.id_resp_professional%TYPE DEFAULT NULL,
        id_resp_rehab_group_in    IN rehab_sch_need_hist.id_resp_rehab_group%TYPE DEFAULT NULL,
        notes_in                  IN rehab_sch_need_hist.notes%TYPE DEFAULT NULL,
        id_cancel_reason_in       IN rehab_sch_need_hist.id_cancel_reason%TYPE DEFAULT NULL,
        dt_cancel_in              IN rehab_sch_need_hist.dt_cancel%TYPE DEFAULT NULL,
        id_cancel_professional_in IN rehab_sch_need_hist.id_cancel_professional%TYPE DEFAULT NULL,
        notes_cancel_in           IN rehab_sch_need_hist.notes_cancel%TYPE DEFAULT NULL,
        create_user_in            IN rehab_sch_need_hist.create_user%TYPE DEFAULT NULL,
        create_time_in            IN rehab_sch_need_hist.create_time%TYPE DEFAULT NULL,
        create_institution_in     IN rehab_sch_need_hist.create_institution%TYPE DEFAULT NULL,
        update_user_in            IN rehab_sch_need_hist.update_user%TYPE DEFAULT NULL,
        update_time_in            IN rehab_sch_need_hist.update_time%TYPE DEFAULT NULL,
        update_institution_in     IN rehab_sch_need_hist.update_institution%TYPE DEFAULT NULL,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO rehab_sch_need_hist
            (id_rehab_sch_need_hist,
             dt_rehab_sch_need_hist,
             ...
             update_institution)
        VALUES
            (id_rehab_sch_need_hist_in,
             dt_rehab_sch_need_hist_in,
    ...
    BEGIN
        ...
        ins(id_rehab_sch_need_hist_in => id_rehab_sch_need_hist_in,
            dt_rehab_sch_need_hist_in => dt_rehab_sch_need_hist_in,
    ...
    PROCEDURE ins
    (
        rec_in          IN rehab_sch_need_hist%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec rehab_sch_need_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_rehab_sch_need_hist := next_key(sequence_in);
        END IF;
        ins(id_rehab_sch_need_hist_in => l_rec.id_rehab_sch_need_hist,
            dt_rehab_sch_need_hist_in => l_rec.dt_rehab_sch_need_hist,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE
    
     IS
        retval rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_rehab_sch_need_hist.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_REHAB_SCH_NEED_HIST'));
    END next_key;
    ...
    (
        ...
        update_time_in             IN rehab_sch_need_hist.update_time%TYPE DEFAULT NULL,
        update_institution_in      IN rehab_sch_need_hist.update_institution%TYPE DEFAULT NULL,
        id_rehab_sch_need_hist_out IN OUT rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE,
        handle_error_in            IN BOOLEAN := TRUE,
        rows_out                   OUT table_varchar
    ) IS
        l_pky rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE := next_key;
    BEGIN
        ins(id_rehab_sch_need_hist_in => l_pky,
            dt_rehab_sch_need_hist_in => dt_rehab_sch_need_hist_in,
            id_professional_hist_in   => id_professional_hist_in,
            id_rehab_sch_need_in      => id_rehab_sch_need_in,
            id_rehab_session_type_in  => id_rehab_session_type_in,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_rehab_sch_need_hist_out := l_pky;
    END ins;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(dt_rehab_sch_need_hist_in  => dt_rehab_sch_need_hist_in,
            id_professional_hist_in    => id_professional_hist_in,
            id_rehab_sch_need_in       => id_rehab_sch_need_in,
            id_rehab_session_type_in   => id_rehab_session_type_in,
            dt_rehab_sch_need_in       => dt_rehab_sch_need_in,
            ...
            update_time_in             => update_time_in,
            update_institution_in      => update_institution_in,
            id_rehab_sch_need_hist_out => id_rehab_sch_need_hist_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) RETURN rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE IS
        l_pky rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE := next_key;
    BEGIN
        ins(id_rehab_sch_need_hist_in => l_pky,
            dt_rehab_sch_need_hist_in => dt_rehab_sch_need_hist_in,
    ...
    PROCEDURE ins
    (
        rows_in         IN rehab_sch_need_hist_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_REHAB_SCH_NEED_HIST _' || indx,
                                                        value_in           => rows_in(indx).id_rehab_sch_need_hist,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_REHAB_SCH_NEED_HIST _' || indx,
                                                        value_in           => rows_in(indx).dt_rehab_sch_need_hist,
                                                        validate_in        => FALSE);
    ...
    (
        id_rehab_sch_need_hist_in  IN rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE,
        dt_rehab_sch_need_hist_in  IN rehab_sch_need_hist.dt_rehab_sch_need_hist%TYPE DEFAULT NULL,
        dt_rehab_sch_need_hist_nin IN BOOLEAN := TRUE,
        id_professional_hist_in    IN rehab_sch_need_hist.id_professional_hist%TYPE DEFAULT NULL,
        ...
        l_dt_rehab_sch_need_hist_n NUMBER(1);
    ...
    BEGIN
        ...
        l_dt_rehab_sch_need_hist_n := sys.diutil.bool_to_int(dt_rehab_sch_need_hist_nin);
        ...
        UPDATE rehab_sch_need_hist
           SET dt_rehab_sch_need_hist = decode(l_dt_rehab_sch_need_hist_n,
                                               0,
                                               dt_rehab_sch_need_hist_in,
                                               nvl(dt_rehab_sch_need_hist_in, dt_rehab_sch_need_hist)),
               ...
               id_rehab_session_type  = decode(l_id_rehab_session_type_n,
                                               0,
                                               id_rehab_session_type_in,
         ...
         WHERE id_rehab_sch_need_hist = id_rehab_sch_need_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_rehab_sch_need_hist_in  => id_rehab_sch_need_hist_in,
            dt_rehab_sch_need_hist_in  => dt_rehab_sch_need_hist_in,
            dt_rehab_sch_need_hist_nin => dt_rehab_sch_need_hist_nin,
            id_professional_hist_in    => id_professional_hist_in,
    ...
    (
        ...
        l_update_time_n            NUMBER(1);
        l_update_institution_n     NUMBER(1);
        id_rehab_sch_need_hist_in  rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE REHAB_SCH_NEED_HIST SET ' || ' DT_REHAB_SCH_NEED_HIST = decode (' ||
                 l_dt_rehab_sch_need_hist_n ||
                 ',0,:dt_rehab_sch_need_hist_in, NVL (:dt_rehab_sch_need_hist_in, DT_REHAB_SCH_NEED_HIST)) ' || ',' ||
                 ' ID_PROFESSIONAL_HIST = decode (' || l_id_professional_hist_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN dt_rehab_sch_need_hist_in, id_professional_hist_in, id_rehab_sch_need_in, id_rehab_session_type_in, dt_rehab_sch_need_in, id_episode_origin_in, id_professional_in, sessions_in, frequency_in, flg_frequency_in, flg_priority_in, dt_begin_in, flg_status_in, id_resp_professional_in, id_resp_rehab_group_in, notes_in, id_cancel_reason_in, dt_cancel_in, id_cancel_professional_in, notes_cancel_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(dt_rehab_sch_need_hist_in  => dt_rehab_sch_need_hist_in,
            dt_rehab_sch_need_hist_nin => dt_rehab_sch_need_hist_nin,
            id_professional_hist_in    => id_professional_hist_in,
            id_professional_hist_nin   => id_professional_hist_nin,
            id_rehab_sch_need_in       => id_rehab_sch_need_in,
    ...
    BEGIN
        upd(id_rehab_sch_need_hist_in => rec_in.id_rehab_sch_need_hist,
            dt_rehab_sch_need_hist_in => rec_in.dt_rehab_sch_need_hist,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_rehab_sch_need_hist_in,
                dt_rehab_sch_need_hist_in,
                id_professional_hist_in,
                id_rehab_sch_need_in,
                id_rehab_session_type_in,
    ...
    PROCEDURE upd
    (
        col_in            IN rehab_sch_need_hist_tc,
        ignore_if_null_in IN BOOLEAN := TRUE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          IN OUT table_varchar
    ) IS
        l_id_rehab_sch_need_hist id_rehab_sch_need_hist_cc;
        l_dt_rehab_sch_need_hist dt_rehab_sch_need_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_rehab_sch_need_hist(i) := col_in(i).id_rehab_sch_need_hist;
            l_dt_rehab_sch_need_hist(i) := col_in(i).dt_rehab_sch_need_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE rehab_sch_need_hist
                   SET dt_rehab_sch_need_hist = nvl(l_dt_rehab_sch_need_hist(i), dt_rehab_sch_need_hist),
                       ...
                       id_rehab_session_type  = nvl(l_id_rehab_session_type(i), id_rehab_session_type),
                 ...
                 WHERE id_rehab_sch_need_hist = l_id_rehab_sch_need_hist(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE rehab_sch_need_hist
                   SET dt_rehab_sch_need_hist = l_dt_rehab_sch_need_hist(i),
                       id_professional_hist   = l_id_professional_hist(i),
                       id_rehab_sch_need      = l_id_rehab_sch_need(i),
                       id_rehab_session_type  = l_id_rehab_session_type(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE REHAB_SCH_NEED_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE REHAB_SCH_NEED_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE REHAB_SCH_NEED_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE REHAB_SCH_NEED_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM rehab_sch_need_hist
         WHERE id_rehab_sch_need_hist = id_rehab_sch_need_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
    ...
    BEGIN
        ...
        del(id_rehab_sch_need_hist_in => id_rehab_sch_need_hist_in,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    
    END del;

    -- Delete all rows for primary key column ID_REHAB_SCH_NEED_HIST
    PROCEDURE del_id_rehab_sch_need_hist
    (
        id_rehab_sch_need_hist_in IN rehab_sch_need_hist.id_rehab_sch_need_hist%TYPE,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_id_rehab_sch_need_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_rehab_sch_need_hist(id_rehab_sch_need_hist_in => id_rehab_sch_need_hist_in,
                                   handle_error_in           => handle_error_in,
                                   rows_out                  => rows_out);
    END del_id_rehab_sch_need_hist;

    PROCEDURE del_rst_rsd_fk
    (
        id_rehab_sch_need_in IN rehab_sch_need_hist.id_rehab_sch_need%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM rehab_sch_need_hist
         WHERE id_rehab_sch_need = del_rst_rsd_fk.id_rehab_sch_need_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_rst_rsd_fk(id_rehab_sch_need_in => id_rehab_sch_need_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_rst_rsd_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM REHAB_SCH_NEED_HIST';
        ELSE
            RETURN 'DELETE FROM REHAB_SCH_NEED_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(rehab_sch_need_hist_inout IN OUT rehab_sch_need_hist%ROWTYPE) IS
    BEGIN
        rehab_sch_need_hist_inout.id_rehab_sch_need_hist := NULL;
        rehab_sch_need_hist_inout.dt_rehab_sch_need_hist := NULL;
        rehab_sch_need_hist_inout.id_professional_hist   := NULL;
        rehab_sch_need_hist_inout.id_rehab_sch_need      := NULL;
        rehab_sch_need_hist_inout.id_rehab_session_type  := NULL;
        rehab_sch_need_hist_inout.dt_rehab_sch_need      := NULL;
        rehab_sch_need_hist_inout.id_episode_origin      := NULL;
        rehab_sch_need_hist_inout.id_professional        := NULL;
        rehab_sch_need_hist_inout.sessions               := NULL;
        rehab_sch_need_hist_inout.frequency              := NULL;
        rehab_sch_need_hist_inout.flg_frequency          := NULL;
        rehab_sch_need_hist_inout.flg_priority           := NULL;
        rehab_sch_need_hist_inout.dt_begin               := NULL;
        rehab_sch_need_hist_inout.flg_status             := NULL;
        rehab_sch_need_hist_inout.id_resp_professional   := NULL;
        rehab_sch_need_hist_inout.id_resp_rehab_group    := NULL;
        rehab_sch_need_hist_inout.notes                  := NULL;
        rehab_sch_need_hist_inout.id_cancel_reason       := NULL;
        rehab_sch_need_hist_inout.dt_cancel              := NULL;
        rehab_sch_need_hist_inout.id_cancel_professional := NULL;
        rehab_sch_need_hist_inout.notes_cancel           := NULL;
        rehab_sch_need_hist_inout.create_user            := NULL;
        rehab_sch_need_hist_inout.create_time            := NULL;
        rehab_sch_need_hist_inout.create_institution     := NULL;
        rehab_sch_need_hist_inout.update_user            := NULL;
        rehab_sch_need_hist_inout.update_time            := NULL;
        rehab_sch_need_hist_inout.update_institution     := NULL;
    END initrec;

    FUNCTION initrec RETURN rehab_sch_need_hist%ROWTYPE IS
        l_rehab_sch_need_hist rehab_sch_need_hist%ROWTYPE;
    BEGIN
        RETURN l_rehab_sch_need_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN rehab_sch_need_hist_tc IS
        data rehab_sch_need_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM rehab_sch_need_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN rehab_sch_need_hist_tc IS
