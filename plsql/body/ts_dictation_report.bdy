/*-- Last Change Revision: $Rev: 2028003 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:55 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_dictation_report
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: May 6, 2010 9:0:57
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_dictation_report_in IN dictation_report.id_dictation_report%TYPE,
        id_external_in         IN dictation_report.id_external%TYPE DEFAULT NULL,
        id_patient_in          IN dictation_report.id_patient%TYPE DEFAULT NULL,
        id_episode_in          IN dictation_report.id_episode%TYPE DEFAULT NULL,
        id_work_type_in        IN dictation_report.id_work_type%TYPE DEFAULT NULL,
        report_status_in       IN dictation_report.report_status%TYPE DEFAULT NULL,
        report_information_in  IN dictation_report.report_information%TYPE DEFAULT NULL,
        id_prof_dictated_in    IN dictation_report.id_prof_dictated%TYPE DEFAULT NULL,
        id_prof_transcribed_in IN dictation_report.id_prof_transcribed%TYPE DEFAULT NULL,
        id_prof_signoff_in     IN dictation_report.id_prof_signoff%TYPE DEFAULT NULL,
        dictated_date_in       IN dictation_report.dictated_date%TYPE DEFAULT NULL,
        transcribed_date_in    IN dictation_report.transcribed_date%TYPE DEFAULT NULL,
        signoff_date_in        IN dictation_report.signoff_date%TYPE DEFAULT NULL,
        last_update_date_in    IN dictation_report.last_update_date%TYPE DEFAULT NULL,
        create_user_in         IN dictation_report.create_user%TYPE DEFAULT NULL,
        create_time_in         IN dictation_report.create_time%TYPE DEFAULT NULL,
        create_institution_in  IN dictation_report.create_institution%TYPE DEFAULT NULL,
        update_user_in         IN dictation_report.update_user%TYPE DEFAULT NULL,
        update_time_in         IN dictation_report.update_time%TYPE DEFAULT NULL,
        update_institution_in  IN dictation_report.update_institution%TYPE DEFAULT NULL,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO dictation_report
            (id_dictation_report,
             id_external,
             id_patient,
             id_episode,
    ...
    BEGIN
        ...
        ins(id_dictation_report_in => id_dictation_report_in,
    ...
    */
    ...
    BEGIN
        ...
        upd(id_dictation_report_in => id_dictation_report_in,
            id_external_in         => id_external_in,
            id_patient_in          => id_patient_in,
            id_episode_in          => id_episode_in,
            id_work_type_in        => id_work_type_in,
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_dictation_report_in => id_dictation_report_in,
                              id_external_in         => id_external_in,
                              id_patient_in          => id_patient_in,
                              id_episode_in          => id_episode_in,
                              id_work_type_in        => id_work_type_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_dictation_report_in => id_dictation_report_in,
                                  id_external_in         => id_external_in,
                                  id_patient_in          => id_patient_in,
                                  id_episode_in          => id_episode_in,
                                  id_work_type_in        => id_work_type_in,
    ...
    */
    ...
    PROCEDURE ins
    (
        rec_in          IN dictation_report%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec dictation_report%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_dictation_report := next_key(sequence_in);
        END IF;
        ins(id_dictation_report_in => l_rec.id_dictation_report,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN dictation_report.id_dictation_report%TYPE
    
     IS
        retval dictation_report.id_dictation_report%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_dictation_report.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_DICTATION_REPORT'));
    END next_key;
    ...
    (
        ...
        update_time_in          IN dictation_report.update_time%TYPE DEFAULT NULL,
        update_institution_in   IN dictation_report.update_institution%TYPE DEFAULT NULL,
        id_dictation_report_out IN OUT dictation_report.id_dictation_report%TYPE,
        handle_error_in         IN BOOLEAN := TRUE,
        rows_out                OUT table_varchar
    ) IS
        l_pky dictation_report.id_dictation_report%TYPE := next_key;
    BEGIN
        ins(id_dictation_report_in => l_pky,
            id_external_in         => id_external_in,
            id_patient_in          => id_patient_in,
            id_episode_in          => id_episode_in,
            id_work_type_in        => id_work_type_in,
    ...
    BEGIN
        ins(id_external_in          => id_external_in,
            ...
            update_time_in          => update_time_in,
            update_institution_in   => update_institution_in,
            id_dictation_report_out => id_dictation_report_out,
            handle_error_in         => handle_error_in,
            rows_out                => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) RETURN dictation_report.id_dictation_report%TYPE IS
        l_pky dictation_report.id_dictation_report%TYPE := next_key;
    BEGIN
        ins(id_dictation_report_in => l_pky,
            id_external_in         => id_external_in,
    ...
    PROCEDURE ins
    (
        rows_in         IN dictation_report_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        l_update_time_n         NUMBER(1);
        l_update_institution_n  NUMBER(1);
        id_dictation_report_in  dictation_report.id_dictation_report%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE DICTATION_REPORT SET ' || ' ID_EXTERNAL = decode (' || l_id_external_n ||
                 ',0,:id_external_in, NVL (:id_external_in, ID_EXTERNAL)) ' || ',' || ' ID_PATIENT = decode (' ||
    ...
    BEGIN
        upd(id_dictation_report_in => rec_in.id_dictation_report,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_dictation_report_in,
                id_external_in,
                id_patient_in,
                id_episode_in,
                id_work_type_in,
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE dictation_report
                 ...
                 WHERE id_dictation_report = l_id_dictation_report(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE dictation_report
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE DICTATION_REPORT
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE DICTATION_REPORT
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE DICTATION_REPORT set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE DICTATION_REPORT set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_dictation_report_in => id_dictation_report_in, handle_error_in => handle_error_in, rows_out => rows_out);
    
    END del;

    -- Delete all rows for primary key column ID_DICTATION_REPORT
    PROCEDURE del_id_dictation_report
    (
        id_dictation_report_in IN dictation_report.id_dictation_report%TYPE,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_dictation_report(id_dictation_report_in => id_dictation_report_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_id_dictation_report;

    PROCEDURE del_dr_episode_fk
    (
        id_episode_in   IN dictation_report.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_episode = del_dr_episode_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_episode_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_dr_episode_fk;

    PROCEDURE del_dr_patient_fk
    (
        id_patient_in   IN dictation_report.id_patient%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_patient = del_dr_patient_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_patient_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_dr_patient_fk;

    PROCEDURE del_dr_prof_dict_fk
    (
        id_prof_dictated_in IN dictation_report.id_prof_dictated%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_prof_dictated = del_dr_prof_dict_fk.id_prof_dictated_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_prof_dict_fk(id_prof_dictated_in => id_prof_dictated_in,
                            handle_error_in     => handle_error_in,
                            rows_out            => rows_out);
    END del_dr_prof_dict_fk;

    PROCEDURE del_dr_prof_sign_fk
    (
        id_prof_signoff_in IN dictation_report.id_prof_signoff%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_prof_signoff = del_dr_prof_sign_fk.id_prof_signoff_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_prof_sign_fk(id_prof_signoff_in => id_prof_signoff_in,
                            handle_error_in    => handle_error_in,
                            rows_out           => rows_out);
    END del_dr_prof_sign_fk;

    PROCEDURE del_dr_prof_tran_fk
    (
        id_prof_transcribed_in IN dictation_report.id_prof_transcribed%TYPE,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_prof_transcribed = del_dr_prof_tran_fk.id_prof_transcribed_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_prof_tran_fk(id_prof_transcribed_in => id_prof_transcribed_in,
                            handle_error_in        => handle_error_in,
                            rows_out               => rows_out);
    END del_dr_prof_tran_fk;

    PROCEDURE del_dr_work_type_fk
    (
        id_work_type_in IN dictation_report.id_work_type%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM dictation_report
         WHERE id_work_type = del_dr_work_type_fk.id_work_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dr_work_type_fk(id_work_type_in => id_work_type_in,
                            handle_error_in => handle_error_in,
                            rows_out        => rows_out);
    END del_dr_work_type_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM DICTATION_REPORT';
        ELSE
            RETURN 'DELETE FROM DICTATION_REPORT WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(dictation_report_inout IN OUT dictation_report%ROWTYPE) IS
    BEGIN
        dictation_report_inout.id_dictation_report := NULL;
        dictation_report_inout.id_external         := NULL;
        dictation_report_inout.id_patient          := NULL;
        dictation_report_inout.id_episode          := NULL;
        dictation_report_inout.id_work_type        := NULL;
        dictation_report_inout.report_status       := NULL;
        dictation_report_inout.report_information  := NULL;
        dictation_report_inout.id_prof_dictated    := NULL;
        dictation_report_inout.id_prof_transcribed := NULL;
        dictation_report_inout.id_prof_signoff     := NULL;
        dictation_report_inout.dictated_date       := NULL;
        dictation_report_inout.transcribed_date    := NULL;
        dictation_report_inout.signoff_date        := NULL;
        dictation_report_inout.last_update_date    := NULL;
        dictation_report_inout.create_user         := NULL;
        dictation_report_inout.create_time         := NULL;
        dictation_report_inout.create_institution  := NULL;
        dictation_report_inout.update_user         := NULL;
        dictation_report_inout.update_time         := NULL;
        dictation_report_inout.update_institution  := NULL;
    END initrec;

    FUNCTION initrec RETURN dictation_report%ROWTYPE IS
        l_dictation_report dictation_report%ROWTYPE;
    BEGIN
        RETURN l_dictation_report;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN dictation_report_tc IS
        data dictation_report_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM dictation_report
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN dictation_report_tc IS
