...
CREATE OR REPLACE PACKAGE BODY ts_pn_button_soft_inst
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Novembro 13, 2014 15:52:54
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO pn_button_soft_inst
            (id_institution,
             id_software,
             id_department,
             id_dep_clin_serv,
    ...
    (
        ...
        l_rec pn_button_soft_inst%ROWTYPE := rec_in;
    BEGIN
        ins(id_institution_in       => l_rec.id_institution,
    ...
    (
        ...
        l_age_max_n             NUMBER(1);
        l_flg_activation_n      NUMBER(1);
        id_institution_in       pn_button_soft_inst.id_institution%TYPE;
        id_software_in          pn_button_soft_inst.id_software%TYPE;
        id_department_in        pn_button_soft_inst.id_department%TYPE;
        id_dep_clin_serv_in     pn_button_soft_inst.id_dep_clin_serv%TYPE;
        id_pn_note_type_in      pn_button_soft_inst.id_pn_note_type%TYPE;
        id_pn_soap_block_in     pn_button_soft_inst.id_pn_soap_block%TYPE;
        id_conf_button_block_in pn_button_soft_inst.id_conf_button_block%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PN_BUTTON_SOFT_INST SET ' || ' FLG_AVAILABLE = decode (' || l_flg_available_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN flg_available_in, rank_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_parent_in, gender_in, age_min_in, age_max_in, flg_activation_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_institution_in       => rec_in.id_institution,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE pn_button_soft_inst
                 ...
                 WHERE id_institution = l_id_institution(i)
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PN_BUTTON_SOFT_INST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PN_BUTTON_SOFT_INST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PN_BUTTON_SOFT_INST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PN_BUTTON_SOFT_INST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_institution = id_institution_in
           AND id_software = id_software_in
           AND id_department = id_department_in
           AND id_dep_clin_serv = id_dep_clin_serv_in
    ...
    BEGIN
        ...
        del(id_institution_in       => id_institution_in,
            id_software_in          => id_software_in,
            id_department_in        => id_department_in,
            id_dep_clin_serv_in     => id_dep_clin_serv_in,
            id_pn_note_type_in      => id_pn_note_type_in,
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_conf_button_block = del_pbsi_cbb_fk.id_conf_button_block_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_cbb_fk(id_conf_button_block_in => id_conf_button_block_in,
                        handle_error_in         => handle_error_in,
                        rows_out                => rows_out);
    END del_pbsi_cbb_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_parent = del_pbsi_cbbprnt_fk.id_parent_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_cbbprnt_fk(id_parent_in => id_parent_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pbsi_cbbprnt_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_dep_clin_serv = del_pbsi_dcs_fk.id_dep_clin_serv_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_dcs_fk(id_dep_clin_serv_in => id_dep_clin_serv_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_pbsi_dcs_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_department = del_pbsi_dep_fk.id_department_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_dep_fk(id_department_in => id_department_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pbsi_dep_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_institution = del_pbsi_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_inst_fk(id_institution_in => id_institution_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_pbsi_inst_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_pn_soap_block = del_pbsi_pnsb_fk.id_pn_soap_block_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_pnsb_fk(id_pn_soap_block_in => id_pn_soap_block_in,
                         handle_error_in     => handle_error_in,
                         rows_out            => rows_out);
    END del_pbsi_pnsb_fk;
    ...
    BEGIN
        DELETE FROM pn_button_soft_inst
         WHERE id_software = del_pbsi_s_fk.id_software_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pbsi_s_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pbsi_s_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PN_BUTTON_SOFT_INST';
        ELSE
            RETURN 'DELETE FROM PN_BUTTON_SOFT_INST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pn_button_soft_inst_inout IN OUT pn_button_soft_inst%ROWTYPE) IS
    BEGIN
        pn_button_soft_inst_inout.id_institution       := NULL;
        pn_button_soft_inst_inout.id_software          := NULL;
        pn_button_soft_inst_inout.id_department        := NULL;
        pn_button_soft_inst_inout.id_dep_clin_serv     := NULL;
        pn_button_soft_inst_inout.id_pn_soap_block     := NULL;
        pn_button_soft_inst_inout.id_conf_button_block := NULL;
        pn_button_soft_inst_inout.flg_available        := NULL;
        pn_button_soft_inst_inout.rank                 := NULL;
        pn_button_soft_inst_inout.create_user          := NULL;
        pn_button_soft_inst_inout.create_time          := NULL;
        pn_button_soft_inst_inout.create_institution   := NULL;
        pn_button_soft_inst_inout.update_user          := NULL;
        pn_button_soft_inst_inout.update_time          := NULL;
        pn_button_soft_inst_inout.update_institution   := NULL;
        pn_button_soft_inst_inout.id_pn_note_type      := NULL;
        pn_button_soft_inst_inout.id_parent            := NULL;
        pn_button_soft_inst_inout.gender               := NULL;
        pn_button_soft_inst_inout.age_min              := NULL;
        pn_button_soft_inst_inout.age_max              := NULL;
        pn_button_soft_inst_inout.flg_activation       := 'N';
    END initrec;

    FUNCTION initrec RETURN pn_button_soft_inst%ROWTYPE IS
        l_pn_button_soft_inst pn_button_soft_inst%ROWTYPE;
    BEGIN
        l_pn_button_soft_inst.flg_activation := 'N';
        RETURN l_pn_button_soft_inst;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_button_soft_inst_tc IS
        data pn_button_soft_inst_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM pn_button_soft_inst
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_button_soft_inst_tc IS
