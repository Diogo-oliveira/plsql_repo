...
CREATE OR REPLACE PACKAGE BODY ts_unit_mea_soft_inst
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Janeiro 21, 2015 10:25:42
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        ins(id_unit_mea_soft_inst_in => id_unit_mea_soft_inst_in,
    ...
    (
        ...
        l_rec unit_mea_soft_inst%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_unit_mea_soft_inst := next_key(sequence_in);
        END IF;
        ins(id_unit_mea_soft_inst_in => l_rec.id_unit_mea_soft_inst,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE
     ...
     IS
        retval unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_UNIT_MEA_SOFT_INST'));
    END next_key;
    ...
    (
        ...
        l_pky unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE := next_key;
    BEGIN
        ins(id_unit_mea_soft_inst_in => l_pky,
            id_unit_measure_in       => id_unit_measure_in,
            id_institution_in        => id_institution_in,
            id_software_in           => id_software_in,
            flg_available_in         => flg_available_in,
            ...
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
        id_unit_mea_soft_inst_out := l_pky;
    END ins;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_unit_measure_in        => id_unit_measure_in,
            id_institution_in         => id_institution_in,
            id_software_in            => id_software_in,
            flg_available_in          => flg_available_in,
            adw_last_update_in        => adw_last_update_in,
            ...
            update_time_in            => update_time_in,
            update_institution_in     => update_institution_in,
            id_unit_mea_soft_inst_out => id_unit_mea_soft_inst_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE IS
        l_pky unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE := next_key;
    BEGIN
        ins(id_unit_mea_soft_inst_in => l_pky,
            id_unit_measure_in       => id_unit_measure_in,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                INSERT INTO unit_mea_soft_inst
                    (id_unit_mea_soft_inst,
                     ...
                     update_institution)
                VALUES
                    (rows_in(indx).id_unit_mea_soft_inst,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_UNIT_MEA_SOFT_INST _' || indx,
    ...
    BEGIN
        ...
        UPDATE unit_mea_soft_inst
           SET id_unit_measure    = decode(l_id_unit_measure_n,
                                           0,
                                           id_unit_measure_in,
               ...
               flg_prescription   = decode(l_flg_prescription_n,
                                           0,
                                           flg_prescription_in,
                                           nvl(flg_prescription_in, flg_prescription)),
         ...
         WHERE id_unit_mea_soft_inst = id_unit_mea_soft_inst_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_unit_mea_soft_inst_in => id_unit_mea_soft_inst_in,
            id_unit_measure_in       => id_unit_measure_in,
    ...
    (
        ...
        l_update_time_n          NUMBER(1);
        l_update_institution_n   NUMBER(1);
        id_unit_mea_soft_inst_in unit_mea_soft_inst.id_unit_mea_soft_inst%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE UNIT_MEA_SOFT_INST SET ' || ' ID_UNIT_MEASURE = decode (' || l_id_unit_measure_n ||
                 ...
                 ' FLG_PRESCRIPTION = decode (' || l_flg_prescription_n ||
                 ',0,:flg_prescription_in, NVL (:flg_prescription_in, FLG_PRESCRIPTION)) ' || ',' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_unit_measure_in, id_institution_in, id_software_in, flg_available_in, adw_last_update_in, flg_prescription_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_unit_measure_in     => id_unit_measure_in,
            id_unit_measure_nin    => id_unit_measure_nin,
            id_institution_in      => id_institution_in,
            id_institution_nin     => id_institution_nin,
            id_software_in         => id_software_in,
    ...
    BEGIN
        upd(id_unit_mea_soft_inst_in => rec_in.id_unit_mea_soft_inst,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_unit_mea_soft_inst_in,
                id_unit_measure_in,
                id_institution_in,
                id_software_in,
                flg_available_in,
    ...
    (
        ...
        l_id_unit_mea_soft_inst id_unit_mea_soft_inst_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_unit_mea_soft_inst(i) := col_in(i).id_unit_mea_soft_inst;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE unit_mea_soft_inst
                   SET id_unit_measure    = nvl(l_id_unit_measure(i), id_unit_measure),
                 ...
                 WHERE id_unit_mea_soft_inst = l_id_unit_mea_soft_inst(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE unit_mea_soft_inst
                   SET id_unit_measure    = l_id_unit_measure(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE UNIT_MEA_SOFT_INST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE UNIT_MEA_SOFT_INST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE UNIT_MEA_SOFT_INST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE UNIT_MEA_SOFT_INST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM unit_mea_soft_inst
         WHERE id_unit_mea_soft_inst = id_unit_mea_soft_inst_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
    ...
    BEGIN
        ...
        del(id_unit_mea_soft_inst_in => id_unit_mea_soft_inst_in,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_unit_mea_soft_inst(id_unit_mea_soft_inst_in => id_unit_mea_soft_inst_in,
                                  handle_error_in          => handle_error_in,
                                  rows_out                 => rows_out);
    END del_id_unit_mea_soft_inst;
    ...
    BEGIN
        DELETE FROM unit_mea_soft_inst
         WHERE id_institution = del_umsi_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_umsi_inst_fk(id_institution_in => id_institution_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_umsi_inst_fk;
    ...
    BEGIN
        DELETE FROM unit_mea_soft_inst
         WHERE id_software = del_umsi_s_fk.id_software_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_umsi_s_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_umsi_s_fk;
    ...
    BEGIN
        DELETE FROM unit_mea_soft_inst
         WHERE id_unit_measure = del_umsi_unitm_fk.id_unit_measure_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_umsi_unitm_fk(id_unit_measure_in => id_unit_measure_in,
                          handle_error_in    => handle_error_in,
                          rows_out           => rows_out);
    END del_umsi_unitm_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM UNIT_MEA_SOFT_INST';
        ELSE
            RETURN 'DELETE FROM UNIT_MEA_SOFT_INST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(unit_mea_soft_inst_inout IN OUT unit_mea_soft_inst%ROWTYPE) IS
    BEGIN
        unit_mea_soft_inst_inout.id_unit_mea_soft_inst := NULL;
        unit_mea_soft_inst_inout.id_unit_measure       := NULL;
        unit_mea_soft_inst_inout.id_institution        := NULL;
        unit_mea_soft_inst_inout.id_software           := NULL;
        unit_mea_soft_inst_inout.flg_available         := NULL;
        unit_mea_soft_inst_inout.adw_last_update       := SYSDATE;
        unit_mea_soft_inst_inout.flg_prescription      := NULL;
        unit_mea_soft_inst_inout.create_user           := NULL;
        unit_mea_soft_inst_inout.create_time           := NULL;
        unit_mea_soft_inst_inout.create_institution    := NULL;
        unit_mea_soft_inst_inout.update_user           := NULL;
        unit_mea_soft_inst_inout.update_time           := NULL;
        unit_mea_soft_inst_inout.update_institution    := NULL;
    END initrec;

    FUNCTION initrec RETURN unit_mea_soft_inst%ROWTYPE IS
        l_unit_mea_soft_inst unit_mea_soft_inst%ROWTYPE;
    BEGIN
        l_unit_mea_soft_inst.adw_last_update := SYSDATE;
        RETURN l_unit_mea_soft_inst;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN unit_mea_soft_inst_tc IS
        data unit_mea_soft_inst_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM unit_mea_soft_inst
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN unit_mea_soft_inst_tc IS
