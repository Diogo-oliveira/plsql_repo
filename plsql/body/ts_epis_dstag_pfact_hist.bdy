...
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO epis_dstag_pfact_hist
                ...
                BEGIN
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'EPIS_DSTAG_PFACT_HIST');
                    END IF;
                END;
            END IF;
    ...
    (
        ...
        l_rec epis_dstag_pfact_hist%ROWTYPE := rec_in;
    BEGIN
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'EPIS_DSTAG_PFACT_HIST',
                                                name2_in      => 'ROW_COUNT',
    ...
    (
        ...
        l_id_staging_basis_n      NUMBER(1);
        l_id_sbasis_inst_owner_n  NUMBER(1);
        id_epis_diagnosis_hist_in epis_dstag_pfact_hist.id_epis_diagnosis_hist%TYPE;
        id_epis_diagnosis_in      epis_dstag_pfact_hist.id_epis_diagnosis%TYPE;
        num_staging_basis_in      epis_dstag_pfact_hist.num_staging_basis%TYPE;
        id_field_in               epis_dstag_pfact_hist.id_field%TYPE;
        id_field_inst_owner_in    epis_dstag_pfact_hist.id_field_inst_owner%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EPIS_DSTAG_PFACT_HIST SET ' || ' FIELD_RANK = decode (' || l_field_rank_n ||
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EPIS_DSTAG_PFACT_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE EPIS_DSTAG_PFACT_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_DSTAG_PFACT_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EPIS_DSTAG_PFACT_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM epis_dstag_pfact_hist
         WHERE id_field = del_edspfh_cncpttr1_fk.id_field_in
           AND id_field_inst_owner = del_edspfh_cncpttr1_fk.id_field_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edspfh_cncpttr1_fk(id_field_in            => id_field_in,
                               id_field_inst_owner_in => id_field_inst_owner_in,
                               handle_error_in        => handle_error_in,
                               rows_out               => rows_out);
    END del_edspfh_cncpttr1_fk;
    ...
    BEGIN
        DELETE FROM epis_dstag_pfact_hist
         WHERE id_value = del_edspfh_cncpttr2_fk.id_value_in
           AND id_value_inst_owner = del_edspfh_cncpttr2_fk.id_value_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edspfh_cncpttr2_fk(id_value_in            => id_value_in,
                               id_value_inst_owner_in => id_value_inst_owner_in,
                               handle_error_in        => handle_error_in,
                               rows_out               => rows_out);
    END del_edspfh_cncpttr2_fk;
    ...
    BEGIN
        DELETE FROM epis_dstag_pfact_hist
         WHERE id_epis_diagnosis_hist = del_edspfh_edstggh_fk.id_epis_diagnosis_hist_in
           AND id_epis_diagnosis = del_edspfh_edstggh_fk.id_epis_diagnosis_in
           AND id_staging_basis = del_edspfh_edstggh_fk.id_staging_basis_in
           AND id_sbasis_inst_owner = del_edspfh_edstggh_fk.id_sbasis_inst_owner_in
           AND num_staging_basis = del_edspfh_edstggh_fk.num_staging_basis_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edspfh_edstggh_fk(id_epis_diagnosis_hist_in => id_epis_diagnosis_hist_in,
                              id_epis_diagnosis_in      => id_epis_diagnosis_in,
                              id_staging_basis_in       => id_staging_basis_in,
                              id_sbasis_inst_owner_in   => id_sbasis_inst_owner_in,
                              num_staging_basis_in      => num_staging_basis_in,
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EPIS_DSTAG_PFACT_HIST';
        ELSE
            RETURN 'DELETE FROM EPIS_DSTAG_PFACT_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_dstag_pfact_hist_inout IN OUT epis_dstag_pfact_hist%ROWTYPE) IS
    BEGIN
        epis_dstag_pfact_hist_inout.id_epis_diagnosis_hist := NULL;
        epis_dstag_pfact_hist_inout.id_epis_diagnosis      := NULL;
        epis_dstag_pfact_hist_inout.num_staging_basis      := NULL;
        epis_dstag_pfact_hist_inout.id_field               := NULL;
        epis_dstag_pfact_hist_inout.id_field_inst_owner    := NULL;
        epis_dstag_pfact_hist_inout.field_rank             := NULL;
        epis_dstag_pfact_hist_inout.id_value               := NULL;
        epis_dstag_pfact_hist_inout.id_value_inst_owner    := NULL;
        epis_dstag_pfact_hist_inout.desc_value             := NULL;
        epis_dstag_pfact_hist_inout.create_user            := NULL;
        epis_dstag_pfact_hist_inout.create_time            := NULL;
        epis_dstag_pfact_hist_inout.create_institution     := NULL;
        epis_dstag_pfact_hist_inout.update_user            := NULL;
        epis_dstag_pfact_hist_inout.update_time            := NULL;
        epis_dstag_pfact_hist_inout.update_institution     := NULL;
        epis_dstag_pfact_hist_inout.id_staging_basis       := NULL;
        epis_dstag_pfact_hist_inout.id_sbasis_inst_owner   := 0;
    END initrec;

    FUNCTION initrec RETURN epis_dstag_pfact_hist%ROWTYPE IS
        l_epis_dstag_pfact_hist epis_dstag_pfact_hist%ROWTYPE;
    BEGIN
        l_epis_dstag_pfact_hist.id_sbasis_inst_owner := 0;
        RETURN l_epis_dstag_pfact_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_dstag_pfact_hist_tc IS
        data epis_dstag_pfact_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM epis_dstag_pfact_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_dstag_pfact_hist_tc IS
