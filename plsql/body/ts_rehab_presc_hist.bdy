/*-- Last Change Revision: $Rev: 2028370 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:23 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_rehab_presc_hist
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN rehab_presc_hist.id_rehab_presc_hist%TYPE IS
        retval rehab_presc_hist.id_rehab_presc_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_rehab_presc_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky rehab_presc_hist.id_rehab_presc_hist%TYPE := next_key;
    BEGIN
        ins(id_rehab_presc_hist_in    => l_pky,
            dt_rehab_presc_hist_in    => dt_rehab_presc_hist_in,
    ...
    BEGIN
        ins(dt_rehab_presc_hist_in    => dt_rehab_presc_hist_in,
            id_professional_hist_in   => id_professional_hist_in,
            id_rehab_presc_in         => id_rehab_presc_in,
            dt_rehab_presc_in         => dt_rehab_presc_in,
            id_professional_in        => id_professional_in,
    ...
    BEGIN
        ins(dt_rehab_presc_hist_in    => dt_rehab_presc_hist_in,
            ...
            id_clinical_purpose_in    => id_clinical_purpose_in,
            clinical_purpose_notes_in => clinical_purpose_notes_in,
            id_rehab_presc_hist_out   => id_rehab_presc_hist_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN rehab_presc_hist.id_rehab_presc_hist%TYPE IS
        l_pky rehab_presc_hist.id_rehab_presc_hist%TYPE := next_key;
    BEGIN
        ins(id_rehab_presc_hist_in    => l_pky,
            dt_rehab_presc_hist_in    => dt_rehab_presc_hist_in,
    ...
    BEGIN
        ...
        VALUES
            (id_rehab_presc_hist_in,
             dt_rehab_presc_hist_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_rehab_presc_hist_in    => id_rehab_presc_hist_in,
            dt_rehab_presc_hist_in    => dt_rehab_presc_hist_in,
            id_professional_hist_in   => id_professional_hist_in,
            id_rehab_presc_in         => id_rehab_presc_in,
            dt_rehab_presc_in         => dt_rehab_presc_in,
    ...
    (
        ...
        l_rec rehab_presc_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_rehab_presc_hist := next_key(sequence_in);
        END IF;
    
        ins(id_rehab_presc_hist_in    => l_rec.id_rehab_presc_hist,
            dt_rehab_presc_hist_in    => l_rec.dt_rehab_presc_hist,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                INSERT INTO rehab_presc_hist
                    (id_rehab_presc_hist,
                     ...
                     clinical_purpose_notes)
                VALUES
                    (rows_in(indx).id_rehab_presc_hist,
                     rows_in(indx).dt_rehab_presc_hist,
                     rows_in(indx).id_professional_hist,
    ...
    (
        ...
        l_dt_rehab_presc_hist_n    NUMBER(1) := sys.diutil.bool_to_int(dt_rehab_presc_hist_nin);
        l_id_professional_hist_n   NUMBER(1) := sys.diutil.bool_to_int(id_professional_hist_nin);
        l_id_rehab_presc_n         NUMBER(1) := sys.diutil.bool_to_int(id_rehab_presc_nin);
    ...
    BEGIN
        ...
        UPDATE rehab_presc_hist
           SET dt_rehab_presc_hist    = decode(l_dt_rehab_presc_hist_n,
                                               0,
                                               dt_rehab_presc_hist_in,
                                               nvl(dt_rehab_presc_hist_in, dt_rehab_presc_hist)),
               ...
               dt_rehab_presc         = decode(l_dt_rehab_presc_n,
                                               0,
                                               dt_rehab_presc_in,
         ...
         WHERE id_rehab_presc_hist = id_rehab_presc_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_rehab_presc_hist_in     => id_rehab_presc_hist_in,
            dt_rehab_presc_hist_in     => dt_rehab_presc_hist_in,
            dt_rehab_presc_hist_nin    => dt_rehab_presc_hist_nin,
            id_professional_hist_in    => id_professional_hist_in,
    ...
    (
        ...
        l_clinical_purpose_notes_n NUMBER(1) := sys.diutil.bool_to_int(clinical_purpose_notes_nin);
    BEGIN
        l_dt_rehab_presc_hist_n    := sys.diutil.bool_to_int(dt_rehab_presc_hist_nin);
        ...
        l_sql                      := 'UPDATE rehab_presc_hist SET' || ' DT_REHAB_PRESC_HIST = decode (' ||
                                      l_dt_rehab_presc_hist_n ||
                                      ',0,:DT_REHAB_PRESC_HIST_in, NVL (:DT_REHAB_PRESC_HIST_in, DT_REHAB_PRESC_HIST)) ' || ',' ||
                                      ' ID_PROFESSIONAL_HIST = decode (' || l_id_professional_hist_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN dt_rehab_presc_hist_in, id_professional_hist_in, id_rehab_presc_in, dt_rehab_presc_in, id_professional_in, id_institution_in, id_rehab_area_interv_in, id_rehab_sch_need_in, id_exec_institution_in, exec_per_session_in, flg_status_in, notes_in, id_cancel_reason_in, notes_cancel_in, dt_cancel_in, id_cancel_professional_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, notes_change_in, id_codification_in, flg_referral_in, flg_laterality_in, id_not_order_reason_in, id_pat_health_plan_in, id_pat_exemption_in, diagnosis_notes_in, id_clinical_purpose_in, clinical_purpose_notes_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(dt_rehab_presc_hist_in     => dt_rehab_presc_hist_in,
            dt_rehab_presc_hist_nin    => dt_rehab_presc_hist_nin,
            id_professional_hist_in    => id_professional_hist_in,
            id_professional_hist_nin   => id_professional_hist_nin,
            id_rehab_presc_in          => id_rehab_presc_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_rehab_presc_hist_in,
                dt_rehab_presc_hist_in,
                id_professional_hist_in,
                id_rehab_presc_in,
                dt_rehab_presc_in,
    ...
    BEGIN
        upd(id_rehab_presc_hist_in    => rec_in.id_rehab_presc_hist,
            dt_rehab_presc_hist_in    => rec_in.dt_rehab_presc_hist,
    ...
    (
        ...
        l_id_rehab_presc_hist    id_rehab_presc_hist_cc;
        l_dt_rehab_presc_hist    dt_rehab_presc_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_rehab_presc_hist(i) := col_in(i).id_rehab_presc_hist;
            l_dt_rehab_presc_hist(i) := col_in(i).dt_rehab_presc_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE rehab_presc_hist
                   SET dt_rehab_presc_hist    = nvl(l_dt_rehab_presc_hist(i), dt_rehab_presc_hist),
                       ...
                       dt_rehab_presc         = nvl(l_dt_rehab_presc(i), dt_rehab_presc),
                 ...
                 WHERE id_rehab_presc_hist = l_id_rehab_presc_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE rehab_presc_hist
                   SET dt_rehab_presc_hist    = l_dt_rehab_presc_hist(i),
                       id_professional_hist   = l_id_professional_hist(i),
                       id_rehab_presc         = l_id_rehab_presc(i),
                       dt_rehab_presc         = l_dt_rehab_presc(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE rehab_presc_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE rehab_presc_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE rehab_presc_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_rehab_presc_hist_in => id_rehab_presc_hist_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_rph_phn_fk(id_pat_health_plan_in => id_pat_health_plan_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_rph_phn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_rph_pio_fk(id_pat_exemption_in => id_pat_exemption_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_rph_pio_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_rpt_rpc_fk(id_rehab_presc_in => id_rehab_presc_in,
                       handle_error_in   => handle_error_in,
                       rows_out          => rows_out);
    END del_rpt_rpc_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM rehab_presc_hist';
        ELSE
            RETURN 'DELETE FROM rehab_presc_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(rehab_presc_hist_inout IN OUT rehab_presc_hist%ROWTYPE) IS
    BEGIN
        rehab_presc_hist_inout.id_rehab_presc_hist    := NULL;
        rehab_presc_hist_inout.dt_rehab_presc_hist    := NULL;
        rehab_presc_hist_inout.id_professional_hist   := NULL;
        rehab_presc_hist_inout.id_rehab_presc         := NULL;
        rehab_presc_hist_inout.dt_rehab_presc         := NULL;
        rehab_presc_hist_inout.id_professional        := NULL;
        rehab_presc_hist_inout.id_institution         := NULL;
        rehab_presc_hist_inout.id_rehab_area_interv   := NULL;
        rehab_presc_hist_inout.id_rehab_sch_need      := NULL;
        rehab_presc_hist_inout.id_exec_institution    := NULL;
        rehab_presc_hist_inout.exec_per_session       := NULL;
        rehab_presc_hist_inout.flg_status             := NULL;
        rehab_presc_hist_inout.notes                  := NULL;
        rehab_presc_hist_inout.id_cancel_reason       := NULL;
        rehab_presc_hist_inout.notes_cancel           := NULL;
        rehab_presc_hist_inout.dt_cancel              := NULL;
        rehab_presc_hist_inout.id_cancel_professional := NULL;
        rehab_presc_hist_inout.create_user            := NULL;
        rehab_presc_hist_inout.create_time            := NULL;
        rehab_presc_hist_inout.create_institution     := NULL;
        rehab_presc_hist_inout.update_user            := NULL;
        rehab_presc_hist_inout.update_time            := NULL;
        rehab_presc_hist_inout.update_institution     := NULL;
        rehab_presc_hist_inout.notes_change           := NULL;
        rehab_presc_hist_inout.id_codification        := NULL;
        rehab_presc_hist_inout.flg_referral           := NULL;
        rehab_presc_hist_inout.flg_laterality         := NULL;
        rehab_presc_hist_inout.id_not_order_reason    := NULL;
        rehab_presc_hist_inout.id_pat_health_plan     := NULL;
        rehab_presc_hist_inout.id_pat_exemption       := NULL;
        rehab_presc_hist_inout.diagnosis_notes        := NULL;
        rehab_presc_hist_inout.id_clinical_purpose    := NULL;
        rehab_presc_hist_inout.clinical_purpose_notes := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN rehab_presc_hist%ROWTYPE IS
        l_rehab_presc_hist rehab_presc_hist%ROWTYPE;
    BEGIN
        RETURN l_rehab_presc_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN rehab_presc_hist_tc IS
        data rehab_presc_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN rehab_presc_hist_tc IS
        data rehab_presc_hist_tc;
