...
CREATE OR REPLACE PACKAGE BODY ts_epis_prob_grp_ass_hist
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2017-12-20 14:42:57
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        INSERT INTO epis_prob_grp_ass_hist
            (id_epis_prob_grp_ass_hist,
    ...
    BEGIN
        ins(id_epis_prob_grp_ass_hist_in => id_epis_prob_grp_ass_hist_in,
            id_epis_prob_group_ass_in    => id_epis_prob_group_ass_in,
    ...
    (
        ...
        l_rec epis_prob_grp_ass_hist%ROWTYPE := rec_in;
    BEGIN
    
        ins(id_epis_prob_grp_ass_hist_in => l_rec.id_epis_prob_grp_ass_hist,
            id_epis_prob_group_ass_in    => l_rec.id_epis_prob_group_ass,
    ...
    (
        ...
        l_id_epis_prob_grp_ass_hist_n NUMBER(1) := sys.diutil.bool_to_int(id_epis_prob_grp_ass_hist_nin);
        l_id_epis_prob_group_ass_n    NUMBER(1) := sys.diutil.bool_to_int(id_epis_prob_group_ass_nin);
    ...
    BEGIN
        ...
        UPDATE epis_prob_grp_ass_hist
           SET id_epis_prob_grp_ass_hist = decode(l_id_epis_prob_grp_ass_hist_n,
                                                  0,
                                                  id_epis_prob_grp_ass_hist_in,
                                                  nvl(id_epis_prob_grp_ass_hist_in, id_epis_prob_grp_ass_hist)),
               id_epis_prob_group_ass    = decode(l_id_epis_prob_group_ass_n,
                                                  0,
                                                  id_epis_prob_group_ass_in,
                                                  nvl(id_epis_prob_group_ass_in, id_epis_prob_group_ass)),
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_prob_grp_ass_hist_in  => id_epis_prob_grp_ass_hist_in,
            id_epis_prob_grp_ass_hist_nin => id_epis_prob_grp_ass_hist_nin,
            id_epis_prob_group_ass_in     => id_epis_prob_group_ass_in,
            id_epis_prob_group_ass_nin    => id_epis_prob_group_ass_nin,
            id_epis_prob_group_in         => id_epis_prob_group_in,
    ...
    (
        ...
        l_update_institution_n        NUMBER(1) := sys.diutil.bool_to_int(update_institution_nin);
    BEGIN
        l_id_epis_prob_grp_ass_hist_n := sys.diutil.bool_to_int(id_epis_prob_grp_ass_hist_nin);
        l_id_epis_prob_group_ass_n    := sys.diutil.bool_to_int(id_epis_prob_group_ass_nin);
        ...
        l_sql                         := 'UPDATE epis_prob_grp_ass_hist SET' || ' ID_EPIS_PROB_GRP_ASS_HIST = decode (' ||
                                         l_id_epis_prob_grp_ass_hist_n ||
                                         ',0,:ID_EPIS_PROB_GRP_ASS_HIST_in, NVL (:ID_EPIS_PROB_GRP_ASS_HIST_in, ID_EPIS_PROB_GRP_ASS_HIST)) ' || ',' ||
                                         ' ID_EPIS_PROB_GROUP_ASS = decode (' || l_id_epis_prob_group_ass_n ||
                                         ',0,:ID_EPIS_PROB_GROUP_ASS_in, NVL (:ID_EPIS_PROB_GROUP_ASS_in, ID_EPIS_PROB_GROUP_ASS)) ' || ',' ||
                                         ' ID_EPIS_PROB_GROUP = decode (' || l_id_epis_prob_group_n ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_epis_prob_grp_ass_hist_in,
                id_epis_prob_group_ass_in,
                id_epis_prob_group_in,
                id_prof_create_in,
                dt_create_in,
    ...
    BEGIN
        upd(id_epis_prob_grp_ass_hist_in => rec_in.id_epis_prob_grp_ass_hist,
            id_epis_prob_group_ass_in    => rec_in.id_epis_prob_group_ass,
    ...
    (
        ...
        l_id_epis_prob_grp_ass_hist id_epis_prob_grp_ass_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_epis_prob_grp_ass_hist(i) := col_in(i).id_epis_prob_grp_ass_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prob_grp_ass_hist
                   SET id_epis_prob_grp_ass_hist = nvl(l_id_epis_prob_grp_ass_hist(i), id_epis_prob_grp_ass_hist),
                       id_epis_prob_group_ass    = nvl(l_id_epis_prob_group_ass(i), id_epis_prob_group_ass),
        ...
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prob_grp_ass_hist
                   SET id_epis_prob_grp_ass_hist = l_id_epis_prob_grp_ass_hist(i),
                       id_epis_prob_group_ass    = l_id_epis_prob_group_ass(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_prob_grp_ass_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_prob_grp_ass_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_prob_grp_ass_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM epis_prob_grp_ass_hist
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_prob_grp_ass_hist';
        ELSE
            RETURN 'DELETE FROM epis_prob_grp_ass_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_prob_grp_ass_hist_inout IN OUT epis_prob_grp_ass_hist%ROWTYPE) IS
    BEGIN
        epis_prob_grp_ass_hist_inout.id_epis_prob_grp_ass_hist := NULL;
        epis_prob_grp_ass_hist_inout.id_epis_prob_group_ass    := NULL;
        epis_prob_grp_ass_hist_inout.id_epis_prob_group        := NULL;
        epis_prob_grp_ass_hist_inout.id_prof_create            := NULL;
        epis_prob_grp_ass_hist_inout.dt_create                 := NULL;
        epis_prob_grp_ass_hist_inout.flg_status                := NULL;
        epis_prob_grp_ass_hist_inout.id_prof_last_update       := NULL;
        epis_prob_grp_ass_hist_inout.dt_last_update            := NULL;
        epis_prob_grp_ass_hist_inout.assessment_note           := NULL;
        epis_prob_grp_ass_hist_inout.plan_note                 := NULL;
        epis_prob_grp_ass_hist_inout.dteg_note                 := NULL;
        epis_prob_grp_ass_hist_inout.id_prof_cancel            := NULL;
        epis_prob_grp_ass_hist_inout.id_cancel_reason          := NULL;
        epis_prob_grp_ass_hist_inout.cancel_notes              := NULL;
        epis_prob_grp_ass_hist_inout.dt_cancel                 := NULL;
        epis_prob_grp_ass_hist_inout.create_user               := NULL;
        epis_prob_grp_ass_hist_inout.create_time               := NULL;
        epis_prob_grp_ass_hist_inout.create_institution        := NULL;
        epis_prob_grp_ass_hist_inout.update_user               := NULL;
        epis_prob_grp_ass_hist_inout.update_time               := NULL;
        epis_prob_grp_ass_hist_inout.update_institution        := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_prob_grp_ass_hist%ROWTYPE IS
        l_epis_prob_grp_ass_hist epis_prob_grp_ass_hist%ROWTYPE;
    BEGIN
        RETURN l_epis_prob_grp_ass_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_prob_grp_ass_hist_tc IS
        data epis_prob_grp_ass_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM epis_prob_grp_ass_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_prob_grp_ass_hist_tc IS
        data epis_prob_grp_ass_hist_tc;
