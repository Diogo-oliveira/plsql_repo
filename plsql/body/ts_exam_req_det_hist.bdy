/*-- Last Change Revision: $Rev: 2028173 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:23 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_exam_req_det_hist
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN exam_req_det_hist.id_exam_req_det_hist%TYPE IS
        retval exam_req_det_hist.id_exam_req_det_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_exam_req_det_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky exam_req_det_hist.id_exam_req_det_hist%TYPE := next_key;
    BEGIN
        ins(id_exam_req_det_hist_in   => l_pky,
            ...
            dt_exam_req_det_hist_in   => dt_exam_req_det_hist_in,
    ...
    BEGIN
        ins(id_exam_req_det_hist_in   => l_pky,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_exam_req_det_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_exam_req_det_in        => id_exam_req_det_in,
            ...
            id_clinical_purpose_in    => id_clinical_purpose_in,
            diagnosis_notes_in        => diagnosis_notes_in,
            id_exam_req_det_hist_out  => id_exam_req_det_hist_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN exam_req_det_hist.id_exam_req_det_hist%TYPE IS
        l_pky exam_req_det_hist.id_exam_req_det_hist%TYPE := next_key;
    BEGIN
        ins(id_exam_req_det_hist_in   => l_pky,
            id_exam_req_det_in        => id_exam_req_det_in,
    ...
    BEGIN
        INSERT INTO exam_req_det_hist
            (id_exam_req_det_hist,
             id_exam_req_det,
             id_erd_parent,
             id_exam_req,
             id_exam,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_exam_req_det_hist_in   => id_exam_req_det_hist_in,
            id_exam_req_det_in        => id_exam_req_det_in,
            id_erd_parent_in          => id_erd_parent_in,
            id_exam_req_in            => id_exam_req_in,
            id_exam_in                => id_exam_in,
    ...
    (
        ...
        l_rec exam_req_det_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_exam_req_det_hist := next_key(sequence_in);
        END IF;
    
        ins(id_exam_req_det_hist_in   => l_rec.id_exam_req_det_hist,
            ...
            operation_time_in         => l_rec.operation_time,
            ...
            dt_exam_req_det_hist_in   => l_rec.dt_exam_req_det_hist,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                INSERT INTO exam_req_det_hist
                    (id_exam_req_det_hist,
                     ...
                     diagnosis_notes)
                VALUES
                    (rows_in(indx).id_exam_req_det_hist,
                     ...
                     rows_in(indx).dt_exam_req_det_hist,
    ...
    (
        ...
        l_id_exam_req_det_n        NUMBER(1) := sys.diutil.bool_to_int(id_exam_req_det_nin);
        ...
        l_operation_time_n         NUMBER(1) := sys.diutil.bool_to_int(operation_time_nin);
        ...
        l_dt_exam_req_det_hist_n   NUMBER(1) := sys.diutil.bool_to_int(dt_exam_req_det_hist_nin);
    ...
    BEGIN
        ...
        UPDATE exam_req_det_hist
           SET id_exam_req_det        = decode(l_id_exam_req_det_n,
                                               0,
                                               id_exam_req_det_in,
                                               nvl(id_exam_req_det_in, id_exam_req_det)),
               id_erd_parent          = decode(l_id_erd_parent_n,
                                               0,
                                               id_erd_parent_in,
               ...
               operation_type         = decode(l_operation_type_n,
                                               0,
                                               operation_type_in,
                                               nvl(operation_type_in, operation_type)),
               operation_time         = decode(l_operation_time_n,
                                               0,
                                               operation_time_in,
                                               nvl(operation_time_in, operation_time)),
               ...
               dt_exam_req_det_hist   = decode(l_dt_exam_req_det_hist_n,
                                               0,
                                               dt_exam_req_det_hist_in,
                                               nvl(dt_exam_req_det_hist_in, dt_exam_req_det_hist)),
         ...
         WHERE id_exam_req_det_hist = id_exam_req_det_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_exam_req_det_hist_in    => id_exam_req_det_hist_in,
            id_exam_req_det_in         => id_exam_req_det_in,
            ...
            operation_time_in          => operation_time_in,
            operation_time_nin         => operation_time_nin,
            operation_user_in          => operation_user_in,
            ...
            dt_exam_req_det_hist_in    => dt_exam_req_det_hist_in,
            dt_exam_req_det_hist_nin   => dt_exam_req_det_hist_nin,
            id_exam_group_in           => id_exam_group_in,
    ...
    BEGIN
        ...
        l_operation_time_n         := sys.diutil.bool_to_int(operation_time_nin);
        ...
        l_dt_exam_req_det_hist_n   := sys.diutil.bool_to_int(dt_exam_req_det_hist_nin);
        ...
        l_sql                      := 'UPDATE exam_req_det_hist SET' || ' ID_EXAM_REQ_DET = decode (' ||
                                      l_id_exam_req_det_n ||
                                      ',0,:ID_EXAM_REQ_DET_in, NVL (:ID_EXAM_REQ_DET_in, ID_EXAM_REQ_DET)) ' || ',' ||
                                      ' ID_ERD_PARENT = decode (' || l_id_erd_parent_n ||
                                      ...
                                      ' OPERATION_TIME = decode (' || l_operation_time_n ||
                                      ',0,:OPERATION_TIME_in, NVL (:OPERATION_TIME_in, OPERATION_TIME)) ' || ',' ||
                                      ' OPERATION_USER = decode (' || l_operation_user_n ||
                                      ...
                                      ' DT_EXAM_REQ_DET_HIST = decode (' || l_dt_exam_req_det_hist_n ||
                                      ',0,:DT_EXAM_REQ_DET_HIST_in, NVL (:DT_EXAM_REQ_DET_HIST_in, DT_EXAM_REQ_DET_HIST)) ' || ',' ||
                                      ' ID_EXAM_GROUP = decode (' || l_id_exam_group_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_exam_req_det_in, id_erd_parent_in, id_exam_req_in, id_exam_in, flg_status_in, notes_in, flg_pre_req_in, id_movement_in, id_prof_cancel_in, notes_cancel_in, barcode_in, id_room_in, notes_tech_in, id_pat_pregnancy_in, dt_target_tstz_in, dt_final_target_tstz_in, dt_final_result_tstz_in, dt_cancel_tstz_in, id_prof_performed_in, start_time_in, end_time_in, flg_referral_in, id_cancel_reason_in, flg_clinical_purpose_in, flg_location_in, id_exec_institution_in, id_exam_codification_in, id_task_dependency_in, flg_req_origin_module_in, id_prof_performed_reg_in, dt_performed_reg_in, operation_type_in, operation_time_in, operation_user_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_order_recurrence_in, flg_fasting_in, flg_prn_in, prn_notes_in, id_pat_health_plan_in, id_cdr_in, flg_laterality_in, clinical_purpose_notes_in, dt_exam_req_det_hist_in, id_exam_group_in, flg_priority_in, notes_patient_in, prof_dep_clin_serv_in, id_prof_last_update_in, dt_last_update_tstz_in, id_pat_exemption_in, id_epis_doc_perform_in, id_diagnosis_list_in, id_co_sign_order_in, id_co_sign_cancel_in, notes_scheduler_in, id_clinical_purpose_in, diagnosis_notes_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_exam_req_det_hist_in,
                id_exam_req_det_in,
                id_erd_parent_in,
                id_exam_req_in,
                id_exam_in,
    ...
    BEGIN
        upd(id_exam_req_det_hist_in   => rec_in.id_exam_req_det_hist,
            ...
            operation_time_in         => rec_in.operation_time,
            ...
            dt_exam_req_det_hist_in   => rec_in.dt_exam_req_det_hist,
    ...
    (
        ...
        l_id_exam_req_det_hist   id_exam_req_det_hist_cc;
        ...
        l_operation_time         operation_time_cc;
        ...
        l_dt_exam_req_det_hist   dt_exam_req_det_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_exam_req_det_hist(i) := col_in(i).id_exam_req_det_hist;
            ...
            l_operation_time(i) := col_in(i).operation_time;
            ...
            l_dt_exam_req_det_hist(i) := col_in(i).dt_exam_req_det_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_req_det_hist
                   SET id_exam_req_det        = nvl(l_id_exam_req_det(i), id_exam_req_det),
                       id_erd_parent          = nvl(l_id_erd_parent(i), id_erd_parent),
                       ...
                       operation_type         = nvl(l_operation_type(i), operation_type),
                       operation_time         = nvl(l_operation_time(i), operation_time),
                       ...
                       dt_exam_req_det_hist   = nvl(l_dt_exam_req_det_hist(i), dt_exam_req_det_hist),
                 ...
                 WHERE id_exam_req_det_hist = l_id_exam_req_det_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_req_det_hist
                   SET id_exam_req_det        = l_id_exam_req_det(i),
                       id_erd_parent          = l_id_erd_parent(i),
                       ...
                       operation_type         = l_operation_type(i),
                       operation_time         = l_operation_time(i),
                       ...
                       dt_exam_req_det_hist   = l_dt_exam_req_det_hist(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE exam_req_det_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE exam_req_det_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE exam_req_det_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_exam_req_det_hist_in => id_exam_req_det_hist_in,
            handle_error_in         => handle_error_in,
            rows_out                => rows_out);
    END del;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM exam_req_det_hist';
        ELSE
            RETURN 'DELETE FROM exam_req_det_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(exam_req_det_hist_inout IN OUT exam_req_det_hist%ROWTYPE) IS
    BEGIN
        exam_req_det_hist_inout.id_exam_req_det_hist   := NULL;
        exam_req_det_hist_inout.id_exam_req_det        := NULL;
        exam_req_det_hist_inout.id_erd_parent          := NULL;
        exam_req_det_hist_inout.id_exam_req            := NULL;
        exam_req_det_hist_inout.id_exam                := NULL;
        exam_req_det_hist_inout.flg_status             := NULL;
        exam_req_det_hist_inout.notes                  := NULL;
        exam_req_det_hist_inout.flg_pre_req            := NULL;
        exam_req_det_hist_inout.id_movement            := NULL;
        exam_req_det_hist_inout.id_prof_cancel         := NULL;
        exam_req_det_hist_inout.notes_cancel           := NULL;
        exam_req_det_hist_inout.barcode                := NULL;
        exam_req_det_hist_inout.id_room                := NULL;
        exam_req_det_hist_inout.notes_tech             := NULL;
        exam_req_det_hist_inout.id_pat_pregnancy       := NULL;
        exam_req_det_hist_inout.dt_target_tstz         := NULL;
        exam_req_det_hist_inout.dt_final_target_tstz   := NULL;
        exam_req_det_hist_inout.dt_final_result_tstz   := NULL;
        exam_req_det_hist_inout.dt_cancel_tstz         := NULL;
        exam_req_det_hist_inout.id_prof_performed      := NULL;
        exam_req_det_hist_inout.start_time             := NULL;
        exam_req_det_hist_inout.end_time               := NULL;
        exam_req_det_hist_inout.flg_referral           := NULL;
        exam_req_det_hist_inout.id_cancel_reason       := NULL;
        exam_req_det_hist_inout.flg_clinical_purpose   := NULL;
        exam_req_det_hist_inout.flg_location           := NULL;
        exam_req_det_hist_inout.id_exec_institution    := NULL;
        exam_req_det_hist_inout.id_exam_codification   := NULL;
        exam_req_det_hist_inout.id_task_dependency     := NULL;
        exam_req_det_hist_inout.flg_req_origin_module  := NULL;
        exam_req_det_hist_inout.id_prof_performed_reg  := NULL;
        exam_req_det_hist_inout.dt_performed_reg       := NULL;
        exam_req_det_hist_inout.operation_type         := NULL;
        exam_req_det_hist_inout.operation_time         := NULL;
        exam_req_det_hist_inout.operation_user         := NULL;
        exam_req_det_hist_inout.create_user            := NULL;
        exam_req_det_hist_inout.create_time            := NULL;
        exam_req_det_hist_inout.create_institution     := NULL;
        exam_req_det_hist_inout.update_user            := NULL;
        exam_req_det_hist_inout.update_time            := NULL;
        exam_req_det_hist_inout.update_institution     := NULL;
        exam_req_det_hist_inout.id_order_recurrence    := NULL;
        exam_req_det_hist_inout.flg_fasting            := NULL;
        exam_req_det_hist_inout.flg_prn                := NULL;
        exam_req_det_hist_inout.prn_notes              := NULL;
        exam_req_det_hist_inout.id_pat_health_plan     := NULL;
        exam_req_det_hist_inout.id_cdr                 := NULL;
        exam_req_det_hist_inout.flg_laterality         := NULL;
        exam_req_det_hist_inout.clinical_purpose_notes := NULL;
        exam_req_det_hist_inout.dt_exam_req_det_hist   := NULL;
        exam_req_det_hist_inout.id_exam_group          := NULL;
        exam_req_det_hist_inout.flg_priority           := NULL;
        exam_req_det_hist_inout.notes_patient          := NULL;
        exam_req_det_hist_inout.prof_dep_clin_serv     := NULL;
        exam_req_det_hist_inout.id_prof_last_update    := NULL;
        exam_req_det_hist_inout.dt_last_update_tstz    := NULL;
        exam_req_det_hist_inout.id_pat_exemption       := NULL;
        exam_req_det_hist_inout.id_epis_doc_perform    := NULL;
        exam_req_det_hist_inout.id_diagnosis_list      := NULL;
        exam_req_det_hist_inout.id_co_sign_order       := NULL;
        exam_req_det_hist_inout.id_co_sign_cancel      := NULL;
        exam_req_det_hist_inout.notes_scheduler        := NULL;
        exam_req_det_hist_inout.id_clinical_purpose    := NULL;
        exam_req_det_hist_inout.diagnosis_notes        := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN exam_req_det_hist%ROWTYPE IS
        l_exam_req_det_hist exam_req_det_hist%ROWTYPE;
    BEGIN
        RETURN l_exam_req_det_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN exam_req_det_hist_tc IS
        data exam_req_det_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM exam_req_det_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN exam_req_det_hist_tc IS
        data exam_req_det_hist_tc;
