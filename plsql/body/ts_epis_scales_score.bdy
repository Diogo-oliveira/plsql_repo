/*-- Last Change Revision: $Rev: 2028150 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:19 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_epis_scales_score
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Agosto 25, 2011 9:8:9
| Created By: ALERT
*/
 IS
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'ESS_SCL_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_SCALES',
                                                        value_in           => id_scales_in);
                    END IF;
                    IF l_name = 'ESS_SG_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_SCALES_GROUP',
                                                        value_in           => id_scales_group_in);
                    END IF;
                    IF l_name = 'ESS_VSR_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_EPISODE',
    ...
    (
        ...
        l_rec epis_scales_score%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_scales_score := next_key(sequence_in);
        END IF;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_scales_score.id_epis_scales_score%TYPE
     ...
     IS
        retval epis_scales_score.id_epis_scales_score%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_epis_scales_score.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_EPIS_SCALES_SCORE'));
    END next_key;
    ...
    (
        ...
        l_pky epis_scales_score.id_epis_scales_score%TYPE := next_key;
    BEGIN
        ins(id_epis_scales_score_in  => l_pky,
            id_episode_in            => id_episode_in,
            id_patient_in            => id_patient_in,
            id_epis_documentation_in => id_epis_documentation_in,
            flg_status_in            => flg_status_in,
            ...
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
        id_epis_scales_score_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_episode_in            => id_episode_in,
            ...
            update_time_in           => update_time_in,
            update_institution_in    => update_institution_in,
            id_epis_scales_score_out => id_epis_scales_score_out,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in          IN BOOLEAN := TRUE,
        rows_out                 OUT table_varchar
    ) RETURN epis_scales_score.id_epis_scales_score%TYPE IS
        l_pky epis_scales_score.id_epis_scales_score%TYPE := next_key;
    BEGIN
        ins(id_epis_scales_score_in  => l_pky,
            id_episode_in            => id_episode_in,
    ...
    (
        ...
        l_update_time_n           NUMBER(1);
        l_update_institution_n    NUMBER(1);
        id_epis_scales_score_in   epis_scales_score.id_epis_scales_score%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EPIS_SCALES_SCORE SET ' || ' ID_EPISODE = decode (' || l_id_episode_n ||
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EPIS_SCALES_SCORE
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE EPIS_SCALES_SCORE
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_SCALES_SCORE set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EPIS_SCALES_SCORE set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_documentation = del_ess_doc_fk.id_documentation_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_doc_fk(id_documentation_in => id_documentation_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ess_doc_fk;
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_patient = del_ess_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ess_pat_fk;
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_prof_create = del_ess_prof_fk.id_prof_create_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_prof_fk(id_prof_create_in => id_prof_create_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_ess_prof_fk;
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_scales = del_ess_scl_fk.id_scales_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_scl_fk(id_scales_in => id_scales_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ess_scl_fk;
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_scales_group = del_ess_sg_fk.id_scales_group_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_sg_fk(id_scales_group_in => id_scales_group_in,
                      handle_error_in    => handle_error_in,
                      rows_out           => rows_out);
    END del_ess_sg_fk;
    ...
    BEGIN
        DELETE FROM epis_scales_score
         WHERE id_episode = del_ess_vsr_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ess_vsr_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ess_vsr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EPIS_SCALES_SCORE';
        ELSE
            RETURN 'DELETE FROM EPIS_SCALES_SCORE WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_scales_score_inout IN OUT epis_scales_score%ROWTYPE) IS
    BEGIN
        epis_scales_score_inout.id_epis_scales_score  := NULL;
        epis_scales_score_inout.id_episode            := NULL;
        epis_scales_score_inout.id_patient            := NULL;
        epis_scales_score_inout.id_epis_documentation := NULL;
        epis_scales_score_inout.flg_status            := NULL;
        epis_scales_score_inout.id_prof_create        := NULL;
        epis_scales_score_inout.dt_create             := NULL;
        epis_scales_score_inout.id_cancel_reason      := NULL;
        epis_scales_score_inout.notes_cancel          := NULL;
        epis_scales_score_inout.dt_cancel             := NULL;
        epis_scales_score_inout.id_prof_cancel        := NULL;
        epis_scales_score_inout.id_scales             := NULL;
        epis_scales_score_inout.id_scales_group       := NULL;
        epis_scales_score_inout.id_documentation      := NULL;
        epis_scales_score_inout.score_value           := NULL;
        epis_scales_score_inout.id_scales_formula     := NULL;
        epis_scales_score_inout.create_user           := NULL;
        epis_scales_score_inout.create_time           := NULL;
        epis_scales_score_inout.create_institution    := NULL;
        epis_scales_score_inout.update_user           := NULL;
        epis_scales_score_inout.update_time           := NULL;
        epis_scales_score_inout.update_institution    := NULL;
    END initrec;

    FUNCTION initrec RETURN epis_scales_score%ROWTYPE IS
        l_epis_scales_score epis_scales_score%ROWTYPE;
    BEGIN
        RETURN l_epis_scales_score;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_scales_score_tc IS
        data epis_scales_score_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM epis_scales_score
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_scales_score_tc IS
