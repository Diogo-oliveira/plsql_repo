...
CREATE OR REPLACE PACKAGE BODY ts_print_list_job
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: October 13, 2014 23:31:2
| Created By: ALERT
*/
 IS
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'PRINT_LIST_JOB');
                    IF l_name = 'PLJ_AINST_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_INST_REQ',
                                                        value_in           => id_inst_req_in);
                    END IF;
                    IF l_name = 'PLJ_EPIS_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_EPISODE',
                    ...
                    END IF;
                    IF l_name = 'PLJ_PLA_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PRINT_LIST_AREA',
                                                        value_in           => id_print_list_area_in);
                    END IF;
                    IF l_name = 'PLJ_PROF_REQ_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROF_REQ',
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_print_list_job_in  => id_print_list_job_in,
                              id_print_list_area_in => id_print_list_area_in,
                              print_arguments_in    => print_arguments_in,
                              id_workflow_in        => id_workflow_in,
                              id_status_in          => id_status_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_print_list_job_in  => id_print_list_job_in,
                                  id_print_list_area_in => id_print_list_area_in,
                                  print_arguments_in    => print_arguments_in,
                                  id_workflow_in        => id_workflow_in,
                                  id_status_in          => id_status_in,
    ...
    */
    ...
    (
        ...
        l_rec print_list_job%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_print_list_job := next_key(sequence_in);
        END IF;
        ins(id_print_list_job_in  => l_rec.id_print_list_job,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN print_list_job.id_print_list_job%TYPE
     ...
     IS
        retval print_list_job.id_print_list_job%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_print_list_job.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_PRINT_LIST_JOB'));
    END next_key;
    ...
    (
        ...
        l_pky print_list_job.id_print_list_job%TYPE := next_key;
    BEGIN
        ins(id_print_list_job_in  => l_pky,
            id_print_list_area_in => id_print_list_area_in,
            print_arguments_in    => print_arguments_in,
            id_workflow_in        => id_workflow_in,
            id_status_in          => id_status_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_print_list_area_in => id_print_list_area_in,
            print_arguments_in    => print_arguments_in,
            id_workflow_in        => id_workflow_in,
            id_status_in          => id_status_in,
            dt_status_in          => dt_status_in,
            ...
            update_time_in        => update_time_in,
            update_institution_in => update_institution_in,
            id_print_list_job_out => id_print_list_job_out,
            handle_error_in       => handle_error_in,
            rows_out              => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN print_list_job.id_print_list_job%TYPE IS
        l_pky print_list_job.id_print_list_job%TYPE := next_key;
    BEGIN
        ins(id_print_list_job_in  => l_pky,
            id_print_list_area_in => id_print_list_area_in,
    ...
    BEGIN
        ...
        UPDATE print_list_job
           SET id_print_list_area = decode(l_id_print_list_area_n,
                                           0,
                                           id_print_list_area_in,
         ...
         WHERE id_print_list_job = id_print_list_job_in
    ...
    (
        ...
        l_update_time_n        NUMBER(1);
        l_update_institution_n NUMBER(1);
        id_print_list_job_in   print_list_job.id_print_list_job%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PRINT_LIST_JOB SET ' || ' ID_PRINT_LIST_AREA = decode (' || l_id_print_list_area_n ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_print_list_area_in  => id_print_list_area_in,
            id_print_list_area_nin => id_print_list_area_nin,
            print_arguments_in     => print_arguments_in,
            print_arguments_nin    => print_arguments_nin,
            id_workflow_in         => id_workflow_in,
    ...
    BEGIN
        upd(id_print_list_job_in  => rec_in.id_print_list_job,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE print_list_job
                   SET id_print_list_area = nvl(l_id_print_list_area(i), id_print_list_area),
                 ...
                 WHERE id_print_list_job = l_id_print_list_job(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE print_list_job
                   SET id_print_list_area = l_id_print_list_area(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PRINT_LIST_JOB
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PRINT_LIST_JOB set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PRINT_LIST_JOB set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_print_list_job_in => id_print_list_job_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_print_list_job(id_print_list_job_in => id_print_list_job_in,
                              handle_error_in      => handle_error_in,
                              rows_out             => rows_out);
    END del_id_print_list_job;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_inst_req = del_plj_ainst_fk.id_inst_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_ainst_fk(id_inst_req_in => id_inst_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_plj_ainst_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_episode = del_plj_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_plj_epis_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_patient = del_plj_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_plj_pat_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_print_list_area = del_plj_pla_fk.id_print_list_area_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_pla_fk(id_print_list_area_in => id_print_list_area_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_plj_pla_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_prof_req = del_plj_prof_req_fk.id_prof_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_prof_req_fk(id_prof_req_in => id_prof_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_plj_prof_req_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_prof_status = del_plj_prof_sts_fk.id_prof_status_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_prof_sts_fk(id_prof_status_in => id_prof_status_in,
                            handle_error_in   => handle_error_in,
                            rows_out          => rows_out);
    END del_plj_prof_sts_fk;
    ...
    BEGIN
        DELETE FROM print_list_job
         WHERE id_workflow = del_plj_wsw_fk.id_workflow_in
           AND id_status = del_plj_wsw_fk.id_status_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_plj_wsw_fk(id_workflow_in  => id_workflow_in,
                       id_status_in    => id_status_in,
                       handle_error_in => handle_error_in,
                       rows_out        => rows_out);
    END del_plj_wsw_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PRINT_LIST_JOB';
        ELSE
            RETURN 'DELETE FROM PRINT_LIST_JOB WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(print_list_job_inout IN OUT print_list_job%ROWTYPE) IS
    BEGIN
        print_list_job_inout.id_print_list_job  := NULL;
        print_list_job_inout.id_print_list_area := NULL;
        print_list_job_inout.print_arguments    := NULL;
        print_list_job_inout.id_workflow        := NULL;
        print_list_job_inout.id_status          := NULL;
        print_list_job_inout.dt_status          := NULL;
        print_list_job_inout.id_prof_status     := NULL;
        print_list_job_inout.id_patient         := NULL;
        print_list_job_inout.id_episode         := NULL;
        print_list_job_inout.id_prof_req        := NULL;
        print_list_job_inout.id_inst_req        := NULL;
        print_list_job_inout.dt_req             := NULL;
        print_list_job_inout.context_data       := NULL;
        print_list_job_inout.create_user        := NULL;
        print_list_job_inout.create_time        := NULL;
        print_list_job_inout.create_institution := NULL;
        print_list_job_inout.update_user        := NULL;
        print_list_job_inout.update_time        := NULL;
        print_list_job_inout.update_institution := NULL;
    END initrec;

    FUNCTION initrec RETURN print_list_job%ROWTYPE IS
        l_print_list_job print_list_job%ROWTYPE;
    BEGIN
        RETURN l_print_list_job;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN print_list_job_tc IS
        data print_list_job_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM print_list_job
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN print_list_job_tc IS
