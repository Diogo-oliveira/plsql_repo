...
CREATE OR REPLACE PACKAGE BODY ts_sr_danger_cont
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Dezembro 20, 2011 14:35:35
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        ins(id_sr_danger_cont_in  => id_sr_danger_cont_in,
    ...
    (
        ...
        l_rec sr_danger_cont%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_sr_danger_cont := next_key(sequence_in);
        END IF;
        ins(id_sr_danger_cont_in  => l_rec.id_sr_danger_cont,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN sr_danger_cont.id_sr_danger_cont%TYPE
     ...
     IS
        retval sr_danger_cont.id_sr_danger_cont%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_sr_danger_cont.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_SR_DANGER_CONT'));
    END next_key;
    ...
    (
        ...
        l_pky sr_danger_cont.id_sr_danger_cont%TYPE := next_key;
    BEGIN
        ins(id_sr_danger_cont_in  => l_pky,
            id_episode_in         => id_episode_in,
            id_patient_in         => id_patient_in,
            id_schedule_sr_in     => id_schedule_sr_in,
            id_prof_reg_in        => id_prof_reg_in,
    ...
    BEGIN
        ins(id_episode_in         => id_episode_in,
            ...
            update_institution_in => update_institution_in,
            id_epis_diagnosis_in  => id_epis_diagnosis_in,
            id_sr_danger_cont_out => id_sr_danger_cont_out,
            handle_error_in       => handle_error_in,
            rows_out              => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN sr_danger_cont.id_sr_danger_cont%TYPE IS
        l_pky sr_danger_cont.id_sr_danger_cont%TYPE := next_key;
    BEGIN
        ins(id_sr_danger_cont_in  => l_pky,
            id_episode_in         => id_episode_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_SR_DANGER_CONT _' || indx,
                                                        value_in           => rows_in(indx).id_sr_danger_cont,
                                                        validate_in        => FALSE);
    ...
    BEGIN
        ...
        UPDATE sr_danger_cont
         ...
         WHERE id_sr_danger_cont = id_sr_danger_cont_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_sr_danger_cont_in   => id_sr_danger_cont_in,
            id_episode_in          => id_episode_in,
    ...
    (
        ...
        l_update_institution_n NUMBER(1);
        l_id_epis_diagnosis_n  NUMBER(1);
        id_sr_danger_cont_in   sr_danger_cont.id_sr_danger_cont%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE SR_DANGER_CONT SET ' || ' ID_EPISODE = decode (' || l_id_episode_n ||
                 ...
                 l_dt_reg_n || ',0,:dt_reg_in, NVL (:dt_reg_in, DT_REG)) ' || ',' || ' FLG_STATUS = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_episode_in, id_patient_in, id_schedule_sr_in, id_prof_reg_in, dt_reg_in, flg_status_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_epis_diagnosis_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_sr_danger_cont_in  => rec_in.id_sr_danger_cont,
    ...
    (
        ...
        l_id_sr_danger_cont  id_sr_danger_cont_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_sr_danger_cont(i) := col_in(i).id_sr_danger_cont;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE sr_danger_cont
                 ...
                 WHERE id_sr_danger_cont = l_id_sr_danger_cont(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE sr_danger_cont
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE SR_DANGER_CONT
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE SR_DANGER_CONT set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE SR_DANGER_CONT set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_sr_danger_cont_in => id_sr_danger_cont_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_sr_danger_cont(id_sr_danger_cont_in => id_sr_danger_cont_in,
                              handle_error_in      => handle_error_in,
                              rows_out             => rows_out);
    END del_id_sr_danger_cont;
    ...
    BEGIN
        DELETE FROM sr_danger_cont
         WHERE id_episode = del_dact_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dact_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_dact_epis_fk;
    ...
    BEGIN
        DELETE FROM sr_danger_cont
         WHERE id_patient = del_dact_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dact_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_dact_pat_fk;
    ...
    BEGIN
        DELETE FROM sr_danger_cont
         WHERE id_prof_reg = del_dact_prof_fk.id_prof_reg_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dact_prof_fk(id_prof_reg_in => id_prof_reg_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_dact_prof_fk;
    ...
    BEGIN
        DELETE FROM sr_danger_cont
         WHERE id_schedule_sr = del_dact_schr_fk.id_schedule_sr_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dact_schr_fk(id_schedule_sr_in => id_schedule_sr_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_dact_schr_fk;
    ...
    BEGIN
        DELETE FROM sr_danger_cont
         WHERE id_epis_diagnosis = del_sdc_epis_diag.id_epis_diagnosis_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sdc_epis_diag(id_epis_diagnosis_in => id_epis_diagnosis_in,
                          handle_error_in      => handle_error_in,
                          rows_out             => rows_out);
    END del_sdc_epis_diag;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM SR_DANGER_CONT';
        ELSE
            RETURN 'DELETE FROM SR_DANGER_CONT WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(sr_danger_cont_inout IN OUT sr_danger_cont%ROWTYPE) IS
    BEGIN
        sr_danger_cont_inout.id_sr_danger_cont  := NULL;
        sr_danger_cont_inout.id_episode         := NULL;
        sr_danger_cont_inout.id_patient         := NULL;
        sr_danger_cont_inout.id_schedule_sr     := NULL;
        sr_danger_cont_inout.id_prof_reg        := NULL;
        sr_danger_cont_inout.dt_reg             := NULL;
        sr_danger_cont_inout.flg_status         := NULL;
        sr_danger_cont_inout.create_user        := NULL;
        sr_danger_cont_inout.create_time        := NULL;
        sr_danger_cont_inout.create_institution := NULL;
        sr_danger_cont_inout.update_user        := NULL;
        sr_danger_cont_inout.update_time        := NULL;
        sr_danger_cont_inout.update_institution := NULL;
        sr_danger_cont_inout.id_epis_diagnosis  := NULL;
    END initrec;

    FUNCTION initrec RETURN sr_danger_cont%ROWTYPE IS
        l_sr_danger_cont sr_danger_cont%ROWTYPE;
    BEGIN
        RETURN l_sr_danger_cont;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN sr_danger_cont_tc IS
        data sr_danger_cont_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM sr_danger_cont
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN sr_danger_cont_tc IS
