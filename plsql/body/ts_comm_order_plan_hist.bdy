...
CREATE OR REPLACE PACKAGE BODY ts_comm_order_plan_hist
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2019-08-23 08:32:26
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN comm_order_plan_hist.id_comm_order_plan_hist%TYPE IS
        retval comm_order_plan_hist.id_comm_order_plan_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_comm_order_plan_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky comm_order_plan_hist.id_comm_order_plan_hist%TYPE := next_key;
    BEGIN
        ins(id_comm_order_plan_hist_in   => l_pky,
            id_comm_order_plan_in        => id_comm_order_plan_in,
            ...
            notes_in                     => notes_in,
            dt_comm_order_plan_h_tstz_in => dt_comm_order_plan_h_tstz_in,
            id_professional_in           => id_professional_in,
            dt_plan_tstz_in              => dt_plan_tstz_in,
            dt_comm_order_plan_tstz_in   => dt_comm_order_plan_tstz_in,
    ...
    BEGIN
        ins(id_comm_order_plan_hist_in   => l_pky,
            ...
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
        id_comm_order_plan_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_comm_order_plan_in        => id_comm_order_plan_in,
            ...
            update_institution_in        => update_institution_in,
            id_po_param_reg_in           => id_po_param_reg_in,
            id_comm_order_plan_hist_out  => id_comm_order_plan_hist_out,
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN comm_order_plan_hist.id_comm_order_plan_hist%TYPE IS
        l_pky comm_order_plan_hist.id_comm_order_plan_hist%TYPE := next_key;
    BEGIN
        ins(id_comm_order_plan_hist_in   => l_pky,
            id_comm_order_plan_in        => id_comm_order_plan_in,
    ...
    BEGIN
        INSERT INTO comm_order_plan_hist
            (id_comm_order_plan_hist,
             id_comm_order_plan,
             id_prof_performed,
             id_episode_write,
             start_time,
             end_time,
             notes,
             dt_comm_order_plan_hist_tstz,
             id_professional,
             dt_plan_tstz,
             dt_comm_order_plan_tstz,
             id_comm_order_req,
             id_prof_take,
             flg_status,
             id_prof_cancel,
        ...
        VALUES
            (id_comm_order_plan_hist_in,
             ...
             end_time_in,
             notes_in,
             dt_comm_order_plan_h_tstz_in,
             id_professional_in,
             dt_plan_tstz_in,
             dt_comm_order_plan_tstz_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_comm_order_plan_hist_in   => id_comm_order_plan_hist_in,
            id_comm_order_plan_in        => id_comm_order_plan_in,
            id_prof_performed_in         => id_prof_performed_in,
            id_episode_write_in          => id_episode_write_in,
            start_time_in                => start_time_in,
    ...
    (
        ...
        l_rec comm_order_plan_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_comm_order_plan_hist := next_key(sequence_in);
        END IF;
    
        ins(id_comm_order_plan_hist_in   => l_rec.id_comm_order_plan_hist,
            id_comm_order_plan_in        => l_rec.id_comm_order_plan,
            ...
            dt_comm_order_plan_h_tstz_in => l_rec.dt_comm_order_plan_hist_tstz,
            id_professional_in           => l_rec.id_professional,
            dt_plan_tstz_in              => l_rec.dt_plan_tstz,
            dt_comm_order_plan_tstz_in   => l_rec.dt_comm_order_plan_tstz,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                ...
                VALUES
                    (rows_in(indx).id_comm_order_plan,
                     ...
                     rows_in(indx).notes,
                     rows_in(indx).dt_comm_order_plan_hist_tstz,
                     rows_in(indx).id_professional,
                     rows_in(indx).id_comm_order_plan_hist,
                     rows_in(indx).dt_plan_tstz,
                     rows_in(indx).dt_comm_order_plan_tstz,
    ...
    (
        ...
        l_id_comm_order_plan_n        NUMBER(1) := sys.diutil.bool_to_int(id_comm_order_plan_nin);
        ...
        l_dt_comm_order_plan_h_tstz_n NUMBER(1) := sys.diutil.bool_to_int(dt_comm_order_plan_h_tstz_nin);
        ...
        l_dt_comm_order_plan_tstz_n   NUMBER(1) := sys.diutil.bool_to_int(dt_comm_order_plan_tstz_nin);
    ...
    BEGIN
        ...
        UPDATE comm_order_plan_hist
           SET id_comm_order_plan           = decode(l_id_comm_order_plan_n,
                                                     0,
                                                     id_comm_order_plan_in,
                                                     nvl(id_comm_order_plan_in, id_comm_order_plan)),
               ...
               dt_comm_order_plan_hist_tstz = decode(l_dt_comm_order_plan_h_tstz_n,
                                                     0,
                                                     dt_comm_order_plan_h_tstz_in,
                                                     nvl(dt_comm_order_plan_h_tstz_in, dt_comm_order_plan_hist_tstz)),
               ...
               dt_comm_order_plan_tstz      = decode(l_dt_comm_order_plan_tstz_n,
                                                     0,
                                                     dt_comm_order_plan_tstz_in,
                                                     nvl(dt_comm_order_plan_tstz_in, dt_comm_order_plan_tstz)),
               id_comm_order_req            = decode(l_id_comm_order_req_n,
                                                     0,
                                                     id_comm_order_req_in,
               ...
               exec_number                  = decode(l_exec_number_n,
                                                     0,
                                                     exec_number_in,
                                                     nvl(exec_number_in, exec_number)),
         ...
         WHERE id_comm_order_plan_hist = id_comm_order_plan_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_comm_order_plan_hist_in    => id_comm_order_plan_hist_in,
            id_comm_order_plan_in         => id_comm_order_plan_in,
            id_comm_order_plan_nin        => id_comm_order_plan_nin,
            id_prof_performed_in          => id_prof_performed_in,
            ...
            notes_nin                     => notes_nin,
            dt_comm_order_plan_h_tstz_in  => dt_comm_order_plan_h_tstz_in,
            dt_comm_order_plan_h_tstz_nin => dt_comm_order_plan_h_tstz_nin,
            id_professional_in            => id_professional_in,
            id_professional_nin           => id_professional_nin,
            dt_plan_tstz_in               => dt_plan_tstz_in,
            dt_plan_tstz_nin              => dt_plan_tstz_nin,
            dt_comm_order_plan_tstz_in    => dt_comm_order_plan_tstz_in,
            dt_comm_order_plan_tstz_nin   => dt_comm_order_plan_tstz_nin,
            id_comm_order_req_in          => id_comm_order_req_in,
    ...
    (
        ...
        l_id_po_param_reg_n           NUMBER(1) := sys.diutil.bool_to_int(id_po_param_reg_nin);
    BEGIN
        l_id_comm_order_plan_n        := sys.diutil.bool_to_int(id_comm_order_plan_nin);
        ...
        l_dt_comm_order_plan_h_tstz_n := sys.diutil.bool_to_int(dt_comm_order_plan_h_tstz_nin);
        l_id_professional_n           := sys.diutil.bool_to_int(id_professional_nin);
        l_dt_plan_tstz_n              := sys.diutil.bool_to_int(dt_plan_tstz_nin);
        l_dt_comm_order_plan_tstz_n   := sys.diutil.bool_to_int(dt_comm_order_plan_tstz_nin);
        ...
        l_sql                         := 'UPDATE comm_order_plan_hist SET' || ' ID_COMM_ORDER_PLAN = decode (' ||
                                         l_id_comm_order_plan_n ||
                                         ',0,:ID_COMM_ORDER_PLAN_in, NVL (:ID_COMM_ORDER_PLAN_in, ID_COMM_ORDER_PLAN)) ' || ',' ||
                                         ' ID_PROF_PERFORMED = decode (' || l_id_prof_performed_n ||
                                         ...
                                         ' NOTES = decode (' || l_notes_n || ',0,:NOTES_in, NVL (:NOTES_in, NOTES)) ' || ',' ||
                                         ' DT_COMM_ORDER_PLAN_HIST_TSTZ = decode (' || l_dt_comm_order_plan_h_tstz_n ||
                                         ',0,:dt_comm_order_plan_h_tstz_in, NVL (:dt_comm_order_plan_h_tstz_in, DT_COMM_ORDER_PLAN_HIST_TSTZ)) ' || ',' ||
                                         ' ID_PROFESSIONAL = decode (' || l_id_professional_n ||
                                         ',0,:ID_PROFESSIONAL_in, NVL (:ID_PROFESSIONAL_in, ID_PROFESSIONAL)) ' || ',' ||
                                         ' DT_PLAN_TSTZ = decode (' || l_dt_plan_tstz_n ||
                                         ',0,:DT_PLAN_TSTZ_in, NVL (:DT_PLAN_TSTZ_in, DT_PLAN_TSTZ)) ' || ',' ||
                                         ' DT_COMM_ORDER_PLAN_TSTZ = decode (' || l_dt_comm_order_plan_tstz_n ||
                                         ',0,:DT_COMM_ORDER_PLAN_TSTZ_in, NVL (:DT_COMM_ORDER_PLAN_TSTZ_in, DT_COMM_ORDER_PLAN_TSTZ)) ' || ',' ||
                                         ' ID_COMM_ORDER_REQ = decode (' || l_id_comm_order_req_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_comm_order_plan_in, id_prof_performed_in, id_episode_write_in, start_time_in, end_time_in, notes_in, dt_comm_order_plan_h_tstz_in, id_professional_in, dt_plan_tstz_in, dt_comm_order_plan_tstz_in, id_comm_order_req_in, id_prof_take_in, flg_status_in, id_prof_cancel_in, notes_cancel_in, id_wound_treat_in, dt_take_tstz_in, dt_cancel_tstz_in, flg_supplies_reg_in, id_cancel_reason_in, id_epis_documentation_in, id_cdr_event_in, exec_number_in, id_prof_last_update_in, dt_last_update_tstz_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_po_param_reg_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_comm_order_plan_hist_in,
                id_comm_order_plan_in,
                id_prof_performed_in,
                id_episode_write_in,
                start_time_in,
    ...
    BEGIN
        upd(id_comm_order_plan_hist_in   => rec_in.id_comm_order_plan_hist,
            id_comm_order_plan_in        => rec_in.id_comm_order_plan,
            ...
            dt_comm_order_plan_h_tstz_in => rec_in.dt_comm_order_plan_hist_tstz,
            id_professional_in           => rec_in.id_professional,
            dt_plan_tstz_in              => rec_in.dt_plan_tstz,
            dt_comm_order_plan_tstz_in   => rec_in.dt_comm_order_plan_tstz,
    ...
    (
        ...
        l_id_comm_order_plan_hist   id_comm_order_plan_hist_cc;
        ...
        l_notes                     notes_cc;
        l_dt_comm_order_plan_h_tstz dt_comm_order_plan_h_tstz_cc;
        l_id_professional           id_professional_cc;
        l_dt_plan_tstz              dt_plan_tstz_cc;
        l_dt_comm_order_plan_tstz   dt_comm_order_plan_tstz_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_comm_order_plan_hist(i) := col_in(i).id_comm_order_plan_hist;
            ...
            l_dt_comm_order_plan_h_tstz(i) := col_in(i).dt_comm_order_plan_hist_tstz;
            l_id_professional(i) := col_in(i).id_professional;
            l_dt_plan_tstz(i) := col_in(i).dt_plan_tstz;
            l_dt_comm_order_plan_tstz(i) := col_in(i).dt_comm_order_plan_tstz;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE comm_order_plan_hist
                   SET id_comm_order_plan           = nvl(l_id_comm_order_plan(i), id_comm_order_plan),
                       ...
                       dt_comm_order_plan_hist_tstz = nvl(l_dt_comm_order_plan_h_tstz(i), dt_comm_order_plan_hist_tstz),
                       id_professional              = nvl(l_id_professional(i), id_professional),
                       dt_plan_tstz                 = nvl(l_dt_plan_tstz(i), dt_plan_tstz),
                       dt_comm_order_plan_tstz      = nvl(l_dt_comm_order_plan_tstz(i), dt_comm_order_plan_tstz),
                       id_comm_order_req            = nvl(l_id_comm_order_req(i), id_comm_order_req),
                 ...
                 WHERE id_comm_order_plan_hist = l_id_comm_order_plan_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE comm_order_plan_hist
                   SET id_comm_order_plan           = l_id_comm_order_plan(i),
                       ...
                       notes                        = l_notes(i),
                       dt_comm_order_plan_hist_tstz = l_dt_comm_order_plan_h_tstz(i),
                       id_professional              = l_id_professional(i),
                       dt_plan_tstz                 = l_dt_plan_tstz(i),
                       dt_comm_order_plan_tstz      = l_dt_comm_order_plan_tstz(i),
                       id_comm_order_req            = l_id_comm_order_req(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE comm_order_plan_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE comm_order_plan_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE comm_order_plan_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM comm_order_plan_hist
         WHERE id_comm_order_plan_hist = id_comm_order_plan_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_comm_order_plan_hist_in => id_comm_order_plan_hist_in,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_coph_ppr_fk(id_po_param_reg_in => id_po_param_reg_in,
                        handle_error_in    => handle_error_in,
                        rows_out           => rows_out);
    END del_coph_ppr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM comm_order_plan_hist';
        ELSE
            RETURN 'DELETE FROM comm_order_plan_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(comm_order_plan_hist_inout IN OUT comm_order_plan_hist%ROWTYPE) IS
    BEGIN
        comm_order_plan_hist_inout.id_comm_order_plan_hist      := NULL;
        comm_order_plan_hist_inout.id_comm_order_plan           := NULL;
        comm_order_plan_hist_inout.id_prof_performed            := NULL;
        comm_order_plan_hist_inout.id_episode_write             := NULL;
        comm_order_plan_hist_inout.start_time                   := NULL;
        comm_order_plan_hist_inout.end_time                     := NULL;
        comm_order_plan_hist_inout.notes                        := NULL;
        comm_order_plan_hist_inout.dt_comm_order_plan_hist_tstz := NULL;
        comm_order_plan_hist_inout.id_professional              := NULL;
        comm_order_plan_hist_inout.dt_plan_tstz                 := NULL;
        comm_order_plan_hist_inout.dt_comm_order_plan_tstz      := NULL;
        comm_order_plan_hist_inout.id_comm_order_req            := NULL;
        comm_order_plan_hist_inout.id_prof_take                 := NULL;
        comm_order_plan_hist_inout.flg_status                   := NULL;
        comm_order_plan_hist_inout.id_prof_cancel               := NULL;
        comm_order_plan_hist_inout.notes_cancel                 := NULL;
        comm_order_plan_hist_inout.id_wound_treat               := NULL;
        comm_order_plan_hist_inout.dt_take_tstz                 := NULL;
        comm_order_plan_hist_inout.dt_cancel_tstz               := NULL;
        comm_order_plan_hist_inout.flg_supplies_reg             := NULL;
        comm_order_plan_hist_inout.id_cancel_reason             := NULL;
        comm_order_plan_hist_inout.id_epis_documentation        := NULL;
        comm_order_plan_hist_inout.id_cdr_event                 := NULL;
        comm_order_plan_hist_inout.exec_number                  := NULL;
        comm_order_plan_hist_inout.id_prof_last_update          := NULL;
        comm_order_plan_hist_inout.dt_last_update_tstz          := NULL;
        comm_order_plan_hist_inout.create_user                  := NULL;
        comm_order_plan_hist_inout.create_time                  := NULL;
        comm_order_plan_hist_inout.create_institution           := NULL;
        comm_order_plan_hist_inout.update_user                  := NULL;
        comm_order_plan_hist_inout.update_time                  := NULL;
        comm_order_plan_hist_inout.update_institution           := NULL;
        comm_order_plan_hist_inout.id_po_param_reg              := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN comm_order_plan_hist%ROWTYPE IS
        l_comm_order_plan_hist comm_order_plan_hist%ROWTYPE;
    BEGIN
        RETURN l_comm_order_plan_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN comm_order_plan_hist_tc IS
        data comm_order_plan_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM comm_order_plan_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN comm_order_plan_hist_tc IS
        data comm_order_plan_hist_tc;
