...
*/
 IS
    ...
    BEGIN
        ...
        ins(dt_exam_req_hist_in       => dt_exam_req_hist_in,
    ...
    (
        ...
        l_rec exam_req_hist%ROWTYPE := rec_in;
    BEGIN
        ins(dt_exam_req_hist_in       => l_rec.dt_exam_req_hist,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_EXAM_REQ_HIST _' || indx,
    ...
    BEGIN
        ...
        UPDATE exam_req_hist
         ...
         WHERE dt_exam_req_hist = dt_exam_req_hist_in
           AND id_exam_req = id_exam_req_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(dt_exam_req_hist_in        => dt_exam_req_hist_in,
            id_exam_req_in             => id_exam_req_in,
            id_patient_in              => id_patient_in,
    ...
    (
        ...
        l_update_time_n            NUMBER(1);
        l_update_institution_n     NUMBER(1);
        dt_exam_req_hist_in        exam_req_hist.dt_exam_req_hist%TYPE;
        id_exam_req_in             exam_req_hist.id_exam_req%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EXAM_REQ_HIST SET ' || ' ID_PATIENT = decode (' || l_id_patient_n ||
                 ...
                 ',0,:id_prof_req_in, NVL (:id_prof_req_in, ID_PROF_REQ)) ' || ',' || ' DT_REQ_TSTZ = decode (' ||
                 l_dt_req_tstz_n || ',0,:dt_req_tstz_in, NVL (:dt_req_tstz_in, DT_REQ_TSTZ)) ' || ',' ||
                 ' DT_BEGIN_TSTZ = decode (' || l_dt_begin_tstz_n ||
                 ...
                 ',0,:notes_cancel_in, NVL (:notes_cancel_in, NOTES_CANCEL)) ' || ',' || ' FLG_CONTACT = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_patient_in, id_episode_in, id_episode_origin_in, id_episode_destination_in, id_prev_episode_in, id_visit_in, id_institution_in, flg_time_in, flg_status_in, id_prof_req_in, dt_req_tstz_in, dt_begin_tstz_in, dt_schedule_tstz_in, dt_pend_req_tstz_in, priority_in, id_exec_institution_in, barcode_in, id_prof_authorize_in, id_prof_approve_in, id_schedule_in, id_sched_consult_in, notes_in, notes_tech_in, notes_patient_in, id_prof_cancel_in, dt_cancel_tstz_in, id_cancel_reason_in, notes_cancel_in, flg_contact_in, dt_contact_in, id_exam_group_in, id_prof_last_update_in, dt_last_update_tstz_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    BEGIN
        upd(dt_exam_req_hist_in       => rec_in.dt_exam_req_hist,
    ...
    (
        ...
        l_dt_exam_req_hist       dt_exam_req_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_dt_exam_req_hist(i) := col_in(i).dt_exam_req_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_req_hist
                 ...
                 WHERE dt_exam_req_hist = l_dt_exam_req_hist(i)
                   AND id_exam_req = l_id_exam_req(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_req_hist
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EXAM_REQ_HIST
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EXAM_REQ_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EXAM_REQ_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(dt_exam_req_hist_in => dt_exam_req_hist_in,
            id_exam_req_in      => id_exam_req_in,
            handle_error_in     => handle_error_in,
            rows_out            => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dt_exam_req_hist(dt_exam_req_hist_in => dt_exam_req_hist_in,
                             handle_error_in     => handle_error_in,
                             rows_out            => rows_out);
    END del_dt_exam_req_hist;
    ...
    BEGIN
        DELETE FROM exam_req_hist
         WHERE id_exam_req = del_ereqh_ereq_fk.id_exam_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ereqh_ereq_fk(id_exam_req_in => id_exam_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ereqh_ereq_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EXAM_REQ_HIST';
        ELSE
            RETURN 'DELETE FROM EXAM_REQ_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(exam_req_hist_inout IN OUT exam_req_hist%ROWTYPE) IS
    BEGIN
        exam_req_hist_inout.dt_exam_req_hist       := NULL;
        exam_req_hist_inout.id_exam_req            := NULL;
        exam_req_hist_inout.id_patient             := NULL;
        exam_req_hist_inout.id_episode             := NULL;
        exam_req_hist_inout.id_episode_origin      := NULL;
        exam_req_hist_inout.id_episode_destination := NULL;
        exam_req_hist_inout.id_prev_episode        := NULL;
        exam_req_hist_inout.id_visit               := NULL;
        exam_req_hist_inout.id_institution         := NULL;
        exam_req_hist_inout.flg_time               := NULL;
        exam_req_hist_inout.flg_status             := NULL;
        exam_req_hist_inout.id_prof_req            := NULL;
        exam_req_hist_inout.dt_req_tstz            := NULL;
        exam_req_hist_inout.dt_begin_tstz          := NULL;
        exam_req_hist_inout.dt_schedule_tstz       := NULL;
        exam_req_hist_inout.dt_pend_req_tstz       := NULL;
        exam_req_hist_inout.priority               := NULL;
        exam_req_hist_inout.id_exec_institution    := NULL;
        exam_req_hist_inout.barcode                := NULL;
        exam_req_hist_inout.id_prof_authorize      := NULL;
        exam_req_hist_inout.id_prof_approve        := NULL;
        exam_req_hist_inout.id_schedule            := NULL;
        exam_req_hist_inout.id_sched_consult       := NULL;
        exam_req_hist_inout.notes                  := NULL;
        exam_req_hist_inout.notes_tech             := NULL;
        exam_req_hist_inout.notes_patient          := NULL;
        exam_req_hist_inout.id_prof_cancel         := NULL;
        exam_req_hist_inout.dt_cancel_tstz         := NULL;
        exam_req_hist_inout.id_cancel_reason       := NULL;
        exam_req_hist_inout.notes_cancel           := NULL;
        exam_req_hist_inout.flg_contact            := NULL;
        exam_req_hist_inout.dt_contact             := NULL;
        exam_req_hist_inout.id_exam_group          := NULL;
        exam_req_hist_inout.id_prof_last_update    := NULL;
        exam_req_hist_inout.dt_last_update_tstz    := NULL;
        exam_req_hist_inout.create_user            := NULL;
        exam_req_hist_inout.create_time            := NULL;
        exam_req_hist_inout.create_institution     := NULL;
        exam_req_hist_inout.update_user            := NULL;
        exam_req_hist_inout.update_time            := NULL;
        exam_req_hist_inout.update_institution     := NULL;
    END initrec;

    FUNCTION initrec RETURN exam_req_hist%ROWTYPE IS
        l_exam_req_hist exam_req_hist%ROWTYPE;
    BEGIN
        RETURN l_exam_req_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN exam_req_hist_tc IS
        data exam_req_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM exam_req_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN exam_req_hist_tc IS
