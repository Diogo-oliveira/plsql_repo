...
CREATE OR REPLACE PACKAGE BODY ts_sr_pos_schedule_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Abril 15, 2010 15:17:21
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_sr_pos_schedule_hist_in IN sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE,
        id_sr_pos_schedule_in      IN sr_pos_schedule_hist.id_sr_pos_schedule%TYPE DEFAULT NULL,
        id_sr_pos_status_in        IN sr_pos_schedule_hist.id_sr_pos_status%TYPE DEFAULT NULL,
        id_schedule_sr_in          IN sr_pos_schedule_hist.id_schedule_sr%TYPE DEFAULT NULL,
        flg_status_in              IN sr_pos_schedule_hist.flg_status%TYPE DEFAULT NULL,
        id_prof_reg_in             IN sr_pos_schedule_hist.id_prof_reg%TYPE DEFAULT NULL,
        dt_reg_in                  IN sr_pos_schedule_hist.dt_reg%TYPE DEFAULT NULL,
        dt_pos_suggested_in        IN sr_pos_schedule_hist.dt_pos_suggested%TYPE DEFAULT NULL,
        req_notes_in               IN sr_pos_schedule_hist.req_notes%TYPE DEFAULT NULL,
        id_prof_req_in             IN sr_pos_schedule_hist.id_prof_req%TYPE DEFAULT NULL,
        dt_req_in                  IN sr_pos_schedule_hist.dt_req%TYPE DEFAULT NULL,
        dt_valid_in                IN sr_pos_schedule_hist.dt_valid%TYPE DEFAULT NULL,
        valid_days_in              IN sr_pos_schedule_hist.valid_days%TYPE DEFAULT NULL,
        decision_notes_in          IN sr_pos_schedule_hist.decision_notes%TYPE DEFAULT NULL,
        id_prof_decision_in        IN sr_pos_schedule_hist.id_prof_decision%TYPE DEFAULT NULL,
        dt_decision_in             IN sr_pos_schedule_hist.dt_decision%TYPE DEFAULT NULL,
        create_user_in             IN sr_pos_schedule_hist.create_user%TYPE DEFAULT NULL,
        create_time_in             IN sr_pos_schedule_hist.create_time%TYPE DEFAULT NULL,
        create_institution_in      IN sr_pos_schedule_hist.create_institution%TYPE DEFAULT NULL,
        update_user_in             IN sr_pos_schedule_hist.update_user%TYPE DEFAULT NULL,
        update_time_in             IN sr_pos_schedule_hist.update_time%TYPE DEFAULT NULL,
        update_institution_in      IN sr_pos_schedule_hist.update_institution%TYPE DEFAULT NULL,
        id_pos_consult_req_in      IN sr_pos_schedule_hist.id_pos_consult_req%TYPE DEFAULT NULL,
        handle_error_in            IN BOOLEAN := TRUE,
        rows_out                   OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO sr_pos_schedule_hist
            (id_sr_pos_schedule_hist,
             id_sr_pos_schedule,
             id_sr_pos_status,
             id_schedule_sr,
             flg_status,
                ...
                BEGIN
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'SR_POS_SCHEDULE_HIST');
                    END IF;
                END;
            END IF;
    ...
    BEGIN
        ...
        ins(id_sr_pos_schedule_hist_in => id_sr_pos_schedule_hist_in,
    ...
    PROCEDURE ins
    (
        rec_in          IN sr_pos_schedule_hist%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec sr_pos_schedule_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_sr_pos_schedule_hist := next_key(sequence_in);
        END IF;
        ins(id_sr_pos_schedule_hist_in => l_rec.id_sr_pos_schedule_hist,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE
    
     IS
        retval sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_sr_pos_schedule_hist.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_SR_POS_SCHEDULE_HIST'));
    END next_key;
    ...
    (
        ...
        update_institution_in       IN sr_pos_schedule_hist.update_institution%TYPE DEFAULT NULL,
        id_pos_consult_req_in       IN sr_pos_schedule_hist.id_pos_consult_req%TYPE DEFAULT NULL,
        id_sr_pos_schedule_hist_out IN OUT sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE,
        handle_error_in             IN BOOLEAN := TRUE,
        rows_out                    OUT table_varchar
    ) IS
        l_pky sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE := next_key;
    BEGIN
        ins(id_sr_pos_schedule_hist_in => l_pky,
            id_sr_pos_schedule_in      => id_sr_pos_schedule_in,
            id_sr_pos_status_in        => id_sr_pos_status_in,
            id_schedule_sr_in          => id_schedule_sr_in,
            flg_status_in              => flg_status_in,
            ...
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
        id_sr_pos_schedule_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_sr_pos_schedule_in       => id_sr_pos_schedule_in,
            ...
            update_institution_in       => update_institution_in,
            id_pos_consult_req_in       => id_pos_consult_req_in,
            id_sr_pos_schedule_hist_out => id_sr_pos_schedule_hist_out,
            handle_error_in             => handle_error_in,
            rows_out                    => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE IS
        l_pky sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE := next_key;
    BEGIN
        ins(id_sr_pos_schedule_hist_in => l_pky,
            id_sr_pos_schedule_in      => id_sr_pos_schedule_in,
    ...
    PROCEDURE ins
    (
        rows_in         IN sr_pos_schedule_hist_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_SR_POS_SCHEDULE_HIST _' || indx,
                                                        value_in           => rows_in(indx).id_sr_pos_schedule_hist,
                                                        validate_in        => FALSE);
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'SR_POS_SCHEDULE_HIST',
                                                name2_in      => 'ROW_COUNT',
    ...
    BEGIN
        ...
        UPDATE sr_pos_schedule_hist
         ...
         WHERE id_sr_pos_schedule_hist = id_sr_pos_schedule_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_sr_pos_schedule_hist_in => id_sr_pos_schedule_hist_in,
            id_sr_pos_schedule_in      => id_sr_pos_schedule_in,
    ...
    (
        ...
        l_update_institution_n     NUMBER(1);
        l_id_pos_consult_req_n     NUMBER(1);
        id_sr_pos_schedule_hist_in sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE SR_POS_SCHEDULE_HIST SET ' || ' ID_SR_POS_SCHEDULE = decode (' || l_id_sr_pos_schedule_n ||
                 ...
                 l_dt_reg_n || ',0,:dt_reg_in, NVL (:dt_reg_in, DT_REG)) ' || ',' || ' DT_POS_SUGGESTED = decode (' ||
                 l_dt_pos_suggested_n || ',0,:dt_pos_suggested_in, NVL (:dt_pos_suggested_in, DT_POS_SUGGESTED)) ' || ',' ||
                 ' REQ_NOTES = decode (' || l_req_notes_n || ',0,:req_notes_in, NVL (:req_notes_in, REQ_NOTES)) ' || ',' ||
                 ...
                 ',0,:dt_decision_in, NVL (:dt_decision_in, DT_DECISION)) ' || ',' || ' CREATE_USER = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_sr_pos_schedule_in, id_sr_pos_status_in, id_schedule_sr_in, flg_status_in, id_prof_reg_in, dt_reg_in, dt_pos_suggested_in, req_notes_in, id_prof_req_in, dt_req_in, dt_valid_in, valid_days_in, decision_notes_in, id_prof_decision_in, dt_decision_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_pos_consult_req_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_sr_pos_schedule_hist_in => rec_in.id_sr_pos_schedule_hist,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_sr_pos_schedule_hist_in,
                id_sr_pos_schedule_in,
                id_sr_pos_status_in,
                id_schedule_sr_in,
                flg_status_in,
    ...
    PROCEDURE upd
    (
        col_in            IN sr_pos_schedule_hist_tc,
        ignore_if_null_in IN BOOLEAN := TRUE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          IN OUT table_varchar
    ) IS
        l_id_sr_pos_schedule_hist id_sr_pos_schedule_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_sr_pos_schedule_hist(i) := col_in(i).id_sr_pos_schedule_hist;
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE sr_pos_schedule_hist
                   SET id_sr_pos_schedule = nvl(l_id_sr_pos_schedule(i), id_sr_pos_schedule),
                       id_sr_pos_status   = nvl(l_id_sr_pos_status(i), id_sr_pos_status),
                 ...
                 WHERE id_sr_pos_schedule_hist = l_id_sr_pos_schedule_hist(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE sr_pos_schedule_hist
                   SET id_sr_pos_schedule = l_id_sr_pos_schedule(i),
                       id_sr_pos_status   = l_id_sr_pos_status(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE SR_POS_SCHEDULE_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE SR_POS_SCHEDULE_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE SR_POS_SCHEDULE_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE SR_POS_SCHEDULE_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_sr_pos_schedule_hist_in => id_sr_pos_schedule_hist_in,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    
    END del;

    -- Delete all rows for primary key column ID_SR_POS_SCHEDULE_HIST
    PROCEDURE del_id_sr_pos_schedule_hist
    (
        id_sr_pos_schedule_hist_in IN sr_pos_schedule_hist.id_sr_pos_schedule_hist%TYPE,
        handle_error_in            IN BOOLEAN := TRUE,
        rows_out                   OUT table_varchar
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_id_sr_pos_schedule_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_sr_pos_schedule_hist(id_sr_pos_schedule_hist_in => id_sr_pos_schedule_hist_in,
                                    handle_error_in            => handle_error_in,
                                    rows_out                   => rows_out);
    END del_id_sr_pos_schedule_hist;

    PROCEDURE del_spsh_creq_fk
    (
        id_pos_consult_req_in IN sr_pos_schedule_hist.id_pos_consult_req%TYPE,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_pos_consult_req = del_spsh_creq_fk.id_pos_consult_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_creq_fk(id_pos_consult_req_in => id_pos_consult_req_in,
                         handle_error_in       => handle_error_in,
                         rows_out              => rows_out);
    END del_spsh_creq_fk;

    PROCEDURE del_spsh_dprf_fk
    (
        id_prof_decision_in IN sr_pos_schedule_hist.id_prof_decision%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_prof_decision = del_spsh_dprf_fk.id_prof_decision_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_dprf_fk(id_prof_decision_in => id_prof_decision_in,
                         handle_error_in     => handle_error_in,
                         rows_out            => rows_out);
    END del_spsh_dprf_fk;

    PROCEDURE del_spsh_rgprf_fk
    (
        id_prof_reg_in  IN sr_pos_schedule_hist.id_prof_reg%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_prof_reg = del_spsh_rgprf_fk.id_prof_reg_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_rgprf_fk(id_prof_reg_in => id_prof_reg_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_spsh_rgprf_fk;

    PROCEDURE del_spsh_rqprf_fk
    (
        id_prof_req_in  IN sr_pos_schedule_hist.id_prof_req%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_prof_req = del_spsh_rqprf_fk.id_prof_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_rqprf_fk(id_prof_req_in => id_prof_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_spsh_rqprf_fk;

    PROCEDURE del_spsh_schr_fk
    (
        id_schedule_sr_in IN sr_pos_schedule_hist.id_schedule_sr%TYPE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_schedule_sr = del_spsh_schr_fk.id_schedule_sr_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_schr_fk(id_schedule_sr_in => id_schedule_sr_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_spsh_schr_fk;

    PROCEDURE del_spsh_spsc_fk
    (
        id_sr_pos_schedule_in IN sr_pos_schedule_hist.id_sr_pos_schedule%TYPE,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM sr_pos_schedule_hist
         WHERE id_sr_pos_schedule = del_spsh_spsc_fk.id_sr_pos_schedule_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_spsh_spsc_fk(id_sr_pos_schedule_in => id_sr_pos_schedule_in,
                         handle_error_in       => handle_error_in,
                         rows_out              => rows_out);
    END del_spsh_spsc_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM SR_POS_SCHEDULE_HIST';
        ELSE
            RETURN 'DELETE FROM SR_POS_SCHEDULE_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(sr_pos_schedule_hist_inout IN OUT sr_pos_schedule_hist%ROWTYPE) IS
    BEGIN
        sr_pos_schedule_hist_inout.id_sr_pos_schedule_hist := NULL;
        sr_pos_schedule_hist_inout.id_sr_pos_schedule      := NULL;
        sr_pos_schedule_hist_inout.id_sr_pos_status        := NULL;
        sr_pos_schedule_hist_inout.id_schedule_sr          := NULL;
        sr_pos_schedule_hist_inout.flg_status              := NULL;
        sr_pos_schedule_hist_inout.id_prof_reg             := NULL;
        sr_pos_schedule_hist_inout.dt_reg                  := NULL;
        sr_pos_schedule_hist_inout.dt_pos_suggested        := NULL;
        sr_pos_schedule_hist_inout.req_notes               := NULL;
        sr_pos_schedule_hist_inout.id_prof_req             := NULL;
        sr_pos_schedule_hist_inout.dt_req                  := NULL;
        sr_pos_schedule_hist_inout.dt_valid                := NULL;
        sr_pos_schedule_hist_inout.valid_days              := NULL;
        sr_pos_schedule_hist_inout.decision_notes          := NULL;
        sr_pos_schedule_hist_inout.id_prof_decision        := NULL;
        sr_pos_schedule_hist_inout.dt_decision             := NULL;
        sr_pos_schedule_hist_inout.create_user             := NULL;
        sr_pos_schedule_hist_inout.create_time             := NULL;
        sr_pos_schedule_hist_inout.create_institution      := NULL;
        sr_pos_schedule_hist_inout.update_user             := NULL;
        sr_pos_schedule_hist_inout.update_time             := NULL;
        sr_pos_schedule_hist_inout.update_institution      := NULL;
        sr_pos_schedule_hist_inout.id_pos_consult_req      := NULL;
    END initrec;

    FUNCTION initrec RETURN sr_pos_schedule_hist%ROWTYPE IS
        l_sr_pos_schedule_hist sr_pos_schedule_hist%ROWTYPE;
    BEGIN
        RETURN l_sr_pos_schedule_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN sr_pos_schedule_hist_tc IS
        data sr_pos_schedule_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM sr_pos_schedule_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN sr_pos_schedule_hist_tc IS
