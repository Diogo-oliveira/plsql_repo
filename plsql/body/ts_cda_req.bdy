 ...
 IS
    ...
    BEGIN
        ...
        ins(id_cda_req_in         => id_cda_req_in,
            ...
            dt_range_start_in     => dt_range_start_in,
            dt_range_end_in       => dt_range_end_in,
            cda_report_file_in    => cda_report_file_in,
    ...
    */
    ...
    BEGIN
        ...
        LOOP
            ...
            THEN
                ...
                THEN
                    ...
                    CASE current_column
                        WHEN 'cda_report_file_in' THEN
                            IF l_cda_report_file IS NULL
                            THEN
                                dbms_lob.createtemporary(l_cda_report_file, TRUE, dbms_lob.call);
                            END IF;
                    END CASE;
                END IF;
                ...
                CASE current_column
                    WHEN 'cda_report_file_in' THEN
                        dbms_lob.writeappend(l_cda_report_file, length(clob_pieces_in(i)), clob_pieces_in(i));
                END CASE;
            END IF;
        END LOOP;
        ...
        ins(id_cda_req_in         => id_cda_req_in,
            ...
            dt_range_start_in     => dt_range_start_in,
            dt_range_end_in       => dt_range_end_in,
            cda_report_file_in    => l_cda_report_file,
            id_professional_in    => id_professional_in,
            id_software_in        => id_software_in,
            handle_error_in       => handle_error_in);
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_cda_req_in         => id_cda_req_in,
                              id_institution_in     => id_institution_in,
                              flg_status_in         => flg_status_in,
                              flg_type_in           => flg_type_in,
                              dt_start_in           => dt_start_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_cda_req_in         => id_cda_req_in,
                                  id_institution_in     => id_institution_in,
                                  flg_status_in         => flg_status_in,
                                  flg_type_in           => flg_type_in,
                                  dt_start_in           => dt_start_in,
    ...
    */
    ...
    (
        ...
        l_rec cda_req%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_cda_req := next_key(sequence_in);
        END IF;
        ins(id_cda_req_in         => l_rec.id_cda_req,
            ...
            dt_range_start_in     => l_rec.dt_range_start,
            dt_range_end_in       => l_rec.dt_range_end,
            cda_report_file_in    => l_rec.cda_report_file,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN cda_req.id_cda_req%TYPE
     ...
     IS
        retval cda_req.id_cda_req%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_cda_req.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_CDA_REQ'));
    END next_key;
    ...
    (
        ...
        l_pky cda_req.id_cda_req%TYPE := next_key;
    BEGIN
        ins(id_cda_req_in         => l_pky,
            id_institution_in     => id_institution_in,
            flg_status_in         => flg_status_in,
            flg_type_in           => flg_type_in,
            dt_start_in           => dt_start_in,
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN cda_req.id_cda_req%TYPE IS
        l_pky cda_req.id_cda_req%TYPE := next_key;
    BEGIN
        ins(id_cda_req_in         => l_pky,
            id_institution_in     => id_institution_in,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                ...
                VALUES
                    (rows_in(indx).id_cda_req,
                     ...
                     rows_in(indx).dt_range_start,
                     rows_in(indx).dt_range_end,
                     rows_in(indx).cda_report_file,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_RANGE_START _' || indx,
                                                        value_in           => rows_in(SQL%BULK_EXCEPTIONS(indx).error_index)
                                                                              .dt_range_start,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_RANGE_END _' || indx,
                                                        value_in           => rows_in(SQL%BULK_EXCEPTIONS(indx).error_index)
                                                                              .dt_range_end,
                                                        validate_in        => FALSE);
    ...
    (
        ...
        l_dt_range_start_n     NUMBER(1);
        l_dt_range_end_n       NUMBER(1);
        l_cda_report_file_n    NUMBER(1);
    ...
    BEGIN
        ...
        l_dt_range_start_n     := sys.diutil.bool_to_int(dt_range_start_nin);
        l_dt_range_end_n       := sys.diutil.bool_to_int(dt_range_end_nin);
        l_cda_report_file_n    := sys.diutil.bool_to_int(cda_report_file_nin);
        ...
        UPDATE cda_req
           SET id_institution     = decode(l_id_institution_n,
               ...
               dt_range_start     = decode(l_dt_range_start_n,
                                           0,
                                           dt_range_start_in,
                                           nvl(dt_range_start_in, dt_range_start)),
               dt_range_end       = decode(l_dt_range_end_n, 0, dt_range_end_in, nvl(dt_range_end_in, dt_range_end)),
               cda_report_file    = decode(l_cda_report_file_n,
                                           0,
                                           cda_report_file_in,
                                           nvl(cda_report_file_in, cda_report_file)),
    ...
    BEGIN
        upd(id_cda_req_in          => id_cda_req_in,
            ...
            dt_range_start_in      => dt_range_start_in,
            dt_range_start_nin     => dt_range_start_nin,
            dt_range_end_in        => dt_range_end_in,
            dt_range_end_nin       => dt_range_end_nin,
            cda_report_file_in     => cda_report_file_in,
            cda_report_file_nin    => cda_report_file_nin,
            id_professional_in     => id_professional_in,
    ...
    (
        ...
        l_id_professional_n    NUMBER(1);
        l_id_software_n        NUMBER(1);
        id_cda_req_in          cda_req.id_cda_req%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE CDA_REQ SET ' || ' ID_INSTITUTION = decode (' || l_id_institution_n ||
                 ',0,:id_institution_in, NVL (:id_institution_in, ID_INSTITUTION)) ' || ',' || ' FLG_STATUS = decode (' ||
                 ...
                 ' DT_RANGE_START = decode (' || l_dt_range_start_n ||
                 ',0,:dt_range_start_in, NVL (:dt_range_start_in, DT_RANGE_START)) ' || ',' ||
                 ' DT_RANGE_END = decode (' || l_dt_range_end_n ||
                 ',0,:dt_range_end_in, NVL (:dt_range_end_in, DT_RANGE_END)) ' || ',' || ' CDA_REPORT_FILE = decode (' ||
                 l_cda_report_file_n || ',0,:cda_report_file_in, NVL (:cda_report_file_in, CDA_REPORT_FILE)) ' || ',' ||
                 ' ID_PROFESSIONAL = decode (' || l_id_professional_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_institution_in, flg_status_in, flg_type_in, dt_start_in, dt_end_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, dt_range_start_in, dt_range_end_in, cda_report_file_in, id_professional_in, id_software_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_cda_req_in         => rec_in.id_cda_req,
            ...
            dt_range_start_in     => rec_in.dt_range_start,
            dt_range_end_in       => rec_in.dt_range_end,
            cda_report_file_in    => rec_in.cda_report_file,
    ...
    (
        ...
        l_dt_range_start     dt_range_start_cc;
        l_dt_range_end       dt_range_end_cc;
        l_cda_report_file    cda_report_file_cc;
    ...
    BEGIN
        ...
        LOOP
            ...
            l_dt_range_start(i) := col_in(i).dt_range_start;
            l_dt_range_end(i) := col_in(i).dt_range_end;
            l_cda_report_file(i) := col_in(i).cda_report_file;
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE cda_req
                   SET id_institution     = nvl(l_id_institution(i), id_institution),
                       ...
                       dt_range_start     = nvl(l_dt_range_start(i), dt_range_start),
                       dt_range_end       = nvl(l_dt_range_end(i), dt_range_end),
                       cda_report_file    = nvl(l_cda_report_file(i), cda_report_file),
                       id_professional    = nvl(l_id_professional(i), id_professional),
                       id_software        = nvl(l_id_software(i), id_software)
                 WHERE id_cda_req = l_id_cda_req(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE cda_req
                   SET id_institution     = l_id_institution(i),
                       ...
                       dt_range_start     = l_dt_range_start(i),
                       dt_range_end       = l_dt_range_end(i),
                       cda_report_file    = l_cda_report_file(i),
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE CDA_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE CDA_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_cda_req_in => id_cda_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_cda_req(id_cda_req_in => id_cda_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_id_cda_req;
    ...
    BEGIN
        DELETE FROM cda_req
         WHERE id_institution = del_cdar_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cdar_inst_fk(id_institution_in => id_institution_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_cdar_inst_fk;
    ...
    BEGIN
        DELETE FROM cda_req
         WHERE id_professional = del_cdar_prof_fk.id_professional_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cdar_prof_fk(id_professional_in => id_professional_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_cdar_prof_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM CDA_REQ';
        ELSE
            RETURN 'DELETE FROM CDA_REQ WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(cda_req_inout IN OUT cda_req%ROWTYPE) IS
    BEGIN
        cda_req_inout.id_cda_req         := NULL;
        cda_req_inout.id_institution     := NULL;
        cda_req_inout.flg_status         := NULL;
        cda_req_inout.flg_type           := NULL;
        cda_req_inout.dt_start           := current_timestamp;
        cda_req_inout.dt_end             := NULL;
        cda_req_inout.create_user        := NULL;
        cda_req_inout.create_time        := NULL;
        cda_req_inout.create_institution := NULL;
        cda_req_inout.update_user        := NULL;
        cda_req_inout.update_time        := NULL;
        cda_req_inout.update_institution := NULL;
        cda_req_inout.dt_range_start     := NULL;
        cda_req_inout.dt_range_end       := NULL;
        cda_req_inout.cda_report_file    := NULL;
        cda_req_inout.id_professional    := NULL;
        cda_req_inout.id_software        := NULL;
    END initrec;

    FUNCTION initrec RETURN cda_req%ROWTYPE IS
        l_cda_req cda_req%ROWTYPE;
    BEGIN
        l_cda_req.dt_start := current_timestamp;
        RETURN l_cda_req;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN cda_req_tc IS
        data cda_req_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN cda_req_tc IS
