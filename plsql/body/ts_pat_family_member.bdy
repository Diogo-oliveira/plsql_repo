/*-- Last Change Revision: $Rev: 2028301 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:57 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_pat_family_member
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Novembro 21, 2008 18:24:32
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO pat_family_member
            (id_pat_family_member,
             id_pat_family,
             id_institution,
             id_patient,
    ...
    BEGIN
        ...
        ins(id_pat_family_member_in   => id_pat_family_member_in,
            ...
            id_pat_related_in         => id_pat_related_in,
    ...
    (
        ...
        l_rec pat_family_member%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_pat_family_member := next_key(sequence_in);
        END IF;
        ins(id_pat_family_member_in   => l_rec.id_pat_family_member,
            ...
            id_pat_related_in         => l_rec.id_pat_related,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN pat_family_member.id_pat_family_member%TYPE
     ...
     IS
        retval pat_family_member.id_pat_family_member%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_pat_family_member.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_PAT_FAMILY_MEMBER'));
    END next_key;
    ...
    (
        ...
        l_pky pat_family_member.id_pat_family_member%TYPE := next_key;
    BEGIN
        ins(id_pat_family_member_in   => l_pky,
            id_pat_family_in          => id_pat_family_in,
            id_institution_in         => id_institution_in,
            id_patient_in             => id_patient_in,
            id_family_relationship_in => id_family_relationship_in,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_pat_family_member_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_pat_family_in          => id_pat_family_in,
            ...
            notes_cancel_in           => notes_cancel_in,
            id_episode_in             => id_episode_in,
            id_pat_family_member_out  => id_pat_family_member_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) RETURN pat_family_member.id_pat_family_member%TYPE IS
        l_pky pat_family_member.id_pat_family_member%TYPE := next_key;
    BEGIN
        ins(id_pat_family_member_in   => l_pky,
            id_pat_family_in          => id_pat_family_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_PAT_FAMILY_MEMBER _' || indx,
                                                        value_in           => rows_in(indx).id_pat_family_member,
                                                        validate_in        => FALSE);
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_PAT_RELATED _' || indx,
                                                        value_in           => rows_in(indx).id_pat_related,
                                                        validate_in        => FALSE);
    ...
    BEGIN
        ...
        l_id_pat_related_n         := sys.diutil.bool_to_int(id_pat_related_nin);
        ...
        UPDATE pat_family_member
           SET id_pat_family          = decode(l_id_pat_family_n,
                                               0,
                                               id_pat_family_in,
               ...
               id_pat_related         = decode(l_id_pat_related_n,
                                               0,
                                               id_pat_related_in,
                                               nvl(id_pat_related_in, id_pat_related)),
         ...
         WHERE id_pat_family_member = id_pat_family_member_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_pat_family_member_in    => id_pat_family_member_in,
            id_pat_family_in           => id_pat_family_in,
            ...
            id_pat_related_in          => id_pat_related_in,
            id_pat_related_nin         => id_pat_related_nin,
            flg_status_in              => flg_status_in,
    ...
    (
        ...
        l_notes_cancel_n           NUMBER(1);
        l_id_episode_n             NUMBER(1);
        id_pat_family_member_in    pat_family_member.id_pat_family_member%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PAT_FAMILY_MEMBER SET ' || ' ID_PAT_FAMILY = decode (' || l_id_pat_family_n ||
                 ...
                 ' ID_PAT_RELATED = decode (' || l_id_pat_related_n ||
                 ',0,:id_pat_related_in, NVL (:id_pat_related_in, ID_PAT_RELATED)) ' || ',' || ' FLG_STATUS = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_pat_family_in, id_institution_in, id_patient_in, id_family_relationship_in, id_pat_related_in, flg_status_in, id_prof_cancel_in, dt_cancel_tstz_in, notes_cancel_in, id_episode_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_pat_family_member_in   => rec_in.id_pat_family_member,
            ...
            id_pat_related_in         => rec_in.id_pat_related,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_pat_family_member_in,
                id_pat_family_in,
                id_institution_in,
                id_patient_in,
                id_family_relationship_in,
    ...
    (
        ...
        l_id_pat_family_member   id_pat_family_member_cc;
        ...
        l_id_pat_related         id_pat_related_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_pat_family_member(i) := col_in(i).id_pat_family_member;
            ...
            l_id_pat_related(i) := col_in(i).id_pat_related;
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE pat_family_member
                   SET id_pat_family          = nvl(l_id_pat_family(i), id_pat_family),
                       ...
                       id_pat_related         = nvl(l_id_pat_related(i), id_pat_related),
                 ...
                 WHERE id_pat_family_member = l_id_pat_family_member(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE pat_family_member
                   SET id_pat_family          = l_id_pat_family(i),
                       ...
                       id_pat_related         = l_id_pat_related(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PAT_FAMILY_MEMBER
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PAT_FAMILY_MEMBER
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PAT_FAMILY_MEMBER set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PAT_FAMILY_MEMBER set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_pat_family_member_in => id_pat_family_member_in,
            handle_error_in         => handle_error_in,
            rows_out                => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_pat_family_member(id_pat_family_member_in => id_pat_family_member_in,
                                 handle_error_in         => handle_error_in,
                                 rows_out                => rows_out);
    END del_id_pat_family_member;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_prof_cancel = del_pfm_prof_cancel_fk.id_prof_cancel_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pfm_prof_cancel_fk(id_prof_cancel_in => id_prof_cancel_in,
                               handle_error_in   => handle_error_in,
                               rows_out          => rows_out);
    END del_pfm_prof_cancel_fk;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_episode = del_ptfmm_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptfmm_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ptfmm_epis_fk;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_family_relationship = del_ptfmm_frp_fk.id_family_relationship_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptfmm_frp_fk(id_family_relationship_in => id_family_relationship_in,
                         handle_error_in           => handle_error_in,
                         rows_out                  => rows_out);
    END del_ptfmm_frp_fk;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_institution = del_ptfmm_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptfmm_inst_fk(id_institution_in => id_institution_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_ptfmm_inst_fk;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_patient = del_ptfmm_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptfmm_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ptfmm_pat_fk;
    ...
    BEGIN
        DELETE FROM pat_family_member
         WHERE id_pat_family = del_ptfmm_ptfam_fk.id_pat_family_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ptfmm_ptfam_fk(id_pat_family_in => id_pat_family_in,
                           handle_error_in  => handle_error_in,
                           rows_out         => rows_out);
    END del_ptfmm_ptfam_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PAT_FAMILY_MEMBER';
        ELSE
            RETURN 'DELETE FROM PAT_FAMILY_MEMBER WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pat_family_member_inout IN OUT pat_family_member%ROWTYPE) IS
    BEGIN
        pat_family_member_inout.id_pat_family_member   := NULL;
        pat_family_member_inout.id_pat_family          := NULL;
        pat_family_member_inout.id_institution         := NULL;
        pat_family_member_inout.id_patient             := NULL;
        pat_family_member_inout.id_family_relationship := NULL;
        pat_family_member_inout.id_pat_related         := NULL;
        pat_family_member_inout.flg_status             := NULL;
        pat_family_member_inout.id_prof_cancel         := NULL;
        pat_family_member_inout.dt_cancel_tstz         := NULL;
        pat_family_member_inout.notes_cancel           := NULL;
        pat_family_member_inout.id_episode             := NULL;
    END initrec;

    FUNCTION initrec RETURN pat_family_member%ROWTYPE IS
        l_pat_family_member pat_family_member%ROWTYPE;
    BEGIN
        RETURN l_pat_family_member;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pat_family_member_tc IS
        data pat_family_member_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pat_family_member_tc IS
