/*-- Last Change Revision: $Rev: 2027911 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:40 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_adm_request
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2019-04-22 15:21:29
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN adm_request.id_adm_request%TYPE IS
        retval adm_request.id_adm_request%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_adm_request.nextval;
        ELSE
    ...
    (
        ...
        l_pky adm_request.id_adm_request%TYPE := next_key;
    BEGIN
        ins(id_adm_request_in         => l_pky,
            ...
            adm_indication_ft_in      => adm_indication_ft_in,
            id_co_sign_order_in       => id_co_sign_order_in,
            id_co_sign_cancel_in      => id_co_sign_cancel_in,
            id_mrp_in                 => id_mrp_in,
            id_written_by_in          => id_written_by_in,
            id_prof_speciality_adm_in => id_prof_speciality_adm_in,
    ...
    BEGIN
        ins(id_adm_indication_in      => id_adm_indication_in,
            id_dest_episode_in        => id_dest_episode_in,
            id_dest_prof_in           => id_dest_prof_in,
            id_dest_inst_in           => id_dest_inst_in,
            id_department_in          => id_department_in,
    ...
    BEGIN
        ins(id_adm_indication_in      => id_adm_indication_in,
            ...
            id_compulsory_reason_in   => id_compulsory_reason_in,
            compulsory_reason_in      => compulsory_reason_in,
            id_adm_request_out        => id_adm_request_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN adm_request.id_adm_request%TYPE IS
        l_pky adm_request.id_adm_request%TYPE := next_key;
    BEGIN
        ins(id_adm_request_in         => l_pky,
            id_adm_indication_in      => id_adm_indication_in,
    ...
    BEGIN
        ...
        VALUES
            (id_adm_request_in,
             ...
             flg_contact_in,
             flg_precauc_in,
             adm_indication_ft_in,
             id_co_sign_order_in,
             id_co_sign_cancel_in,
             id_mrp_in,
             id_written_by_in,
             id_prof_speciality_adm_in,
             flg_compulsory_in,
    ...
    (
        ...
        l_rec adm_request%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_adm_request := next_key(sequence_in);
        END IF;
    
        ins(id_adm_request_in         => l_rec.id_adm_request,
            ...
            adm_indication_ft_in      => l_rec.adm_indication_ft,
            id_co_sign_order_in       => l_rec.id_co_sign_order,
            id_co_sign_cancel_in      => l_rec.id_co_sign_cancel,
            id_mrp_in                 => l_rec.id_mrp,
            id_written_by_in          => l_rec.id_written_by,
            id_prof_speciality_adm_in => l_rec.id_prof_speciality_adm,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                ...
                VALUES
                    (rows_in(indx).id_adm_request,
                     ...
                     rows_in(indx).adm_indication_ft,
                     rows_in(indx).id_co_sign_order,
                     rows_in(indx).id_co_sign_cancel,
                     rows_in(indx).id_mrp,
                     rows_in(indx).id_written_by,
                     rows_in(indx).id_prof_speciality_adm,
    ...
    (
        ...
        l_adm_indication_ft_n      NUMBER(1) := sys.diutil.bool_to_int(adm_indication_ft_nin);
        ...
        l_id_mrp_n                 NUMBER(1) := sys.diutil.bool_to_int(id_mrp_nin);
        l_id_written_by_n          NUMBER(1) := sys.diutil.bool_to_int(id_written_by_nin);
        l_id_prof_speciality_adm_n NUMBER(1) := sys.diutil.bool_to_int(id_prof_speciality_adm_nin);
    ...
    BEGIN
        ...
        UPDATE adm_request
           SET id_adm_indication      = decode(l_id_adm_indication_n,
                                               0,
                                               id_adm_indication_in,
               ...
               adm_indication_ft      = decode(l_adm_indication_ft_n,
                                               0,
                                               adm_indication_ft_in,
                                               nvl(adm_indication_ft_in, adm_indication_ft)),
               ...
               id_mrp                 = decode(l_id_mrp_n, 0, id_mrp_in, nvl(id_mrp_in, id_mrp)),
               id_written_by          = decode(l_id_written_by_n,
                                               0,
                                               id_written_by_in,
                                               nvl(id_written_by_in, id_written_by)),
               id_prof_speciality_adm = decode(l_id_prof_speciality_adm_n,
                                               0,
                                               id_prof_speciality_adm_in,
                                               nvl(id_prof_speciality_adm_in, id_prof_speciality_adm)),
    ...
    BEGIN
        upd(id_adm_request_in          => id_adm_request_in,
            ...
            adm_indication_ft_in       => adm_indication_ft_in,
            adm_indication_ft_nin      => adm_indication_ft_nin,
            id_co_sign_order_in        => id_co_sign_order_in,
            id_co_sign_order_nin       => id_co_sign_order_nin,
            id_co_sign_cancel_in       => id_co_sign_cancel_in,
            id_co_sign_cancel_nin      => id_co_sign_cancel_nin,
            id_mrp_in                  => id_mrp_in,
            id_mrp_nin                 => id_mrp_nin,
            id_written_by_in           => id_written_by_in,
            id_written_by_nin          => id_written_by_nin,
            id_prof_speciality_adm_in  => id_prof_speciality_adm_in,
            id_prof_speciality_adm_nin => id_prof_speciality_adm_nin,
            flg_compulsory_in          => flg_compulsory_in,
    ...
    BEGIN
        ...
        l_adm_indication_ft_n      := sys.diutil.bool_to_int(adm_indication_ft_nin);
        ...
        l_id_mrp_n                 := sys.diutil.bool_to_int(id_mrp_nin);
        l_id_written_by_n          := sys.diutil.bool_to_int(id_written_by_nin);
        l_id_prof_speciality_adm_n := sys.diutil.bool_to_int(id_prof_speciality_adm_nin);
        ...
        l_sql                      := 'UPDATE adm_request SET' || ' ID_ADM_INDICATION = decode (' ||
                                      l_id_adm_indication_n ||
                                      ...
                                      ' ADM_INDICATION_FT = decode (' || l_adm_indication_ft_n ||
                                      ',0,:ADM_INDICATION_FT_in, NVL (:ADM_INDICATION_FT_in, ADM_INDICATION_FT)) ' || ',' ||
                                      ' ID_CO_SIGN_ORDER = decode (' || l_id_co_sign_order_n ||
                                      ...
                                      ' ID_MRP = decode (' || l_id_mrp_n || ',0,:ID_MRP_in, NVL (:ID_MRP_in, ID_MRP)) ' || ',' ||
                                      ' ID_WRITTEN_BY = decode (' || l_id_written_by_n ||
                                      ',0,:ID_WRITTEN_BY_in, NVL (:ID_WRITTEN_BY_in, ID_WRITTEN_BY)) ' || ',' ||
                                      ' ID_PROF_SPECIALITY_ADM = decode (' || l_id_prof_speciality_adm_n ||
                                      ',0,:ID_PROF_SPECIALITY_ADM_in, NVL (:ID_PROF_SPECIALITY_ADM_in, ID_PROF_SPECIALITY_ADM)) ' || ',' ||
                                      ' FLG_COMPULSORY = decode (' || l_flg_compulsory_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_adm_indication_in, id_dest_episode_in, id_dest_prof_in, id_dest_inst_in, id_department_in, id_dep_clin_serv_in, id_room_type_in, id_pref_room_in, id_admission_type_in, expected_duration_in, id_adm_preparation_in, flg_mixed_nursing_in, id_bed_type_in, dt_admission_in, flg_nit_in, dt_nit_suggested_in, id_nit_dcs_in, id_nit_req_in, notes_in, flg_status_in, id_upd_episode_in, id_upd_prof_in, id_upd_inst_in, dt_upd_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, flg_regim_in, flg_benefi_in, flg_contact_in, flg_precauc_in, adm_indication_ft_in, id_co_sign_order_in, id_co_sign_cancel_in, id_mrp_in, id_written_by_in, id_prof_speciality_adm_in, flg_compulsory_in, id_compulsory_reason_in, compulsory_reason_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_adm_indication_in       => id_adm_indication_in,
            id_adm_indication_nin      => id_adm_indication_nin,
            id_dest_episode_in         => id_dest_episode_in,
            id_dest_episode_nin        => id_dest_episode_nin,
            id_dest_prof_in            => id_dest_prof_in,
    ...
    BEGIN
        upd(id_adm_request_in         => rec_in.id_adm_request,
            ...
            adm_indication_ft_in      => rec_in.adm_indication_ft,
            id_co_sign_order_in       => rec_in.id_co_sign_order,
            id_co_sign_cancel_in      => rec_in.id_co_sign_cancel,
            id_mrp_in                 => rec_in.id_mrp,
            id_written_by_in          => rec_in.id_written_by,
            id_prof_speciality_adm_in => rec_in.id_prof_speciality_adm,
    ...
    (
        ...
        l_adm_indication_ft      adm_indication_ft_cc;
        l_id_co_sign_order       id_co_sign_order_cc;
        l_id_co_sign_cancel      id_co_sign_cancel_cc;
        l_id_mrp                 id_mrp_cc;
        l_id_written_by          id_written_by_cc;
        l_id_prof_speciality_adm id_prof_speciality_adm_cc;
    ...
    BEGIN
        ...
        LOOP
            ...
            l_adm_indication_ft(i) := col_in(i).adm_indication_ft;
            l_id_co_sign_order(i) := col_in(i).id_co_sign_order;
            l_id_co_sign_cancel(i) := col_in(i).id_co_sign_cancel;
            l_id_mrp(i) := col_in(i).id_mrp;
            l_id_written_by(i) := col_in(i).id_written_by;
            l_id_prof_speciality_adm(i) := col_in(i).id_prof_speciality_adm;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE adm_request
                   SET id_adm_indication      = nvl(l_id_adm_indication(i), id_adm_indication),
                       ...
                       adm_indication_ft      = nvl(l_adm_indication_ft(i), adm_indication_ft),
                       id_co_sign_order       = nvl(l_id_co_sign_order(i), id_co_sign_order),
                       id_co_sign_cancel      = nvl(l_id_co_sign_cancel(i), id_co_sign_cancel),
                       id_mrp                 = nvl(l_id_mrp(i), id_mrp),
                       id_written_by          = nvl(l_id_written_by(i), id_written_by),
                       id_prof_speciality_adm = nvl(l_id_prof_speciality_adm(i), id_prof_speciality_adm),
                 ...
                 WHERE id_adm_request = l_id_adm_request(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE adm_request
                   SET id_adm_indication      = l_id_adm_indication(i),
                       ...
                       adm_indication_ft      = l_adm_indication_ft(i),
                       id_co_sign_order       = l_id_co_sign_order(i),
                       id_co_sign_cancel      = l_id_co_sign_cancel(i),
                       id_mrp                 = l_id_mrp(i),
                       id_written_by          = l_id_written_by(i),
                       id_prof_speciality_adm = l_id_prof_speciality_adm(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE adm_request
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE adm_request
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE adm_request
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_adm_request_in => id_adm_request_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_admission_type = id_admission_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_bed_type = id_bed_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_dest_episode = id_dest_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_dest_inst = id_dest_inst_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_dest_prof = id_dest_prof_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_nit_dcs = id_nit_dcs_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_nit_req = id_nit_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_pref_room = id_pref_room_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_upd_episode = id_upd_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_upd_inst = id_upd_inst_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_upd_prof = id_upd_prof_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM adm_request
         WHERE id_adm_indication = id_adm_indication_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_aprep_fk(id_adm_preparation_in => id_adm_preparation_in,
                          handle_error_in       => handle_error_in,
                          rows_out              => rows_out);
    END del_ared_aprep_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_aty_fk(id_admission_type_in => id_admission_type_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_ared_aty_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_bty_fk(id_bed_type_in => id_bed_type_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_bty_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_dcs_fk(id_dep_clin_serv_in => id_dep_clin_serv_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_ared_dcs_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_depis_fk(id_dest_episode_in => id_dest_episode_in,
                          handle_error_in    => handle_error_in,
                          rows_out           => rows_out);
    END del_ared_depis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_dep_fk(id_department_in => id_department_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_dep_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_dinst_fk(id_dest_inst_in => id_dest_inst_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_dinst_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_dprf_fk(id_dest_prof_in => id_dest_prof_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_dprf_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_ndcs_fk(id_nit_dcs_in => id_nit_dcs_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_ndcs_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_nreq_fk(id_nit_req_in => id_nit_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_nreq_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_prm_fk(id_pref_room_in => id_pref_room_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_prm_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_rty_fk(id_room_type_in => id_room_type_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_rty_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_uepis_fk(id_upd_episode_in => id_upd_episode_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_ared_uepis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_uinst_fk(id_upd_inst_in => id_upd_inst_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_uinst_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ared_uprf_fk(id_upd_prof_in => id_upd_prof_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ared_uprf_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_areq_ain_fk(id_adm_indication_in => id_adm_indication_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_areq_ain_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM adm_request';
        ELSE
            RETURN 'DELETE FROM adm_request WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(adm_request_inout IN OUT adm_request%ROWTYPE) IS
    BEGIN
        adm_request_inout.id_adm_request         := NULL;
        adm_request_inout.id_adm_indication      := NULL;
        adm_request_inout.id_dest_episode        := NULL;
        adm_request_inout.id_dest_prof           := NULL;
        adm_request_inout.id_dest_inst           := NULL;
        adm_request_inout.id_department          := NULL;
        adm_request_inout.id_dep_clin_serv       := NULL;
        adm_request_inout.id_room_type           := NULL;
        adm_request_inout.id_pref_room           := NULL;
        adm_request_inout.id_admission_type      := NULL;
        adm_request_inout.expected_duration      := NULL;
        adm_request_inout.id_adm_preparation     := NULL;
        adm_request_inout.flg_mixed_nursing      := NULL;
        adm_request_inout.id_bed_type            := NULL;
        adm_request_inout.dt_admission           := NULL;
        adm_request_inout.flg_nit                := NULL;
        adm_request_inout.dt_nit_suggested       := NULL;
        adm_request_inout.id_nit_dcs             := NULL;
        adm_request_inout.id_nit_req             := NULL;
        adm_request_inout.notes                  := NULL;
        adm_request_inout.flg_status             := NULL;
        adm_request_inout.id_upd_episode         := NULL;
        adm_request_inout.id_upd_prof            := NULL;
        adm_request_inout.id_upd_inst            := NULL;
        adm_request_inout.dt_upd                 := NULL;
        adm_request_inout.create_user            := NULL;
        adm_request_inout.create_time            := NULL;
        adm_request_inout.create_institution     := NULL;
        adm_request_inout.update_user            := NULL;
        adm_request_inout.update_time            := NULL;
        adm_request_inout.update_institution     := NULL;
        adm_request_inout.flg_regim              := NULL;
        adm_request_inout.flg_benefi             := NULL;
        adm_request_inout.flg_contact            := NULL;
        adm_request_inout.flg_precauc            := NULL;
        adm_request_inout.adm_indication_ft      := NULL;
        adm_request_inout.id_co_sign_order       := NULL;
        adm_request_inout.id_co_sign_cancel      := NULL;
        adm_request_inout.id_mrp                 := NULL;
        adm_request_inout.id_written_by          := NULL;
        adm_request_inout.id_prof_speciality_adm := NULL;
        adm_request_inout.flg_compulsory         := NULL;
        adm_request_inout.id_compulsory_reason   := NULL;
        adm_request_inout.compulsory_reason      := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN adm_request%ROWTYPE IS
        l_adm_request adm_request%ROWTYPE;
    BEGIN
        RETURN l_adm_request;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN adm_request_tc IS
        data adm_request_tc;
    BEGIN
        SELECT *
          BULK COLLECT
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN adm_request_tc IS
        data adm_request_tc;
