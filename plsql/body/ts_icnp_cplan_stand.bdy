/*-- Last Change Revision: $Rev: 2028206 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:28 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_icnp_cplan_stand
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Setembro 28, 2010 16:55:20
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        ins(id_cplan_stand_in     => id_cplan_stand_in,
            ...
            dt_care_plan_stand_in => dt_care_plan_stand_in,
    ...
    (
        ...
        l_rec icnp_cplan_stand%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_cplan_stand := next_key(sequence_in);
        END IF;
        ins(id_cplan_stand_in     => l_rec.id_cplan_stand,
            name_in               => l_rec.name,
            notes_in              => l_rec.notes,
            flg_status_in         => l_rec.flg_status,
            dt_care_plan_stand_in => l_rec.dt_care_plan_stand,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN icnp_cplan_stand.id_cplan_stand%TYPE
     ...
     IS
        retval icnp_cplan_stand.id_cplan_stand%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_icnp_cplan_stand.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_ICNP_CPLAN_STAND'));
    END next_key;
    ...
    (
        ...
        l_pky icnp_cplan_stand.id_cplan_stand%TYPE := next_key;
    BEGIN
        ins(id_cplan_stand_in     => l_pky,
            name_in               => name_in,
            notes_in              => notes_in,
            flg_status_in         => flg_status_in,
            dt_care_plan_stand_in => dt_care_plan_stand_in,
    ...
    BEGIN
        ins(name_in               => name_in,
            ...
            update_time_in        => update_time_in,
            update_institution_in => update_institution_in,
            id_cplan_stand_out    => id_cplan_stand_out,
            handle_error_in       => handle_error_in,
            rows_out              => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN icnp_cplan_stand.id_cplan_stand%TYPE IS
        l_pky icnp_cplan_stand.id_cplan_stand%TYPE := next_key;
    BEGIN
        ins(id_cplan_stand_in     => l_pky,
            name_in               => name_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_CARE_PLAN_STAND _' || indx,
                                                        value_in           => rows_in(indx).dt_care_plan_stand,
                                                        validate_in        => FALSE);
    ...
    (
        ...
        l_dt_care_plan_stand_n NUMBER(1);
    ...
    BEGIN
        ...
        l_dt_care_plan_stand_n := sys.diutil.bool_to_int(dt_care_plan_stand_nin);
    ...
    BEGIN
        upd(id_cplan_stand_in      => id_cplan_stand_in,
            ...
            dt_care_plan_stand_in  => dt_care_plan_stand_in,
            dt_care_plan_stand_nin => dt_care_plan_stand_nin,
            id_professional_in     => id_professional_in,
    ...
    (
        ...
        l_update_time_n        NUMBER(1);
        l_update_institution_n NUMBER(1);
        id_cplan_stand_in      icnp_cplan_stand.id_cplan_stand%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE ICNP_CPLAN_STAND SET ' || ' NAME = decode (' || l_name_n ||
                 ',0,:name_in, NVL (:name_in, NAME)) ' || ',' || ' NOTES = decode (' || l_notes_n ||
                 ',0,:notes_in, NVL (:notes_in, NOTES)) ' || ',' || ' FLG_STATUS = decode (' || l_flg_status_n ||
                 ',0,:flg_status_in, NVL (:flg_status_in, FLG_STATUS)) ' || ',' || ' DT_CARE_PLAN_STAND = decode (' ||
                 l_dt_care_plan_stand_n ||
                 ',0,:dt_care_plan_stand_in, NVL (:dt_care_plan_stand_in, DT_CARE_PLAN_STAND)) ' || ',' ||
                 ' ID_PROFESSIONAL = decode (' || l_id_professional_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN name_in, notes_in, flg_status_in, dt_care_plan_stand_in, id_professional_in, id_institution_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_cplan_stand_in     => rec_in.id_cplan_stand,
            name_in               => rec_in.name,
            notes_in              => rec_in.notes,
            flg_status_in         => rec_in.flg_status,
            dt_care_plan_stand_in => rec_in.dt_care_plan_stand,
    ...
    (
        ...
        l_dt_care_plan_stand dt_care_plan_stand_cc;
    ...
    BEGIN
        ...
        LOOP
            ...
            l_dt_care_plan_stand(i) := col_in(i).dt_care_plan_stand;
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE icnp_cplan_stand
                   SET name               = nvl(l_name(i), name),
                       ...
                       dt_care_plan_stand = nvl(l_dt_care_plan_stand(i), dt_care_plan_stand),
                 ...
                 WHERE id_cplan_stand = l_id_cplan_stand(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE icnp_cplan_stand
                   SET name               = l_name(i),
                       ...
                       dt_care_plan_stand = l_dt_care_plan_stand(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE ICNP_CPLAN_STAND
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE ICNP_CPLAN_STAND
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE ICNP_CPLAN_STAND set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE ICNP_CPLAN_STAND set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_cplan_stand_in => id_cplan_stand_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_cplan_stand(id_cplan_stand_in => id_cplan_stand_in,
                           handle_error_in   => handle_error_in,
                           rows_out          => rows_out);
    END del_id_cplan_stand;
    ...
    BEGIN
        DELETE FROM icnp_cplan_stand
         WHERE id_institution = del_icps_inn_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_icps_inn_fk(id_institution_in => id_institution_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_icps_inn_fk;
    ...
    BEGIN
        DELETE FROM icnp_cplan_stand
         WHERE id_professional = del_icps_prl_fk.id_professional_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_icps_prl_fk(id_professional_in => id_professional_in,
                        handle_error_in    => handle_error_in,
                        rows_out           => rows_out);
    END del_icps_prl_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM ICNP_CPLAN_STAND';
        ELSE
            RETURN 'DELETE FROM ICNP_CPLAN_STAND WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(icnp_cplan_stand_inout IN OUT icnp_cplan_stand%ROWTYPE) IS
    BEGIN
        icnp_cplan_stand_inout.id_cplan_stand     := NULL;
        icnp_cplan_stand_inout.name               := NULL;
        icnp_cplan_stand_inout.notes              := NULL;
        icnp_cplan_stand_inout.flg_status         := NULL;
        icnp_cplan_stand_inout.dt_care_plan_stand := NULL;
        icnp_cplan_stand_inout.id_professional    := NULL;
        icnp_cplan_stand_inout.id_institution     := NULL;
        icnp_cplan_stand_inout.create_user        := NULL;
        icnp_cplan_stand_inout.create_time        := NULL;
        icnp_cplan_stand_inout.create_institution := NULL;
        icnp_cplan_stand_inout.update_user        := NULL;
        icnp_cplan_stand_inout.update_time        := NULL;
        icnp_cplan_stand_inout.update_institution := NULL;
    END initrec;

    FUNCTION initrec RETURN icnp_cplan_stand%ROWTYPE IS
        l_icnp_cplan_stand icnp_cplan_stand%ROWTYPE;
    BEGIN
        RETURN l_icnp_cplan_stand;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN icnp_cplan_stand_tc IS
        data icnp_cplan_stand_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM icnp_cplan_stand
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN icnp_cplan_stand_tc IS
