/*-- Last Change Revision: $Rev: 2028039 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:01 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_epis_diagnosis
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2017-10-23 11:13:50
| Created By: ALERT
*/
IS
...
IS
retval epis_diagnosis.ID_EPIS_DIAGNOSIS%TYPE;
BEGIN
IF sequence_in IS NULL
THEN
retval := seq_epis_diagnosis.NEXTVAL;
ELSE
...
IS
l_pky epis_diagnosis.ID_EPIS_DIAGNOSIS%TYPE := next_key;
BEGIN
ins(
ID_EPIS_DIAGNOSIS_IN => l_pky,
...
DESC_EPIS_DIAGNOSIS_IN => DESC_EPIS_DIAGNOSIS_IN,
...
DT_EPIS_DIAGNOSIS_TSTZ_IN => DT_EPIS_DIAGNOSIS_TSTZ_IN,
...
ID_LESION_TYPE_INST_OWNER_IN => ID_LESION_TYPE_INST_OWNER_IN,
RANK_IN => RANK_IN,
ID_EPIS_DIAGNOSIS_OUT => ID_EPIS_DIAGNOSIS_OUT,
handle_error_in       => handle_error_in,
rows_out              => rows_out);
END ins;
...
l_rec epis_diagnosis%ROWTYPE := rec_in;
BEGIN
IF gen_pky_in
THEN
l_rec.ID_EPIS_DIAGNOSIS := next_key(sequence_in);
END IF;
...
DESC_EPIS_DIAGNOSIS_IN => l_rec.DESC_EPIS_DIAGNOSIS,
...
DT_EPIS_DIAGNOSIS_TSTZ_IN => l_rec.DT_EPIS_DIAGNOSIS_TSTZ,
...
l_ID_PROFESSIONAL_DIAG_n number(1) := sys.diutil.bool_to_int(ID_PROFESSIONAL_DIAG_nin);
l_ID_PROFESSIONAL_CANCEL_n number(1) := sys.diutil.bool_to_int(ID_PROFESSIONAL_CANCEL_nin);
...
l_DESC_EPIS_DIAGNOSIS_n number(1) := sys.diutil.bool_to_int(DESC_EPIS_DIAGNOSIS_nin);
l_ID_PROF_CONFIRMED_n number(1) := sys.diutil.bool_to_int(ID_PROF_CONFIRMED_nin);
l_ID_PROF_RULLED_OUT_n number(1) := sys.diutil.bool_to_int(ID_PROF_RULLED_OUT_nin);
l_ID_PROF_BASE_n number(1) := sys.diutil.bool_to_int(ID_PROF_BASE_nin);
...
l_DT_EPIS_DIAGNOSIS_TSTZ_n number(1) := sys.diutil.bool_to_int(DT_EPIS_DIAGNOSIS_TSTZ_nin);
l_DT_CANCEL_TSTZ_n number(1) := sys.diutil.bool_to_int(DT_CANCEL_TSTZ_nin);
l_DT_RULLED_OUT_TSTZ_n number(1) := sys.diutil.bool_to_int(DT_RULLED_OUT_TSTZ_nin);
l_DT_CONFIRMED_TSTZ_n number(1) := sys.diutil.bool_to_int(DT_CONFIRMED_TSTZ_nin);
l_DT_BASE_TSTZ_n number(1) := sys.diutil.bool_to_int(DT_BASE_TSTZ_nin);
...
ID_PROFESSIONAL_DIAG = decode(l_ID_PROFESSIONAL_DIAG_n, 0, ID_PROFESSIONAL_DIAG_in, nvl(ID_PROFESSIONAL_DIAG_in, ID_PROFESSIONAL_DIAG)),
ID_PROFESSIONAL_CANCEL = decode(l_ID_PROFESSIONAL_CANCEL_n, 0, ID_PROFESSIONAL_CANCEL_in, nvl(ID_PROFESSIONAL_CANCEL_in, ID_PROFESSIONAL_CANCEL)),
...
DESC_EPIS_DIAGNOSIS = decode(l_DESC_EPIS_DIAGNOSIS_n, 0, DESC_EPIS_DIAGNOSIS_in, nvl(DESC_EPIS_DIAGNOSIS_in, DESC_EPIS_DIAGNOSIS)),
ID_PROF_CONFIRMED = decode(l_ID_PROF_CONFIRMED_n, 0, ID_PROF_CONFIRMED_in, nvl(ID_PROF_CONFIRMED_in, ID_PROF_CONFIRMED)),
ID_PROF_RULLED_OUT = decode(l_ID_PROF_RULLED_OUT_n, 0, ID_PROF_RULLED_OUT_in, nvl(ID_PROF_RULLED_OUT_in, ID_PROF_RULLED_OUT)),
...
DT_EPIS_DIAGNOSIS_TSTZ = decode(l_DT_EPIS_DIAGNOSIS_TSTZ_n, 0, DT_EPIS_DIAGNOSIS_TSTZ_in, nvl(DT_EPIS_DIAGNOSIS_TSTZ_in, DT_EPIS_DIAGNOSIS_TSTZ)),
DT_CANCEL_TSTZ = decode(l_DT_CANCEL_TSTZ_n, 0, DT_CANCEL_TSTZ_in, nvl(DT_CANCEL_TSTZ_in, DT_CANCEL_TSTZ)),
DT_RULLED_OUT_TSTZ = decode(l_DT_RULLED_OUT_TSTZ_n, 0, DT_RULLED_OUT_TSTZ_in, nvl(DT_RULLED_OUT_TSTZ_in, DT_RULLED_OUT_TSTZ)),
DT_CONFIRMED_TSTZ = decode(l_DT_CONFIRMED_TSTZ_n, 0, DT_CONFIRMED_TSTZ_in, nvl(DT_CONFIRMED_TSTZ_in, DT_CONFIRMED_TSTZ)),
...
ID_ALERT_DIAGNOSIS = decode(l_ID_ALERT_DIAGNOSIS_n, 0, ID_ALERT_DIAGNOSIS_in, nvl(ID_ALERT_DIAGNOSIS_in, ID_ALERT_DIAGNOSIS)),
...
ID_ADIAG_INST_OWNER = decode(l_ID_ADIAG_INST_OWNER_n, 0, ID_ADIAG_INST_OWNER_in, nvl(ID_ADIAG_INST_OWNER_in, ID_ADIAG_INST_OWNER)),
ID_DIAG_INST_OWNER = decode(l_ID_DIAG_INST_OWNER_n, 0, ID_DIAG_INST_OWNER_in, nvl(ID_DIAG_INST_OWNER_in, ID_DIAG_INST_OWNER)),
...
DESC_EPIS_DIAGNOSIS_IN => DESC_EPIS_DIAGNOSIS_IN,
DESC_EPIS_DIAGNOSIS_NIN => DESC_EPIS_DIAGNOSIS_NIN,
ID_PROF_CONFIRMED_IN => ID_PROF_CONFIRMED_IN,
...
DT_EPIS_DIAGNOSIS_TSTZ_IN => DT_EPIS_DIAGNOSIS_TSTZ_IN,
DT_EPIS_DIAGNOSIS_TSTZ_NIN => DT_EPIS_DIAGNOSIS_TSTZ_NIN,
DT_CANCEL_TSTZ_IN => DT_CANCEL_TSTZ_IN,
...
l_DESC_EPIS_DIAGNOSIS_n := sys.diutil.bool_to_int(DESC_EPIS_DIAGNOSIS_nin);
...
l_DT_EPIS_DIAGNOSIS_TSTZ_n := sys.diutil.bool_to_int(DT_EPIS_DIAGNOSIS_TSTZ_nin);
...
l_sql := 'UPDATE epis_diagnosis SET' ||
' ID_EPISODE = decode (' || l_ID_EPISODE_n || ',0,:ID_EPISODE_in, NVL (:ID_EPISODE_in, ID_EPISODE)) ' ||',' ||
' ID_DIAGNOSIS = decode (' || l_ID_DIAGNOSIS_n || ',0,:ID_DIAGNOSIS_in, NVL (:ID_DIAGNOSIS_in, ID_DIAGNOSIS)) ' ||',' ||
' ID_PROFESSIONAL_DIAG = decode (' || l_ID_PROFESSIONAL_DIAG_n || ',0,:ID_PROFESSIONAL_DIAG_in, NVL (:ID_PROFESSIONAL_DIAG_in, ID_PROFESSIONAL_DIAG)) ' ||',' ||
' ID_PROFESSIONAL_CANCEL = decode (' || l_ID_PROFESSIONAL_CANCEL_n || ',0,:ID_PROFESSIONAL_CANCEL_in, NVL (:ID_PROFESSIONAL_CANCEL_in, ID_PROFESSIONAL_CANCEL)) ' ||',' ||
...
DESC_EPIS_DIAGNOSIS_IN => rec_in.DESC_EPIS_DIAGNOSIS,
...
DT_EPIS_DIAGNOSIS_TSTZ_IN => rec_in.DT_EPIS_DIAGNOSIS_TSTZ,
...
l_DESC_EPIS_DIAGNOSIS DESC_EPIS_DIAGNOSIS_CC;
...
l_DT_EPIS_DIAGNOSIS_TSTZ DT_EPIS_DIAGNOSIS_TSTZ_CC;
...
l_DESC_EPIS_DIAGNOSIS(i) := col_in(i).DESC_EPIS_DIAGNOSIS;
...
l_DT_EPIS_DIAGNOSIS_TSTZ(i) := col_in(i).DT_EPIS_DIAGNOSIS_TSTZ;
...
DESC_EPIS_DIAGNOSIS = nvl(l_DESC_EPIS_DIAGNOSIS(i), DESC_EPIS_DIAGNOSIS),
...
DT_EPIS_DIAGNOSIS_TSTZ = nvl(l_DT_EPIS_DIAGNOSIS_TSTZ(i), DT_EPIS_DIAGNOSIS_TSTZ),
...
DESC_EPIS_DIAGNOSIS = l_DESC_EPIS_DIAGNOSIS(i),
...
DT_EPIS_DIAGNOSIS_TSTZ = l_DT_EPIS_DIAGNOSIS_TSTZ(i),
...
RETURN VARCHAR2 IS
BEGIN
RETURN 'BEGIN UPDATE epis_diagnosis
...
is
begin
EXECUTE IMMEDIATE 'BEGIN UPDATE epis_diagnosis
...
rows_out table_varchar;
begin
EXECUTE IMMEDIATE 'UPDATE epis_diagnosis
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in,1) ||
...
DELETE FROM epis_diagnosis
 WHERE
ID_ADIAG_INST_OWNER = ID_ADIAG_INST_OWNER_in AND 
ID_ALERT_DIAGNOSIS = ID_ALERT_DIAGNOSIS_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_DIAG_INST_OWNER = ID_DIAG_INST_OWNER_in AND 
ID_DIAGNOSIS = ID_DIAGNOSIS_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_LESION_LOCAT_INST_OWNER = ID_LESION_LOCAT_INST_OWNER_in AND 
ID_LESION_LOCATION = ID_LESION_LOCATION_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_PROFESSIONAL_DIAG = ID_PROFESSIONAL_DIAG_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_PROFESSIONAL_CANCEL = ID_PROFESSIONAL_CANCEL_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_PROF_CONFIRMED = ID_PROF_CONFIRMED_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
DELETE FROM epis_diagnosis
 WHERE
ID_PROF_RULLED_OUT = ID_PROF_RULLED_OUT_in
 RETURNING ROWID BULK COLLECT INTO rows_out;
...
IF where_in IS NULL
THEN
RETURN 'DELETE FROM epis_diagnosis';
ELSE
RETURN 'DELETE FROM epis_diagnosis WHERE ' || where_in;
END IF;
end dyndelstr;
...
is
begin
epis_diagnosis_inout.ID_EPIS_DIAGNOSIS := NULL;
epis_diagnosis_inout.ID_EPISODE := NULL;
epis_diagnosis_inout.ID_DIAGNOSIS := NULL;
epis_diagnosis_inout.ID_PROFESSIONAL_DIAG := NULL;
epis_diagnosis_inout.ID_PROFESSIONAL_CANCEL := NULL;
epis_diagnosis_inout.FLG_TYPE := NULL;
epis_diagnosis_inout.FLG_STATUS := NULL;
epis_diagnosis_inout.NOTES := NULL;
epis_diagnosis_inout.NOTES_CANCEL := NULL;
epis_diagnosis_inout.DESC_EPIS_DIAGNOSIS := NULL;
epis_diagnosis_inout.ID_PROF_CONFIRMED := NULL;
epis_diagnosis_inout.ID_PROF_RULLED_OUT := NULL;
epis_diagnosis_inout.ID_PROF_BASE := NULL;
epis_diagnosis_inout.FLG_FINAL_TYPE := NULL;
epis_diagnosis_inout.ID_EPIS_DIAGNOSIS_NOTES := NULL;
epis_diagnosis_inout.DT_EPIS_DIAGNOSIS_TSTZ := NULL;
epis_diagnosis_inout.DT_CANCEL_TSTZ := NULL;
epis_diagnosis_inout.DT_RULLED_OUT_TSTZ := NULL;
epis_diagnosis_inout.DT_CONFIRMED_TSTZ := NULL;
epis_diagnosis_inout.DT_BASE_TSTZ := NULL;
epis_diagnosis_inout.ID_PATIENT := NULL;
epis_diagnosis_inout.ID_CANCEL_REASON := NULL;
epis_diagnosis_inout.CREATE_USER := NULL;
epis_diagnosis_inout.CREATE_TIME := NULL;
epis_diagnosis_inout.CREATE_INSTITUTION := NULL;
epis_diagnosis_inout.UPDATE_USER := NULL;
epis_diagnosis_inout.UPDATE_TIME := NULL;
epis_diagnosis_inout.UPDATE_INSTITUTION := NULL;
epis_diagnosis_inout.ID_ALERT_DIAGNOSIS := NULL;
epis_diagnosis_inout.ID_EPISODE_ORIGIN := NULL;
epis_diagnosis_inout.FLG_ADD_PROBLEM := NULL;
epis_diagnosis_inout.ID_CDR_CALL := NULL;
epis_diagnosis_inout.ID_ADIAG_INST_OWNER := NULL;
epis_diagnosis_inout.ID_DIAG_INST_OWNER := NULL;
epis_diagnosis_inout.DT_INITIAL_DIAG := NULL;
epis_diagnosis_inout.ID_DIAG_BASIS := NULL;
epis_diagnosis_inout.ID_DBASIS_INST_OWNER := NULL;
epis_diagnosis_inout.DIAG_BASIS_SPEC := NULL;
epis_diagnosis_inout.FLG_RECURRENCE := NULL;
epis_diagnosis_inout.FLG_MULT_TUMORS := NULL;
epis_diagnosis_inout.NUM_PRIMARY_TUMORS := NULL;
epis_diagnosis_inout.ID_SUB_ANALYSIS := NULL;
epis_diagnosis_inout.ID_SUBANALY_INST_OWNER := NULL;
epis_diagnosis_inout.ID_ANATOMICAL_AREA := NULL;
epis_diagnosis_inout.ID_ANATAREA_INST_OWNER := NULL;
epis_diagnosis_inout.ID_ANATOMICAL_SIDE := NULL;
epis_diagnosis_inout.ID_ANATSIDE_INST_OWNER := NULL;
epis_diagnosis_inout.ID_DIAGNOSIS_CONDITION := NULL;
epis_diagnosis_inout.ID_DIAGCOND_INST_OWNER := NULL;
epis_diagnosis_inout.ID_LESION_LOCATION := NULL;
epis_diagnosis_inout.ID_LESION_LOCAT_INST_OWNER := NULL;
epis_diagnosis_inout.ID_LESION_TYPE := NULL;
epis_diagnosis_inout.ID_LESION_TYPE_INST_OWNER := NULL;
epis_diagnosis_inout.RANK := NULL;
end initrec;

-- Initialize a record with default values for columns in the table (fnc)
FUNCTION initrec RETURN epis_diagnosis%ROWTYPE
is
l_epis_diagnosis epis_diagnosis%ROWTYPE;
begin
...
is
data epis_diagnosis_tc;
begin
select * bulk collect into data from epis_diagnosis
