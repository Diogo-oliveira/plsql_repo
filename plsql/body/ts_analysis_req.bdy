...
*/
 IS
    ...
    PROCEDURE ins
    (
        id_analysis_req_in        IN analysis_req.id_analysis_req%TYPE,
        id_episode_in             IN analysis_req.id_episode%TYPE DEFAULT NULL,
        id_prof_writes_in         IN analysis_req.id_prof_writes%TYPE DEFAULT NULL,
        id_institution_in         IN analysis_req.id_institution%TYPE DEFAULT NULL,
        id_schedule_in            IN analysis_req.id_schedule%TYPE DEFAULT NULL,
        id_sched_consult_in       IN analysis_req.id_sched_consult%TYPE DEFAULT NULL,
        notes_in                  IN analysis_req.notes%TYPE DEFAULT NULL,
        id_prof_cancel_in         IN analysis_req.id_prof_cancel%TYPE DEFAULT NULL,
        notes_cancel_in           IN analysis_req.notes_cancel%TYPE DEFAULT NULL,
        id_prof_approve_in        IN analysis_req.id_prof_approve%TYPE DEFAULT NULL,
        id_prof_authorize_in      IN analysis_req.id_prof_authorize%TYPE DEFAULT NULL,
        flg_time_in               IN analysis_req.flg_time%TYPE DEFAULT NULL,
        flg_status_in             IN analysis_req.flg_status%TYPE DEFAULT NULL,
        id_episode_origin_in      IN analysis_req.id_episode_origin%TYPE DEFAULT NULL,
        id_episode_destination_in IN analysis_req.id_episode_destination%TYPE DEFAULT NULL,
        id_prev_episode_in        IN analysis_req.id_prev_episode%TYPE DEFAULT NULL,
        notes_tech_in             IN analysis_req.notes_tech%TYPE DEFAULT NULL,
        dt_req_tstz_in            IN analysis_req.dt_req_tstz%TYPE DEFAULT NULL,
        dt_cancel_tstz_in         IN analysis_req.dt_cancel_tstz%TYPE DEFAULT NULL,
        dt_begin_tstz_in          IN analysis_req.dt_begin_tstz%TYPE DEFAULT NULL,
        dt_pend_req_tstz_in       IN analysis_req.dt_pend_req_tstz%TYPE DEFAULT NULL,
        id_analysis_group_in      IN analysis_req.id_analysis_group%TYPE DEFAULT NULL,
        id_patient_in             IN analysis_req.id_patient%TYPE DEFAULT NULL,
        id_visit_in               IN analysis_req.id_visit%TYPE DEFAULT NULL,
        create_user_in            IN analysis_req.create_user%TYPE DEFAULT NULL,
        create_time_in            IN analysis_req.create_time%TYPE DEFAULT NULL,
        create_institution_in     IN analysis_req.create_institution%TYPE DEFAULT NULL,
        update_user_in            IN analysis_req.update_user%TYPE DEFAULT NULL,
        update_time_in            IN analysis_req.update_time%TYPE DEFAULT NULL,
        update_institution_in     IN analysis_req.update_institution%TYPE DEFAULT NULL,
        flg_priority_in           IN analysis_req.flg_priority%TYPE DEFAULT NULL,
        id_exec_institution_in    IN analysis_req.id_exec_institution%TYPE DEFAULT NULL,
        barcode_in                IN analysis_req.barcode%TYPE DEFAULT NULL,
        id_cancel_reason_in       IN analysis_req.id_cancel_reason%TYPE DEFAULT NULL,
        id_prof_last_update_in    IN analysis_req.id_prof_last_update%TYPE DEFAULT NULL,
        dt_last_update_tstz_in    IN analysis_req.dt_last_update_tstz%TYPE DEFAULT NULL,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO analysis_req
            (id_analysis_req,
             id_episode,
             id_prof_writes,
             id_institution,
        ...
        WHEN dup_val_on_index THEN
            ...
            ELSE
                ...
                BEGIN
                    ...
                    ELSIF l_name = 'ARQ_REQ_PREV_EPIS_I'
                    THEN
                        pk_alert_exceptions.register_error(error_name_in       => 'DUPLICATE-VALUE',
                                                           err_instance_id_out => l_err_instance_id,
                                                           text_in             => 'Violation of unique index "ARQ_REQ_PREV_EPIS_I"');
                    ...
                    ELSIF l_name = 'ARQ_REQ_EPIS_I'
                    THEN
                        pk_alert_exceptions.register_error(error_name_in       => 'DUPLICATE-VALUE',
                                                           err_instance_id_out => l_err_instance_id,
                                                           text_in             => 'Violation of unique index "ARQ_REQ_EPIS_I"');
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'OWNER',
                                                        value_in           => l_owner,
                                                        validate_in        => FALSE);
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'ANALYSIS_REQ');
                    IF l_name = 'ARQ_AGP_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_ANALYSIS_GROUP',
                                                        value_in           => id_analysis_group_in);
                    END IF;
                    IF l_name = 'ARQ_PAT_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PATIENT',
    ...
    BEGIN
        ...
        ins(id_analysis_req_in        => id_analysis_req_in,
    ...
    PROCEDURE ins
    (
        rec_in          IN analysis_req%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec analysis_req%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_analysis_req := next_key(sequence_in);
        END IF;
        ins(id_analysis_req_in        => l_rec.id_analysis_req,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN analysis_req.id_analysis_req%TYPE
    
     IS
        retval analysis_req.id_analysis_req%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_analysis_req.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_ANALYSIS_REQ'));
    END next_key;
    ...
    (
        ...
        id_prof_last_update_in    IN analysis_req.id_prof_last_update%TYPE DEFAULT NULL,
        dt_last_update_tstz_in    IN analysis_req.dt_last_update_tstz%TYPE DEFAULT NULL,
        id_analysis_req_out       IN OUT analysis_req.id_analysis_req%TYPE,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) IS
        l_pky analysis_req.id_analysis_req%TYPE := next_key;
    BEGIN
        ins(id_analysis_req_in        => l_pky,
            id_episode_in             => id_episode_in,
            id_prof_writes_in         => id_prof_writes_in,
            id_institution_in         => id_institution_in,
            id_schedule_in            => id_schedule_in,
    ...
    BEGIN
        ins(id_episode_in             => id_episode_in,
            ...
            id_prof_last_update_in    => id_prof_last_update_in,
            dt_last_update_tstz_in    => dt_last_update_tstz_in,
            id_analysis_req_out       => id_analysis_req_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) RETURN analysis_req.id_analysis_req%TYPE IS
        l_pky analysis_req.id_analysis_req%TYPE := next_key;
    BEGIN
        ins(id_analysis_req_in        => l_pky,
            id_episode_in             => id_episode_in,
    ...
    (
        ...
        l_id_prof_last_update_n    NUMBER(1);
        l_dt_last_update_tstz_n    NUMBER(1);
        id_analysis_req_in         analysis_req.id_analysis_req%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE ANALYSIS_REQ SET ' || ' ID_EPISODE = decode (' || l_id_episode_n ||
                 ',0,:id_episode_in, NVL (:id_episode_in, ID_EPISODE)) ' || ',' || ' ID_PROF_WRITES = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_episode_in, id_prof_writes_in, id_institution_in, id_schedule_in, id_sched_consult_in, notes_in, id_prof_cancel_in, notes_cancel_in, id_prof_approve_in, id_prof_authorize_in, flg_time_in, flg_status_in, id_episode_origin_in, id_episode_destination_in, id_prev_episode_in, notes_tech_in, dt_req_tstz_in, dt_cancel_tstz_in, dt_begin_tstz_in, dt_pend_req_tstz_in, id_analysis_group_in, id_patient_in, id_visit_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, flg_priority_in, id_exec_institution_in, barcode_in, id_cancel_reason_in, id_prof_last_update_in, dt_last_update_tstz_in, OUT l_rows_out;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE analysis_req
                 ...
                 WHERE id_analysis_req = l_id_analysis_req(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE analysis_req
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE ANALYSIS_REQ
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE ANALYSIS_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE ANALYSIS_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_analysis_req_in => id_analysis_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    -- Delete for unique value of ARQ_REQ_PREV_EPIS_I
    PROCEDURE del_arq_req_prev_epis_i
    (
        id_analysis_req_in IN analysis_req.id_analysis_req%TYPE,
        id_prev_episode_in IN analysis_req.id_prev_episode%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_arq_req_prev_epis_i;
    -- Delete for unique value of ARQ_REQ_EPIS_I
    PROCEDURE del_arq_req_epis_i
    (
        id_analysis_req_in IN analysis_req.id_analysis_req%TYPE,
        id_episode_in      IN analysis_req.id_episode%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_arq_req_prev_epis_i(id_analysis_req_in => id_analysis_req_in,
                                id_prev_episode_in => id_prev_episode_in,
                                handle_error_in    => handle_error_in,
                                rows_out           => rows_out);
    END del_arq_req_prev_epis_i;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_arq_req_epis_i(id_analysis_req_in => id_analysis_req_in,
                           id_episode_in      => id_episode_in,
                           handle_error_in    => handle_error_in,
                           rows_out           => rows_out);
    END del_arq_req_epis_i;

    PROCEDURE del_arq_agp_fk
    (
        id_analysis_group_in IN analysis_req.id_analysis_group%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_analysis_group = del_arq_agp_fk.id_analysis_group_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_arq_agp_fk(id_analysis_group_in => id_analysis_group_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_arq_agp_fk;

    PROCEDURE del_arq_pat_fk
    (
        id_patient_in   IN analysis_req.id_patient%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_patient = del_arq_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_arq_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_arq_pat_fk;

    PROCEDURE del_arq_vit_fk
    (
        id_visit_in     IN analysis_req.id_visit%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_visit = del_arq_vit_fk.id_visit_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_arq_vit_fk(id_visit_in => id_visit_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_arq_vit_fk;

    PROCEDURE del_art_epis_dest_fk
    (
        id_episode_destination_in IN analysis_req.id_episode_destination%TYPE,
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_episode_destination = del_art_epis_dest_fk.id_episode_destination_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_epis_dest_fk(id_episode_destination_in => id_episode_destination_in,
                             handle_error_in           => handle_error_in,
                             rows_out                  => rows_out);
    END del_art_epis_dest_fk;

    PROCEDURE del_art_epis_fk
    (
        id_episode_in   IN analysis_req.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    BEGIN
        DELETE FROM analysis_req
         WHERE id_episode = del_art_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_art_epis_fk;

    PROCEDURE del_art_epis_fk2
    (
        id_prev_episode_in IN analysis_req.id_prev_episode%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ...
    BEGIN
        DELETE FROM analysis_req
         WHERE id_prev_episode = del_art_epis_fk2.id_prev_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_epis_fk2(id_prev_episode_in => id_prev_episode_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_art_epis_fk2;

    PROCEDURE del_art_epis_origin_fk
    (
        id_episode_origin_in IN analysis_req.id_episode_origin%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_episode_origin = del_art_epis_origin_fk.id_episode_origin_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_epis_origin_fk(id_episode_origin_in => id_episode_origin_in,
                               handle_error_in      => handle_error_in,
                               rows_out             => rows_out);
    END del_art_epis_origin_fk;

    PROCEDURE del_art_inst_fk
    (
        id_institution_in IN analysis_req.id_institution%TYPE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_institution = del_art_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_inst_fk(id_institution_in => id_institution_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_art_inst_fk;

    PROCEDURE del_art_prof_app_fk
    (
        id_prof_approve_in IN analysis_req.id_prof_approve%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_prof_approve = del_art_prof_app_fk.id_prof_approve_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_prof_app_fk(id_prof_approve_in => id_prof_approve_in,
                            handle_error_in    => handle_error_in,
                            rows_out           => rows_out);
    END del_art_prof_app_fk;

    PROCEDURE del_art_prof_authz_fk
    (
        id_prof_authorize_in IN analysis_req.id_prof_authorize%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_prof_authorize = del_art_prof_authz_fk.id_prof_authorize_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_prof_authz_fk(id_prof_authorize_in => id_prof_authorize_in,
                              handle_error_in      => handle_error_in,
                              rows_out             => rows_out);
    END del_art_prof_authz_fk;

    PROCEDURE del_art_prof_cancel_fk
    (
        id_prof_cancel_in IN analysis_req.id_prof_cancel%TYPE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_prof_cancel = del_art_prof_cancel_fk.id_prof_cancel_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_prof_cancel_fk(id_prof_cancel_in => id_prof_cancel_in,
                               handle_error_in   => handle_error_in,
                               rows_out          => rows_out);
    END del_art_prof_cancel_fk;

    PROCEDURE del_art_prof_writes_fk
    (
        id_prof_writes_in IN analysis_req.id_prof_writes%TYPE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_prof_writes = del_art_prof_writes_fk.id_prof_writes_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_prof_writes_fk(id_prof_writes_in => id_prof_writes_in,
                               handle_error_in   => handle_error_in,
                               rows_out          => rows_out);
    END del_art_prof_writes_fk;

    PROCEDURE del_art_schd_consult_fk
    (
        id_sched_consult_in IN analysis_req.id_sched_consult%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_sched_consult = del_art_schd_consult_fk.id_sched_consult_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_schd_consult_fk(id_sched_consult_in => id_sched_consult_in,
                                handle_error_in     => handle_error_in,
                                rows_out            => rows_out);
    END del_art_schd_consult_fk;

    PROCEDURE del_art_schd_fk
    (
        id_schedule_in  IN analysis_req.id_schedule%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM analysis_req
         WHERE id_schedule = del_art_schd_fk.id_schedule_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_art_schd_fk(id_schedule_in => id_schedule_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_art_schd_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM ANALYSIS_REQ';
        ELSE
            RETURN 'DELETE FROM ANALYSIS_REQ WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(analysis_req_inout IN OUT analysis_req%ROWTYPE) IS
    BEGIN
        analysis_req_inout.id_analysis_req        := NULL;
        analysis_req_inout.id_episode             := NULL;
        analysis_req_inout.id_prof_writes         := NULL;
        analysis_req_inout.id_institution         := NULL;
        analysis_req_inout.id_schedule            := NULL;
        analysis_req_inout.id_sched_consult       := NULL;
        analysis_req_inout.notes                  := NULL;
        analysis_req_inout.id_prof_cancel         := NULL;
        analysis_req_inout.notes_cancel           := NULL;
        analysis_req_inout.id_prof_approve        := NULL;
        analysis_req_inout.id_prof_authorize      := NULL;
        analysis_req_inout.flg_time               := NULL;
        analysis_req_inout.flg_status             := NULL;
        analysis_req_inout.id_episode_origin      := NULL;
        analysis_req_inout.id_episode_destination := NULL;
        analysis_req_inout.id_prev_episode        := NULL;
        analysis_req_inout.notes_tech             := NULL;
        analysis_req_inout.dt_req_tstz            := NULL;
        analysis_req_inout.dt_cancel_tstz         := NULL;
        analysis_req_inout.dt_begin_tstz          := NULL;
        analysis_req_inout.dt_pend_req_tstz       := NULL;
        analysis_req_inout.id_analysis_group      := NULL;
        analysis_req_inout.id_patient             := NULL;
        analysis_req_inout.id_visit               := NULL;
        analysis_req_inout.create_user            := NULL;
        analysis_req_inout.create_time            := NULL;
        analysis_req_inout.create_institution     := NULL;
        analysis_req_inout.update_user            := NULL;
        analysis_req_inout.update_time            := NULL;
        analysis_req_inout.update_institution     := NULL;
        analysis_req_inout.flg_priority           := NULL;
        analysis_req_inout.id_exec_institution    := NULL;
        analysis_req_inout.barcode                := NULL;
        analysis_req_inout.id_cancel_reason       := NULL;
        analysis_req_inout.id_prof_last_update    := NULL;
        analysis_req_inout.dt_last_update_tstz    := NULL;
    END initrec;

    FUNCTION initrec RETURN analysis_req%ROWTYPE IS
        l_analysis_req analysis_req%ROWTYPE;
    BEGIN
        RETURN l_analysis_req;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN analysis_req_tc IS
        data analysis_req_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM analysis_req
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN analysis_req_tc IS
