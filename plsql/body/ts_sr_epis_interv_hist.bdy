/*-- Last Change Revision: $Rev: 2028386 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:28 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_sr_epis_interv_hist
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN sr_epis_interv_hist.id_sr_epis_interv_hist%TYPE IS
        retval sr_epis_interv_hist.id_sr_epis_interv_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_sr_epis_interv_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky sr_epis_interv_hist.id_sr_epis_interv_hist%TYPE := next_key;
    BEGIN
        ins(id_sr_epis_interv_hist_in => l_pky,
            id_sr_epis_interv_in      => id_sr_epis_interv_in,
    ...
    BEGIN
        ins(id_sr_epis_interv_hist_in => l_pky,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_sr_epis_interv_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_sr_epis_interv_in       => id_sr_epis_interv_in,
            ...
            surgical_site_in           => surgical_site_in,
            id_interv_codification_in  => id_interv_codification_in,
            id_sr_epis_interv_hist_out => id_sr_epis_interv_hist_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN sr_epis_interv_hist.id_sr_epis_interv_hist%TYPE IS
        l_pky sr_epis_interv_hist.id_sr_epis_interv_hist%TYPE := next_key;
    BEGIN
        ins(id_sr_epis_interv_hist_in => l_pky,
            id_sr_epis_interv_in      => id_sr_epis_interv_in,
    ...
    BEGIN
        INSERT INTO sr_epis_interv_hist
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_sr_epis_interv_hist_in => id_sr_epis_interv_hist_in,
            id_sr_epis_interv_in      => id_sr_epis_interv_in,
            flg_status_hist_in        => flg_status_hist_in,
            id_episode_in             => id_episode_in,
            id_sr_intervention_in     => id_sr_intervention_in,
    ...
    (
        ...
        l_rec sr_epis_interv_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_sr_epis_interv_hist := next_key(sequence_in);
        END IF;
    
        ins(id_sr_epis_interv_hist_in => l_rec.id_sr_epis_interv_hist,
            id_sr_epis_interv_in      => l_rec.id_sr_epis_interv,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                INSERT INTO sr_epis_interv_hist
                    (id_sr_epis_interv_hist,
                     ...
                     id_interv_codification)
                VALUES
                    (rows_in(indx).id_sr_epis_interv_hist,
                     rows_in(indx).id_sr_epis_interv,
                     rows_in(indx).flg_status_hist,
    ...
    (
        ...
        l_id_sr_epis_interv_n      NUMBER(1) := sys.diutil.bool_to_int(id_sr_epis_interv_nin);
        l_flg_status_hist_n        NUMBER(1) := sys.diutil.bool_to_int(flg_status_hist_nin);
    ...
    BEGIN
        ...
        UPDATE sr_epis_interv_hist
           SET id_sr_epis_interv      = decode(l_id_sr_epis_interv_n,
                                               0,
                                               id_sr_epis_interv_in,
                                               nvl(id_sr_epis_interv_in, id_sr_epis_interv)),
               flg_status_hist        = decode(l_flg_status_hist_n,
                                               0,
                                               flg_status_hist_in,
                                               nvl(flg_status_hist_in, flg_status_hist)),
         ...
         WHERE id_sr_epis_interv_hist = id_sr_epis_interv_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_sr_epis_interv_hist_in  => id_sr_epis_interv_hist_in,
            id_sr_epis_interv_in       => id_sr_epis_interv_in,
            id_sr_epis_interv_nin      => id_sr_epis_interv_nin,
            flg_status_hist_in         => flg_status_hist_in,
    ...
    (
        ...
        l_id_interv_codification_n NUMBER(1) := sys.diutil.bool_to_int(id_interv_codification_nin);
    BEGIN
        l_id_sr_epis_interv_n      := sys.diutil.bool_to_int(id_sr_epis_interv_nin);
        ...
        l_sql                      := 'UPDATE sr_epis_interv_hist SET' || ' ID_SR_EPIS_INTERV = decode (' ||
                                      l_id_sr_epis_interv_n ||
                                      ',0,:ID_SR_EPIS_INTERV_in, NVL (:ID_SR_EPIS_INTERV_in, ID_SR_EPIS_INTERV)) ' || ',' ||
                                      ' FLG_STATUS_HIST = decode (' || l_flg_status_hist_n ||
                                      ',0,:FLG_STATUS_HIST_in, NVL (:FLG_STATUS_HIST_in, FLG_STATUS_HIST)) ' || ',' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_sr_epis_interv_in, flg_status_hist_in, id_episode_in, id_sr_intervention_in, id_prof_req_in, flg_type_in, flg_status_in, notes_cancel_in, id_prof_cancel_in, id_sr_cancel_reason_in, dt_req_tstz_in, dt_interv_start_tstz_in, dt_interv_end_tstz_in, dt_cancel_tstz_in, id_episode_context_in, name_interv_in, id_prof_req_unc_in, dt_req_unc_tstz_in, flg_code_type_in, laterality_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, flg_surg_request_in, notes_in, id_epis_diagnosis_in, id_not_order_reason_in, surgical_site_in, id_interv_codification_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_sr_epis_interv_hist_in,
                id_sr_epis_interv_in,
                flg_status_hist_in,
                id_episode_in,
                id_sr_intervention_in,
    ...
    BEGIN
        upd(id_sr_epis_interv_hist_in => rec_in.id_sr_epis_interv_hist,
            id_sr_epis_interv_in      => rec_in.id_sr_epis_interv,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE sr_epis_interv_hist
                   SET id_sr_epis_interv      = nvl(l_id_sr_epis_interv(i), id_sr_epis_interv),
                 ...
                 WHERE id_sr_epis_interv_hist = l_id_sr_epis_interv_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE sr_epis_interv_hist
                   SET id_sr_epis_interv      = l_id_sr_epis_interv(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE sr_epis_interv_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE sr_epis_interv_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE sr_epis_interv_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_sr_epis_interv_hist_in => id_sr_epis_interv_hist_in,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_seih_nor_fk(id_not_order_reason_in => id_not_order_reason_in,
                        handle_error_in        => handle_error_in,
                        rows_out               => rows_out);
    END del_seih_nor_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_epis_context_fk(id_episode_context_in => id_episode_context_in,
                                 handle_error_in       => handle_error_in,
                                 rows_out              => rows_out);
    END del_sevh_epis_context_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_sevh_epis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_prof_fk(id_prof_req_in => id_prof_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_sevh_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_prof_fk2(id_prof_cancel_in => id_prof_cancel_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_sevh_prof_fk2;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_prof_fk3(id_prof_req_unc_in => id_prof_req_unc_in,
                          handle_error_in    => handle_error_in,
                          rows_out           => rows_out);
    END del_sevh_prof_fk3;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_sev_fk(id_sr_epis_interv_in => id_sr_epis_interv_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_sevh_sev_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_sevh_sr_can_rea_fk(id_sr_cancel_reason_in => id_sr_cancel_reason_in,
                               handle_error_in        => handle_error_in,
                               rows_out               => rows_out);
    END del_sevh_sr_can_rea_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM sr_epis_interv_hist';
        ELSE
            RETURN 'DELETE FROM sr_epis_interv_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(sr_epis_interv_hist_inout IN OUT sr_epis_interv_hist%ROWTYPE) IS
    BEGIN
        sr_epis_interv_hist_inout.id_sr_epis_interv_hist := NULL;
        sr_epis_interv_hist_inout.id_sr_epis_interv      := NULL;
        sr_epis_interv_hist_inout.flg_status_hist        := NULL;
        sr_epis_interv_hist_inout.id_episode             := NULL;
        sr_epis_interv_hist_inout.id_sr_intervention     := NULL;
        sr_epis_interv_hist_inout.id_prof_req            := NULL;
        sr_epis_interv_hist_inout.flg_type               := NULL;
        sr_epis_interv_hist_inout.flg_status             := NULL;
        sr_epis_interv_hist_inout.notes_cancel           := NULL;
        sr_epis_interv_hist_inout.id_prof_cancel         := NULL;
        sr_epis_interv_hist_inout.id_sr_cancel_reason    := NULL;
        sr_epis_interv_hist_inout.dt_req_tstz            := NULL;
        sr_epis_interv_hist_inout.dt_interv_start_tstz   := NULL;
        sr_epis_interv_hist_inout.dt_interv_end_tstz     := NULL;
        sr_epis_interv_hist_inout.dt_cancel_tstz         := NULL;
        sr_epis_interv_hist_inout.id_episode_context     := NULL;
        sr_epis_interv_hist_inout.name_interv            := NULL;
        sr_epis_interv_hist_inout.id_prof_req_unc        := NULL;
        sr_epis_interv_hist_inout.dt_req_unc_tstz        := NULL;
        sr_epis_interv_hist_inout.flg_code_type          := NULL;
        sr_epis_interv_hist_inout.laterality             := NULL;
        sr_epis_interv_hist_inout.create_user            := NULL;
        sr_epis_interv_hist_inout.create_time            := NULL;
        sr_epis_interv_hist_inout.create_institution     := NULL;
        sr_epis_interv_hist_inout.update_user            := NULL;
        sr_epis_interv_hist_inout.update_time            := NULL;
        sr_epis_interv_hist_inout.update_institution     := NULL;
        sr_epis_interv_hist_inout.flg_surg_request       := NULL;
        sr_epis_interv_hist_inout.notes                  := NULL;
        sr_epis_interv_hist_inout.id_epis_diagnosis      := NULL;
        sr_epis_interv_hist_inout.id_not_order_reason    := NULL;
        sr_epis_interv_hist_inout.surgical_site          := NULL;
        sr_epis_interv_hist_inout.id_interv_codification := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN sr_epis_interv_hist%ROWTYPE IS
        l_sr_epis_interv_hist sr_epis_interv_hist%ROWTYPE;
    BEGIN
        RETURN l_sr_epis_interv_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN sr_epis_interv_hist_tc IS
        data sr_epis_interv_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN sr_epis_interv_hist_tc IS
        data sr_epis_interv_hist_tc;
