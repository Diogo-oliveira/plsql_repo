/*-- Last Change Revision: $Rev: 2028097 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:10 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_epis_hidrics_det_ftxt
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 15, 2011 9:47:35
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_epis_hidrics_det_ftxt_in IN epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE,
        id_way_in                   IN epis_hidrics_det_ftxt.id_way%TYPE DEFAULT NULL,
        id_hidrics_location_in      IN epis_hidrics_det_ftxt.id_hidrics_location%TYPE DEFAULT NULL,
        id_hidrics_in               IN epis_hidrics_det_ftxt.id_hidrics%TYPE DEFAULT NULL,
        id_hidrics_charact_in       IN epis_hidrics_det_ftxt.id_hidrics_charact%TYPE DEFAULT NULL,
        free_text_in                IN epis_hidrics_det_ftxt.free_text%TYPE DEFAULT NULL,
        create_user_in              IN epis_hidrics_det_ftxt.create_user%TYPE DEFAULT NULL,
        create_time_in              IN epis_hidrics_det_ftxt.create_time%TYPE DEFAULT NULL,
        create_institution_in       IN epis_hidrics_det_ftxt.create_institution%TYPE DEFAULT NULL,
        update_user_in              IN epis_hidrics_det_ftxt.update_user%TYPE DEFAULT NULL,
        update_time_in              IN epis_hidrics_det_ftxt.update_time%TYPE DEFAULT NULL,
        update_institution_in       IN epis_hidrics_det_ftxt.update_institution%TYPE DEFAULT NULL,
        id_prof_last_change_in      IN epis_hidrics_det_ftxt.id_prof_last_change%TYPE DEFAULT NULL,
        dt_eh_det_ftxt_in           IN epis_hidrics_det_ftxt.dt_eh_det_ftxt%TYPE DEFAULT NULL,
        id_hidrics_device_in        IN epis_hidrics_det_ftxt.id_hidrics_device%TYPE DEFAULT NULL,
        id_patient_in               IN epis_hidrics_det_ftxt.id_patient%TYPE DEFAULT NULL,
                ...
                BEGIN
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'EPIS_HIDRICS_DET_FTXT');
                    END IF;
                END;
            END IF;
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'HID_FTXT_DET_HIDDEV_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
    ...
    PROCEDURE ins
    (
        rec_in          IN epis_hidrics_det_ftxt%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec epis_hidrics_det_ftxt%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_hidrics_det_ftxt := next_key(sequence_in);
        END IF;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE
    
     IS
        retval epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_EPIS_HIDRICS_DET_FTXT'));
    END next_key;
    ...
    (
        ...
        id_hidrics_device_in         IN epis_hidrics_det_ftxt.id_hidrics_device%TYPE DEFAULT NULL,
        id_patient_in                IN epis_hidrics_det_ftxt.id_patient%TYPE DEFAULT NULL,
        id_epis_hidrics_det_ftxt_out IN OUT epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE,
        handle_error_in              IN BOOLEAN := TRUE,
        rows_out                     OUT table_varchar
    ) IS
        l_pky epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE := next_key;
    BEGIN
        ins(id_epis_hidrics_det_ftxt_in => l_pky,
            id_way_in                   => id_way_in,
            id_hidrics_location_in      => id_hidrics_location_in,
            id_hidrics_in               => id_hidrics_in,
            id_hidrics_charact_in       => id_hidrics_charact_in,
            ...
            handle_error_in             => handle_error_in,
            rows_out                    => rows_out);
        id_epis_hidrics_det_ftxt_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_way_in                    => id_way_in,
            ...
            id_hidrics_device_in         => id_hidrics_device_in,
            id_patient_in                => id_patient_in,
            id_epis_hidrics_det_ftxt_out => id_epis_hidrics_det_ftxt_out,
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) RETURN epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE IS
        l_pky epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE := next_key;
    BEGIN
        ins(id_epis_hidrics_det_ftxt_in => l_pky,
            id_way_in                   => id_way_in,
    ...
    PROCEDURE ins
    (
        rows_in         IN epis_hidrics_det_ftxt_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'EPIS_HIDRICS_DET_FTXT',
                                                name2_in      => 'ROW_COUNT',
    ...
    (
        ...
        l_id_hidrics_device_n       NUMBER(1);
        l_id_patient_n              NUMBER(1);
        id_epis_hidrics_det_ftxt_in epis_hidrics_det_ftxt.id_epis_hidrics_det_ftxt%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EPIS_HIDRICS_DET_FTXT SET ' || ' ID_WAY = decode (' || l_id_way_n ||
    ...
    PROCEDURE upd
    (
        col_in            IN epis_hidrics_det_ftxt_tc,
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EPIS_HIDRICS_DET_FTXT
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE EPIS_HIDRICS_DET_FTXT
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_HIDRICS_DET_FTXT set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EPIS_HIDRICS_DET_FTXT set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_epis_hidrics_det_ftxt = id_epis_hidrics_det_ftxt_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
    ...
    PROCEDURE del_ehdft_hc_fk
    (
        id_hidrics_charact_in IN epis_hidrics_det_ftxt.id_hidrics_charact%TYPE,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_hidrics_charact = del_ehdft_hc_fk.id_hidrics_charact_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ehdft_hc_fk(id_hidrics_charact_in => id_hidrics_charact_in,
                        handle_error_in       => handle_error_in,
                        rows_out              => rows_out);
    END del_ehdft_hc_fk;

    PROCEDURE del_ehdft_h_fk
    (
        id_hidrics_in   IN epis_hidrics_det_ftxt.id_hidrics%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_hidrics = del_ehdft_h_fk.id_hidrics_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ehdft_h_fk(id_hidrics_in => id_hidrics_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ehdft_h_fk;

    PROCEDURE del_ehdft_hl_fk
    (
        id_hidrics_location_in IN epis_hidrics_det_ftxt.id_hidrics_location%TYPE,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_hidrics_location = del_ehdft_hl_fk.id_hidrics_location_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ehdft_hl_fk(id_hidrics_location_in => id_hidrics_location_in,
                        handle_error_in        => handle_error_in,
                        rows_out               => rows_out);
    END del_ehdft_hl_fk;

    PROCEDURE del_ehdft_hw_fk
    (
        id_way_in       IN epis_hidrics_det_ftxt.id_way%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_way = del_ehdft_hw_fk.id_way_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ehdft_hw_fk(id_way_in => id_way_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ehdft_hw_fk;

    PROCEDURE del_ehdft_prof_fk
    (
        id_prof_last_change_in IN epis_hidrics_det_ftxt.id_prof_last_change%TYPE,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_prof_last_change = del_ehdft_prof_fk.id_prof_last_change_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ehdft_prof_fk(id_prof_last_change_in => id_prof_last_change_in,
                          handle_error_in        => handle_error_in,
                          rows_out               => rows_out);
    END del_ehdft_prof_fk;

    PROCEDURE del_hftxt_pat_fk
    (
        id_patient_in   IN epis_hidrics_det_ftxt.id_patient%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_patient = del_hftxt_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_hftxt_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_hftxt_pat_fk;

    PROCEDURE del_hid_ftxt_det_hiddev_fk
    (
        id_hidrics_device_in IN epis_hidrics_det_ftxt.id_hidrics_device%TYPE,
        handle_error_in      IN BOOLEAN := TRUE,
        rows_out             OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM epis_hidrics_det_ftxt
         WHERE id_hidrics_device = del_hid_ftxt_det_hiddev_fk.id_hidrics_device_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_hid_ftxt_det_hiddev_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_hid_ftxt_det_hiddev_fk(id_hidrics_device_in => id_hidrics_device_in,
                                   handle_error_in      => handle_error_in,
                                   rows_out             => rows_out);
    END del_hid_ftxt_det_hiddev_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EPIS_HIDRICS_DET_FTXT';
        ELSE
            RETURN 'DELETE FROM EPIS_HIDRICS_DET_FTXT WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_hidrics_det_ftxt_inout IN OUT epis_hidrics_det_ftxt%ROWTYPE) IS
    BEGIN
        epis_hidrics_det_ftxt_inout.id_epis_hidrics_det_ftxt := NULL;
        epis_hidrics_det_ftxt_inout.id_way                   := NULL;
        epis_hidrics_det_ftxt_inout.id_hidrics_location      := NULL;
        epis_hidrics_det_ftxt_inout.id_hidrics               := NULL;
        epis_hidrics_det_ftxt_inout.id_hidrics_charact       := NULL;
        epis_hidrics_det_ftxt_inout.free_text                := NULL;
        epis_hidrics_det_ftxt_inout.create_user              := NULL;
        epis_hidrics_det_ftxt_inout.create_time              := NULL;
        epis_hidrics_det_ftxt_inout.create_institution       := NULL;
        epis_hidrics_det_ftxt_inout.update_user              := NULL;
        epis_hidrics_det_ftxt_inout.update_time              := NULL;
        epis_hidrics_det_ftxt_inout.update_institution       := NULL;
        epis_hidrics_det_ftxt_inout.id_prof_last_change      := NULL;
        epis_hidrics_det_ftxt_inout.dt_eh_det_ftxt           := NULL;
        epis_hidrics_det_ftxt_inout.id_hidrics_device        := NULL;
        epis_hidrics_det_ftxt_inout.id_patient               := NULL;
    END initrec;

    FUNCTION initrec RETURN epis_hidrics_det_ftxt%ROWTYPE IS
        l_epis_hidrics_det_ftxt epis_hidrics_det_ftxt%ROWTYPE;
    BEGIN
        RETURN l_epis_hidrics_det_ftxt;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_hidrics_det_ftxt_tc IS
        data epis_hidrics_det_ftxt_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM epis_hidrics_det_ftxt
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_hidrics_det_ftxt_tc IS
