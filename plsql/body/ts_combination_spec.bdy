...
CREATE OR REPLACE PACKAGE BODY ts_combination_spec
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Março 16, 2011 15:26:57
| Created By: ALERT
*/
 IS
    ...
    (
        ...
        l_rec combination_spec%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_combination_spec := next_key(sequence_in);
        END IF;
        ins(id_combination_spec_in    => l_rec.id_combination_spec,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN combination_spec.id_combination_spec%TYPE
     ...
     IS
        retval combination_spec.id_combination_spec%TYPE;

    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_combination_spec.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_COMBINATION_SPEC'));
    END next_key;
    ...
    (
        ...
        l_pky combination_spec.id_combination_spec%TYPE := next_key;
    BEGIN
        ins(id_combination_spec_in    => l_pky,
            id_patient_in             => id_patient_in,
            comb_name_in              => comb_name_in,
            dt_suggest_begin_in       => dt_suggest_begin_in,
            dt_suggest_end_in         => dt_suggest_end_in,
    ...
    BEGIN
        ins(id_patient_in             => id_patient_in,
            ...
            update_institution_in     => update_institution_in,
            id_episode_in             => id_episode_in,
            id_combination_spec_out   => id_combination_spec_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in           IN BOOLEAN := TRUE,
        rows_out                  OUT table_varchar
    ) RETURN combination_spec.id_combination_spec%TYPE IS
        l_pky combination_spec.id_combination_spec%TYPE := next_key;
    BEGIN
        ins(id_combination_spec_in    => l_pky,
            id_patient_in             => id_patient_in,
    ...
    BEGIN
        ...
        UPDATE combination_spec
         ...
         WHERE id_combination_spec = id_combination_spec_in
    ...
    (
        ...
        l_update_institution_n     NUMBER(1);
        l_id_episode_n             NUMBER(1);
        id_combination_spec_in     combination_spec.id_combination_spec%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE COMBINATION_SPEC SET ' || ' ID_PATIENT = decode (' || l_id_patient_n ||
                 ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) ' || ',' || ' COMB_NAME = decode (' ||
                 l_comb_name_n || ',0,:comb_name_in, NVL (:comb_name_in, COMB_NAME)) ' || ',' ||
                 ' DT_SUGGEST_BEGIN = decode (' || l_dt_suggest_begin_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_patient_in, comb_name_in, dt_suggest_begin_in, dt_suggest_end_in, flg_status_in, flg_single_visit_in, dt_last_update_in, id_prof_last_update_in, id_inst_last_update_in, flg_freq_origin_module_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_episode_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_combination_spec_in    => rec_in.id_combination_spec,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_combination_spec_in,
                id_patient_in,
                comb_name_in,
                dt_suggest_begin_in,
                dt_suggest_end_in,
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE combination_spec
                 ...
                 WHERE id_combination_spec = l_id_combination_spec(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE combination_spec
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE COMBINATION_SPEC
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE COMBINATION_SPEC
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE COMBINATION_SPEC set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE COMBINATION_SPEC set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_combination_spec_in => id_combination_spec_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_combination_spec(id_combination_spec_in => id_combination_spec_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_id_combination_spec;
    ...
    BEGIN
        DELETE FROM combination_spec
         WHERE id_episode = del_cs_ep_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_ep_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cs_ep_fk;
    ...
    BEGIN
        DELETE FROM combination_spec
         WHERE id_prof_last_update = del_cs_lub_fk.id_prof_last_update_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_lub_fk(id_prof_last_update_in => id_prof_last_update_in,
                      handle_error_in        => handle_error_in,
                      rows_out               => rows_out);
    END del_cs_lub_fk;
    ...
    BEGIN
        DELETE FROM combination_spec
         WHERE id_inst_last_update = del_cs_lui_fk.id_inst_last_update_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_lui_fk(id_inst_last_update_in => id_inst_last_update_in,
                      handle_error_in        => handle_error_in,
                      rows_out               => rows_out);
    END del_cs_lui_fk;
    ...
    BEGIN
        DELETE FROM combination_spec
         WHERE id_patient = del_cs_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cs_pat_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM COMBINATION_SPEC';
        ELSE
            RETURN 'DELETE FROM COMBINATION_SPEC WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(combination_spec_inout IN OUT combination_spec%ROWTYPE) IS
    BEGIN
        combination_spec_inout.id_combination_spec    := NULL;
        combination_spec_inout.id_patient             := NULL;
        combination_spec_inout.comb_name              := NULL;
        combination_spec_inout.dt_suggest_begin       := NULL;
        combination_spec_inout.dt_suggest_end         := NULL;
        combination_spec_inout.flg_status             := NULL;
        combination_spec_inout.flg_single_visit       := NULL;
        combination_spec_inout.dt_last_update         := NULL;
        combination_spec_inout.id_prof_last_update    := NULL;
        combination_spec_inout.id_inst_last_update    := NULL;
        combination_spec_inout.flg_freq_origin_module := NULL;
        combination_spec_inout.create_user            := NULL;
        combination_spec_inout.create_time            := NULL;
        combination_spec_inout.create_institution     := NULL;
        combination_spec_inout.update_user            := NULL;
        combination_spec_inout.update_time            := NULL;
        combination_spec_inout.update_institution     := NULL;
        combination_spec_inout.id_episode             := NULL;
    END initrec;

    FUNCTION initrec RETURN combination_spec%ROWTYPE IS
        l_combination_spec combination_spec%ROWTYPE;
    BEGIN
        RETURN l_combination_spec;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN combination_spec_tc IS
        data combination_spec_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM combination_spec
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN combination_spec_tc IS
