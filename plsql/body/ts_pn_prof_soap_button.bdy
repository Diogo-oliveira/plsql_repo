...
CREATE OR REPLACE PACKAGE BODY ts_pn_prof_soap_button
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Julho 14, 2016 11:22:13
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO pn_prof_soap_button
            (id_profile_template,
             create_user,
             create_time,
             create_institution,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'PN_PROF_SOAP_BUTTON');
                    IF l_name = 'PPSB_PROFILE_TEMPLATE_FK'
                    THEN
    ...
    (
        ...
        l_rec pn_prof_soap_button%ROWTYPE := rec_in;
    BEGIN
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'FLG_CONFIG_TYPE _' || indx,
                                                        value_in           => rows_in(SQL%BULK_EXCEPTIONS(indx).error_index)
                                                                              .flg_config_type,
                                                        validate_in        => FALSE);
    ...
    (
        ...
        l_update_time_n         NUMBER(1);
        l_update_institution_n  NUMBER(1);
        id_institution_in       pn_prof_soap_button.id_institution%TYPE;
        id_profile_template_in  pn_prof_soap_button.id_profile_template%TYPE;
        id_conf_button_block_in pn_prof_soap_button.id_conf_button_block%TYPE;
        id_software_in          pn_prof_soap_button.id_software%TYPE;
        id_category_in          pn_prof_soap_button.id_category%TYPE;
        flg_config_type_in      pn_prof_soap_button.flg_config_type%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PN_PROF_SOAP_BUTTON SET ' || ' CREATE_USER = decode (' || l_create_user_n ||
    ...
    BEGIN
        upd(id_profile_template_in  => rec_in.id_profile_template,
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PN_PROF_SOAP_BUTTON
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PN_PROF_SOAP_BUTTON
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PN_PROF_SOAP_BUTTON set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PN_PROF_SOAP_BUTTON set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM pn_prof_soap_button
         WHERE id_institution = id_institution_in
           AND id_profile_template = id_profile_template_in
           AND id_conf_button_block = id_conf_button_block_in
           AND id_software = id_software_in
    ...
    BEGIN
        DELETE FROM pn_prof_soap_button
         WHERE flg_config_type = flg_config_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_category(id_category_in => id_category_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_id_category;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_flg_config_type(flg_config_type_in => flg_config_type_in,
                            handle_error_in    => handle_error_in,
                            rows_out           => rows_out);
    END del_flg_config_type;
    ...
    BEGIN
        DELETE FROM pn_prof_soap_button
         WHERE id_profile_template = del_ppsb_profile_template_fk.id_profile_template_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_ppsb_profile_template_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppsb_profile_template_fk(id_profile_template_in => id_profile_template_in,
                                     handle_error_in        => handle_error_in,
                                     rows_out               => rows_out);
    END del_ppsb_profile_template_fk;
    ...
    BEGIN
        DELETE FROM pn_prof_soap_button
         WHERE id_conf_button_block = del_psbb_cbb_fk.id_conf_button_block_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_psbb_cbb_fk(id_conf_button_block_in => id_conf_button_block_in,
                        handle_error_in         => handle_error_in,
                        rows_out                => rows_out);
    END del_psbb_cbb_fk;
    ...
    BEGIN
        DELETE FROM pn_prof_soap_button
         WHERE id_institution = del_psbb_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_psbb_inst_fk(id_institution_in => id_institution_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_psbb_inst_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PN_PROF_SOAP_BUTTON';
        ELSE
            RETURN 'DELETE FROM PN_PROF_SOAP_BUTTON WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pn_prof_soap_button_inout IN OUT pn_prof_soap_button%ROWTYPE) IS
    BEGIN
        pn_prof_soap_button_inout.id_profile_template  := NULL;
        pn_prof_soap_button_inout.create_user          := NULL;
        pn_prof_soap_button_inout.create_time          := NULL;
        pn_prof_soap_button_inout.create_institution   := NULL;
        pn_prof_soap_button_inout.update_user          := NULL;
        pn_prof_soap_button_inout.update_time          := NULL;
        pn_prof_soap_button_inout.update_institution   := NULL;
        pn_prof_soap_button_inout.id_conf_button_block := NULL;
        pn_prof_soap_button_inout.id_institution       := NULL;
        pn_prof_soap_button_inout.id_category          := -1;
        pn_prof_soap_button_inout.id_software          := 0;
        pn_prof_soap_button_inout.flg_config_type      := 'P';
    END initrec;

    FUNCTION initrec RETURN pn_prof_soap_button%ROWTYPE IS
        l_pn_prof_soap_button pn_prof_soap_button%ROWTYPE;
    BEGIN
        l_pn_prof_soap_button.id_category     := -1;
        l_pn_prof_soap_button.id_software     := 0;
        l_pn_prof_soap_button.flg_config_type := 'P';
        RETURN l_pn_prof_soap_button;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_prof_soap_button_tc IS
        data pn_prof_soap_button_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM pn_prof_soap_button
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_prof_soap_button_tc IS
