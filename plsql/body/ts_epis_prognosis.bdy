...
CREATE OR REPLACE PACKAGE BODY ts_epis_prognosis
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_prognosis.id_epis_prognosis%TYPE IS
        retval epis_prognosis.id_epis_prognosis%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_epis_prognosis.nextval;
        ELSE
    ...
    (
        ...
        l_pky epis_prognosis.id_epis_prognosis%TYPE := next_key;
    BEGIN
        ins(id_epis_prognosis_in   => l_pky,
    ...
    BEGIN
        ins(id_episode_in          => id_episode_in,
            ...
            update_institution_in  => update_institution_in,
            id_prognosis_in        => id_prognosis_in,
            id_epis_prognosis_out  => id_epis_prognosis_out,
            handle_error_in        => handle_error_in,
            rows_out               => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := FALSE,
        rows_out        OUT table_varchar
    ) RETURN epis_prognosis.id_epis_prognosis%TYPE IS
        l_pky epis_prognosis.id_epis_prognosis%TYPE := next_key;
    BEGIN
        ins(id_epis_prognosis_in   => l_pky,
            id_episode_in          => id_episode_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_epis_prognosis_in   => id_epis_prognosis_in,
            id_episode_in          => id_episode_in,
            flg_status_in          => flg_status_in,
            prognosis_notes_in     => prognosis_notes_in,
            id_prof_create_in      => id_prof_create_in,
    ...
    (
        ...
        l_rec epis_prognosis%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_prognosis := next_key(sequence_in);
        END IF;
    
        ins(id_epis_prognosis_in   => l_rec.id_epis_prognosis,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_prognosis_in    => id_epis_prognosis_in,
            id_episode_in           => id_episode_in,
    ...
    BEGIN
        ...
        l_sql                   := 'UPDATE epis_prognosis SET' || ' ID_EPISODE = decode (' || l_id_episode_n ||
    ...
    BEGIN
        upd(id_epis_prognosis_in   => rec_in.id_epis_prognosis,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prognosis
                 ...
                 WHERE id_epis_prognosis = l_id_epis_prognosis(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prognosis
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_prognosis
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_prognosis
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_prognosis
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_prognosis_in => id_epis_prognosis_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_cr_fk(id_cancel_reason_in => id_cancel_reason_in,
                     handle_error_in     => handle_error_in,
                     rows_out            => rows_out);
    END del_ep_cr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ep_epis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_prof_cancel_fk(id_prof_cancel_in => id_prof_cancel_in,
                              handle_error_in   => handle_error_in,
                              rows_out          => rows_out);
    END del_ep_prof_cancel_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_prof_create_fk(id_prof_create_in => id_prof_create_in,
                              handle_error_in   => handle_error_in,
                              rows_out          => rows_out);
    END del_ep_prof_create_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_prof_update_fk(id_prof_last_update_in => id_prof_last_update_in,
                              handle_error_in        => handle_error_in,
                              rows_out               => rows_out);
    END del_ep_prof_update_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_prognosis';
        ELSE
            RETURN 'DELETE FROM epis_prognosis WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_prognosis_inout IN OUT epis_prognosis%ROWTYPE) IS
    BEGIN
        epis_prognosis_inout.id_epis_prognosis   := NULL;
        epis_prognosis_inout.id_episode          := NULL;
        epis_prognosis_inout.flg_status          := NULL;
        epis_prognosis_inout.prognosis_notes     := NULL;
        epis_prognosis_inout.id_prof_create      := NULL;
        epis_prognosis_inout.dt_create           := NULL;
        epis_prognosis_inout.id_prof_last_update := NULL;
        epis_prognosis_inout.dt_last_update      := NULL;
        epis_prognosis_inout.id_prof_cancel      := NULL;
        epis_prognosis_inout.id_cancel_reason    := NULL;
        epis_prognosis_inout.cancel_notes        := NULL;
        epis_prognosis_inout.dt_cancel           := NULL;
        epis_prognosis_inout.create_user         := NULL;
        epis_prognosis_inout.create_time         := NULL;
        epis_prognosis_inout.create_institution  := NULL;
        epis_prognosis_inout.update_user         := NULL;
        epis_prognosis_inout.update_time         := NULL;
        epis_prognosis_inout.update_institution  := NULL;
        epis_prognosis_inout.id_prognosis        := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_prognosis%ROWTYPE IS
        l_epis_prognosis epis_prognosis%ROWTYPE;
    BEGIN
        RETURN l_epis_prognosis;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_prognosis_tc IS
        data epis_prognosis_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_prognosis_tc IS
        data epis_prognosis_tc;
