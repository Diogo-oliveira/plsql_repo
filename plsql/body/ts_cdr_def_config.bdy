...
CREATE OR REPLACE PACKAGE BODY TS_CDR_DEF_CONFIG
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Fevereiro 28, 2012 17:44:27
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO CDR_DEF_CONFIG (
      ...
      VALUES (
         id_cdr_def_config_in,
         id_cdr_def_severity_in,
        ...
        BEGIN
           ...
           THEN
              ...
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_err_instance_id
                ,NAME_IN => 'TABLE_NAME'
                ,value_in => 'CDR_DEF_CONFIG'
                ,validate_in => FALSE
                );
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_err_instance_id
                ,NAME_IN => 'ID_CDR_DEF_CONFIG'
                ,value_in => id_cdr_def_config_in
                ,validate_in => FALSE
                );
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'CDR_DEF_CONFIG');
           IF l_name = 'CDRDCF_CDRDS_FK'
           THEN
              -- Add a context value for each column
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_id
               , name_in => 'ID_CDR_DEF_SEVERITY'
               , value_in => id_cdr_def_severity_in);
           END IF;
           IF l_name = 'CDRDCF_CDRPA_FK'
           THEN
              -- Add a context value for each column
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_id
   ...
   BEGIN
     ...
     ins (
      id_cdr_def_severity_in => id_cdr_def_severity_in,
      ...
      ,
      id_cdr_def_config_in => id_cdr_def_config_in,
   ...
   IS
      l_rec CDR_DEF_CONFIG%ROWTYPE := rec_in;
   BEGIN
      ins (
         id_cdr_def_severity_in => l_rec.ID_CDR_DEF_SEVERITY,
         ...
         ,
         id_cdr_def_config_in => l_rec.ID_CDR_DEF_CONFIG,
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO CDR_DEF_CONFIG VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_CDR_DEF_CONFIG _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_CDR_DEF_CONFIG
                  ,validate_in => FALSE
                );

                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_CDR_DEF_SEVERITY _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_CDR_DEF_SEVERITY
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
   ...
   l_ID_CDR_DEF_CONFIG_n NUMBER(1);
   ...
   l_ID_CDR_DEF_CONFIG_n := sys.diutil.bool_to_int(ID_CDR_DEF_CONFIG_nin);
   ...
   l_UPDATE_INSTITUTION_n := sys.diutil.bool_to_int(UPDATE_INSTITUTION_nin);
         ...
         UPDATE CDR_DEF_CONFIG SET
     ID_CDR_DEF_CONFIG = decode (l_ID_CDR_DEF_CONFIG_n,0,id_cdr_def_config_in, NVL (id_cdr_def_config_in, ID_CDR_DEF_CONFIG)),
     ...
     UPDATE_INSTITUTION = decode (l_UPDATE_INSTITUTION_n,0,update_institution_in, NVL (update_institution_in, UPDATE_INSTITUTION))
          WHERE
             ID_CDR_DEF_SEVERITY = id_cdr_def_severity_in AND
             ID_CDR_PARAM_ACTION = id_cdr_param_action_in AND
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      ...
      id_professional_in => id_professional_in,
      id_cdr_def_config_in => id_cdr_def_config_in,
      ID_CDR_DEF_CONFIG_nin => ID_CDR_DEF_CONFIG_nin,
      create_user_in => create_user_in,
...
PROCEDURE upd (
   ...
   l_UPDATE_TIME_n NUMBER(1);
   l_UPDATE_INSTITUTION_n NUMBER(1);
      id_cdr_def_severity_in CDR_DEF_CONFIG.ID_CDR_DEF_SEVERITY%TYPE;
      id_cdr_param_action_in CDR_DEF_CONFIG.ID_CDR_PARAM_ACTION%TYPE;
      id_institution_in CDR_DEF_CONFIG.ID_INSTITUTION%TYPE;
      id_software_in CDR_DEF_CONFIG.ID_SOFTWARE%TYPE;
      id_profile_template_in CDR_DEF_CONFIG.ID_PROFILE_TEMPLATE%TYPE;
      id_dep_clin_serv_in CDR_DEF_CONFIG.ID_DEP_CLIN_SERV%TYPE;
      id_professional_in CDR_DEF_CONFIG.ID_PROFESSIONAL%TYPE;
   BEGIN
...
l_sql := 'UPDATE CDR_DEF_CONFIG SET '
     || ' ID_CDR_DEF_CONFIG = decode (' || l_ID_CDR_DEF_CONFIG_n || ',0,:id_cdr_def_config_in, NVL (:id_cdr_def_config_in, ID_CDR_DEF_CONFIG)) '|| ','
     || ' CREATE_USER = decode (' || l_CREATE_USER_n || ',0,:create_user_in, NVL (:create_user_in, CREATE_USER)) '|| ','
     || ' CREATE_TIME = decode (' || l_CREATE_TIME_n || ',0,:create_time_in, NVL (:create_time_in, CREATE_TIME)) '|| ','
     || ' CREATE_INSTITUTION = decode (' || l_CREATE_INSTITUTION_n || ',0,:create_institution_in, NVL (:create_institution_in, CREATE_INSTITUTION)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         id_cdr_def_config_in => rec_in.ID_CDR_DEF_CONFIG,
         id_cdr_def_severity_in => rec_in.ID_CDR_DEF_SEVERITY,
   ...
   IS
      l_ID_CDR_DEF_CONFIG ID_CDR_DEF_CONFIG_cc;
      l_ID_CDR_DEF_SEVERITY ID_CDR_DEF_SEVERITY_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         l_ID_CDR_DEF_CONFIG(i) := col_in(i).ID_CDR_DEF_CONFIG;
         l_ID_CDR_DEF_SEVERITY(i) := col_in(i).ID_CDR_DEF_SEVERITY;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE CDR_DEF_CONFIG SET
               ID_CDR_DEF_CONFIG = NVL (l_ID_CDR_DEF_CONFIG(i), ID_CDR_DEF_CONFIG),
             ...
             WHERE
                ID_CDR_DEF_SEVERITY = l_ID_CDR_DEF_SEVERITY(i) AND
                ID_CDR_PARAM_ACTION = l_ID_CDR_PARAM_ACTION(i) AND
      ...
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE CDR_DEF_CONFIG SET
               ID_CDR_DEF_CONFIG = l_ID_CDR_DEF_CONFIG(i),
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE CDR_DEF_CONFIG set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE CDR_DEF_CONFIG set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE ID_CDR_DEF_SEVERITY = id_cdr_def_severity_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE ID_CDR_PARAM_ACTION = id_cdr_param_action_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_CDR_DEF_CONFIG = id_cdr_def_config_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_UK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_CDR_DEF_SEVERITY = del_CDRDCF_CDRDS_FK.id_cdr_def_severity_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_CDRDS_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_CDR_PARAM_ACTION = del_CDRDCF_CDRPA_FK.id_cdr_param_action_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_CDRPA_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_DEP_CLIN_SERV = del_CDRDCF_DCS_FK.id_dep_clin_serv_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_DCS_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_INSTITUTION = del_CDRDCF_INST_FK.id_institution_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_INST_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_PROFESSIONAL = del_CDRDCF_PROF_FK.id_professional_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_PROF_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_SOFTWARE = del_CDRDCF_S_FK.id_software_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_S_FK (
   ...
   BEGIN
      DELETE FROM CDR_DEF_CONFIG
       WHERE
          ID_PROFILE_TEMPLATE = del_CDRDCF_SPT_FK.id_profile_template_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_CDRDCF_SPT_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM CDR_DEF_CONFIG';
      ELSE
         RETURN
            'DELETE FROM CDR_DEF_CONFIG WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      cdr_def_config_inout.ID_CDR_DEF_CONFIG := NULL;
      cdr_def_config_inout.ID_CDR_DEF_SEVERITY := NULL;
      cdr_def_config_inout.ID_CDR_PARAM_ACTION := NULL;
      cdr_def_config_inout.ID_INSTITUTION := NULL;
      cdr_def_config_inout.ID_SOFTWARE := NULL;
      cdr_def_config_inout.ID_PROFILE_TEMPLATE := NULL;
      cdr_def_config_inout.ID_DEP_CLIN_SERV := NULL;
      cdr_def_config_inout.ID_PROFESSIONAL := NULL;
      cdr_def_config_inout.CREATE_USER := NULL;
      cdr_def_config_inout.CREATE_TIME := NULL;
      cdr_def_config_inout.CREATE_INSTITUTION := NULL;
      cdr_def_config_inout.UPDATE_USER := NULL;
      cdr_def_config_inout.UPDATE_TIME := NULL;
      cdr_def_config_inout.UPDATE_INSTITUTION := NULL;
   END initrec;

   FUNCTION initrec RETURN CDR_DEF_CONFIG%ROWTYPE
   IS
      l_cdr_def_config CDR_DEF_CONFIG%ROWTYPE;
   BEGIN
      RETURN l_cdr_def_config;
   END initrec;
   ...
   IS
        data CDR_DEF_CONFIG_tc;
   BEGIN
        select * bulk collect into data from CDR_DEF_CONFIG where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
