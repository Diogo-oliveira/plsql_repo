...
CREATE OR REPLACE PACKAGE BODY TS_PO_PARAM_ALIAS
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Fevereiro 9, 2015 9:48:3
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO PO_PARAM_ALIAS (
      ...
      VALUES (
         id_po_param_alias_in,
         code_po_param_alias_in,
         id_po_param_in,
         id_inst_owner_in,
         id_institution_in,
         id_software_in,
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'PO_PARAM_ALIAS');
           IF l_name = 'POPA_DCS_FK'
           THEN
   ...
   BEGIN
     ...
     ins (
      id_po_param_alias_in => id_po_param_alias_in
      ,
      code_po_param_alias_in => code_po_param_alias_in,
   ...
   IS
      l_rec PO_PARAM_ALIAS%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_PO_PARAM_ALIAS := next_key (sequence_in);
      END IF;
      ins (
         id_po_param_alias_in => l_rec.ID_PO_PARAM_ALIAS
         ,
         code_po_param_alias_in => l_rec.CODE_PO_PARAM_ALIAS,
  ...
  ins (
   ...
   IS
     retval PO_PARAM_ALIAS.ID_PO_PARAM_ALIAS%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_PO_PARAM_ALIAS.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_PO_PARAM_ALIAS')
           );
   END next_key;
   ...
   IS
        l_pky PO_PARAM_ALIAS.ID_PO_PARAM_ALIAS%TYPE := next_key;
   BEGIN
      ins (
         id_po_param_alias_in => l_pky,
         code_po_param_alias_in => code_po_param_alias_in,
         id_po_param_in => id_po_param_in,
         id_inst_owner_in => id_inst_owner_in,
         id_institution_in => id_institution_in,
   ...
   BEGIN
      ...
      update_time_in => update_time_in,
      update_institution_in => update_institution_in,
      id_po_param_alias_out => id_po_param_alias_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
       FORALL indx IN rows_in.FIRST .. rows_in.LAST
            ...
            VALUES (
               rows_in(indx).ID_PO_PARAM_ALIAS,
               rows_in(indx).CODE_PO_PARAM_ALIAS,
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_PO_PARAM_ALIAS _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_PO_PARAM_ALIAS
                  ,validate_in => FALSE
                );

                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'CODE_PO_PARAM_ALIAS _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).CODE_PO_PARAM_ALIAS
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
   ...
   l_CODE_PO_PARAM_ALIAS_n NUMBER(1);
   ...
   l_CODE_PO_PARAM_ALIAS_n := sys.diutil.bool_to_int(CODE_PO_PARAM_ALIAS_nin);
   ...
   l_UPDATE_INSTITUTION_n := sys.diutil.bool_to_int(UPDATE_INSTITUTION_nin);
         ...
         UPDATE PO_PARAM_ALIAS SET
     CODE_PO_PARAM_ALIAS = decode (l_CODE_PO_PARAM_ALIAS_n,0,code_po_param_alias_in, NVL (code_po_param_alias_in, CODE_PO_PARAM_ALIAS)),
     ...
     UPDATE_INSTITUTION = decode (l_UPDATE_INSTITUTION_n,0,update_institution_in, NVL (update_institution_in, UPDATE_INSTITUTION))
          WHERE
             ID_PO_PARAM_ALIAS = id_po_param_alias_in
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      id_po_param_alias_in => id_po_param_alias_in,
      code_po_param_alias_in => code_po_param_alias_in,
      CODE_PO_PARAM_ALIAS_nin => CODE_PO_PARAM_ALIAS_nin,
      id_po_param_in => id_po_param_in,
...
PROCEDURE upd (
   ...
   l_UPDATE_TIME_n NUMBER(1);
   l_UPDATE_INSTITUTION_n NUMBER(1);
      id_po_param_alias_in PO_PARAM_ALIAS.ID_PO_PARAM_ALIAS%TYPE;
   BEGIN
...
l_sql := 'UPDATE PO_PARAM_ALIAS SET '
     || ' CODE_PO_PARAM_ALIAS = decode (' || l_CODE_PO_PARAM_ALIAS_n || ',0,:code_po_param_alias_in, NVL (:code_po_param_alias_in, CODE_PO_PARAM_ALIAS)) '|| ','
     || ' ID_PO_PARAM = decode (' || l_ID_PO_PARAM_n || ',0,:id_po_param_in, NVL (:id_po_param_in, ID_PO_PARAM)) '|| ','
     || ' ID_INST_OWNER = decode (' || l_ID_INST_OWNER_n || ',0,:id_inst_owner_in, NVL (:id_inst_owner_in, ID_INST_OWNER)) '|| ','
     || ' ID_INSTITUTION = decode (' || l_ID_INSTITUTION_n || ',0,:id_institution_in, NVL (:id_institution_in, ID_INSTITUTION)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         id_po_param_alias_in => rec_in.ID_PO_PARAM_ALIAS,
         code_po_param_alias_in => rec_in.CODE_PO_PARAM_ALIAS,
   ...
   IS
      l_ID_PO_PARAM_ALIAS ID_PO_PARAM_ALIAS_cc;
      l_CODE_PO_PARAM_ALIAS CODE_PO_PARAM_ALIAS_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         l_ID_PO_PARAM_ALIAS(i) := col_in(i).ID_PO_PARAM_ALIAS;
         l_CODE_PO_PARAM_ALIAS(i) := col_in(i).CODE_PO_PARAM_ALIAS;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE PO_PARAM_ALIAS SET
               CODE_PO_PARAM_ALIAS = NVL (l_CODE_PO_PARAM_ALIAS(i), CODE_PO_PARAM_ALIAS),
             ...
             WHERE
                ID_PO_PARAM_ALIAS = l_ID_PO_PARAM_ALIAS(i)
          returning rowid bulk collect into rows_out;
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE PO_PARAM_ALIAS SET
               CODE_PO_PARAM_ALIAS = l_CODE_PO_PARAM_ALIAS(i),
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE PO_PARAM_ALIAS set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE PO_PARAM_ALIAS set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE ID_PO_PARAM_ALIAS = id_po_param_alias_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE
          ID_DEP_CLIN_SERV = del_POPA_DCS_FK.id_dep_clin_serv_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_POPA_DCS_FK (
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE
          ID_INSTITUTION = del_POPA_INST_FK.id_institution_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_POPA_INST_FK (
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE
          ID_PO_PARAM = del_POPA_POP_FK.id_po_param_in AND
          ID_INST_OWNER = del_POPA_POP_FK.id_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_POPA_POP_FK (
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE
          ID_PROFESSIONAL = del_POPA_PROF_FK.id_professional_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_POPA_PROF_FK (
   ...
   BEGIN
      DELETE FROM PO_PARAM_ALIAS
       WHERE
          ID_SOFTWARE = del_POPA_SOFT_FK.id_software_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_POPA_SOFT_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM PO_PARAM_ALIAS';
      ELSE
         RETURN
            'DELETE FROM PO_PARAM_ALIAS WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      po_param_alias_inout.ID_PO_PARAM_ALIAS := NULL;
      po_param_alias_inout.CODE_PO_PARAM_ALIAS := NULL;
      po_param_alias_inout.ID_PO_PARAM := NULL;
      po_param_alias_inout.ID_INST_OWNER := NULL;
      po_param_alias_inout.ID_INSTITUTION := NULL;
      po_param_alias_inout.ID_SOFTWARE := NULL;
      po_param_alias_inout.ID_DEP_CLIN_SERV := NULL;
      po_param_alias_inout.ID_PROFESSIONAL := NULL;
      po_param_alias_inout.CREATE_USER := NULL;
      po_param_alias_inout.CREATE_TIME := NULL;
      po_param_alias_inout.CREATE_INSTITUTION := NULL;
      po_param_alias_inout.UPDATE_USER := NULL;
      po_param_alias_inout.UPDATE_TIME := NULL;
      po_param_alias_inout.UPDATE_INSTITUTION := NULL;
   END initrec;

   FUNCTION initrec RETURN PO_PARAM_ALIAS%ROWTYPE
   IS
      l_po_param_alias PO_PARAM_ALIAS%ROWTYPE;
   BEGIN
      RETURN l_po_param_alias;
   END initrec;
   ...
   IS
        data PO_PARAM_ALIAS_tc;
   BEGIN
        select * bulk collect into data from PO_PARAM_ALIAS where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
