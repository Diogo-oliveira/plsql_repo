...
CREATE OR REPLACE PACKAGE BODY ts_pn_dblock_soft_inst
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2022-12-05 15:43:01
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ins(id_pn_note_type_in          => id_pn_note_type_in,
            ...
            code_message_title_in       => code_message_title_in,
    ...
    (
        ...
        l_rec pn_dblock_soft_inst%ROWTYPE := rec_in;
    BEGIN
        ...
        ins(id_pn_note_type_in          => l_rec.id_pn_note_type,
            ...
            code_message_title_in       => l_rec.code_message_title,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                ...
                VALUES
                    (rows_in(indx).id_institution,
                     ...
                     rows_in(indx).code_message_title,
    ...
    (
        ...
        l_code_message_title_n       NUMBER(1) := sys.diutil.bool_to_int(code_message_title_nin);
    ...
    BEGIN
        ...
        UPDATE pn_dblock_soft_inst
           SET flg_available            = decode(l_flg_available_n,
               ...
               code_message_title       = decode(l_code_message_title_n,
                                                 0,
                                                 code_message_title_in,
                                                 nvl(code_message_title_in, code_message_title)),
    ...
    BEGIN
        upd(id_pn_note_type_in           => id_pn_note_type_in,
            ...
            code_message_title_in        => code_message_title_in,
            code_message_title_nin       => code_message_title_nin,
            create_user_in               => create_user_in,
    ...
    BEGIN
        ...
        l_code_message_title_n       := sys.diutil.bool_to_int(code_message_title_nin);
        ...
        l_sql                        := 'UPDATE pn_dblock_soft_inst SET' || ' FLG_AVAILABLE = decode (' ||
                                        l_flg_available_n ||
                                        ...
                                        ' CODE_MESSAGE_TITLE = decode (' || l_code_message_title_n ||
                                        ',0,:CODE_MESSAGE_TITLE_in, NVL (:CODE_MESSAGE_TITLE_in, CODE_MESSAGE_TITLE)) ' || ',' ||
    ...
    BEGIN
        upd(id_pn_note_type_in          => rec_in.id_pn_note_type,
            ...
            code_message_title_in       => rec_in.code_message_title,
    ...
    (
        ...
        l_code_message_title       code_message_title_cc;
    ...
    BEGIN
        ...
        LOOP
            ...
            l_code_message_title(i) := col_in(i).code_message_title;
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE pn_dblock_soft_inst
                   SET flg_available            = nvl(l_flg_available(i), flg_available),
                       ...
                       code_message_title       = nvl(l_code_message_title(i), code_message_title),
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE pn_dblock_soft_inst
                   SET flg_available            = l_flg_available(i),
                       ...
                       code_message_title       = l_code_message_title(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE pn_dblock_soft_inst
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE pn_dblock_soft_inst
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE pn_dblock_soft_inst
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM pn_dblock_soft_inst
         WHERE id_pn_note_type = id_pn_note_type_in
           AND id_department = id_department_in
           AND id_pn_data_block = id_pn_data_block_in
           AND id_institution = id_institution_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdbsi_dbprnt_fk(id_pndb_parent_in => id_pndb_parent_in,
                            handle_error_in   => handle_error_in,
                            rows_out          => rows_out);
    END del_pdbsi_dbprnt_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_dcs_fk(id_dep_clin_serv_in => id_dep_clin_serv_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_pdsi_dcs_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_dep_fk(id_department_in => id_department_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pdsi_dep_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_inst_fk(id_institution_in => id_institution_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_pdsi_inst_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_pndb_fk(id_pn_data_block_in => id_pn_data_block_in,
                         handle_error_in     => handle_error_in,
                         rows_out            => rows_out);
    END del_pdsi_pndb_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_pnsb_fk(id_pn_soap_block_in => id_pn_soap_block_in,
                         handle_error_in     => handle_error_in,
                         rows_out            => rows_out);
    END del_pdsi_pnsb_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pdsi_s_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pdsi_s_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pndbsi_pnnt_fk(id_pn_note_type_in => id_pn_note_type_in,
                           handle_error_in    => handle_error_in,
                           rows_out           => rows_out);
    END del_pndbsi_pnnt_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pndbsi_tt_fk(id_task_type_in => id_task_type_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_pndbsi_tt_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM pn_dblock_soft_inst';
        ELSE
            RETURN 'DELETE FROM pn_dblock_soft_inst WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pn_dblock_soft_inst_inout IN OUT pn_dblock_soft_inst%ROWTYPE) IS
    BEGIN
        pn_dblock_soft_inst_inout.id_pn_note_type          := NULL;
        pn_dblock_soft_inst_inout.id_department            := NULL;
        pn_dblock_soft_inst_inout.id_pn_data_block         := NULL;
        pn_dblock_soft_inst_inout.id_institution           := NULL;
        pn_dblock_soft_inst_inout.id_software              := NULL;
        pn_dblock_soft_inst_inout.id_dep_clin_serv         := NULL;
        pn_dblock_soft_inst_inout.id_pn_soap_block         := NULL;
        pn_dblock_soft_inst_inout.flg_available            := NULL;
        pn_dblock_soft_inst_inout.rank                     := NULL;
        pn_dblock_soft_inst_inout.flg_import               := NULL;
        pn_dblock_soft_inst_inout.flg_select               := NULL;
        pn_dblock_soft_inst_inout.flg_scope                := NULL;
        pn_dblock_soft_inst_inout.code_message_title       := NULL;
        pn_dblock_soft_inst_inout.create_user              := NULL;
        pn_dblock_soft_inst_inout.create_time              := NULL;
        pn_dblock_soft_inst_inout.create_institution       := NULL;
        pn_dblock_soft_inst_inout.update_user              := NULL;
        pn_dblock_soft_inst_inout.update_institution       := NULL;
        pn_dblock_soft_inst_inout.update_time              := NULL;
        pn_dblock_soft_inst_inout.flg_actions_available    := NULL;
        pn_dblock_soft_inst_inout.flg_line_on_boxes        := NULL;
        pn_dblock_soft_inst_inout.gender                   := NULL;
        pn_dblock_soft_inst_inout.age_min                  := NULL;
        pn_dblock_soft_inst_inout.age_max                  := NULL;
        pn_dblock_soft_inst_inout.flg_pregnant             := NULL;
        pn_dblock_soft_inst_inout.flg_outside_period       := NULL;
        pn_dblock_soft_inst_inout.days_available_period    := NULL;
        pn_dblock_soft_inst_inout.flg_mandatory            := NULL;
        pn_dblock_soft_inst_inout.flg_cp_no_changes_import := NULL;
        pn_dblock_soft_inst_inout.flg_import_date          := NULL;
        pn_dblock_soft_inst_inout.flg_group_on_import      := NULL;
        pn_dblock_soft_inst_inout.id_pndb_parent           := NULL;
        pn_dblock_soft_inst_inout.flg_struct_type          := NULL;
        pn_dblock_soft_inst_inout.flg_show_title           := NULL;
        pn_dblock_soft_inst_inout.flg_show_sub_title       := NULL;
        pn_dblock_soft_inst_inout.flg_data_removable       := NULL;
        pn_dblock_soft_inst_inout.auto_pop_exec_prof_cat   := NULL;
        pn_dblock_soft_inst_inout.flg_focus                := NULL;
        pn_dblock_soft_inst_inout.flg_editable             := NULL;
        pn_dblock_soft_inst_inout.flg_group_select_filter  := NULL;
        pn_dblock_soft_inst_inout.id_task_type             := NULL;
        pn_dblock_soft_inst_inout.flg_order_type           := NULL;
        pn_dblock_soft_inst_inout.flg_signature            := NULL;
        pn_dblock_soft_inst_inout.flg_min_value            := NULL;
        pn_dblock_soft_inst_inout.flg_default_value        := NULL;
        pn_dblock_soft_inst_inout.flg_max_value            := NULL;
        pn_dblock_soft_inst_inout.flg_format               := NULL;
        pn_dblock_soft_inst_inout.flg_validation           := NULL;
        pn_dblock_soft_inst_inout.id_pndb_related          := NULL;
        pn_dblock_soft_inst_inout.id_swf_file_viewer       := NULL;
        pn_dblock_soft_inst_inout.value_viewer             := NULL;
        pn_dblock_soft_inst_inout.min_days_period          := NULL;
        pn_dblock_soft_inst_inout.max_days_period          := NULL;
        pn_dblock_soft_inst_inout.default_days_period      := NULL;
        pn_dblock_soft_inst_inout.flg_exc_sum_page_da      := NULL;
        pn_dblock_soft_inst_inout.flg_group_type           := NULL;
        pn_dblock_soft_inst_inout.desc_function            := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN pn_dblock_soft_inst%ROWTYPE IS
        l_pn_dblock_soft_inst pn_dblock_soft_inst%ROWTYPE;
    BEGIN
        RETURN l_pn_dblock_soft_inst;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_dblock_soft_inst_tc IS
        data pn_dblock_soft_inst_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM pn_dblock_soft_inst
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_dblock_soft_inst_tc IS
        data pn_dblock_soft_inst_tc;
