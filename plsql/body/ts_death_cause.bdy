/*-- Last Change Revision: $Rev: 2027993 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:53 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_death_cause
/*
...
*/
 IS
    ...
    (
        ...
        l_rec death_cause%ROWTYPE := rec_in;
    BEGIN
    ...
    BEGIN
        ...
        UPDATE death_cause
         ...
         WHERE id_epis_diagnosis = id_epis_diagnosis_in
           AND id_death_cause = id_death_cause_in
    ...
    BEGIN
        ...
        l_sql                   := 'UPDATE death_cause SET' || ' ID_DEATH_REGISTRY = decode (' || l_id_death_registry_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_death_registry_in, death_cause_rank_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_diag_inst_owner_in, id_alert_diagnosis_in, id_adiag_inst_owner_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE death_cause
                 ...
                 WHERE id_epis_diagnosis = l_id_epis_diagnosis(i)
                   AND id_death_cause = l_id_death_cause(i)
    ...
    BEGIN
        RETURN 'BEGIN UPDATE death_cause
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE death_cause
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE death_cause
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM death_cause
         WHERE id_death_cause = id_death_cause_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM death_cause
         WHERE id_death_registry = id_death_registry_in
           AND death_cause_rank = death_cause_rank_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dthc_dthc_uk(id_death_cause_in => id_death_cause_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_dthc_dthc_uk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dthc_dthr_dcr_uk(id_death_registry_in => id_death_registry_in,
                             death_cause_rank_in  => death_cause_rank_in,
                             handle_error_in      => handle_error_in,
                             rows_out             => rows_out);
    END del_dthc_dthr_dcr_uk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dc_adi_fk(id_alert_diagnosis_in  => id_alert_diagnosis_in,
                      id_adiag_inst_owner_in => id_adiag_inst_owner_in,
                      handle_error_in        => handle_error_in,
                      rows_out               => rows_out);
    END del_dc_adi_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dc_diag_fk(id_diagnosis_in       => id_diagnosis_in,
                       id_diag_inst_owner_in => id_diag_inst_owner_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_dc_diag_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dthc_dthr_fk(id_death_registry_in => id_death_registry_in,
                         handle_error_in      => handle_error_in,
                         rows_out             => rows_out);
    END del_dthc_dthr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dthc_ed_fk(id_epis_diagnosis_in => id_epis_diagnosis_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_dthc_ed_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM death_cause';
        ELSE
            RETURN 'DELETE FROM death_cause WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(death_cause_inout IN OUT death_cause%ROWTYPE) IS
    BEGIN
        death_cause_inout.id_epis_diagnosis   := NULL;
        death_cause_inout.id_death_cause      := NULL;
        death_cause_inout.id_diagnosis        := NULL;
        death_cause_inout.id_death_registry   := NULL;
        death_cause_inout.death_cause_rank    := NULL;
        death_cause_inout.create_user         := NULL;
        death_cause_inout.create_time         := NULL;
        death_cause_inout.create_institution  := NULL;
        death_cause_inout.update_user         := NULL;
        death_cause_inout.update_time         := NULL;
        death_cause_inout.update_institution  := NULL;
        death_cause_inout.id_diag_inst_owner  := NULL;
        death_cause_inout.id_alert_diagnosis  := NULL;
        death_cause_inout.id_adiag_inst_owner := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN death_cause%ROWTYPE IS
        l_death_cause death_cause%ROWTYPE;
    BEGIN
        RETURN l_death_cause;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN death_cause_tc IS
        data death_cause_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN death_cause_tc IS
        data death_cause_tc;
