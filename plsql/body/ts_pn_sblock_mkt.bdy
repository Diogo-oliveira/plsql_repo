/*-- Last Change Revision: $Rev: 1888947 $*/
/*-- Last Change by: $Author: vitor.sa $*/
/*-- Date of last change: $Date: 2019-01-28 15:49:17 +0000 (seg, 28 jan 2019) $*/
CREATE OR REPLACE PACKAGE BODY ts_pn_sblock_mkt
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2019-01-21 11:46:36
| Created By: ALERT
*/
 IS
    ...
    (
        ...
        l_rec pn_sblock_mkt%ROWTYPE := rec_in;
    BEGIN
    ...
    BEGIN
        ...
        l_sql                  := 'UPDATE pn_sblock_mkt SET' || ' RANK = decode (' || l_rank_n ||
                                  ...
                                  l_age_max_n || ',0,:AGE_MAX_in, NVL (:AGE_MAX_in, AGE_MAX)) ' || ' where ' ||
                                  nvl(where_in, '(1=1)') || ' RETURNING ROWID BULK COLLECT INTO :l_rows_out';
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN rank_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, flg_execute_import_in, flg_show_title_in, id_swf_file_viewer_in, value_viewer_in, age_min_in, age_max_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        RETURN 'BEGIN UPDATE pn_sblock_mkt
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE pn_sblock_mkt
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE pn_sblock_mkt
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pnsbm_pnnt_fk(id_pn_note_type_in => id_pn_note_type_in,
                          handle_error_in    => handle_error_in,
                          rows_out           => rows_out);
    END del_pnsbm_pnnt_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_psm_mrk_fk(id_market_in => id_market_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_psm_mrk_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_psm_pnsb_fk(id_pn_soap_block_in => id_pn_soap_block_in,
                        handle_error_in     => handle_error_in,
                        rows_out            => rows_out);
    END del_psm_pnsb_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_psm_s_fk(id_software_in => id_software_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_psm_s_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM pn_sblock_mkt';
        ELSE
            RETURN 'DELETE FROM pn_sblock_mkt WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pn_sblock_mkt_inout IN OUT pn_sblock_mkt%ROWTYPE) IS
    BEGIN
        pn_sblock_mkt_inout.id_pn_soap_block   := NULL;
        pn_sblock_mkt_inout.id_pn_note_type    := NULL;
        pn_sblock_mkt_inout.id_software        := NULL;
        pn_sblock_mkt_inout.id_market          := NULL;
        pn_sblock_mkt_inout.rank               := NULL;
        pn_sblock_mkt_inout.create_user        := NULL;
        pn_sblock_mkt_inout.create_time        := NULL;
        pn_sblock_mkt_inout.create_institution := NULL;
        pn_sblock_mkt_inout.update_user        := NULL;
        pn_sblock_mkt_inout.update_time        := NULL;
        pn_sblock_mkt_inout.update_institution := NULL;
        pn_sblock_mkt_inout.flg_execute_import := NULL;
        pn_sblock_mkt_inout.flg_show_title     := NULL;
        pn_sblock_mkt_inout.id_swf_file_viewer := NULL;
        pn_sblock_mkt_inout.value_viewer       := NULL;
        pn_sblock_mkt_inout.age_min            := NULL;
        pn_sblock_mkt_inout.age_max            := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN pn_sblock_mkt%ROWTYPE IS
        l_pn_sblock_mkt pn_sblock_mkt%ROWTYPE;
    BEGIN
        RETURN l_pn_sblock_mkt;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pn_sblock_mkt_tc IS
        data pn_sblock_mkt_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pn_sblock_mkt_tc IS
        data pn_sblock_mkt_tc;
