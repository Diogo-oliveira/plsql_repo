/*-- Last Change Revision: $Rev: 2028133 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:16 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_epis_positioning
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_positioning.id_epis_positioning%TYPE IS
        retval epis_positioning.id_epis_positioning%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_epis_positioning.nextval;
        ELSE
    ...
    (
        ...
        l_pky epis_positioning.id_epis_positioning%TYPE := next_key;
    BEGIN
        ins(id_epis_positioning_in  => l_pky,
    ...
    BEGIN
        ins(id_episode_in           => id_episode_in,
            ...
            flg_origin_in           => flg_origin_in,
            id_episode_context_in   => id_episode_context_in,
            id_epis_positioning_out => id_epis_positioning_out,
            handle_error_in         => handle_error_in,
            rows_out                => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN epis_positioning.id_epis_positioning%TYPE IS
        l_pky epis_positioning.id_epis_positioning%TYPE := next_key;
    BEGIN
        ins(id_epis_positioning_in  => l_pky,
            id_episode_in           => id_episode_in,
    ...
    (
        ...
        l_rec epis_positioning%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_positioning := next_key(sequence_in);
        END IF;
    
        ins(id_epis_positioning_in  => l_rec.id_epis_positioning,
    ...
    BEGIN
        ...
        l_sql                    := 'UPDATE epis_positioning SET' || ' ID_EPISODE = decode (' || l_id_episode_n ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_epis_positioning_in,
                id_episode_in,
                id_professional_in,
                flg_status_in,
                flg_massage_in,
    ...
    BEGIN
        upd(id_epis_positioning_in  => rec_in.id_epis_positioning,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_positioning
                 ...
                 WHERE id_epis_positioning = l_id_epis_positioning(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_positioning
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_positioning
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_positioning
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_positioning
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_positioning_in => id_epis_positioning_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;
    ...
    END del_epg_rotation_interval_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epg_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_epg_epis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epg_prof_fk(id_professional_in => id_professional_in,
                        handle_error_in    => handle_error_in,
                        rows_out           => rows_out);
    END del_epg_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epg_prof_fk2(id_prof_cancel_in => id_prof_cancel_in,
                         handle_error_in   => handle_error_in,
                         rows_out          => rows_out);
    END del_epg_prof_fk2;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epg_prof_fk3(id_prof_inter_in => id_prof_inter_in,
                         handle_error_in  => handle_error_in,
                         rows_out         => rows_out);
    END del_epg_prof_fk3;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epg_rotation_interval_fk(id_rotation_interval_in => id_rotation_interval_in,
                                     handle_error_in         => handle_error_in,
                                     rows_out                => rows_out);
    END del_epg_rotation_interval_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ep_icr_fk(id_cancel_reason_in => id_cancel_reason_in,
                      handle_error_in     => handle_error_in,
                      rows_out            => rows_out);
    END del_ep_icr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_positioning';
        ELSE
            RETURN 'DELETE FROM epis_positioning WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_positioning_inout IN OUT epis_positioning%ROWTYPE) IS
    BEGIN
        epis_positioning_inout.id_epis_positioning  := NULL;
        epis_positioning_inout.id_episode           := NULL;
        epis_positioning_inout.id_professional      := NULL;
        epis_positioning_inout.flg_status           := NULL;
        epis_positioning_inout.flg_massage          := NULL;
        epis_positioning_inout.notes                := NULL;
        epis_positioning_inout.id_prof_cancel       := NULL;
        epis_positioning_inout.notes_cancel         := NULL;
        epis_positioning_inout.rot_interval         := NULL;
        epis_positioning_inout.id_prof_inter        := NULL;
        epis_positioning_inout.notes_inter          := NULL;
        epis_positioning_inout.dt_creation_tstz     := NULL;
        epis_positioning_inout.dt_cancel_tstz       := NULL;
        epis_positioning_inout.dt_inter_tstz        := NULL;
        epis_positioning_inout.create_user          := NULL;
        epis_positioning_inout.create_time          := NULL;
        epis_positioning_inout.create_institution   := NULL;
        epis_positioning_inout.update_user          := NULL;
        epis_positioning_inout.update_time          := NULL;
        epis_positioning_inout.update_institution   := NULL;
        epis_positioning_inout.id_rotation_interval := NULL;
        epis_positioning_inout.id_cancel_reason     := NULL;
        epis_positioning_inout.dt_epis_positioning  := NULL;
        epis_positioning_inout.flg_origin           := NULL;
        epis_positioning_inout.id_episode_context   := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_positioning%ROWTYPE IS
        l_epis_positioning epis_positioning%ROWTYPE;
    BEGIN
        RETURN l_epis_positioning;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_positioning_tc IS
        data epis_positioning_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_positioning_tc IS
        data epis_positioning_tc;
