...
CREATE OR REPLACE PACKAGE BODY ts_co_sign
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {7A44F965-7C77-42EE-9A04-269EF006213B}
| Created On: Janeiro 7, 2015 13:17:25
| Created By: ALERT
*/
 IS
            ...
            ELSE
                ...
                BEGIN
                    ...
                    THEN
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_ACTION',
                                                        value_in           => id_action_in,
                                                        validate_in        => FALSE);
                        pk_alert_exceptions.raise_error_instance(err_instance_id_in => l_err_instance_id);
                    ELSIF l_name = 'CS_PK_IDX'
                    THEN
                        pk_alert_exceptions.register_error(error_name_in       => 'DUPLICATE-VALUE',
                                                           err_instance_id_out => l_err_instance_id,
                                                           text_in             => 'Violation of unique index "CS_PK_IDX"');
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'OWNER',
                                                        value_in           => l_owner,
                                                        validate_in        => FALSE);
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'CS_PROF_CONSIGNED_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROF_CO_SIGNED',
                                                        value_in           => id_prof_co_signed_in);
                    END IF;
                    IF l_name = 'CS_PROF_CREATED_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                    ...
                    END IF;
                    IF l_name = 'CS_PROF_ORD_BY_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROF_ORDERED_BY',
                                                        value_in           => id_prof_ordered_by_in);
                    END IF;
                    IF l_name = 'CS_TASK_TYPE_ACTION_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_TASK_TYPE',
    ...
    (
        ...
        l_rec co_sign%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_co_sign := next_key(sequence_in);
        END IF;
        ins(id_co_sign_in         => l_rec.id_co_sign,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN co_sign.id_co_sign%TYPE
     ...
     IS
        retval co_sign.id_co_sign%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_co_sign.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_CO_SIGN'));
    END next_key;
    ...
    (
        ...
        l_pky co_sign.id_co_sign%TYPE := next_key;
    BEGIN
        ins(id_co_sign_in         => l_pky,
            id_task_in            => id_task_in,
            id_task_group_in      => id_task_group_in,
            id_task_type_in       => id_task_type_in,
            id_action_in          => id_action_in,
    ...
    (
        ...
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) RETURN co_sign.id_co_sign%TYPE IS
        l_pky co_sign.id_co_sign%TYPE := next_key;
    BEGIN
        ins(id_co_sign_in         => l_pky,
            id_task_in            => id_task_in,
    ...
    BEGIN
        ...
        UPDATE co_sign
           SET id_task            = decode(l_id_task_n, 0, id_task_in, nvl(id_task_in, id_task)),
         ...
         WHERE id_co_sign = id_co_sign_in
    ...
    (
        ...
        l_update_time_n        NUMBER(1);
        l_update_institution_n NUMBER(1);
        id_co_sign_in          co_sign.id_co_sign%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE CO_SIGN SET ' || ' ID_TASK = decode (' || l_id_task_n ||
                 ...
                 ' FLG_STATUS = decode (' || l_flg_status_n || ',0,:flg_status_in, NVL (:flg_status_in, FLG_STATUS)) ' || ',' ||
                 ' FLG_MADE_AUTH = decode (' || l_flg_made_auth_n ||
                 ',0,:flg_made_auth_in, NVL (:flg_made_auth_in, FLG_MADE_AUTH)) ' || ',' || ' CREATE_USER = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_task_in, id_task_group_in, id_task_type_in, id_action_in, id_order_type_in, id_episode_in, id_prof_created_in, id_prof_ordered_by_in, id_prof_co_signed_in, dt_created_in, dt_ordered_by_in, dt_co_signed_in, flg_status_in, flg_made_auth_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_co_sign_in         => rec_in.id_co_sign,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE co_sign
                   SET id_task            = nvl(l_id_task(i), id_task),
                 ...
                 WHERE id_co_sign = l_id_co_sign(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE co_sign
                   SET id_task            = l_id_task(i),
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE CO_SIGN set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE CO_SIGN set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_co_sign_in => id_co_sign_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_co_sign(id_co_sign_in => id_co_sign_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_id_co_sign;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_co_sign_uk(id_task_in      => id_task_in,
                       id_task_type_in => id_task_type_in,
                       id_action_in    => id_action_in,
                       handle_error_in => handle_error_in,
                       rows_out        => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_pk_idx(id_task_in      => id_task_in,
                      id_task_type_in => id_task_type_in,
                      id_action_in    => id_action_in,
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_episode = del_cs_episode_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_episode_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_cs_episode_fk;
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_order_type = del_cs_order_type_fk.id_order_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_order_type_fk(id_order_type_in => id_order_type_in,
                             handle_error_in  => handle_error_in,
                             rows_out         => rows_out);
    END del_cs_order_type_fk;
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_prof_co_signed = del_cs_prof_consigned_fk.id_prof_co_signed_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_prof_consigned_fk(id_prof_co_signed_in => id_prof_co_signed_in,
                                 handle_error_in      => handle_error_in,
                                 rows_out             => rows_out);
    END del_cs_prof_consigned_fk;
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_prof_created = del_cs_prof_created_fk.id_prof_created_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_prof_created_fk(id_prof_created_in => id_prof_created_in,
                               handle_error_in    => handle_error_in,
                               rows_out           => rows_out);
    END del_cs_prof_created_fk;
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_prof_ordered_by = del_cs_prof_ord_by_fk.id_prof_ordered_by_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_prof_ord_by_fk(id_prof_ordered_by_in => id_prof_ordered_by_in,
                              handle_error_in       => handle_error_in,
                              rows_out              => rows_out);
    END del_cs_prof_ord_by_fk;
    ...
    BEGIN
        DELETE FROM co_sign
         WHERE id_task_type = del_cs_task_type_action_fk.id_task_type_in
           AND id_action = del_cs_task_type_action_fk.id_action_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_cs_task_type_action_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_cs_task_type_action_fk(id_task_type_in => id_task_type_in,
                                   id_action_in    => id_action_in,
                                   handle_error_in => handle_error_in,
                                   rows_out        => rows_out);
    END del_cs_task_type_action_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM CO_SIGN';
        ELSE
            RETURN 'DELETE FROM CO_SIGN WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(co_sign_inout IN OUT co_sign%ROWTYPE) IS
    BEGIN
        co_sign_inout.id_co_sign         := NULL;
        co_sign_inout.id_task            := NULL;
        co_sign_inout.id_task_group      := NULL;
        co_sign_inout.id_task_type       := NULL;
        co_sign_inout.id_action          := NULL;
        co_sign_inout.id_order_type      := NULL;
        co_sign_inout.id_episode         := NULL;
        co_sign_inout.id_prof_created    := NULL;
        co_sign_inout.id_prof_ordered_by := NULL;
        co_sign_inout.id_prof_co_signed  := NULL;
        co_sign_inout.dt_created         := NULL;
        co_sign_inout.dt_ordered_by      := NULL;
        co_sign_inout.dt_co_signed       := NULL;
        co_sign_inout.flg_status         := NULL;
        co_sign_inout.flg_made_auth      := NULL;
        co_sign_inout.create_user        := NULL;
        co_sign_inout.create_time        := NULL;
        co_sign_inout.create_institution := NULL;
        co_sign_inout.update_user        := NULL;
        co_sign_inout.update_time        := NULL;
        co_sign_inout.update_institution := NULL;
    END initrec;

    FUNCTION initrec RETURN co_sign%ROWTYPE IS
        l_co_sign co_sign%ROWTYPE;
    BEGIN
        RETURN l_co_sign;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN co_sign_tc IS
        data co_sign_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN co_sign_tc IS
