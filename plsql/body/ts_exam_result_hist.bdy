...
*/
 IS
                ...
                BEGIN
                    ...
                    THEN
                        pk_alert_exceptions.register_error(error_name_in       => 'DUPLICATE-VALUE',
                                                           ...
                                                           text_in             => 'Violation of unique index "ERH_PK"');
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'TABLE_NAME',
                                                        value_in           => 'EXAM_RESULT_HIST',
                                                        validate_in        => FALSE);
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_EXAM_RESULT_HIST',
                                                        value_in           => dt_exam_result_hist_in,
                                                        validate_in        => FALSE);
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
    ...
    BEGIN
        ...
        ins(dt_exam_result_hist_in        => dt_exam_result_hist_in,
    ...
    */
    ...
    BEGIN
        ...
        upd(dt_exam_result_hist_in        => dt_exam_result_hist_in,
            id_exam_result_in             => id_exam_result_in,
            id_exam_in                    => id_exam_in,
            id_exam_req_det_in            => id_exam_req_det_in,
            id_professional_in            => id_professional_in,
    ...
    BEGIN
        n_upd_clobs_in_chunks(dt_exam_result_hist_in        => dt_exam_result_hist_in,
                              id_exam_result_in             => id_exam_result_in,
                              id_exam_in                    => id_exam_in,
                              id_exam_req_det_in            => id_exam_req_det_in,
                              id_professional_in            => id_professional_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(dt_exam_result_hist_in        => dt_exam_result_hist_in,
                                  id_exam_result_in             => id_exam_result_in,
                                  id_exam_in                    => id_exam_in,
                                  id_exam_req_det_in            => id_exam_req_det_in,
                                  id_professional_in            => id_professional_in,
    ...
    */
    ...
    (
        ...
        l_rec exam_result_hist%ROWTYPE := rec_in;
    BEGIN
        ins(dt_exam_result_hist_in        => l_rec.dt_exam_result_hist,
            ...
            FORALL indx IN rows_in.first .. rows_in.last SAVE EXCEPTIONS
                INSERT INTO exam_result_hist
                    (dt_exam_result_hist,
                     ...
                     flg_relevant)
                VALUES
                    (rows_in(indx).dt_exam_result_hist,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_EXAM_RESULT_HIST _' || indx,
    ...
    BEGIN
        ...
        UPDATE exam_result_hist
         ...
         WHERE dt_exam_result_hist = dt_exam_result_hist_in
           AND id_exam_result = id_exam_result_in
    ...
    (
        ...
        l_id_epis_documentation_n      NUMBER(1);
        l_flg_relevant_n               NUMBER(1);
        dt_exam_result_hist_in         exam_result_hist.dt_exam_result_hist%TYPE;
        id_exam_result_in              exam_result_hist.id_exam_result%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EXAM_RESULT_HIST SET ' || ' ID_EXAM = decode (' || l_id_exam_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_exam_in, id_exam_req_det_in, id_professional_in, id_patient_in, flg_type_in, id_institution_in, id_prof_mov_begin_in, id_prof_mov_end_in, id_episode_in, id_episode_write_in, dt_exam_result_tstz_in, dt_mov_begin_tstz_in, dt_mov_end_tstz_in, id_external_doc_in, flg_status_in, dt_exam_result_cancel_tstz_in, id_prof_cancel_in, flg_result_origin_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_result_status_in, notes_in, id_cancel_reason_in, notes_cancel_in, id_result_notes_in, notes_result_in, id_prof_read_in, dt_prof_read_tstz_in, id_exam_result_parent_in, result_origin_notes_in, id_abnormality_in, id_epis_documentation_in, flg_relevant_in, OUT l_rows_out;
    ...
    BEGIN
        upd(dt_exam_result_hist_in        => rec_in.dt_exam_result_hist,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(dt_exam_result_hist_in,
                id_exam_result_in,
                id_exam_in,
                id_exam_req_det_in,
                id_professional_in,
    ...
    (
        ...
        l_dt_exam_result_hist        dt_exam_result_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_dt_exam_result_hist(i) := col_in(i).dt_exam_result_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_result_hist
                 ...
                 WHERE dt_exam_result_hist = l_dt_exam_result_hist(i)
                   AND id_exam_result = l_id_exam_result(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE exam_result_hist
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EXAM_RESULT_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE EXAM_RESULT_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EXAM_RESULT_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EXAM_RESULT_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(dt_exam_result_hist_in => dt_exam_result_hist_in,
            id_exam_result_in      => id_exam_result_in,
            handle_error_in        => handle_error_in,
            rows_out               => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_dt_exam_result_hist(dt_exam_result_hist_in => dt_exam_result_hist_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_dt_exam_result_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_erh_pk(dt_exam_result_hist_in => dt_exam_result_hist_in,
                   id_exam_result_in      => id_exam_result_in,
                   handle_error_in        => handle_error_in,
                   rows_out               => rows_out);
    END del_erh_pk;
    ...
    BEGIN
        DELETE FROM exam_result_hist
         WHERE id_exam_result = del_eresh_eres_fk.id_exam_result_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_eresh_eres_fk(id_exam_result_in => id_exam_result_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_eresh_eres_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EXAM_RESULT_HIST';
        ELSE
            RETURN 'DELETE FROM EXAM_RESULT_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(exam_result_hist_inout IN OUT exam_result_hist%ROWTYPE) IS
    BEGIN
        exam_result_hist_inout.dt_exam_result_hist        := NULL;
        exam_result_hist_inout.id_exam_result             := NULL;
        exam_result_hist_inout.id_exam                    := NULL;
        exam_result_hist_inout.id_exam_req_det            := NULL;
        exam_result_hist_inout.id_professional            := NULL;
        exam_result_hist_inout.id_patient                 := NULL;
        exam_result_hist_inout.flg_type                   := NULL;
        exam_result_hist_inout.id_institution             := NULL;
        exam_result_hist_inout.id_prof_mov_begin          := NULL;
        exam_result_hist_inout.id_prof_mov_end            := NULL;
        exam_result_hist_inout.id_episode                 := NULL;
        exam_result_hist_inout.id_episode_write           := NULL;
        exam_result_hist_inout.dt_exam_result_tstz        := NULL;
        exam_result_hist_inout.dt_mov_begin_tstz          := NULL;
        exam_result_hist_inout.dt_mov_end_tstz            := NULL;
        exam_result_hist_inout.id_external_doc            := NULL;
        exam_result_hist_inout.flg_status                 := 'A';
        exam_result_hist_inout.dt_exam_result_cancel_tstz := NULL;
        exam_result_hist_inout.id_prof_cancel             := NULL;
        exam_result_hist_inout.flg_result_origin          := NULL;
        exam_result_hist_inout.create_user                := NULL;
        exam_result_hist_inout.create_time                := NULL;
        exam_result_hist_inout.create_institution         := NULL;
        exam_result_hist_inout.update_user                := NULL;
        exam_result_hist_inout.update_time                := NULL;
        exam_result_hist_inout.update_institution         := NULL;
        exam_result_hist_inout.id_result_status           := NULL;
        exam_result_hist_inout.notes                      := NULL;
        exam_result_hist_inout.id_cancel_reason           := NULL;
        exam_result_hist_inout.notes_cancel               := NULL;
        exam_result_hist_inout.id_result_notes            := NULL;
        exam_result_hist_inout.notes_result               := NULL;
        exam_result_hist_inout.id_prof_read               := NULL;
        exam_result_hist_inout.dt_prof_read_tstz          := NULL;
        exam_result_hist_inout.id_exam_result_parent      := NULL;
        exam_result_hist_inout.result_origin_notes        := NULL;
        exam_result_hist_inout.id_abnormality             := NULL;
        exam_result_hist_inout.id_epis_documentation      := NULL;
        exam_result_hist_inout.flg_relevant               := NULL;
    END initrec;

    FUNCTION initrec RETURN exam_result_hist%ROWTYPE IS
        l_exam_result_hist exam_result_hist%ROWTYPE;
    BEGIN
        l_exam_result_hist.flg_status := 'A';
        RETURN l_exam_result_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN exam_result_hist_tc IS
        data exam_result_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM exam_result_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN exam_result_hist_tc IS
