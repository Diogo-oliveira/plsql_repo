/*-- Last Change Revision: $Rev: 2028318 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:45:04 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY TS_PAT_MEDICATION_LIST
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Maio 18, 2011 18:44:48
| Created By: ALERT
*/
IS
   ...
   EXCEPTION
      ...
      THEN
        ...
        BEGIN
           ...
           ELSIF l_name = 'PML_PDIR_IDX'
           THEN
              pk_alert_exceptions.register_error (
                 error_name_in => 'DUPLICATE-VALUE'
                ,err_instance_id_out => l_err_instance_id
                ,text_in => 'Violation of unique index "PML_PDIR_IDX"'
                );
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'PAT_MEDICATION_LIST');
           IF l_name = 'PML_CC_FK'
           THEN
   ...
   BEGIN
     ...
     ins (
      ...
      quantity_old_in => quantity_old_in,
   ...
   IS
      l_rec PAT_MEDICATION_LIST%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_PAT_MEDICATION_LIST := next_key (sequence_in);
      END IF;
      ins (
         ...
         quantity_old_in => l_rec.QUANTITY_OLD,
  ...
  ins (
   ...
   IS
     retval PAT_MEDICATION_LIST.ID_PAT_MEDICATION_LIST%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_PAT_MEDICATION_LIST.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_PAT_MEDICATION_LIST')
           );
   END next_key;
   ...
   IS
        l_pky PAT_MEDICATION_LIST.ID_PAT_MEDICATION_LIST%TYPE := next_key;
   BEGIN
      ins (
         id_pat_medication_list_in => l_pky,
         id_episode_in => id_episode_in,
         id_patient_in => id_patient_in,
         id_institution_in => id_institution_in,
         id_software_in => id_software_in,
      ...
      id_pat_medication_list_out := l_pky;
   END ins;
   ...
   BEGIN
      ...
      id_presc_directions_in => id_presc_directions_in,
      id_cdr_call_in => id_cdr_call_in,
      id_pat_medication_list_out => id_pat_medication_list_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO PAT_MEDICATION_LIST VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'QUANTITY_OLD _' || indx
                  ,value_in => rows_in(indx).QUANTITY_OLD
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
   ...
   l_QUANTITY_OLD_n := sys.diutil.bool_to_int(QUANTITY_OLD_nin);
   ...
   l_ID_CDR_CALL_n := sys.diutil.bool_to_int(ID_CDR_CALL_nin);
         ...
         UPDATE PAT_MEDICATION_LIST SET
     ...
     QUANTITY_OLD = decode (l_QUANTITY_OLD_n,0,quantity_old_in, NVL (quantity_old_in, QUANTITY_OLD)),
     ...
     ID_CDR_CALL = decode (l_ID_CDR_CALL_n,0,id_cdr_call_in, NVL (id_cdr_call_in, ID_CDR_CALL))
          WHERE
             ID_PAT_MEDICATION_LIST = id_pat_medication_list_in
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      ...
      quantity_old_in => quantity_old_in,
      QUANTITY_OLD_nin => QUANTITY_OLD_nin,
      flg_take_type_in => flg_take_type_in,
...
PROCEDURE upd (
   ...
   l_ID_PRESC_DIRECTIONS_n NUMBER(1);
   l_ID_CDR_CALL_n NUMBER(1);
      id_pat_medication_list_in PAT_MEDICATION_LIST.ID_PAT_MEDICATION_LIST%TYPE;
   BEGIN
...
l_sql := 'UPDATE PAT_MEDICATION_LIST SET '
     || ' ID_EPISODE = decode (' || l_ID_EPISODE_n || ',0,:id_episode_in, NVL (:id_episode_in, ID_EPISODE)) '|| ','
     || ' ID_PATIENT = decode (' || l_ID_PATIENT_n || ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) '|| ','
     || ' ID_INSTITUTION = decode (' || l_ID_INSTITUTION_n || ',0,:id_institution_in, NVL (:id_institution_in, ID_INSTITUTION)) '|| ','
     || ' ID_SOFTWARE = decode (' || l_ID_SOFTWARE_n || ',0,:id_software_in, NVL (:id_software_in, ID_SOFTWARE)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         ...
         quantity_old_in => rec_in.QUANTITY_OLD,
   ...
   IS
      ...
      l_QUANTITY_OLD QUANTITY_OLD_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         ...
         l_QUANTITY_OLD(i) := col_in(i).QUANTITY_OLD;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE PAT_MEDICATION_LIST SET
               ...
               QUANTITY_OLD = NVL (l_QUANTITY_OLD(i), QUANTITY_OLD),
   ...
   BEGIN
      RETURN
         'BEGIN UPDATE PAT_MEDICATION_LIST
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE PAT_MEDICATION_LIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE PAT_MEDICATION_LIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
   ...
   IS
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_PAT_MEDICATION_LIST = id_pat_medication_list_in
       RETURNING ROWID BULK COLLECT INTO rows_out
         ;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE ID_PAT_MEDICATION_LIST = id_pat_medication_list_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
      ...
      THEN
        ...
        END;
        END IF;
   END del_ID_PAT_MEDICATION_LIST;
...
del_PML_PDIR_IDX (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_CDR_CALL = del_PML_CC_FK.id_cdr_call_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_CC_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_DRUG_REQ_DET = del_PML_DRD_FK.id_drug_req_det_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_DRD_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_EPISODE = del_PML_EPIS_FK.id_episode_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_EPIS_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_INSTITUTION = del_PML_INST_FK.id_institution_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_INST_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          EMB_ID = del_PML_MED_EI_FK.emb_id_in AND
          VERS = del_PML_MED_EI_FK.vers_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_MED_EI_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_DRUG = del_PML_MED_INT_ID_FK.id_drug_in AND
          VERS = del_PML_MED_INT_ID_FK.vers_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_MED_INT_ID_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_PATIENT = del_PML_PAT_FK.id_patient_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_PAT_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_PRESC_DIRECTIONS = del_PML_PDIR_FK.id_presc_directions_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_PDIR_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_PROFESSIONAL = del_PML_PROFESSIONAL_FK.id_professional_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_PROFESSIONAL_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_SOFTWARE = del_PML_SOFTW_FK.id_software_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_SOFTW_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_UNIT_MEASURE_DUR = del_PML_UMD_FK.id_unit_measure_dur_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_UMD_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_UNIT_MEASURE_FREQ = del_PML_UMF_FK.id_unit_measure_freq_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_UMF_FK (
   ...
   BEGIN
      DELETE FROM PAT_MEDICATION_LIST
       WHERE
          ID_UNIT_MEASURE_QTY = del_PML_UMQ_FK.id_unit_measure_qty_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PML_UMQ_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM PAT_MEDICATION_LIST';
      ELSE
         RETURN
            'DELETE FROM PAT_MEDICATION_LIST WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      pat_medication_list_inout.ID_PAT_MEDICATION_LIST := NULL;
      pat_medication_list_inout.ID_EPISODE := NULL;
      pat_medication_list_inout.ID_PATIENT := NULL;
      pat_medication_list_inout.ID_INSTITUTION := NULL;
      pat_medication_list_inout.ID_SOFTWARE := NULL;
      pat_medication_list_inout.YEAR_BEGIN := NULL;
      pat_medication_list_inout.MONTH_BEGIN := NULL;
      pat_medication_list_inout.DAY_BEGIN := NULL;
      pat_medication_list_inout.QTY := NULL;
      pat_medication_list_inout.FREQUENCY := NULL;
      pat_medication_list_inout.FLG_STATUS := NULL;
      pat_medication_list_inout.ID_PROFESSIONAL := NULL;
      pat_medication_list_inout.NOTES := NULL;
      pat_medication_list_inout.FLG_PRESC := NULL;
      pat_medication_list_inout.ID_PRESCRIPTION_PHARM := NULL;
      pat_medication_list_inout.DT_PAT_MEDICATION_LIST_TSTZ := NULL;
      pat_medication_list_inout.ID_UNIT_MEASURE_QTY := NULL;
      pat_medication_list_inout.ID_UNIT_MEASURE_FREQ := NULL;
      pat_medication_list_inout.FREQ := NULL;
      pat_medication_list_inout.DURATION := NULL;
      pat_medication_list_inout.ID_UNIT_MEASURE_DUR := NULL;
      pat_medication_list_inout.DT_START_PAT_MED_TSTZ := NULL;
      pat_medication_list_inout.DT_END_PAT_MED_TSTZ := NULL;
      pat_medication_list_inout.EMB_ID := NULL;
      pat_medication_list_inout.ID_PROD_MED := NULL;
      pat_medication_list_inout.PROD_MED_DECR := NULL;
      pat_medication_list_inout.ID_DRUG_REQ_DET := NULL;
      pat_medication_list_inout.ID_DRUG_PRESC_DET := NULL;
      pat_medication_list_inout.ID_EPIS_DOCUMENTATION := NULL;
      pat_medication_list_inout.MED_ID_TYPE := NULL;
      pat_medication_list_inout.CONTINUE := NULL;
      pat_medication_list_inout.VERS := NULL;
      pat_medication_list_inout.ID_DRUG := NULL;
      pat_medication_list_inout.MED_ID := NULL;
      pat_medication_list_inout.DOSAGE := NULL;
      pat_medication_list_inout.FLG_NO_MED := NULL;
      pat_medication_list_inout.NOTES_ADVERS_REACT := NULL;
      pat_medication_list_inout.NOTES_MED_DESTINATION := NULL;
      pat_medication_list_inout.QUANTITY := NULL;
      pat_medication_list_inout.CREATE_USER := NULL;
      pat_medication_list_inout.CREATE_TIME := NULL;
      pat_medication_list_inout.CREATE_INSTITUTION := NULL;
      pat_medication_list_inout.UPDATE_USER := NULL;
      pat_medication_list_inout.UPDATE_TIME := NULL;
      pat_medication_list_inout.UPDATE_INSTITUTION := NULL;
      pat_medication_list_inout.QUANTITY_OLD := NULL;
      pat_medication_list_inout.FLG_TAKE_TYPE := NULL;
      pat_medication_list_inout.ID_PRESC_DIRECTIONS := NULL;
      pat_medication_list_inout.ID_CDR_CALL := NULL;
   END initrec;

   FUNCTION initrec RETURN PAT_MEDICATION_LIST%ROWTYPE
   IS
      l_pat_medication_list PAT_MEDICATION_LIST%ROWTYPE;
   BEGIN
      RETURN l_pat_medication_list;
   END initrec;
   ...
   IS
        data PAT_MEDICATION_LIST_tc;
   BEGIN
        select * bulk collect into data from PAT_MEDICATION_LIST where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
