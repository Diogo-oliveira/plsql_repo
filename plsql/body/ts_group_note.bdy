/*-- Last Change Revision: $Rev: 2028187 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:25 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_group_note
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: June 22, 2012 16:52:37
| Created By: ALERT
*/
 IS
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_group_note_in       => id_group_note_in,
                              id_group_in            => id_group_in,
                              id_prof_last_update_in => id_prof_last_update_in,
                              dt_last_update_in      => dt_last_update_in,
                              create_user_in         => create_user_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_group_note_in       => id_group_note_in,
                                  id_group_in            => id_group_in,
                                  id_prof_last_update_in => id_prof_last_update_in,
                                  dt_last_update_in      => dt_last_update_in,
                                  create_user_in         => create_user_in,
    ...
    */
    ...
    (
        ...
        l_rec group_note%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_group_note := next_key(sequence_in);
        END IF;
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN group_note.id_group_note%TYPE
     ...
     IS
        retval group_note.id_group_note%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_group_note.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_GROUP_NOTE'));
    END next_key;
    ...
    (
        ...
        l_pky group_note.id_group_note%TYPE := next_key;
    BEGIN
        ins(id_group_note_in       => l_pky,
            id_group_in            => id_group_in,
            id_prof_last_update_in => id_prof_last_update_in,
            dt_last_update_in      => dt_last_update_in,
            notes_in               => notes_in,
    ...
    BEGIN
        ins(id_group_in            => id_group_in,
            ...
            update_time_in         => update_time_in,
            update_institution_in  => update_institution_in,
            id_group_note_out      => id_group_note_out,
            handle_error_in        => handle_error_in,
            rows_out               => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) RETURN group_note.id_group_note%TYPE IS
        l_pky group_note.id_group_note%TYPE := next_key;
    BEGIN
        ins(id_group_note_in       => l_pky,
            id_group_in            => id_group_in,
    ...
    BEGIN
        ...
        UPDATE group_note
           SET id_group            = decode(l_id_group_n, 0, id_group_in, nvl(id_group_in, id_group)),
    ...
    (
        ...
        l_update_time_n         NUMBER(1);
        l_update_institution_n  NUMBER(1);
        id_group_note_in        group_note.id_group_note%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE GROUP_NOTE SET ' || ' ID_GROUP = decode (' || l_id_group_n ||
                 ',0,:id_group_in, NVL (:id_group_in, ID_GROUP)) ' || ',' || ' ID_PROF_LAST_UPDATE = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_group_in, id_prof_last_update_in, dt_last_update_in, notes_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE group_note
                   SET id_group            = nvl(l_id_group(i), id_group),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE GROUP_NOTE
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE GROUP_NOTE set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE GROUP_NOTE set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_group_note_in => id_group_note_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    BEGIN
        DELETE FROM group_note
         WHERE id_prof_last_update = del_gn_prof_fk.id_prof_last_update_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_gn_prof_fk(id_prof_last_update_in => id_prof_last_update_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_gn_prof_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM GROUP_NOTE';
        ELSE
            RETURN 'DELETE FROM GROUP_NOTE WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(group_note_inout IN OUT group_note%ROWTYPE) IS
    BEGIN
        group_note_inout.id_group_note       := NULL;
        group_note_inout.id_group            := NULL;
        group_note_inout.id_prof_last_update := NULL;
        group_note_inout.dt_last_update      := NULL;
        group_note_inout.notes               := NULL;
        group_note_inout.create_user         := NULL;
        group_note_inout.create_time         := NULL;
        group_note_inout.create_institution  := NULL;
        group_note_inout.update_user         := NULL;
        group_note_inout.update_time         := NULL;
        group_note_inout.update_institution  := NULL;
    END initrec;

    FUNCTION initrec RETURN group_note%ROWTYPE IS
        l_group_note group_note%ROWTYPE;
    BEGIN
        RETURN l_group_note;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN group_note_tc IS
        data group_note_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN group_note_tc IS
