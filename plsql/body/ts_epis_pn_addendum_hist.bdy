...
CREATE OR REPLACE PACKAGE BODY ts_epis_pn_addendum_hist
/*
...
*/
 IS
    ...
    BEGIN
        INSERT INTO epis_pn_addendum_hist
            (id_epis_pn_addendum,
             dt_epis_addendum_hist,
             id_epis_pn,
             flg_status,
             id_professional,
             dt_addendum,
    ...
    BEGIN
        ins(id_epis_pn_addendum_in   => id_epis_pn_addendum_in,
            dt_epis_addendum_hist_in => dt_epis_addendum_hist_in,
    ...
    (
        ...
        l_rec epis_pn_addendum_hist%ROWTYPE := rec_in;
    BEGIN
    
        ins(id_epis_pn_addendum_in   => l_rec.id_epis_pn_addendum,
            dt_epis_addendum_hist_in => l_rec.dt_epis_addendum_hist,
    ...
    BEGIN
        ...
        UPDATE epis_pn_addendum_hist
         ...
         WHERE id_epis_pn_addendum = id_epis_pn_addendum_in
           AND dt_epis_addendum_hist = dt_epis_addendum_hist_in
    ...
    BEGIN
        ...
        l_sql                   := 'UPDATE epis_pn_addendum_hist SET' || ' ID_EPIS_PN = decode (' || l_id_epis_pn_n ||
    ...
    BEGIN
        upd(id_epis_pn_addendum_in   => rec_in.id_epis_pn_addendum,
            dt_epis_addendum_hist_in => rec_in.dt_epis_addendum_hist,
    ...
    (
        ...
        l_dt_epis_addendum_hist dt_epis_addendum_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            ...
            l_dt_epis_addendum_hist(i) := col_in(i).dt_epis_addendum_hist;
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_addendum_hist
                 ...
                 WHERE id_epis_pn_addendum = l_id_epis_pn_addendum(i)
                   AND dt_epis_addendum_hist = l_dt_epis_addendum_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_addendum_hist
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_pn_addendum_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_pn_addendum_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_pn_addendum_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM epis_pn_addendum_hist
         WHERE id_epis_pn_addendum = id_epis_pn_addendum_in
           AND dt_epis_addendum_hist = dt_epis_addendum_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_pn_addendum_in   => id_epis_pn_addendum_in,
            dt_epis_addendum_hist_in => dt_epis_addendum_hist_in,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ept_epma_fk(id_epis_pn_addendum_in => id_epis_pn_addendum_in,
                        handle_error_in        => handle_error_in,
                        rows_out               => rows_out);
    END del_ept_epma_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_pn_addendum_hist';
        ELSE
            RETURN 'DELETE FROM epis_pn_addendum_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_pn_addendum_hist_inout IN OUT epis_pn_addendum_hist%ROWTYPE) IS
    BEGIN
        epis_pn_addendum_hist_inout.id_epis_pn_addendum   := NULL;
        epis_pn_addendum_hist_inout.dt_epis_addendum_hist := NULL;
        epis_pn_addendum_hist_inout.id_epis_pn            := NULL;
        epis_pn_addendum_hist_inout.flg_status            := NULL;
        epis_pn_addendum_hist_inout.id_professional       := NULL;
        epis_pn_addendum_hist_inout.dt_addendum           := NULL;
        epis_pn_addendum_hist_inout.pn_addendum           := NULL;
        epis_pn_addendum_hist_inout.dt_last_update        := NULL;
        epis_pn_addendum_hist_inout.id_prof_last_update   := NULL;
        epis_pn_addendum_hist_inout.dt_signoff            := NULL;
        epis_pn_addendum_hist_inout.id_prof_signoff       := NULL;
        epis_pn_addendum_hist_inout.id_prof_cancel        := NULL;
        epis_pn_addendum_hist_inout.id_cancel_reason      := NULL;
        epis_pn_addendum_hist_inout.dt_cancel             := NULL;
        epis_pn_addendum_hist_inout.notes_cancel          := NULL;
        epis_pn_addendum_hist_inout.create_user           := NULL;
        epis_pn_addendum_hist_inout.create_time           := NULL;
        epis_pn_addendum_hist_inout.create_institution    := NULL;
        epis_pn_addendum_hist_inout.update_user           := NULL;
        epis_pn_addendum_hist_inout.update_time           := NULL;
        epis_pn_addendum_hist_inout.update_institution    := NULL;
        epis_pn_addendum_hist_inout.flg_type              := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_pn_addendum_hist%ROWTYPE IS
        l_epis_pn_addendum_hist epis_pn_addendum_hist%ROWTYPE;
    BEGIN
        RETURN l_epis_pn_addendum_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_pn_addendum_hist_tc IS
        data epis_pn_addendum_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM epis_pn_addendum_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_pn_addendum_hist_tc IS
        data epis_pn_addendum_hist_tc;
