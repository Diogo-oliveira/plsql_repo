...
IS
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'PAT_ALLERGY_HIST');
           IF l_name = 'PAH_CR_FK'
           THEN
           ...
           END IF;
           IF l_name = 'PAH_PAL_FK'
           THEN
              -- Add a context value for each column
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_id
               , name_in => 'ID_PAT_ALLERGY'
               , value_in => id_pat_allergy_in);
           END IF;
           IF l_name = 'PAH_PAT_FK'
           THEN
              -- Add a context value for each column
              pk_alert_exceptions.add_context (
                 err_instance_id_in => l_id
   ...
   BEGIN
     ...
     ins (
      id_pat_allergy_hist_in => id_pat_allergy_hist_in
      ,
   ...
   IS
      l_rec PAT_ALLERGY_HIST%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_PAT_ALLERGY_HIST := next_key (sequence_in);
      END IF;
      ins (
         id_pat_allergy_hist_in => l_rec.ID_PAT_ALLERGY_HIST
         ,
  ...
  ins (
   ...
   IS
     retval PAT_ALLERGY_HIST.ID_PAT_ALLERGY_HIST%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_PAT_ALLERGY_HIST.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_PAT_ALLERGY_HIST')
           );
   END next_key;
...
,
   ...
   IS
        l_pky PAT_ALLERGY_HIST.ID_PAT_ALLERGY_HIST%TYPE := next_key;
   BEGIN
      ins (
         id_pat_allergy_hist_in => l_pky,
         id_pat_allergy_in => id_pat_allergy_in,
         id_allergy_in => id_allergy_in,
         id_patient_in => id_patient_in,
         id_drug_pharma_in => id_drug_pharma_in,
...
,
   ...
   BEGIN
      ...
      id_cdr_call_in => id_cdr_call_in,
      flg_cda_reconciliation_in => flg_cda_reconciliation_in,
      id_pat_allergy_hist_out => id_pat_allergy_hist_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
       FORALL indx IN rows_in.FIRST .. rows_in.LAST
            ...
            VALUES (
               rows_in(indx).ID_PAT_ALLERGY_HIST,
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_PAT_ALLERGY_HIST _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_PAT_ALLERGY_HIST
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
   ...
   l_ID_PAT_ALLERGY_n := sys.diutil.bool_to_int(ID_PAT_ALLERGY_nin);
   ...
   l_FLG_CDA_RECONCILIATION_n := sys.diutil.bool_to_int(FLG_CDA_RECONCILIATION_nin);
         ...
         UPDATE PAT_ALLERGY_HIST SET
     ID_PAT_ALLERGY = decode (l_ID_PAT_ALLERGY_n,0,id_pat_allergy_in, NVL (id_pat_allergy_in, ID_PAT_ALLERGY)),
     ...
     FLG_CDA_RECONCILIATION = decode (l_FLG_CDA_RECONCILIATION_n,0,flg_cda_reconciliation_in, NVL (flg_cda_reconciliation_in, FLG_CDA_RECONCILIATION))
          WHERE
             ID_PAT_ALLERGY_HIST = id_pat_allergy_hist_in
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      id_pat_allergy_hist_in => id_pat_allergy_hist_in,
      id_pat_allergy_in => id_pat_allergy_in,
      ID_PAT_ALLERGY_nin => ID_PAT_ALLERGY_nin,
      id_allergy_in => id_allergy_in,
...
PROCEDURE upd (
   ...
   l_ID_CDR_CALL_n NUMBER(1);
   l_FLG_CDA_RECONCILIATION_n NUMBER(1);
      id_pat_allergy_hist_in PAT_ALLERGY_HIST.ID_PAT_ALLERGY_HIST%TYPE;
   BEGIN
...
l_sql := 'UPDATE PAT_ALLERGY_HIST SET '
     || ' ID_PAT_ALLERGY = decode (' || l_ID_PAT_ALLERGY_n || ',0,:id_pat_allergy_in, NVL (:id_pat_allergy_in, ID_PAT_ALLERGY)) '|| ','
     || ' ID_ALLERGY = decode (' || l_ID_ALLERGY_n || ',0,:id_allergy_in, NVL (:id_allergy_in, ID_ALLERGY)) '|| ','
     || ' ID_PATIENT = decode (' || l_ID_PATIENT_n || ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) '|| ','
     || ' ID_DRUG_PHARMA = decode (' || l_ID_DRUG_PHARMA_n || ',0,:id_drug_pharma_in, NVL (:id_drug_pharma_in, ID_DRUG_PHARMA)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         id_pat_allergy_hist_in => rec_in.ID_PAT_ALLERGY_HIST,
   ...
   IS
      l_ID_PAT_ALLERGY_HIST ID_PAT_ALLERGY_HIST_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         l_ID_PAT_ALLERGY_HIST(i) := col_in(i).ID_PAT_ALLERGY_HIST;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE PAT_ALLERGY_HIST SET
               ID_PAT_ALLERGY = NVL (l_ID_PAT_ALLERGY(i), ID_PAT_ALLERGY),
             ...
             WHERE
                ID_PAT_ALLERGY_HIST = l_ID_PAT_ALLERGY_HIST(i)
          returning rowid bulk collect into rows_out;
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE PAT_ALLERGY_HIST SET
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE PAT_ALLERGY_HIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE PAT_ALLERGY_HIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE ID_PAT_ALLERGY_HIST = id_pat_allergy_hist_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_CANCEL_REASON = del_PAH_CR_FK.id_cancel_reason_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_CR_FK (
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_EPISODE = del_PAH_EPIS_FK.id_episode_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_EPIS_FK (
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_CDR_CALL = del_PAH_ICC_FK.id_cdr_call_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_ICC_FK (
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_INSTITUTION = del_PAH_INST_FK.id_institution_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_INST_FK (
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_PAT_ALLERGY = del_PAH_PAL_FK.id_pat_allergy_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_PAL_FK (
   ...
   BEGIN
      DELETE FROM PAT_ALLERGY_HIST
       WHERE
          ID_PATIENT = del_PAH_PAT_FK.id_patient_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_PAH_PAT_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM PAT_ALLERGY_HIST';
      ELSE
         RETURN
            'DELETE FROM PAT_ALLERGY_HIST WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      pat_allergy_hist_inout.ID_PAT_ALLERGY_HIST := NULL;
      pat_allergy_hist_inout.ID_PAT_ALLERGY := NULL;
      pat_allergy_hist_inout.ID_ALLERGY := NULL;
      pat_allergy_hist_inout.ID_PATIENT := NULL;
      pat_allergy_hist_inout.ID_DRUG_PHARMA := NULL;
      pat_allergy_hist_inout.FLG_STATUS := NULL;
      pat_allergy_hist_inout.NOTES := NULL;
      pat_allergy_hist_inout.ID_PROF_WRITE := NULL;
      pat_allergy_hist_inout.FLG_TYPE := NULL;
      pat_allergy_hist_inout.FLG_APROVED := NULL;
      pat_allergy_hist_inout.YEAR_BEGIN := NULL;
      pat_allergy_hist_inout.MONTH_BEGIN := NULL;
      pat_allergy_hist_inout.DAY_BEGIN := NULL;
      pat_allergy_hist_inout.YEAR_END := NULL;
      pat_allergy_hist_inout.MONTH_END := NULL;
      pat_allergy_hist_inout.DAY_END := NULL;
      pat_allergy_hist_inout.ID_INSTITUTION := NULL;
      pat_allergy_hist_inout.ID_EPISODE := NULL;
      pat_allergy_hist_inout.FLG_NATURE := NULL;
      pat_allergy_hist_inout.DT_PAT_ALLERGY_TSTZ := NULL;
      pat_allergy_hist_inout.DT_FIRST_TIME_TSTZ := NULL;
      pat_allergy_hist_inout.ID_CANCEL_REASON := NULL;
      pat_allergy_hist_inout.CANCEL_NOTES := NULL;
      pat_allergy_hist_inout.ID_ALLERGY_SEVERITY := NULL;
      pat_allergy_hist_inout.DESC_ALLERGY := NULL;
      pat_allergy_hist_inout.DESC_APROVED := NULL;
      pat_allergy_hist_inout.FLG_EDIT := NULL;
      pat_allergy_hist_inout.FLG_CANCEL := NULL;
      pat_allergy_hist_inout.CREATE_USER := NULL;
      pat_allergy_hist_inout.CREATE_TIME := NULL;
      pat_allergy_hist_inout.CREATE_INSTITUTION := NULL;
      pat_allergy_hist_inout.UPDATE_USER := NULL;
      pat_allergy_hist_inout.UPDATE_TIME := NULL;
      pat_allergy_hist_inout.UPDATE_INSTITUTION := NULL;
      pat_allergy_hist_inout.DESC_EDIT := NULL;
      pat_allergy_hist_inout.REVISION := NULL;
      pat_allergy_hist_inout.DT_RESOLUTION := NULL;
      pat_allergy_hist_inout.ID_CDR_CALL := NULL;
      pat_allergy_hist_inout.FLG_CDA_RECONCILIATION := 'N'
;
   END initrec;

   FUNCTION initrec RETURN PAT_ALLERGY_HIST%ROWTYPE
   IS
      l_pat_allergy_hist PAT_ALLERGY_HIST%ROWTYPE;
   BEGIN
      l_pat_allergy_hist.FLG_CDA_RECONCILIATION := 'N'
;
      RETURN l_pat_allergy_hist;
   END initrec;
   ...
   IS
        data PAT_ALLERGY_HIST_tc;
   BEGIN
        select * bulk collect into data from PAT_ALLERGY_HIST where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
