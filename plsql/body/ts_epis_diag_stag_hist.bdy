...
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO epis_diag_stag_hist
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'EDSTGGH_EDH_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_EPIS_DIAGNOSIS_HIST',
                                                        value_in           => id_epis_diagnosis_hist_in);
                    END IF;
                    IF l_name = 'EDSTGGH_PROF_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
    ...
    BEGIN
        ...
        ins(id_epis_diagnosis_hist_in => id_epis_diagnosis_hist_in,
    ...
    (
        ...
        l_rec epis_diag_stag_hist%ROWTYPE := rec_in;
    BEGIN
        ins(id_epis_diagnosis_hist_in => l_rec.id_epis_diagnosis_hist,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_EPIS_DIAGNOSIS_HIST _' || indx,
    ...
    BEGIN
        ...
        UPDATE epis_diag_stag_hist
         ...
         WHERE id_epis_diagnosis_hist = id_epis_diagnosis_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_diagnosis_hist_in  => id_epis_diagnosis_hist_in,
            id_epis_diagnosis_in       => id_epis_diagnosis_in,
            id_staging_basis_in        => id_staging_basis_in,
            id_sbasis_inst_owner_in    => id_sbasis_inst_owner_in,
            num_staging_basis_in       => num_staging_basis_in,
    ...
    (
        ...
        l_update_time_n            NUMBER(1);
        l_update_institution_n     NUMBER(1);
        id_epis_diagnosis_hist_in  epis_diag_stag_hist.id_epis_diagnosis_hist%TYPE;
        id_epis_diagnosis_in       epis_diag_stag_hist.id_epis_diagnosis%TYPE;
        id_staging_basis_in        epis_diag_stag_hist.id_staging_basis%TYPE;
        id_sbasis_inst_owner_in    epis_diag_stag_hist.id_sbasis_inst_owner%TYPE;
        num_staging_basis_in       epis_diag_stag_hist.num_staging_basis%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE EPIS_DIAG_STAG_HIST SET ' || ' ID_TNM_T = decode (' || l_id_tnm_t_n ||
    ...
    BEGIN
        upd(id_epis_diagnosis_hist_in => rec_in.id_epis_diagnosis_hist,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_epis_diagnosis_hist_in,
                id_epis_diagnosis_in,
                id_staging_basis_in,
                id_sbasis_inst_owner_in,
                num_staging_basis_in,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_diag_stag_hist
                 ...
                 WHERE id_epis_diagnosis_hist = l_id_epis_diagnosis_hist(i)
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE EPIS_DIAG_STAG_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE EPIS_DIAG_STAG_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_DIAG_STAG_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE EPIS_DIAG_STAG_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_epis_diagnosis_hist = id_epis_diagnosis_hist_in
           AND id_epis_diagnosis = id_epis_diagnosis_in
           AND id_staging_basis = id_staging_basis_in
           AND id_sbasis_inst_owner = id_sbasis_inst_owner_in
    ...
    BEGIN
        ...
        del(id_epis_diagnosis_hist_in => id_epis_diagnosis_hist_in,
            id_epis_diagnosis_in      => id_epis_diagnosis_in,
            id_staging_basis_in       => id_staging_basis_in,
            id_sbasis_inst_owner_in   => id_sbasis_inst_owner_in,
            num_staging_basis_in      => num_staging_basis_in,
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_id_epis_diagnosis_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_epis_diagnosis_hist(id_epis_diagnosis_hist_in => id_epis_diagnosis_hist_in,
                                   handle_error_in           => handle_error_in,
                                   rows_out                  => rows_out);
    END del_id_epis_diagnosis_hist;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_staging_group = del_edstggh_cncpttra_fk.id_staging_group_in
           AND id_sgroup_inst_owner = del_edstggh_cncpttra_fk.id_sgroup_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttra_fk(id_staging_group_in     => id_staging_group_in,
                                id_sgroup_inst_owner_in => id_sgroup_inst_owner_in,
                                handle_error_in         => handle_error_in,
                                rows_out                => rows_out);
    END del_edstggh_cncpttra_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_staging_basis = del_edstggh_cncpttr1_fk.id_staging_basis_in
           AND id_sbasis_inst_owner = del_edstggh_cncpttr1_fk.id_sbasis_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr1_fk(id_staging_basis_in     => id_staging_basis_in,
                                id_sbasis_inst_owner_in => id_sbasis_inst_owner_in,
                                handle_error_in         => handle_error_in,
                                rows_out                => rows_out);
    END del_edstggh_cncpttr1_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_tnm_t = del_edstggh_cncpttr2_fk.id_tnm_t_in
           AND id_tnm_t_inst_owner = del_edstggh_cncpttr2_fk.id_tnm_t_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr2_fk(id_tnm_t_in            => id_tnm_t_in,
                                id_tnm_t_inst_owner_in => id_tnm_t_inst_owner_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_edstggh_cncpttr2_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_tnm_n = del_edstggh_cncpttr3_fk.id_tnm_n_in
           AND id_tnm_n_inst_owner = del_edstggh_cncpttr3_fk.id_tnm_n_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr3_fk(id_tnm_n_in            => id_tnm_n_in,
                                id_tnm_n_inst_owner_in => id_tnm_n_inst_owner_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_edstggh_cncpttr3_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_tnm_m = del_edstggh_cncpttr4_fk.id_tnm_m_in
           AND id_tnm_m_inst_owner = del_edstggh_cncpttr4_fk.id_tnm_m_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr4_fk(id_tnm_m_in            => id_tnm_m_in,
                                id_tnm_m_inst_owner_in => id_tnm_m_inst_owner_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_edstggh_cncpttr4_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_metastatic_sites = del_edstggh_cncpttr5_fk.id_metastatic_sites_in
           AND id_msites_inst_owner = del_edstggh_cncpttr5_fk.id_msites_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr5_fk(id_metastatic_sites_in  => id_metastatic_sites_in,
                                id_msites_inst_owner_in => id_msites_inst_owner_in,
                                handle_error_in         => handle_error_in,
                                rows_out                => rows_out);
    END del_edstggh_cncpttr5_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_residual_tumor = del_edstggh_cncpttr6_fk.id_residual_tumor_in
           AND id_rtumor_inst_owner = del_edstggh_cncpttr6_fk.id_rtumor_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr6_fk(id_residual_tumor_in    => id_residual_tumor_in,
                                id_rtumor_inst_owner_in => id_rtumor_inst_owner_in,
                                handle_error_in         => handle_error_in,
                                rows_out                => rows_out);
    END del_edstggh_cncpttr6_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_surgical_margins = del_edstggh_cncpttr7_fk.id_surgical_margins_in
           AND id_smargins_inst_owner = del_edstggh_cncpttr7_fk.id_smargins_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr7_fk(id_surgical_margins_in    => id_surgical_margins_in,
                                id_smargins_inst_owner_in => id_smargins_inst_owner_in,
                                handle_error_in           => handle_error_in,
                                rows_out                  => rows_out);
    END del_edstggh_cncpttr7_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_lymph_vasc_inv = del_edstggh_cncpttr8_fk.id_lymph_vasc_inv_in
           AND id_lvinv_inst_owner = del_edstggh_cncpttr8_fk.id_lvinv_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr8_fk(id_lymph_vasc_inv_in   => id_lymph_vasc_inv_in,
                                id_lvinv_inst_owner_in => id_lvinv_inst_owner_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_edstggh_cncpttr8_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_other_staging_sys = del_edstggh_cncpttr9_fk.id_other_staging_sys_in
           AND id_ostgsys_inst_owner = del_edstggh_cncpttr9_fk.id_ostgsys_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cncpttr9_fk(id_other_staging_sys_in  => id_other_staging_sys_in,
                                id_ostgsys_inst_owner_in => id_ostgsys_inst_owner_in,
                                handle_error_in          => handle_error_in,
                                rows_out                 => rows_out);
    END del_edstggh_cncpttr9_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_cancel_reason = del_edstggh_cr_fk.id_cancel_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_cr_fk(id_cancel_reason_in => id_cancel_reason_in,
                          handle_error_in     => handle_error_in,
                          rows_out            => rows_out);
    END del_edstggh_cr_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_epis_diagnosis_hist = del_edstggh_edh_fk.id_epis_diagnosis_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_edh_fk(id_epis_diagnosis_hist_in => id_epis_diagnosis_hist_in,
                           handle_error_in           => handle_error_in,
                           rows_out                  => rows_out);
    END del_edstggh_edh_fk;
    ...
    BEGIN
        DELETE FROM epis_diag_stag_hist
         WHERE id_prof_create = del_edstggh_prof_fk.id_prof_create_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_edstggh_prof_fk(id_prof_create_in => id_prof_create_in,
                            handle_error_in   => handle_error_in,
                            rows_out          => rows_out);
    END del_edstggh_prof_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM EPIS_DIAG_STAG_HIST';
        ELSE
            RETURN 'DELETE FROM EPIS_DIAG_STAG_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_diag_stag_hist_inout IN OUT epis_diag_stag_hist%ROWTYPE) IS
    BEGIN
        epis_diag_stag_hist_inout.id_epis_diagnosis_hist := NULL;
        epis_diag_stag_hist_inout.id_epis_diagnosis      := NULL;
        epis_diag_stag_hist_inout.num_staging_basis      := 1;
        epis_diag_stag_hist_inout.id_staging_basis       := NULL;
        epis_diag_stag_hist_inout.id_sbasis_inst_owner   := 0;
        epis_diag_stag_hist_inout.id_tnm_t               := NULL;
        epis_diag_stag_hist_inout.id_tnm_t_inst_owner    := NULL;
        epis_diag_stag_hist_inout.code_tnm_t             := NULL;
        epis_diag_stag_hist_inout.id_tnm_n               := NULL;
        epis_diag_stag_hist_inout.id_tnm_n_inst_owner    := NULL;
        epis_diag_stag_hist_inout.code_tnm_n             := NULL;
        epis_diag_stag_hist_inout.id_tnm_m               := NULL;
        epis_diag_stag_hist_inout.id_tnm_m_inst_owner    := NULL;
        epis_diag_stag_hist_inout.code_tnm_m             := NULL;
        epis_diag_stag_hist_inout.id_metastatic_sites    := NULL;
        epis_diag_stag_hist_inout.id_msites_inst_owner   := NULL;
        epis_diag_stag_hist_inout.id_staging_group       := NULL;
        epis_diag_stag_hist_inout.id_sgroup_inst_owner   := NULL;
        epis_diag_stag_hist_inout.id_residual_tumor      := NULL;
        epis_diag_stag_hist_inout.id_rtumor_inst_owner   := NULL;
        epis_diag_stag_hist_inout.id_surgical_margins    := NULL;
        epis_diag_stag_hist_inout.id_smargins_inst_owner := NULL;
        epis_diag_stag_hist_inout.id_lymph_vasc_inv      := NULL;
        epis_diag_stag_hist_inout.id_lvinv_inst_owner    := NULL;
        epis_diag_stag_hist_inout.id_other_staging_sys   := NULL;
        epis_diag_stag_hist_inout.id_ostgsys_inst_owner  := NULL;
        epis_diag_stag_hist_inout.id_cancel_reason       := NULL;
        epis_diag_stag_hist_inout.cancel_notes           := NULL;
        epis_diag_stag_hist_inout.id_prof_create         := NULL;
        epis_diag_stag_hist_inout.dt_epis_diagnosis_stag := NULL;
        epis_diag_stag_hist_inout.create_user            := NULL;
        epis_diag_stag_hist_inout.create_time            := NULL;
        epis_diag_stag_hist_inout.create_institution     := NULL;
        epis_diag_stag_hist_inout.update_user            := NULL;
        epis_diag_stag_hist_inout.update_time            := NULL;
        epis_diag_stag_hist_inout.update_institution     := NULL;
    END initrec;

    FUNCTION initrec RETURN epis_diag_stag_hist%ROWTYPE IS
        l_epis_diag_stag_hist epis_diag_stag_hist%ROWTYPE;
    BEGIN
        l_epis_diag_stag_hist.num_staging_basis    := 1;
        l_epis_diag_stag_hist.id_sbasis_inst_owner := 0;
        RETURN l_epis_diag_stag_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_diag_stag_hist_tc IS
        data epis_diag_stag_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM epis_diag_stag_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_diag_stag_hist_tc IS
