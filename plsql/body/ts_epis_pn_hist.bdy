/*-- Last Change Revision: $Rev: 1817949 $*/
/*-- Last Change by: $Author: anna.kurowska $*/
/*-- Date of last change: $Date: 2018-01-21 22:56:07 +0000 (dom, 21 jan 2018) $*/
CREATE OR REPLACE PACKAGE BODY ts_epis_pn_hist
/*
...
*/
 IS
    ...
    BEGIN
        ins(dt_epis_pn_hist_in     => dt_epis_pn_hist_in,
    ...
    (
        ...
        l_rec epis_pn_hist%ROWTYPE := rec_in;
    BEGIN
    
        ins(dt_epis_pn_hist_in     => l_rec.dt_epis_pn_hist,
    ...
    BEGIN
        ...
        UPDATE epis_pn_hist
         ...
         WHERE dt_epis_pn_hist = dt_epis_pn_hist_in
           AND id_epis_pn = id_epis_pn_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(dt_epis_pn_hist_in      => dt_epis_pn_hist_in,
            id_epis_pn_in           => id_epis_pn_in,
            id_episode_in           => id_episode_in,
    ...
    BEGIN
        ...
        l_sql                   := 'UPDATE epis_pn_hist SET' || ' ID_EPISODE = decode (' || l_id_episode_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_episode_in, flg_status_in, id_dep_clin_serv_in, id_prof_create_in, dt_create_in, dt_last_update_in, id_prof_last_update_in, dt_signoff_in, id_prof_signoff_in, id_prof_cancel_in, dt_cancel_in, id_cancel_reason_in, notes_cancel_in, id_dictation_report_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_pn_note_type_in, dt_pn_date_in, id_pn_area_in, flg_auto_saved_in, id_software_in, id_prof_submit_in, dt_submit_in, id_prof_reviewed_in, dt_reviewed_in, id_submit_reason_in, notes_submit_in, dt_proposed_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        upd(dt_epis_pn_hist_in     => rec_in.dt_epis_pn_hist,
    ...
    (
        ...
        l_dt_epis_pn_hist     dt_epis_pn_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_dt_epis_pn_hist(i) := col_in(i).dt_epis_pn_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_hist
                 ...
                 WHERE dt_epis_pn_hist = l_dt_epis_pn_hist(i)
                   AND id_epis_pn = l_id_epis_pn(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_hist
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_pn_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_pn_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_pn_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(dt_epis_pn_hist_in => dt_epis_pn_hist_in,
            id_epis_pn_in      => id_epis_pn_in,
            handle_error_in    => handle_error_in,
            rows_out           => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epnh_id_area_fk(id_pn_area_in => id_pn_area_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_epnh_id_area_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epnh_pnnt_fk(id_pn_note_type_in => id_pn_note_type_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_epnh_pnnt_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ept_epn_fk(id_epis_pn_in => id_epis_pn_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ept_epn_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_pn_hist';
        ELSE
            RETURN 'DELETE FROM epis_pn_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_pn_hist_inout IN OUT epis_pn_hist%ROWTYPE) IS
    BEGIN
        epis_pn_hist_inout.dt_epis_pn_hist     := NULL;
        epis_pn_hist_inout.id_epis_pn          := NULL;
        epis_pn_hist_inout.id_episode          := NULL;
        epis_pn_hist_inout.flg_status          := NULL;
        epis_pn_hist_inout.id_dep_clin_serv    := NULL;
        epis_pn_hist_inout.id_prof_create      := NULL;
        epis_pn_hist_inout.dt_create           := NULL;
        epis_pn_hist_inout.dt_last_update      := NULL;
        epis_pn_hist_inout.id_prof_last_update := NULL;
        epis_pn_hist_inout.dt_signoff          := NULL;
        epis_pn_hist_inout.id_prof_signoff     := NULL;
        epis_pn_hist_inout.id_prof_cancel      := NULL;
        epis_pn_hist_inout.dt_cancel           := NULL;
        epis_pn_hist_inout.id_cancel_reason    := NULL;
        epis_pn_hist_inout.notes_cancel        := NULL;
        epis_pn_hist_inout.id_dictation_report := NULL;
        epis_pn_hist_inout.create_user         := NULL;
        epis_pn_hist_inout.create_time         := NULL;
        epis_pn_hist_inout.create_institution  := NULL;
        epis_pn_hist_inout.update_user         := NULL;
        epis_pn_hist_inout.update_time         := NULL;
        epis_pn_hist_inout.update_institution  := NULL;
        epis_pn_hist_inout.id_pn_note_type     := NULL;
        epis_pn_hist_inout.dt_pn_date          := NULL;
        epis_pn_hist_inout.id_pn_area          := NULL;
        epis_pn_hist_inout.flg_auto_saved      := NULL;
        epis_pn_hist_inout.id_software         := NULL;
        epis_pn_hist_inout.id_prof_submit      := NULL;
        epis_pn_hist_inout.dt_submit           := NULL;
        epis_pn_hist_inout.id_prof_reviewed    := NULL;
        epis_pn_hist_inout.dt_reviewed         := NULL;
        epis_pn_hist_inout.id_submit_reason    := NULL;
        epis_pn_hist_inout.notes_submit        := NULL;
        epis_pn_hist_inout.dt_proposed         := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_pn_hist%ROWTYPE IS
        l_epis_pn_hist epis_pn_hist%ROWTYPE;
    BEGIN
        RETURN l_epis_pn_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_pn_hist_tc IS
        data epis_pn_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_pn_hist_tc IS
        data epis_pn_hist_tc;
