/*-- Last Change Revision: $Rev: 2028214 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:30 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_icnp_epis_diagnosis_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Setembro 28, 2010 16:55:59
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        INSERT INTO icnp_epis_diagnosis_hist
                ...
                BEGIN
                    ...
                    ELSE
                        pk_alert_exceptions.raise_error(error_name_in => 'DUPLICATE-VALUE',
                                                        ...
                                                        value2_in     => l_name,
                                                        name3_in      => 'TABLE_NAME',
                                                        value3_in     => 'ICNP_EPIS_DIAGNOSIS_HIST');
                    END IF;
                END;
            END IF;
    ...
    BEGIN
        ...
        ins(id_icnp_epis_diag_hist_in => id_icnp_epis_diag_hist_in,
            ...
            dt_icnp_epis_diag_in      => dt_icnp_epis_diag_in,
    ...
    (
        ...
        l_rec icnp_epis_diagnosis_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_icnp_epis_diag_hist := next_key(sequence_in);
        END IF;
        ins(id_icnp_epis_diag_hist_in => l_rec.id_icnp_epis_diag_hist,
            ...
            dt_icnp_epis_diag_in      => l_rec.dt_icnp_epis_diag,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE
     ...
     IS
        retval icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_icnp_epis_diagnosis_hist.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_ICNP_EPIS_DIAGNOSIS_HIST'));
    END next_key;
    ...
    (
        ...
        l_pky icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE := next_key;
    BEGIN
        ins(id_icnp_epis_diag_hist_in => l_pky,
            id_icnp_epis_diag_in      => id_icnp_epis_diag_in,
            id_composition_in         => id_composition_in,
            id_professional_in        => id_professional_in,
            flg_status_in             => flg_status_in,
            ...
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
        id_icnp_epis_diag_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_icnp_epis_diag_in       => id_icnp_epis_diag_in,
            ...
            update_time_in             => update_time_in,
            update_institution_in      => update_institution_in,
            id_icnp_epis_diag_hist_out => id_icnp_epis_diag_hist_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in         IN BOOLEAN := TRUE,
        rows_out                OUT table_varchar
    ) RETURN icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE IS
        l_pky icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE := next_key;
    BEGIN
        ins(id_icnp_epis_diag_hist_in => l_pky,
            id_icnp_epis_diag_in      => id_icnp_epis_diag_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_ICNP_EPIS_DIAG_HIST _' || indx,
                                                        value_in           => rows_in(indx).id_icnp_epis_diag_hist,
                                                        validate_in        => FALSE);
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'DT_ICNP_EPIS_DIAG _' || indx,
                                                        value_in           => rows_in(indx).dt_icnp_epis_diag,
                                                        validate_in        => FALSE);
        ...
        WHEN OTHERS THEN
            ...
            ELSE
                pk_alert_exceptions.raise_error(error_name_in => 'FORALL-INSERT-FAILURE',
                                                name1_in      => 'TABLE_NAME',
                                                value1_in     => 'ICNP_EPIS_DIAGNOSIS_HIST',
                                                name2_in      => 'ROW_COUNT',
    ...
    (
        ...
        l_dt_icnp_epis_diag_n    NUMBER(1);
    ...
    BEGIN
        ...
        l_dt_icnp_epis_diag_n    := sys.diutil.bool_to_int(dt_icnp_epis_diag_nin);
        ...
        UPDATE icnp_epis_diagnosis_hist
           SET id_icnp_epis_diag    = decode(l_id_icnp_epis_diag_n,
                                             0,
                                             id_icnp_epis_diag_in,
               ...
               dt_icnp_epis_diag    = decode(l_dt_icnp_epis_diag_n,
                                             0,
                                             dt_icnp_epis_diag_in,
                                             nvl(dt_icnp_epis_diag_in, dt_icnp_epis_diag)),
               ...
               id_prof_created_hist = decode(l_id_prof_created_hist_n,
                                             0,
                                             id_prof_created_hist_in,
                                             nvl(id_prof_created_hist_in, id_prof_created_hist)),
               dt_created_hist      = decode(l_dt_created_hist_n,
                                             0,
                                             dt_created_hist_in,
                                             nvl(dt_created_hist_in, dt_created_hist)),
         ...
         WHERE id_icnp_epis_diag_hist = id_icnp_epis_diag_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_icnp_epis_diag_hist_in => id_icnp_epis_diag_hist_in,
            id_icnp_epis_diag_in      => id_icnp_epis_diag_in,
            ...
            dt_icnp_epis_diag_in      => dt_icnp_epis_diag_in,
            dt_icnp_epis_diag_nin     => dt_icnp_epis_diag_nin,
            dt_close_in               => dt_close_in,
    ...
    (
        ...
        l_update_time_n           NUMBER(1);
        l_update_institution_n    NUMBER(1);
        id_icnp_epis_diag_hist_in icnp_epis_diagnosis_hist.id_icnp_epis_diag_hist%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE ICNP_EPIS_DIAGNOSIS_HIST SET ' || ' ID_ICNP_EPIS_DIAG = decode (' || l_id_icnp_epis_diag_n ||
                 ...
                 ' ID_PATIENT = decode (' || l_id_patient_n || ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) ' || ',' ||
                 ' DT_ICNP_EPIS_DIAG = decode (' || l_dt_icnp_epis_diag_n ||
                 ',0,:dt_icnp_epis_diag_in, NVL (:dt_icnp_epis_diag_in, DT_ICNP_EPIS_DIAG)) ' || ',' ||
                 ' DT_CLOSE = decode (' || l_dt_close_n || ',0,:dt_close_in, NVL (:dt_close_in, DT_CLOSE)) ' || ',' ||
                 ' ID_VISIT = decode (' || l_id_visit_n || ',0,:id_visit_in, NVL (:id_visit_in, ID_VISIT)) ' || ',' ||
                 ' ID_EPIS_TYPE = decode (' || l_id_epis_type_n ||
                 ',0,:id_epis_type_in, NVL (:id_epis_type_in, ID_EPIS_TYPE)) ' || ',' || ' FLG_EXECUTIONS = decode (' ||
                 l_flg_executions_n || ',0,:flg_executions_in, NVL (:flg_executions_in, FLG_EXECUTIONS)) ' || ',' ||
                 ' ICNP_COMPO_REEVAL = decode (' || l_icnp_compo_reeval_n ||
                 ...
                 ' ID_PROF_CREATED_HIST = decode (' || l_id_prof_created_hist_n ||
                 ',0,:id_prof_created_hist_in, NVL (:id_prof_created_hist_in, ID_PROF_CREATED_HIST)) ' || ',' ||
                 ' DT_CREATED_HIST = decode (' || l_dt_created_hist_n ||
                 ',0,:dt_created_hist_in, NVL (:dt_created_hist_in, DT_CREATED_HIST)) ' || ',' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_icnp_epis_diag_in, id_composition_in, id_professional_in, flg_status_in, id_episode_in, notes_in, id_prof_close_in, notes_close_in, id_patient_in, dt_icnp_epis_diag_in, dt_close_in, id_visit_in, id_epis_type_in, flg_executions_in, icnp_compo_reeval_in, id_prof_last_update_in, dt_last_update_in, id_suspend_reason_in, id_suspend_prof_in, suspend_notes_in, dt_suspend_in, id_cancel_reason_in, id_cancel_prof_in, cancel_notes_in, dt_cancel_in, id_prof_created_hist_in, dt_created_hist_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_icnp_epis_diag_hist_in => rec_in.id_icnp_epis_diag_hist,
            ...
            dt_icnp_epis_diag_in      => rec_in.dt_icnp_epis_diag,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_icnp_epis_diag_hist_in,
                id_icnp_epis_diag_in,
                id_composition_in,
                id_professional_in,
                flg_status_in,
    ...
    (
        ...
        l_id_icnp_epis_diag_hist id_icnp_epis_diag_hist_cc;
        ...
        l_dt_icnp_epis_diag      dt_icnp_epis_diag_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_icnp_epis_diag_hist(i) := col_in(i).id_icnp_epis_diag_hist;
            ...
            l_dt_icnp_epis_diag(i) := col_in(i).dt_icnp_epis_diag;
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE icnp_epis_diagnosis_hist
                   SET id_icnp_epis_diag    = nvl(l_id_icnp_epis_diag(i), id_icnp_epis_diag),
                       ...
                       dt_icnp_epis_diag    = nvl(l_dt_icnp_epis_diag(i), dt_icnp_epis_diag),
                 ...
                 WHERE id_icnp_epis_diag_hist = l_id_icnp_epis_diag_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE icnp_epis_diagnosis_hist
                   SET id_icnp_epis_diag    = l_id_icnp_epis_diag(i),
                       ...
                       dt_icnp_epis_diag    = l_dt_icnp_epis_diag(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE ICNP_EPIS_DIAGNOSIS_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE ICNP_EPIS_DIAGNOSIS_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE ICNP_EPIS_DIAGNOSIS_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE ICNP_EPIS_DIAGNOSIS_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM icnp_epis_diagnosis_hist
         WHERE id_icnp_epis_diag_hist = id_icnp_epis_diag_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
    ...
    BEGIN
        ...
        del(id_icnp_epis_diag_hist_in => id_icnp_epis_diag_hist_in,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    ...
    EXCEPTION
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_id_icnp_epis_diag_hist;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_icnp_epis_diag_hist(id_icnp_epis_diag_hist_in => id_icnp_epis_diag_hist_in,
                                   handle_error_in           => handle_error_in,
                                   rows_out                  => rows_out);
    END del_id_icnp_epis_diag_hist;
    ...
    BEGIN
        DELETE FROM icnp_epis_diagnosis_hist
         WHERE id_icnp_epis_diag = del_iedh_eipd_fk.id_icnp_epis_diag_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_iedh_eipd_fk(id_icnp_epis_diag_in => id_icnp_epis_diag_in,
                         handle_error_in      => handle_error_in,
                         rows_out             => rows_out);
    END del_iedh_eipd_fk;
    ...
    BEGIN
        DELETE FROM icnp_epis_diagnosis_hist
         WHERE id_episode = del_iedh_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_iedh_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_iedh_epis_fk;
    ...
    BEGIN
        DELETE FROM icnp_epis_diagnosis_hist
         WHERE id_patient = del_iedh_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_iedh_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_iedh_pat_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM ICNP_EPIS_DIAGNOSIS_HIST';
        ELSE
            RETURN 'DELETE FROM ICNP_EPIS_DIAGNOSIS_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(icnp_epis_diagnosis_hist_inout IN OUT icnp_epis_diagnosis_hist%ROWTYPE) IS
    BEGIN
        icnp_epis_diagnosis_hist_inout.id_icnp_epis_diag_hist := NULL;
        icnp_epis_diagnosis_hist_inout.id_icnp_epis_diag      := NULL;
        icnp_epis_diagnosis_hist_inout.id_composition         := NULL;
        icnp_epis_diagnosis_hist_inout.id_professional        := NULL;
        icnp_epis_diagnosis_hist_inout.flg_status             := NULL;
        icnp_epis_diagnosis_hist_inout.id_episode             := NULL;
        icnp_epis_diagnosis_hist_inout.notes                  := NULL;
        icnp_epis_diagnosis_hist_inout.id_prof_close          := NULL;
        icnp_epis_diagnosis_hist_inout.notes_close            := NULL;
        icnp_epis_diagnosis_hist_inout.id_patient             := NULL;
        icnp_epis_diagnosis_hist_inout.dt_icnp_epis_diag      := NULL;
        icnp_epis_diagnosis_hist_inout.dt_close               := NULL;
        icnp_epis_diagnosis_hist_inout.id_visit               := NULL;
        icnp_epis_diagnosis_hist_inout.id_epis_type           := NULL;
        icnp_epis_diagnosis_hist_inout.flg_executions         := NULL;
        icnp_epis_diagnosis_hist_inout.icnp_compo_reeval      := NULL;
        icnp_epis_diagnosis_hist_inout.id_prof_last_update    := NULL;
        icnp_epis_diagnosis_hist_inout.dt_last_update         := NULL;
        icnp_epis_diagnosis_hist_inout.id_suspend_reason      := NULL;
        icnp_epis_diagnosis_hist_inout.id_suspend_prof        := NULL;
        icnp_epis_diagnosis_hist_inout.suspend_notes          := NULL;
        icnp_epis_diagnosis_hist_inout.dt_suspend             := NULL;
        icnp_epis_diagnosis_hist_inout.id_cancel_reason       := NULL;
        icnp_epis_diagnosis_hist_inout.id_cancel_prof         := NULL;
        icnp_epis_diagnosis_hist_inout.cancel_notes           := NULL;
        icnp_epis_diagnosis_hist_inout.dt_cancel              := NULL;
        icnp_epis_diagnosis_hist_inout.id_prof_created_hist   := NULL;
        icnp_epis_diagnosis_hist_inout.dt_created_hist        := NULL;
        icnp_epis_diagnosis_hist_inout.create_user            := NULL;
        icnp_epis_diagnosis_hist_inout.create_time            := NULL;
        icnp_epis_diagnosis_hist_inout.create_institution     := NULL;
        icnp_epis_diagnosis_hist_inout.update_user            := NULL;
        icnp_epis_diagnosis_hist_inout.update_time            := NULL;
        icnp_epis_diagnosis_hist_inout.update_institution     := NULL;
    END initrec;

    FUNCTION initrec RETURN icnp_epis_diagnosis_hist%ROWTYPE IS
        l_icnp_epis_diagnosis_hist icnp_epis_diagnosis_hist%ROWTYPE;
    BEGIN
        RETURN l_icnp_epis_diagnosis_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN icnp_epis_diagnosis_hist_tc IS
        data icnp_epis_diagnosis_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM icnp_epis_diagnosis_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN icnp_epis_diagnosis_hist_tc IS
