/*-- Last Change Revision: $Rev: 2028246 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:38 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_interv_presc_plan_hist
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2017-03-15 08:05:34
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE IS
        retval interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_interv_presc_plan_hist.nextval;
        ELSE
    ...
    PROCEDURE ins
    (
        id_interv_presc_plan_in      IN interv_presc_plan_hist.id_interv_presc_plan%TYPE DEFAULT NULL,
        id_prof_performed_in         IN interv_presc_plan_hist.id_prof_performed%TYPE DEFAULT NULL,
        id_episode_write_in          IN interv_presc_plan_hist.id_episode_write%TYPE DEFAULT NULL,
        start_time_in                IN interv_presc_plan_hist.start_time%TYPE DEFAULT NULL,
        end_time_in                  IN interv_presc_plan_hist.end_time%TYPE DEFAULT NULL,
        notes_in                     IN interv_presc_plan_hist.notes%TYPE DEFAULT NULL,
        dt_interv_presc_plan_hist_in IN interv_presc_plan_hist.dt_interv_presc_plan_hist%TYPE DEFAULT NULL,
        id_professional_in           IN interv_presc_plan_hist.id_professional%TYPE DEFAULT NULL,
        dt_plan_tstz_in              IN interv_presc_plan_hist.dt_plan_tstz%TYPE DEFAULT NULL,
        num_exec_sess_in             IN interv_presc_plan_hist.num_exec_sess%TYPE DEFAULT NULL,
        dt_interv_presc_plan_in      IN interv_presc_plan_hist.dt_interv_presc_plan%TYPE DEFAULT NULL,
        create_user_in               IN interv_presc_plan_hist.create_user%TYPE DEFAULT NULL,
        create_time_in               IN interv_presc_plan_hist.create_time%TYPE DEFAULT NULL,
        create_institution_in        IN interv_presc_plan_hist.create_institution%TYPE DEFAULT NULL,
        update_user_in               IN interv_presc_plan_hist.update_user%TYPE DEFAULT NULL,
        update_time_in               IN interv_presc_plan_hist.update_time%TYPE DEFAULT NULL,
        update_institution_in        IN interv_presc_plan_hist.update_institution%TYPE DEFAULT NULL,
        id_interv_presc_det_in       IN interv_presc_plan_hist.id_interv_presc_det%TYPE DEFAULT NULL,
        id_prof_take_in              IN interv_presc_plan_hist.id_prof_take%TYPE DEFAULT NULL,
        flg_status_in                IN interv_presc_plan_hist.flg_status%TYPE DEFAULT NULL,
        id_prof_cancel_in            IN interv_presc_plan_hist.id_prof_cancel%TYPE DEFAULT NULL,
        notes_cancel_in              IN interv_presc_plan_hist.notes_cancel%TYPE DEFAULT NULL,
        id_wound_treat_in            IN interv_presc_plan_hist.id_wound_treat%TYPE DEFAULT NULL,
        dt_take_tstz_in              IN interv_presc_plan_hist.dt_take_tstz%TYPE DEFAULT NULL,
        dt_cancel_tstz_in            IN interv_presc_plan_hist.dt_cancel_tstz%TYPE DEFAULT NULL,
        id_schedule_intervention_in  IN interv_presc_plan_hist.id_schedule_intervention%TYPE DEFAULT NULL,
        id_change_in                 IN interv_presc_plan_hist.id_change%TYPE DEFAULT NULL,
        flg_supplies_reg_in          IN interv_presc_plan_hist.flg_supplies_reg%TYPE DEFAULT 'N',
        id_cancel_reason_in          IN interv_presc_plan_hist.id_cancel_reason%TYPE DEFAULT NULL,
        id_epis_documentation_in     IN interv_presc_plan_hist.id_epis_documentation%TYPE DEFAULT NULL,
        id_cdr_event_in              IN interv_presc_plan_hist.id_cdr_event%TYPE DEFAULT NULL,
        exec_number_in               IN interv_presc_plan_hist.exec_number%TYPE DEFAULT NULL,
        id_prof_last_update_in       IN interv_presc_plan_hist.id_prof_last_update%TYPE DEFAULT NULL,
        dt_last_update_tstz_in       IN interv_presc_plan_hist.dt_last_update_tstz%TYPE DEFAULT NULL,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_pky interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE := next_key;
    BEGIN
        ins(id_interv_presc_plan_hist_in => l_pky,
            ...
            notes_in                     => notes_in,
            dt_interv_presc_plan_hist_in => dt_interv_presc_plan_hist_in,
    ...
    (
        ...
        id_prof_last_update_in        IN interv_presc_plan_hist.id_prof_last_update%TYPE DEFAULT NULL,
        dt_last_update_tstz_in        IN interv_presc_plan_hist.dt_last_update_tstz%TYPE DEFAULT NULL,
        id_interv_presc_plan_hist_out IN OUT interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    ...
    BEGIN
        ins(id_interv_presc_plan_hist_in => l_pky,
            ...
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
        id_interv_presc_plan_hist_out := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_interv_presc_plan_in       => id_interv_presc_plan_in,
            ...
            id_prof_last_update_in        => id_prof_last_update_in,
            dt_last_update_tstz_in        => dt_last_update_tstz_in,
            id_interv_presc_plan_hist_out => id_interv_presc_plan_hist_out,
            handle_error_in               => handle_error_in,
            rows_out                      => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE IS
        l_pky interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE := next_key;
    BEGIN
        ins(id_interv_presc_plan_hist_in => l_pky,
            id_interv_presc_plan_in      => id_interv_presc_plan_in,
    ...
    PROCEDURE ins
    (
        id_interv_presc_plan_hist_in IN interv_presc_plan_hist.id_interv_presc_plan_hist%TYPE,
        id_interv_presc_plan_in      IN interv_presc_plan_hist.id_interv_presc_plan%TYPE DEFAULT NULL,
        id_prof_performed_in         IN interv_presc_plan_hist.id_prof_performed%TYPE DEFAULT NULL,
        id_episode_write_in          IN interv_presc_plan_hist.id_episode_write%TYPE DEFAULT NULL,
        start_time_in                IN interv_presc_plan_hist.start_time%TYPE DEFAULT NULL,
    ...
    BEGIN
        INSERT INTO interv_presc_plan_hist
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_interv_presc_plan_hist_in => id_interv_presc_plan_hist_in,
            id_interv_presc_plan_in      => id_interv_presc_plan_in,
            id_prof_performed_in         => id_prof_performed_in,
            id_episode_write_in          => id_episode_write_in,
            start_time_in                => start_time_in,
    ...
    PROCEDURE ins
    (
        rec_in          IN interv_presc_plan_hist%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec interv_presc_plan_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_interv_presc_plan_hist := next_key(sequence_in);
        END IF;
    
        ins(id_interv_presc_plan_hist_in => l_rec.id_interv_presc_plan_hist,
            ...
            dt_interv_presc_plan_hist_in => l_rec.dt_interv_presc_plan_hist,
    ...
    PROCEDURE ins
    (
        rows_in         IN interv_presc_plan_hist_tc,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        dt_interv_presc_plan_hist_in  IN interv_presc_plan_hist.dt_interv_presc_plan_hist%TYPE DEFAULT NULL,
        dt_interv_presc_plan_hist_nin IN BOOLEAN := TRUE,
        id_professional_in            IN interv_presc_plan_hist.id_professional%TYPE DEFAULT NULL,
        ...
        flg_supplies_reg_in           IN interv_presc_plan_hist.flg_supplies_reg%TYPE DEFAULT NULL,
        ...
        l_dt_interv_presc_plan_hist_n NUMBER(1) := sys.diutil.bool_to_int(dt_interv_presc_plan_hist_nin);
    ...
    BEGIN
        ...
        UPDATE interv_presc_plan_hist
           SET id_interv_presc_plan      = decode(l_id_interv_presc_plan_n,
               ...
               dt_interv_presc_plan_hist = decode(l_dt_interv_presc_plan_hist_n,
                                                  0,
                                                  dt_interv_presc_plan_hist_in,
                                                  nvl(dt_interv_presc_plan_hist_in, dt_interv_presc_plan_hist)),
         ...
         WHERE id_interv_presc_plan_hist = id_interv_presc_plan_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_interv_presc_plan_hist_in  => id_interv_presc_plan_hist_in,
            id_interv_presc_plan_in       => id_interv_presc_plan_in,
            ...
            notes_nin                     => notes_nin,
            dt_interv_presc_plan_hist_in  => dt_interv_presc_plan_hist_in,
            dt_interv_presc_plan_hist_nin => dt_interv_presc_plan_hist_nin,
            id_professional_in            => id_professional_in,
    ...
    BEGIN
        ...
        l_dt_interv_presc_plan_hist_n := sys.diutil.bool_to_int(dt_interv_presc_plan_hist_nin);
        ...
        l_sql                         := 'UPDATE interv_presc_plan_hist SET' || ' ID_INTERV_PRESC_PLAN = decode (' ||
                                         l_id_interv_presc_plan_n ||
                                         ...
                                         ' NOTES = decode (' || l_notes_n || ',0,:NOTES_in, NVL (:NOTES_in, NOTES)) ' || ',' ||
                                         ' DT_INTERV_PRESC_PLAN_HIST = decode (' || l_dt_interv_presc_plan_hist_n ||
                                         ',0,:DT_INTERV_PRESC_PLAN_HIST_in, NVL (:DT_INTERV_PRESC_PLAN_HIST_in, DT_INTERV_PRESC_PLAN_HIST)) ' || ',' ||
                                         ' ID_PROFESSIONAL = decode (' || l_id_professional_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_interv_presc_plan_in, id_prof_performed_in, id_episode_write_in, start_time_in, end_time_in, notes_in, dt_interv_presc_plan_hist_in, id_professional_in, dt_plan_tstz_in, num_exec_sess_in, dt_interv_presc_plan_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_interv_presc_det_in, id_prof_take_in, flg_status_in, id_prof_cancel_in, notes_cancel_in, id_wound_treat_in, dt_take_tstz_in, dt_cancel_tstz_in, id_schedule_intervention_in, id_change_in, flg_supplies_reg_in, id_cancel_reason_in, id_epis_documentation_in, id_cdr_event_in, exec_number_in, id_prof_last_update_in, dt_last_update_tstz_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_interv_presc_plan_hist_in,
                id_interv_presc_plan_in,
                id_prof_performed_in,
                id_episode_write_in,
                start_time_in,
    ...
    BEGIN
        upd(id_interv_presc_plan_hist_in => rec_in.id_interv_presc_plan_hist,
            ...
            dt_interv_presc_plan_hist_in => rec_in.dt_interv_presc_plan_hist,
    ...
    PROCEDURE upd
    (
        col_in            IN interv_presc_plan_hist_tc,
        ignore_if_null_in IN BOOLEAN := TRUE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          IN OUT table_varchar
    ) IS
        l_id_interv_presc_plan_hist id_interv_presc_plan_hist_cc;
        ...
        l_notes                     notes_cc;
        l_dt_interv_presc_plan_hist dt_interv_presc_plan_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_interv_presc_plan_hist(i) := col_in(i).id_interv_presc_plan_hist;
            ...
            l_dt_interv_presc_plan_hist(i) := col_in(i).dt_interv_presc_plan_hist;
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE interv_presc_plan_hist
                   SET id_interv_presc_plan      = nvl(l_id_interv_presc_plan(i), id_interv_presc_plan),
                       ...
                       dt_interv_presc_plan_hist = nvl(l_dt_interv_presc_plan_hist(i), dt_interv_presc_plan_hist),
                 ...
                 WHERE id_interv_presc_plan_hist = l_id_interv_presc_plan_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE interv_presc_plan_hist
                   SET id_interv_presc_plan      = l_id_interv_presc_plan(i),
                       ...
                       notes                     = l_notes(i),
                       dt_interv_presc_plan_hist = l_dt_interv_presc_plan_hist(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE interv_presc_plan_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE interv_presc_plan_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE interv_presc_plan_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM interv_presc_plan_hist
         WHERE id_interv_presc_plan_hist = id_interv_presc_plan_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_interv_presc_plan_hist_in => id_interv_presc_plan_hist_in,
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
    END del;

    -- Delete all rows for this IPPH_IPP_FK foreign key value
    PROCEDURE del_ipph_ipp_fk
    (
        id_interv_presc_plan_in IN interv_presc_plan_hist.id_interv_presc_plan%TYPE,
        handle_error_in         IN BOOLEAN := TRUE,
        rows_out                OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ipph_ipp_fk(id_interv_presc_plan_in => id_interv_presc_plan_in,
                        handle_error_in         => handle_error_in,
                        rows_out                => rows_out);
    END del_ipph_ipp_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM interv_presc_plan_hist';
        ELSE
            RETURN 'DELETE FROM interv_presc_plan_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(interv_presc_plan_hist_inout IN OUT interv_presc_plan_hist%ROWTYPE) IS
    BEGIN
        interv_presc_plan_hist_inout.id_interv_presc_plan_hist := NULL;
        interv_presc_plan_hist_inout.id_interv_presc_plan      := NULL;
        interv_presc_plan_hist_inout.id_prof_performed         := NULL;
        interv_presc_plan_hist_inout.id_episode_write          := NULL;
        interv_presc_plan_hist_inout.start_time                := NULL;
        interv_presc_plan_hist_inout.end_time                  := NULL;
        interv_presc_plan_hist_inout.notes                     := NULL;
        interv_presc_plan_hist_inout.dt_interv_presc_plan_hist := NULL;
        interv_presc_plan_hist_inout.id_professional           := NULL;
        interv_presc_plan_hist_inout.dt_plan_tstz              := NULL;
        interv_presc_plan_hist_inout.num_exec_sess             := NULL;
        interv_presc_plan_hist_inout.dt_interv_presc_plan      := NULL;
        interv_presc_plan_hist_inout.create_user               := NULL;
        interv_presc_plan_hist_inout.create_time               := NULL;
        interv_presc_plan_hist_inout.create_institution        := NULL;
        interv_presc_plan_hist_inout.update_user               := NULL;
        interv_presc_plan_hist_inout.update_time               := NULL;
        interv_presc_plan_hist_inout.update_institution        := NULL;
        interv_presc_plan_hist_inout.id_interv_presc_det       := NULL;
        interv_presc_plan_hist_inout.id_prof_take              := NULL;
        interv_presc_plan_hist_inout.flg_status                := NULL;
        interv_presc_plan_hist_inout.id_prof_cancel            := NULL;
        interv_presc_plan_hist_inout.notes_cancel              := NULL;
        interv_presc_plan_hist_inout.id_wound_treat            := NULL;
        interv_presc_plan_hist_inout.dt_take_tstz              := NULL;
        interv_presc_plan_hist_inout.dt_cancel_tstz            := NULL;
        interv_presc_plan_hist_inout.id_schedule_intervention  := NULL;
        interv_presc_plan_hist_inout.id_change                 := NULL;
        interv_presc_plan_hist_inout.flg_supplies_reg          := NULL;
        interv_presc_plan_hist_inout.id_cancel_reason          := NULL;
        interv_presc_plan_hist_inout.id_epis_documentation     := NULL;
        interv_presc_plan_hist_inout.id_cdr_event              := NULL;
        interv_presc_plan_hist_inout.exec_number               := NULL;
        interv_presc_plan_hist_inout.id_prof_last_update       := NULL;
        interv_presc_plan_hist_inout.dt_last_update_tstz       := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN interv_presc_plan_hist%ROWTYPE IS
        l_interv_presc_plan_hist interv_presc_plan_hist%ROWTYPE;
    BEGIN
        RETURN l_interv_presc_plan_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN interv_presc_plan_hist_tc IS
        data interv_presc_plan_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN interv_presc_plan_hist_tc IS
        data interv_presc_plan_hist_tc;
