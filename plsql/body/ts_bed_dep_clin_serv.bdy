/*-- Last Change Revision: $Rev: 2027947 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:46 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_bed_dep_clin_serv
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Julho 29, 2009 14:35:7
| Created By: ALERT
*/
 IS
    ...
    (
        ...
        l_rec bed_dep_clin_serv%ROWTYPE := rec_in;
    BEGIN
    ...
    (
        ...
        l_update_time_n        NUMBER(1);
        l_update_institution_n NUMBER(1);
        id_bed_in              bed_dep_clin_serv.id_bed%TYPE;
        id_dep_clin_serv_in    bed_dep_clin_serv.id_dep_clin_serv%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE BED_DEP_CLIN_SERV SET ' || ' FLG_AVAILABLE = decode (' || l_flg_available_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN flg_available_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE BED_DEP_CLIN_SERV
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE BED_DEP_CLIN_SERV
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE BED_DEP_CLIN_SERV set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE BED_DEP_CLIN_SERV set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM bed_dep_clin_serv
         WHERE id_bed = del_bdcs_ib_fk.id_bed_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_bdcs_ib_fk(id_bed_in => id_bed_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_bdcs_ib_fk;
    ...
    BEGIN
        DELETE FROM bed_dep_clin_serv
         WHERE id_dep_clin_serv = del_bdcs_id_fk.id_dep_clin_serv_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_bdcs_id_fk(id_dep_clin_serv_in => id_dep_clin_serv_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_bdcs_id_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM BED_DEP_CLIN_SERV';
        ELSE
            RETURN 'DELETE FROM BED_DEP_CLIN_SERV WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(bed_dep_clin_serv_inout IN OUT bed_dep_clin_serv%ROWTYPE) IS
    BEGIN
        bed_dep_clin_serv_inout.id_bed             := NULL;
        bed_dep_clin_serv_inout.id_dep_clin_serv   := NULL;
        bed_dep_clin_serv_inout.flg_available      := 'Y';
        bed_dep_clin_serv_inout.create_user        := NULL;
        bed_dep_clin_serv_inout.create_time        := NULL;
        bed_dep_clin_serv_inout.create_institution := NULL;
        bed_dep_clin_serv_inout.update_user        := NULL;
        bed_dep_clin_serv_inout.update_time        := NULL;
        bed_dep_clin_serv_inout.update_institution := NULL;
    END initrec;

    FUNCTION initrec RETURN bed_dep_clin_serv%ROWTYPE IS
        l_bed_dep_clin_serv bed_dep_clin_serv%ROWTYPE;
    BEGIN
        l_bed_dep_clin_serv.flg_available := 'Y';
        RETURN l_bed_dep_clin_serv;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN bed_dep_clin_serv_tc IS
        data bed_dep_clin_serv_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM bed_dep_clin_serv
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN bed_dep_clin_serv_tc IS
