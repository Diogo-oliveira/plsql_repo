...
CREATE OR REPLACE PACKAGE BODY ts_consult_req_hist
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: July 3, 2010 12:54:52
| Created By: ALERT
*/
 IS
    ...
    BEGIN
        ...
        ins(id_consult_req_hist_in   => id_consult_req_hist_in,
            id_consult_req_in        => id_consult_req_in,
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_consult_req_hist_in   => id_consult_req_hist_in,
                              id_consult_req_in        => id_consult_req_in,
                              consult_type_in          => consult_type_in,
                              id_clinical_service_in   => id_clinical_service_in,
                              id_patient_in            => id_patient_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_consult_req_hist_in   => id_consult_req_hist_in,
                                  id_consult_req_in        => id_consult_req_in,
                                  consult_type_in          => consult_type_in,
                                  id_clinical_service_in   => id_clinical_service_in,
                                  id_patient_in            => id_patient_in,
    ...
    */
    ...
    (
        ...
        l_rec consult_req_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_consult_req_hist := next_key(sequence_in);
        END IF;
        ins(id_consult_req_hist_in   => l_rec.id_consult_req_hist,
            id_consult_req_in        => l_rec.id_consult_req,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN consult_req_hist.id_consult_req_hist%TYPE
     ...
     IS
        retval consult_req_hist.id_consult_req_hist%TYPE;

    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_consult_req_hist.NEXTVAL
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_CONSULT_REQ_HIST'));
    END next_key;
    ...
    (
        ...
        l_pky consult_req_hist.id_consult_req_hist%TYPE := next_key;
    BEGIN
        ins(id_consult_req_hist_in   => l_pky,
            id_consult_req_in        => id_consult_req_in,
            consult_type_in          => consult_type_in,
            id_clinical_service_in   => id_clinical_service_in,
            id_patient_in            => id_patient_in,
    ...
    BEGIN
        ins(id_consult_req_in        => id_consult_req_in,
            ...
            month_nr_in              => month_nr_in,
            id_soft_reg_by_in        => id_soft_reg_by_in,
            id_consult_req_hist_out  => id_consult_req_hist_out,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in          IN BOOLEAN := TRUE,
        rows_out                 OUT table_varchar
    ) RETURN consult_req_hist.id_consult_req_hist%TYPE IS
        l_pky consult_req_hist.id_consult_req_hist%TYPE := next_key;
    BEGIN
        ins(id_consult_req_hist_in   => l_pky,
            id_consult_req_in        => id_consult_req_in,
    ...
    BEGIN
        ...
        l_id_consult_req_n        := sys.diutil.bool_to_int(id_consult_req_nin);
        ...
        UPDATE consult_req_hist
           SET id_consult_req        = decode(l_id_consult_req_n,
                                              0,
                                              id_consult_req_in,
                                              nvl(id_consult_req_in, id_consult_req)),
               consult_type          = decode(l_consult_type_n, 0, consult_type_in, nvl(consult_type_in, consult_type)),
    ...
    BEGIN
        upd(id_consult_req_hist_in    => id_consult_req_hist_in,
            id_consult_req_in         => id_consult_req_in,
            id_consult_req_nin        => id_consult_req_nin,
            consult_type_in           => consult_type_in,
    ...
    (
        ...
        l_month_nr_n              NUMBER(1);
        l_id_soft_reg_by_n        NUMBER(1);
        id_consult_req_hist_in    consult_req_hist.id_consult_req_hist%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE CONSULT_REQ_HIST SET ' || ' ID_CONSULT_REQ = decode (' || l_id_consult_req_n ||
                 ',0,:id_consult_req_in, NVL (:id_consult_req_in, ID_CONSULT_REQ)) ' || ',' ||
                 ' CONSULT_TYPE = decode (' || l_consult_type_n ||
    ...
    BEGIN
        upd(id_consult_req_hist_in   => rec_in.id_consult_req_hist,
            id_consult_req_in        => rec_in.id_consult_req,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_consult_req_hist_in,
                id_consult_req_in,
                consult_type_in,
                id_clinical_service_in,
                id_patient_in,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE consult_req_hist
                   SET id_consult_req        = nvl(l_id_consult_req(i), id_consult_req),
                       consult_type          = nvl(l_consult_type(i), consult_type),
                 ...
                 WHERE id_consult_req_hist = l_id_consult_req_hist(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE consult_req_hist
                   SET id_consult_req        = l_id_consult_req(i),
                       consult_type          = l_consult_type(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE CONSULT_REQ_HIST
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE CONSULT_REQ_HIST
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE CONSULT_REQ_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE CONSULT_REQ_HIST set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_consult_req_hist_in => id_consult_req_hist_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_consult_req_hist(id_consult_req_hist_in => id_consult_req_hist_in,
                                handle_error_in        => handle_error_in,
                                rows_out               => rows_out);
    END del_id_consult_req_hist;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM CONSULT_REQ_HIST';
        ELSE
            RETURN 'DELETE FROM CONSULT_REQ_HIST WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(consult_req_hist_inout IN OUT consult_req_hist%ROWTYPE) IS
    BEGIN
        consult_req_hist_inout.id_consult_req_hist   := NULL;
        consult_req_hist_inout.id_consult_req        := NULL;
        consult_req_hist_inout.consult_type          := NULL;
        consult_req_hist_inout.id_clinical_service   := NULL;
        consult_req_hist_inout.id_patient            := NULL;
        consult_req_hist_inout.id_instit_requests    := NULL;
        consult_req_hist_inout.id_inst_requested     := NULL;
        consult_req_hist_inout.id_episode            := NULL;
        consult_req_hist_inout.id_prof_req           := NULL;
        consult_req_hist_inout.id_prof_auth          := NULL;
        consult_req_hist_inout.id_prof_appr          := NULL;
        consult_req_hist_inout.id_prof_proc          := NULL;
        consult_req_hist_inout.notes                 := NULL;
        consult_req_hist_inout.id_prof_cancel        := NULL;
        consult_req_hist_inout.notes_cancel          := NULL;
        consult_req_hist_inout.id_dep_clin_serv      := NULL;
        consult_req_hist_inout.id_prof_requested     := NULL;
        consult_req_hist_inout.flg_status            := NULL;
        consult_req_hist_inout.notes_admin           := NULL;
        consult_req_hist_inout.id_schedule           := NULL;
        consult_req_hist_inout.dt_consult_req_tstz   := NULL;
        consult_req_hist_inout.dt_scheduled_tstz     := NULL;
        consult_req_hist_inout.dt_cancel_tstz        := NULL;
        consult_req_hist_inout.next_visit_in_notes   := NULL;
        consult_req_hist_inout.flg_instructions      := NULL;
        consult_req_hist_inout.id_complaint          := NULL;
        consult_req_hist_inout.flg_type_date         := NULL;
        consult_req_hist_inout.status_flg            := NULL;
        consult_req_hist_inout.status_icon           := NULL;
        consult_req_hist_inout.status_msg            := NULL;
        consult_req_hist_inout.status_str            := NULL;
        consult_req_hist_inout.reason_for_visit      := NULL;
        consult_req_hist_inout.create_user           := NULL;
        consult_req_hist_inout.create_time           := NULL;
        consult_req_hist_inout.create_institution    := NULL;
        consult_req_hist_inout.update_user           := NULL;
        consult_req_hist_inout.update_time           := NULL;
        consult_req_hist_inout.update_institution    := NULL;
        consult_req_hist_inout.flg_type              := NULL;
        consult_req_hist_inout.id_cancel_reason      := NULL;
        consult_req_hist_inout.id_epis_documentation := NULL;
        consult_req_hist_inout.id_epis_type          := NULL;
        consult_req_hist_inout.dt_last_update        := NULL;
        consult_req_hist_inout.id_prof_last_update   := NULL;
        consult_req_hist_inout.id_inst_last_update   := NULL;
        consult_req_hist_inout.id_sch_event          := NULL;
        consult_req_hist_inout.dt_begin_event        := NULL;
        consult_req_hist_inout.dt_end_event          := NULL;
        consult_req_hist_inout.flg_priority          := NULL;
        consult_req_hist_inout.flg_contact_type      := NULL;
        consult_req_hist_inout.instructions          := NULL;
        consult_req_hist_inout.id_room               := NULL;
        consult_req_hist_inout.flg_request_type      := NULL;
        consult_req_hist_inout.flg_req_resp          := NULL;
        consult_req_hist_inout.request_reason        := NULL;
        consult_req_hist_inout.id_language           := NULL;
        consult_req_hist_inout.flg_recurrence        := NULL;
        consult_req_hist_inout.frequency             := NULL;
        consult_req_hist_inout.dt_rec_begin          := NULL;
        consult_req_hist_inout.dt_rec_end            := NULL;
        consult_req_hist_inout.nr_events             := NULL;
        consult_req_hist_inout.week_day              := NULL;
        consult_req_hist_inout.week_nr               := NULL;
        consult_req_hist_inout.month_day             := NULL;
        consult_req_hist_inout.month_nr              := NULL;
        consult_req_hist_inout.id_soft_reg_by        := NULL;
    END initrec;

    FUNCTION initrec RETURN consult_req_hist%ROWTYPE IS
        l_consult_req_hist consult_req_hist%ROWTYPE;
    BEGIN
        RETURN l_consult_req_hist;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN consult_req_hist_tc IS
        data consult_req_hist_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM consult_req_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN consult_req_hist_tc IS
