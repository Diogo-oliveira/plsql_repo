...
CREATE OR REPLACE PACKAGE BODY TS_TREATMENT_MANAGEMENT
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Maio 17, 2012 12:20:9
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO TREATMENT_MANAGEMENT (
         ID_TREATMENT_MANAGEMENT,
         ID_TREATMENT,
      ...
      VALUES (
         id_treatment_management_in,
         id_treatment_in,
         desc_treatment_management_in,
         id_professional_in,
         flg_type_in,
         dt_creation_tstz_in,
         create_user_in,
        ...
        BEGIN
           ...
           ELSE
              pk_alert_exceptions.raise_error (
                    ...
                    ,value2_in => l_name
                    ,name3_in => 'TABLE_NAME'
                    ,value3_in => 'TREATMENT_MANAGEMENT');
           END IF;
        END;
        END IF;
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'TREATMENT_MANAGEMENT');
           IF l_name = 'TMAN_PROF_FK'
           THEN
   ...
   BEGIN
     ...
     ins (
      id_treatment_management_in => id_treatment_management_in
      ,
      id_treatment_in => id_treatment_in,
      desc_treatment_management_in => desc_treatment_management_in,
   ...
   IS
      l_rec TREATMENT_MANAGEMENT%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_TREATMENT_MANAGEMENT := next_key (sequence_in);
      END IF;
      ins (
         id_treatment_management_in => l_rec.ID_TREATMENT_MANAGEMENT
         ,
         id_treatment_in => l_rec.ID_TREATMENT,
         desc_treatment_management_in => l_rec.DESC_TREATMENT_MANAGEMENT,
  ...
  ins (
   ...
   IS
     retval TREATMENT_MANAGEMENT.ID_TREATMENT_MANAGEMENT%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_TREATMENT_MANAGEMENT.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_TREATMENT_MANAGEMENT')
           );
   END next_key;
   ...
   IS
        l_pky TREATMENT_MANAGEMENT.ID_TREATMENT_MANAGEMENT%TYPE := next_key;
   BEGIN
      ins (
         id_treatment_management_in => l_pky,
         id_treatment_in => id_treatment_in,
         desc_treatment_management_in => desc_treatment_management_in,
         id_professional_in => id_professional_in,
         flg_type_in => flg_type_in,
      ...
      id_treatment_management_out := l_pky;
   END ins;
   ...
   BEGIN
      ...
      update_time_in => update_time_in,
      update_institution_in => update_institution_in,
      id_treatment_management_out => id_treatment_management_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO TREATMENT_MANAGEMENT VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_TREATMENT_MANAGEMENT _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_TREATMENT_MANAGEMENT
                  ,validate_in => FALSE
                );

                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_TREATMENT _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_TREATMENT
                  ,validate_in => FALSE
                );

                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'DESC_TREATMENT_MANAGEMENT _' || indx
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).DESC_TREATMENT_MANAGEMENT
                  ,validate_in => FALSE
                );
     ...
     THEN
       ...
       pk_alert_exceptions.raise_error(
          error_name_in => 'FORALL-INSERT-FAILURE'
          ,name1_in => 'TABLE_NAME'
          ,value1_in => 'TREATMENT_MANAGEMENT'
          ,name2_in => 'ROW_COUNT'
...
PROCEDURE upd (
   ...
   l_ID_TREATMENT_n NUMBER(1);
   l_DESC_TREATMENT_MANAGEMENT_n NUMBER(1);
   ...
   l_ID_TREATMENT_n := sys.diutil.bool_to_int(ID_TREATMENT_nin);
   l_DESC_TREATMENT_MANAGEMENT_n := sys.diutil.bool_to_int(DESC_TREATMENT_MANAGEMENT_nin);
   ...
   l_UPDATE_INSTITUTION_n := sys.diutil.bool_to_int(UPDATE_INSTITUTION_nin);
         ...
         UPDATE TREATMENT_MANAGEMENT SET
     ID_TREATMENT = decode (l_ID_TREATMENT_n,0,id_treatment_in, NVL (id_treatment_in, ID_TREATMENT)),
     DESC_TREATMENT_MANAGEMENT = decode (l_DESC_TREATMENT_MANAGEMENT_n,0,desc_treatment_management_in, NVL (desc_treatment_management_in, DESC_TREATMENT_MANAGEMENT)),
     ...
     UPDATE_INSTITUTION = decode (l_UPDATE_INSTITUTION_n,0,update_institution_in, NVL (update_institution_in, UPDATE_INSTITUTION))
          WHERE
             ID_TREATMENT_MANAGEMENT = id_treatment_management_in
...
rows_out :=  rows_out MULTISET UNION DISTINCT l_rows_out;
   ...
   BEGIN
     upd (
      id_treatment_management_in => id_treatment_management_in,
      id_treatment_in => id_treatment_in,
      ID_TREATMENT_nin => ID_TREATMENT_nin,
      desc_treatment_management_in => desc_treatment_management_in,
      DESC_TREATMENT_MANAGEMENT_nin => DESC_TREATMENT_MANAGEMENT_nin,
      id_professional_in => id_professional_in,
...
PROCEDURE upd (
   ...
   l_UPDATE_TIME_n NUMBER(1);
   l_UPDATE_INSTITUTION_n NUMBER(1);
      id_treatment_management_in TREATMENT_MANAGEMENT.ID_TREATMENT_MANAGEMENT%TYPE;
   BEGIN
...
l_sql := 'UPDATE TREATMENT_MANAGEMENT SET '
     || ' ID_TREATMENT = decode (' || l_ID_TREATMENT_n || ',0,:id_treatment_in, NVL (:id_treatment_in, ID_TREATMENT)) '|| ','
     || ' DESC_TREATMENT_MANAGEMENT = decode (' || l_DESC_TREATMENT_MANAGEMENT_n || ',0,:desc_treatment_management_in, NVL (:desc_treatment_management_in, DESC_TREATMENT_MANAGEMENT)) '|| ','
     || ' ID_PROFESSIONAL = decode (' || l_ID_PROFESSIONAL_n || ',0,:id_professional_in, NVL (:id_professional_in, ID_PROFESSIONAL)) '|| ','
     || ' FLG_TYPE = decode (' || l_FLG_TYPE_n || ',0,:flg_type_in, NVL (:flg_type_in, FLG_TYPE)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         id_treatment_management_in => rec_in.ID_TREATMENT_MANAGEMENT,
         id_treatment_in => rec_in.ID_TREATMENT,
         desc_treatment_management_in => rec_in.DESC_TREATMENT_MANAGEMENT,
   ...
   IS
      l_ID_TREATMENT_MANAGEMENT ID_TREATMENT_MANAGEMENT_cc;
      l_ID_TREATMENT ID_TREATMENT_cc;
      l_DESC_TREATMENT_MANAGEMENT DESC_TREATMENT_MANAGEMENT_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         l_ID_TREATMENT_MANAGEMENT(i) := col_in(i).ID_TREATMENT_MANAGEMENT;
         l_ID_TREATMENT(i) := col_in(i).ID_TREATMENT;
         l_DESC_TREATMENT_MANAGEMENT(i) := col_in(i).DESC_TREATMENT_MANAGEMENT;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE TREATMENT_MANAGEMENT SET
               ID_TREATMENT = NVL (l_ID_TREATMENT(i), ID_TREATMENT),
               DESC_TREATMENT_MANAGEMENT = NVL (l_DESC_TREATMENT_MANAGEMENT(i), DESC_TREATMENT_MANAGEMENT),
             ...
             WHERE
                ID_TREATMENT_MANAGEMENT = l_ID_TREATMENT_MANAGEMENT(i)
          returning rowid bulk collect into rows_out;
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE TREATMENT_MANAGEMENT SET
               ID_TREATMENT = l_ID_TREATMENT(i),
               DESC_TREATMENT_MANAGEMENT = l_DESC_TREATMENT_MANAGEMENT(i),
   ...
   BEGIN
      RETURN
         'BEGIN UPDATE TREATMENT_MANAGEMENT
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE TREATMENT_MANAGEMENT set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE TREATMENT_MANAGEMENT set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
   ...
   IS
   BEGIN
      DELETE FROM TREATMENT_MANAGEMENT
       WHERE
          ID_TREATMENT_MANAGEMENT = id_treatment_management_in
       RETURNING ROWID BULK COLLECT INTO rows_out
         ;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM TREATMENT_MANAGEMENT
       WHERE ID_TREATMENT_MANAGEMENT = id_treatment_management_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
      ...
      THEN
        ...
        END;
        END IF;
   END del_ID_TREATMENT_MANAGEMENT;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM TREATMENT_MANAGEMENT
       WHERE
          ID_PROFESSIONAL = del_TMAN_PROF_FK.id_professional_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_TMAN_PROF_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM TREATMENT_MANAGEMENT';
      ELSE
         RETURN
            'DELETE FROM TREATMENT_MANAGEMENT WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      treatment_management_inout.ID_TREATMENT_MANAGEMENT := NULL;
      treatment_management_inout.ID_TREATMENT := NULL;
      treatment_management_inout.DESC_TREATMENT_MANAGEMENT := NULL;
      treatment_management_inout.ID_PROFESSIONAL := NULL;
      treatment_management_inout.FLG_TYPE := NULL;
      treatment_management_inout.DT_CREATION_TSTZ := NULL;
      treatment_management_inout.CREATE_USER := NULL;
      treatment_management_inout.CREATE_TIME := NULL;
      treatment_management_inout.CREATE_INSTITUTION := NULL;
      treatment_management_inout.UPDATE_USER := NULL;
      treatment_management_inout.UPDATE_TIME := NULL;
      treatment_management_inout.UPDATE_INSTITUTION := NULL;
   END initrec;

   FUNCTION initrec RETURN TREATMENT_MANAGEMENT%ROWTYPE
   IS
      l_treatment_management TREATMENT_MANAGEMENT%ROWTYPE;
   BEGIN
      RETURN l_treatment_management;
   END initrec;
   ...
   IS
        data TREATMENT_MANAGEMENT_tc;
   BEGIN
        select * bulk collect into data from TREATMENT_MANAGEMENT where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
