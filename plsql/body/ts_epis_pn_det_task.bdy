/*-- Last Change Revision: $Rev: 2028128 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:16 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_epis_pn_det_task
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2021-11-10 12:09:21
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_pn_det_task.id_epis_pn_det_task%TYPE IS
        retval epis_pn_det_task.id_epis_pn_det_task%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_epis_pn_det_task.nextval;
        ELSE
    ...
    (
        ...
        l_pky epis_pn_det_task.id_epis_pn_det_task%TYPE := next_key;
    BEGIN
        ins(id_epis_pn_det_task_in    => l_pky,
    ...
    BEGIN
        ins(id_epis_pn_det_in         => id_epis_pn_det_in,
            id_task_in                => id_task_in,
            id_task_type_in           => id_task_type_in,
            flg_status_in             => flg_status_in,
            pn_note_in                => pn_note_in,
    ...
    BEGIN
        ins(id_epis_pn_det_in         => id_epis_pn_det_in,
            ...
            code_desc_group_parent_in => code_desc_group_parent_in,
            instructions_hash_in      => instructions_hash_in,
            id_epis_pn_det_task_out   => id_epis_pn_det_task_out,
            handle_error_in           => handle_error_in,
            rows_out                  => rows_out);
    END ins;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_epis_pn_det_task_in    => id_epis_pn_det_task_in,
            id_epis_pn_det_in         => id_epis_pn_det_in,
            id_task_in                => id_task_in,
            id_task_type_in           => id_task_type_in,
            flg_status_in             => flg_status_in,
    ...
    (
        ...
        l_rec epis_pn_det_task%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_pn_det_task := next_key(sequence_in);
        END IF;
    
        ins(id_epis_pn_det_task_in    => l_rec.id_epis_pn_det_task,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_pn_det_task_in     => id_epis_pn_det_task_in,
            id_epis_pn_det_in          => id_epis_pn_det_in,
    ...
    BEGIN
        ...
        l_sql                      := 'UPDATE epis_pn_det_task SET' || ' ID_EPIS_PN_DET = decode (' ||
                                      l_id_epis_pn_det_n ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_epis_pn_det_task_in,
                id_epis_pn_det_in,
                id_task_in,
                id_task_type_in,
                flg_status_in,
    ...
    BEGIN
        upd(id_epis_pn_det_task_in    => rec_in.id_epis_pn_det_task,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_det_task
                 ...
                 WHERE id_epis_pn_det_task = l_id_epis_pn_det_task(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_pn_det_task
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_pn_det_task
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_pn_det_task
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_pn_det_task
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_pn_det_task_in => id_epis_pn_det_task_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;
    ...
    BEGIN
        DELETE FROM epis_pn_det_task
         WHERE id_epis_pn_det = id_epis_pn_det_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM epis_pn_det_task
         WHERE id_prof_task = id_prof_task_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdtk_episd_fk(id_task_type_in => id_task_type_in,
                           handle_error_in => handle_error_in,
                           rows_out        => rows_out);
    END del_epdtk_episd_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdtk_eptd_fk(id_epis_pn_det_in => id_epis_pn_det_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_epdtk_eptd_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdtk_proft_fk(id_prof_task_in => id_prof_task_in,
                           handle_error_in => handle_error_in,
                           rows_out        => rows_out);
    END del_epdtk_proft_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdtk_prof_fk(id_prof_last_update_in => id_prof_last_update_in,
                          handle_error_in        => handle_error_in,
                          rows_out               => rows_out);
    END del_epdtk_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdt_profr_fk(id_prof_review_in => id_prof_review_in,
                          handle_error_in   => handle_error_in,
                          rows_out          => rows_out);
    END del_epdt_profr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epdt_prt_fk(id_parent_in => id_parent_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_epdt_prt_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_pn_det_task';
        ELSE
            RETURN 'DELETE FROM epis_pn_det_task WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_pn_det_task_inout IN OUT epis_pn_det_task%ROWTYPE) IS
    BEGIN
        epis_pn_det_task_inout.id_epis_pn_det_task    := NULL;
        epis_pn_det_task_inout.id_epis_pn_det         := NULL;
        epis_pn_det_task_inout.id_task                := NULL;
        epis_pn_det_task_inout.id_task_type           := NULL;
        epis_pn_det_task_inout.flg_status             := NULL;
        epis_pn_det_task_inout.pn_note                := NULL;
        epis_pn_det_task_inout.dt_last_update         := NULL;
        epis_pn_det_task_inout.id_prof_last_update    := NULL;
        epis_pn_det_task_inout.flg_table_origin       := NULL;
        epis_pn_det_task_inout.create_user            := NULL;
        epis_pn_det_task_inout.create_time            := NULL;
        epis_pn_det_task_inout.create_institution     := NULL;
        epis_pn_det_task_inout.update_user            := NULL;
        epis_pn_det_task_inout.update_time            := NULL;
        epis_pn_det_task_inout.update_institution     := NULL;
        epis_pn_det_task_inout.id_task_aggregator     := NULL;
        epis_pn_det_task_inout.dt_task                := NULL;
        epis_pn_det_task_inout.id_prof_task           := NULL;
        epis_pn_det_task_inout.rank_task              := NULL;
        epis_pn_det_task_inout.id_parent              := NULL;
        epis_pn_det_task_inout.dt_group_import        := NULL;
        epis_pn_det_task_inout.id_group_import        := NULL;
        epis_pn_det_task_inout.code_desc_group        := NULL;
        epis_pn_det_task_inout.id_sub_group_import    := NULL;
        epis_pn_det_task_inout.code_desc_sub_group    := NULL;
        epis_pn_det_task_inout.id_group_table         := NULL;
        epis_pn_det_task_inout.table_position         := NULL;
        epis_pn_det_task_inout.flg_action             := NULL;
        epis_pn_det_task_inout.id_prof_review         := NULL;
        epis_pn_det_task_inout.dt_review              := NULL;
        epis_pn_det_task_inout.id_sample_type         := NULL;
        epis_pn_det_task_inout.code_desc_sample_type  := NULL;
        epis_pn_det_task_inout.dt_req_task            := NULL;
        epis_pn_det_task_inout.code_desc_group_parent := NULL;
        epis_pn_det_task_inout.instructions_hash      := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_pn_det_task%ROWTYPE IS
        l_epis_pn_det_task epis_pn_det_task%ROWTYPE;
    BEGIN
        RETURN l_epis_pn_det_task;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_pn_det_task_tc IS
        data epis_pn_det_task_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_pn_det_task_tc IS
        data epis_pn_det_task_tc;
