...
CREATE OR REPLACE PACKAGE BODY ts_pre_hosp_vs_read
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 26, 2009 18:4:42
| Created By: ALERT
*/
 IS
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'PRE_HOSP_VS_READ');
                    IF l_name = 'PR_HSP_VSR_PR_HSP_ACC_FK'
                    THEN
    ...
    (
        ...
        l_rec pre_hosp_vs_read%ROWTYPE := rec_in;
    BEGIN
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        ...
                                                        value_in           => rows_in(indx).id_pre_hosp_accident,
                                                        validate_in        => FALSE);
    ...
    BEGIN
        ...
        UPDATE pre_hosp_vs_read
         ...
         WHERE id_pre_hosp_accident = id_pre_hosp_accident_in
           AND id_vital_sign_read = id_vital_sign_read_in
    ...
    (
        ...
        l_update_time_n         NUMBER(1);
        l_update_institution_n  NUMBER(1);
        id_pre_hosp_accident_in pre_hosp_vs_read.id_pre_hosp_accident%TYPE;
        id_vital_sign_read_in   pre_hosp_vs_read.id_vital_sign_read%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PRE_HOSP_VS_READ SET ' || ' FLG_STATUS = decode (' || l_flg_status_n ||
                 ',0,:flg_status_in, NVL (:flg_status_in, FLG_STATUS)) ' || ',' || ' CREATE_USER = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN flg_status_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, OUT l_rows_out;
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE pre_hosp_vs_read
                 ...
                 WHERE id_pre_hosp_accident = l_id_pre_hosp_accident(i)
                   AND id_vital_sign_read = l_id_vital_sign_read(i);
        ELSE
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE pre_hosp_vs_read
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PRE_HOSP_VS_READ
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'UPDATE PRE_HOSP_VS_READ
             SET ' || colname_in || ' = :value
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PRE_HOSP_VS_READ set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PRE_HOSP_VS_READ set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM pre_hosp_vs_read
         WHERE id_pre_hosp_accident = del_pr_hsp_vsr_pr_hsp_acc_fk.id_pre_hosp_accident_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                END;
            END IF;
    END del_pr_hsp_vsr_pr_hsp_acc_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pr_hsp_vsr_pr_hsp_acc_fk(id_pre_hosp_accident_in => id_pre_hosp_accident_in,
                                     handle_error_in         => handle_error_in,
                                     rows_out                => rows_out);
    END del_pr_hsp_vsr_pr_hsp_acc_fk;
    ...
    BEGIN
        DELETE FROM pre_hosp_vs_read
         WHERE id_vital_sign_read = del_pr_hsp_vsr_vsr_fk.id_vital_sign_read_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_pr_hsp_vsr_vsr_fk(id_vital_sign_read_in => id_vital_sign_read_in,
                              handle_error_in       => handle_error_in,
                              rows_out              => rows_out);
    END del_pr_hsp_vsr_vsr_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PRE_HOSP_VS_READ';
        ELSE
            RETURN 'DELETE FROM PRE_HOSP_VS_READ WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pre_hosp_vs_read_inout IN OUT pre_hosp_vs_read%ROWTYPE) IS
    BEGIN
        pre_hosp_vs_read_inout.id_pre_hosp_accident := NULL;
        pre_hosp_vs_read_inout.id_vital_sign_read   := NULL;
        pre_hosp_vs_read_inout.flg_status           := 'A';
        pre_hosp_vs_read_inout.create_user          := NULL;
        pre_hosp_vs_read_inout.create_time          := NULL;
        pre_hosp_vs_read_inout.create_institution   := NULL;
        pre_hosp_vs_read_inout.update_user          := NULL;
        pre_hosp_vs_read_inout.update_time          := NULL;
        pre_hosp_vs_read_inout.update_institution   := NULL;
    END initrec;

    FUNCTION initrec RETURN pre_hosp_vs_read%ROWTYPE IS
        l_pre_hosp_vs_read pre_hosp_vs_read%ROWTYPE;
    BEGIN
        l_pre_hosp_vs_read.flg_status := 'A';
        RETURN l_pre_hosp_vs_read;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pre_hosp_vs_read_tc IS
        data pre_hosp_vs_read_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM pre_hosp_vs_read
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pre_hosp_vs_read_tc IS
