/*-- Last Change Revision: $Rev: 2028272 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:47 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY ts_nurse_tea_req
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Junho 18, 2012 15:51:34
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_nurse_tea_req_in      IN nurse_tea_req.id_nurse_tea_req%TYPE,
        id_prof_req_in           IN nurse_tea_req.id_prof_req%TYPE DEFAULT NULL,
        id_episode_in            IN nurse_tea_req.id_episode%TYPE DEFAULT NULL,
        req_header_in            IN nurse_tea_req.req_header%TYPE DEFAULT NULL,
        flg_status_in            IN nurse_tea_req.flg_status%TYPE DEFAULT NULL,
        notes_req_in             IN nurse_tea_req.notes_req%TYPE DEFAULT NULL,
        id_prof_close_in         IN nurse_tea_req.id_prof_close%TYPE DEFAULT NULL,
        notes_close_in           IN nurse_tea_req.notes_close%TYPE DEFAULT NULL,
        id_prof_exec_in          IN nurse_tea_req.id_prof_exec%TYPE DEFAULT NULL,
        id_prev_episode_in       IN nurse_tea_req.id_prev_episode%TYPE DEFAULT NULL,
        dt_nurse_tea_req_tstz_in IN nurse_tea_req.dt_nurse_tea_req_tstz%TYPE DEFAULT NULL,
        dt_begin_tstz_in         IN nurse_tea_req.dt_begin_tstz%TYPE DEFAULT NULL,
        dt_close_tstz_in         IN nurse_tea_req.dt_close_tstz%TYPE DEFAULT NULL,
        id_visit_in              IN nurse_tea_req.id_visit%TYPE DEFAULT NULL,
        id_patient_in            IN nurse_tea_req.id_patient%TYPE DEFAULT NULL,
        status_flg_in            IN nurse_tea_req.status_flg%TYPE DEFAULT NULL,
        status_icon_in           IN nurse_tea_req.status_icon%TYPE DEFAULT NULL,
        status_msg_in            IN nurse_tea_req.status_msg%TYPE DEFAULT NULL,
        status_str_in            IN nurse_tea_req.status_str%TYPE DEFAULT NULL,
        create_user_in           IN nurse_tea_req.create_user%TYPE DEFAULT NULL,
        create_time_in           IN nurse_tea_req.create_time%TYPE DEFAULT NULL,
        create_institution_in    IN nurse_tea_req.create_institution%TYPE DEFAULT NULL,
        update_user_in           IN nurse_tea_req.update_user%TYPE DEFAULT NULL,
        update_time_in           IN nurse_tea_req.update_time%TYPE DEFAULT NULL,
        update_institution_in    IN nurse_tea_req.update_institution%TYPE DEFAULT NULL,
        id_cancel_reason_in      IN nurse_tea_req.id_cancel_reason%TYPE DEFAULT NULL,
        id_context_in            IN nurse_tea_req.id_context%TYPE DEFAULT NULL,
        flg_context_in           IN nurse_tea_req.flg_context%TYPE DEFAULT NULL,
        id_nurse_tea_topic_in    IN nurse_tea_req.id_nurse_tea_topic%TYPE DEFAULT NULL,
        id_order_recurr_plan_in  IN nurse_tea_req.id_order_recurr_plan%TYPE DEFAULT NULL,
        description_in           IN nurse_tea_req.description%TYPE DEFAULT NULL,
        flg_time_in              IN nurse_tea_req.flg_time%TYPE DEFAULT NULL,
        desc_topic_aux_in        IN nurse_tea_req.desc_topic_aux%TYPE DEFAULT NULL,
        id_not_order_reason_in   IN nurse_tea_req.id_not_order_reason%TYPE DEFAULT NULL,
        handle_error_in          IN BOOLEAN := TRUE,
        rows_out                 OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO nurse_tea_req
            (id_nurse_tea_req,
             id_prof_req,
             id_episode,
             req_header,
        ...
        WHEN e_integ_constraint_failure
            ...
            ELSE
                ...
                BEGIN
                    ...
                    END IF;
                    IF l_name = 'NTR_NOR_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_NOT_ORDER_REASON',
                                                        value_in           => id_not_order_reason_in);
                    END IF;
                    IF l_name = 'NTR_NTT_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
    ...
    */
    ...
    BEGIN
        n_upd_clobs_in_chunks(id_nurse_tea_req_in      => id_nurse_tea_req_in,
                              id_prof_req_in           => id_prof_req_in,
                              id_episode_in            => id_episode_in,
                              req_header_in            => req_header_in,
                              flg_status_in            => flg_status_in,
        ...
        IF SQL%ROWCOUNT = 0
        THEN
            n_ins_clobs_in_chunks(id_nurse_tea_req_in      => id_nurse_tea_req_in,
                                  id_prof_req_in           => id_prof_req_in,
                                  id_episode_in            => id_episode_in,
                                  req_header_in            => req_header_in,
                                  flg_status_in            => flg_status_in,
    ...
    */
    ...
    PROCEDURE ins
    (
        rec_in          IN nurse_tea_req%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec nurse_tea_req%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_nurse_tea_req := next_key(sequence_in);
        END IF;
        ins(id_nurse_tea_req_in      => l_rec.id_nurse_tea_req,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN nurse_tea_req.id_nurse_tea_req%TYPE
    
     IS
        retval nurse_tea_req.id_nurse_tea_req%TYPE;
    
    BEGIN
        IF sequence_in IS NULL
        THEN
            SELECT seq_nurse_tea_req.nextval
              INTO retval
              FROM dual;
        ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_NURSE_TEA_REQ'));
    END next_key;
    ...
    (
        ...
        desc_topic_aux_in        IN nurse_tea_req.desc_topic_aux%TYPE DEFAULT NULL,
        id_not_order_reason_in   IN nurse_tea_req.id_not_order_reason%TYPE DEFAULT NULL,
        id_nurse_tea_req_out     IN OUT nurse_tea_req.id_nurse_tea_req%TYPE,
        handle_error_in          IN BOOLEAN := TRUE,
        rows_out                 OUT table_varchar
    ) IS
        l_pky nurse_tea_req.id_nurse_tea_req%TYPE := next_key;
    BEGIN
        ins(id_nurse_tea_req_in      => l_pky,
            id_prof_req_in           => id_prof_req_in,
            id_episode_in            => id_episode_in,
            req_header_in            => req_header_in,
            flg_status_in            => flg_status_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_prof_req_in           => id_prof_req_in,
            id_episode_in            => id_episode_in,
            req_header_in            => req_header_in,
            flg_status_in            => flg_status_in,
            notes_req_in             => notes_req_in,
            ...
            desc_topic_aux_in        => desc_topic_aux_in,
            id_not_order_reason_in   => id_not_order_reason_in,
            id_nurse_tea_req_out     => id_nurse_tea_req_out,
            handle_error_in          => handle_error_in,
            rows_out                 => rows_out);
    END ins;
    ...
    BEGIN
        ...
        UPDATE nurse_tea_req
           SET id_prof_req           = decode(l_id_prof_req_n, 0, id_prof_req_in, nvl(id_prof_req_in, id_prof_req)),
    ...
    (
        ...
        l_desc_topic_aux_n        NUMBER(1);
        l_id_not_order_reason_n   NUMBER(1);
        id_nurse_tea_req_in       nurse_tea_req.id_nurse_tea_req%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE NURSE_TEA_REQ SET ' || ' ID_PROF_REQ = decode (' || l_id_prof_req_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_prof_req_in, id_episode_in, req_header_in, flg_status_in, notes_req_in, id_prof_close_in, notes_close_in, id_prof_exec_in, id_prev_episode_in, dt_nurse_tea_req_tstz_in, dt_begin_tstz_in, dt_close_tstz_in, id_visit_in, id_patient_in, status_flg_in, status_icon_in, status_msg_in, status_str_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_cancel_reason_in, id_context_in, flg_context_in, id_nurse_tea_topic_in, id_order_recurr_plan_in, description_in, flg_time_in, desc_topic_aux_in, id_not_order_reason_in, OUT l_rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_prof_req_in            => id_prof_req_in,
            id_prof_req_nin           => id_prof_req_nin,
            id_episode_in             => id_episode_in,
            id_episode_nin            => id_episode_nin,
            req_header_in             => req_header_in,
    ...
    BEGIN
        upd(id_nurse_tea_req_in      => rec_in.id_nurse_tea_req,
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE nurse_tea_req
                   SET id_prof_req           = nvl(l_id_prof_req(i), id_prof_req),
                 ...
                 WHERE id_nurse_tea_req = l_id_nurse_tea_req(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE nurse_tea_req
                   SET id_prof_req           = l_id_prof_req(i),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE NURSE_TEA_REQ
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE NURSE_TEA_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE NURSE_TEA_REQ set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_nurse_tea_req_in => id_nurse_tea_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    
    END del;

    -- Delete all rows for primary key column ID_NURSE_TEA_REQ
    PROCEDURE del_id_nurse_tea_req
    (
        id_nurse_tea_req_in IN nurse_tea_req.id_nurse_tea_req%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_nurse_tea_req(id_nurse_tea_req_in => id_nurse_tea_req_in,
                             handle_error_in     => handle_error_in,
                             rows_out            => rows_out);
    END del_id_nurse_tea_req;

    PROCEDURE del_ntr_crn_fk
    (
        id_cancel_reason_in IN nurse_tea_req.id_cancel_reason%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_cancel_reason = del_ntr_crn_fk.id_cancel_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_crn_fk(id_cancel_reason_in => id_cancel_reason_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ntr_crn_fk;

    PROCEDURE del_ntr_epis_fk
    (
        id_episode_in   IN nurse_tea_req.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_episode = del_ntr_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ntr_epis_fk;

    PROCEDURE del_ntr_epis_fk1
    (
        id_prev_episode_in IN nurse_tea_req.id_prev_episode%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_prev_episode = del_ntr_epis_fk1.id_prev_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_epis_fk1(id_prev_episode_in => id_prev_episode_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_ntr_epis_fk1;

    PROCEDURE del_ntr_nor_fk
    (
        id_not_order_reason_in IN nurse_tea_req.id_not_order_reason%TYPE,
        handle_error_in        IN BOOLEAN := TRUE,
        rows_out               OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_not_order_reason = del_ntr_nor_fk.id_not_order_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_nor_fk(id_not_order_reason_in => id_not_order_reason_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ntr_nor_fk;

    PROCEDURE del_ntr_ntt_fk
    (
        id_nurse_tea_topic_in IN nurse_tea_req.id_nurse_tea_topic%TYPE,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_nurse_tea_topic = del_ntr_ntt_fk.id_nurse_tea_topic_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_ntt_fk(id_nurse_tea_topic_in => id_nurse_tea_topic_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_ntr_ntt_fk;

    PROCEDURE del_ntr_orp_fk
    (
        id_order_recurr_plan_in IN nurse_tea_req.id_order_recurr_plan%TYPE,
        handle_error_in         IN BOOLEAN := TRUE,
        rows_out                OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_order_recurr_plan = del_ntr_orp_fk.id_order_recurr_plan_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_orp_fk(id_order_recurr_plan_in => id_order_recurr_plan_in,
                       handle_error_in         => handle_error_in,
                       rows_out                => rows_out);
    END del_ntr_orp_fk;

    PROCEDURE del_ntr_prof_cancel_fk
    (
        id_prof_close_in IN nurse_tea_req.id_prof_close%TYPE,
        handle_error_in  IN BOOLEAN := TRUE,
        rows_out         OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_prof_close = del_ntr_prof_cancel_fk.id_prof_close_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_prof_cancel_fk(id_prof_close_in => id_prof_close_in,
                               handle_error_in  => handle_error_in,
                               rows_out         => rows_out);
    END del_ntr_prof_cancel_fk;

    PROCEDURE del_ntr_prof_exec_fk
    (
        id_prof_exec_in IN nurse_tea_req.id_prof_exec%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_prof_exec = del_ntr_prof_exec_fk.id_prof_exec_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_prof_exec_fk(id_prof_exec_in => id_prof_exec_in,
                             handle_error_in => handle_error_in,
                             rows_out        => rows_out);
    END del_ntr_prof_exec_fk;

    PROCEDURE del_ntr_prof_req_fk
    (
        id_prof_req_in  IN nurse_tea_req.id_prof_req%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM nurse_tea_req
         WHERE id_prof_req = del_ntr_prof_req_fk.id_prof_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ntr_prof_req_fk(id_prof_req_in => id_prof_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ntr_prof_req_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM NURSE_TEA_REQ';
        ELSE
            RETURN 'DELETE FROM NURSE_TEA_REQ WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(nurse_tea_req_inout IN OUT nurse_tea_req%ROWTYPE) IS
    BEGIN
        nurse_tea_req_inout.id_nurse_tea_req      := NULL;
        nurse_tea_req_inout.id_prof_req           := NULL;
        nurse_tea_req_inout.id_episode            := NULL;
        nurse_tea_req_inout.req_header            := NULL;
        nurse_tea_req_inout.flg_status            := NULL;
        nurse_tea_req_inout.notes_req             := NULL;
        nurse_tea_req_inout.id_prof_close         := NULL;
        nurse_tea_req_inout.notes_close           := NULL;
        nurse_tea_req_inout.id_prof_exec          := NULL;
        nurse_tea_req_inout.id_prev_episode       := NULL;
        nurse_tea_req_inout.dt_nurse_tea_req_tstz := NULL;
        nurse_tea_req_inout.dt_begin_tstz         := NULL;
        nurse_tea_req_inout.dt_close_tstz         := NULL;
        nurse_tea_req_inout.id_visit              := NULL;
        nurse_tea_req_inout.id_patient            := NULL;
        nurse_tea_req_inout.status_flg            := NULL;
        nurse_tea_req_inout.status_icon           := NULL;
        nurse_tea_req_inout.status_msg            := NULL;
        nurse_tea_req_inout.status_str            := NULL;
        nurse_tea_req_inout.create_user           := NULL;
        nurse_tea_req_inout.create_time           := NULL;
        nurse_tea_req_inout.create_institution    := NULL;
        nurse_tea_req_inout.update_user           := NULL;
        nurse_tea_req_inout.update_time           := NULL;
        nurse_tea_req_inout.update_institution    := NULL;
        nurse_tea_req_inout.id_cancel_reason      := NULL;
        nurse_tea_req_inout.id_context            := NULL;
        nurse_tea_req_inout.flg_context           := NULL;
        nurse_tea_req_inout.id_nurse_tea_topic    := NULL;
        nurse_tea_req_inout.id_order_recurr_plan  := NULL;
        nurse_tea_req_inout.description           := NULL;
        nurse_tea_req_inout.flg_time              := NULL;
        nurse_tea_req_inout.desc_topic_aux        := NULL;
        nurse_tea_req_inout.id_not_order_reason   := NULL;
    END initrec;

    FUNCTION initrec RETURN nurse_tea_req%ROWTYPE IS
        l_nurse_tea_req nurse_tea_req%ROWTYPE;
    BEGIN
        RETURN l_nurse_tea_req;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN nurse_tea_req_tc IS
        data nurse_tea_req_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
          FROM nurse_tea_req
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN nurse_tea_req_tc IS
