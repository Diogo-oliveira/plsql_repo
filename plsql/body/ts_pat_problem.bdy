...
*/
 IS
            ...
            ELSE
                ...
                BEGIN
                    ...
                    pk_alert_exceptions.register_error(error_name_in       => l_err_name,
                                                       ...
                                                       name3_in            => 'TABLE_NAME',
                                                       value3_in           => 'PAT_PROBLEM');
                    IF l_name = 'PPM_ADI_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_ALERT_DIAGNOSIS',
                                                        value_in           => id_alert_diagnosis_in);
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_ADIAG_INST_OWNER',
                                                        value_in           => id_adiag_inst_owner_in);
                    END IF;
                    IF l_name = 'PPM_CHAR_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_HABIT_CHARACTERIZATION',
                                                        value_in           => id_habit_characterization_in);
                    END IF;
                    IF l_name = 'PPM_COMP_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                    ...
                    THEN
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_DIAG_INST_OWNER',
                                                        value_in           => id_diag_inst_owner_in);
                    END IF;
                    IF l_name = 'PPM_EDS_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                    ...
                    END IF;
                    IF l_name = 'PPM_PROF_INS_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
                                                        name_in            => 'ID_PROFESSIONAL_INS',
                                                        value_in           => id_professional_ins_in);
                    END IF;
                    IF l_name = 'PPM_PTNOT_FK'
                    THEN
                        -- Add a context value for each column
                        pk_alert_exceptions.add_context(err_instance_id_in => l_id,
    ...
    (
        ...
        l_rec pat_problem%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_pat_problem := next_key(sequence_in);
        END IF;
        ins(id_pat_problem_in            => l_rec.id_pat_problem,
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN pat_problem.id_pat_problem%TYPE
     ...
     IS
        retval pat_problem.id_pat_problem%TYPE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pk_alert_exceptions.raise_error(error_name_in => 'SEQUENCE-GENERATION-FAILURE',
                                            name1_in      => 'SEQUENCE',
                                            value1_in     => nvl(sequence_in, 'seq_PAT_PROBLEM'));
    END next_key;
    ...
    (
        ...
        l_pky pat_problem.id_pat_problem%TYPE := next_key;
    BEGIN
        ins(id_pat_problem_in            => l_pky,
            id_patient_in                => id_patient_in,
            id_diagnosis_in              => id_diagnosis_in,
            id_professional_ins_in       => id_professional_ins_in,
            desc_pat_problem_in          => desc_pat_problem_in,
    ...
    BEGIN
        ins(id_patient_in                => id_patient_in,
            ...
            id_diag_inst_owner_in        => id_diag_inst_owner_in,
            id_habit_characterization_in => id_habit_characterization_in,
            id_pat_problem_out           => id_pat_problem_out,
            handle_error_in              => handle_error_in,
            rows_out                     => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in              IN BOOLEAN := TRUE,
        rows_out                     OUT table_varchar
    ) RETURN pat_problem.id_pat_problem%TYPE IS
        l_pky pat_problem.id_pat_problem%TYPE := next_key;
    BEGIN
        ins(id_pat_problem_in            => l_pky,
            id_patient_in                => id_patient_in,
            ...
            ELSE
                ...
                BEGIN
                    ...
                    LOOP
                        ...
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_ADIAG_INST_OWNER _' || indx,
                                                        value_in           => rows_in(SQL%BULK_EXCEPTIONS(indx).error_index)
                                                                              .id_adiag_inst_owner,
                                                        validate_in        => FALSE);
                    
                        pk_alert_exceptions.add_context(err_instance_id_in => l_err_instance_id,
                                                        name_in            => 'ID_DIAG_INST_OWNER _' || indx,
                                                        value_in           => rows_in(SQL%BULK_EXCEPTIONS(indx).error_index)
                                                                              .id_diag_inst_owner,
                                                        validate_in        => FALSE);
    ...
    (
        ...
        l_id_adiag_inst_owner_n       NUMBER(1);
        l_id_diag_inst_owner_n        NUMBER(1);
    ...
    BEGIN
        ...
        UPDATE pat_problem
         ...
         WHERE id_pat_problem = id_pat_problem_in
    ...
    (
        ...
        l_id_diag_inst_owner_n        NUMBER(1);
        l_id_habit_characterization_n NUMBER(1);
        id_pat_problem_in             pat_problem.id_pat_problem%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE PAT_PROBLEM SET ' || ' ID_PATIENT = decode (' || l_id_patient_n ||
                 ',0,:id_patient_in, NVL (:id_patient_in, ID_PATIENT)) ' || ',' || ' ID_DIAGNOSIS = decode (' ||
                 l_id_diagnosis_n || ',0,:id_diagnosis_in, NVL (:id_diagnosis_in, ID_DIAGNOSIS)) ' || ',' ||
                 ' ID_PROFESSIONAL_INS = decode (' || l_id_professional_ins_n ||
                 ...
                 ' ID_PAT_HABIT = decode (' || l_id_pat_habit_n ||
                 ',0,:id_pat_habit_in, NVL (:id_pat_habit_in, ID_PAT_HABIT)) ' || ',' || ' ID_HABIT = decode (' ||
                 l_id_habit_n || ',0,:id_habit_in, NVL (:id_habit_in, ID_HABIT)) ' || ',' || ' ID_EPISODE = decode (' ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_patient_in, id_diagnosis_in, id_professional_ins_in, desc_pat_problem_in, notes_in, flg_age_in, year_begin_in, month_begin_in, day_begin_in, year_end_in, month_end_in, day_end_in, pct_incapacity_in, flg_surgery_in, notes_support_in, rank_in, flg_status_in, id_epis_diagnosis_in, flg_aproved_in, id_institution_in, id_pat_habit_in, id_habit_in, id_episode_in, id_epis_anamnesis_in, flg_nature_in, id_alert_diagnosis_in, dt_pat_problem_tstz_in, dt_confirm_tstz_in, id_cancel_reason_in, cancel_notes_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, dt_resolution_in, id_adiag_inst_owner_in, id_diag_inst_owner_in, id_habit_characterization_in, OUT l_rows_out;
    ...
    BEGIN
        upd(id_pat_problem_in            => rec_in.id_pat_problem,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE pat_problem
                 ...
                 WHERE id_pat_problem = l_id_pat_problem(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE pat_problem
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE PAT_PROBLEM
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE PAT_PROBLEM set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE PAT_PROBLEM set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        ...
        del(id_pat_problem_in => id_pat_problem_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_id_pat_problem(id_pat_problem_in => id_pat_problem_in,
                           handle_error_in   => handle_error_in,
                           rows_out          => rows_out);
    END del_id_pat_problem;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_alert_diagnosis = del_ppm_adi_fk.id_alert_diagnosis_in
           AND id_adiag_inst_owner = del_ppm_adi_fk.id_adiag_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_adi_fk(id_alert_diagnosis_in  => id_alert_diagnosis_in,
                       id_adiag_inst_owner_in => id_adiag_inst_owner_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ppm_adi_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_habit_characterization = del_ppm_char_fk.id_habit_characterization_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_char_fk(id_habit_characterization_in => id_habit_characterization_in,
                        handle_error_in              => handle_error_in,
                        rows_out                     => rows_out);
    END del_ppm_char_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_epis_anamnesis = del_ppm_comp_fk.id_epis_anamnesis_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_comp_fk(id_epis_anamnesis_in => id_epis_anamnesis_in,
                        handle_error_in      => handle_error_in,
                        rows_out             => rows_out);
    END del_ppm_comp_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_cancel_reason = del_ppm_cr_fk.id_cancel_reason_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_cr_fk(id_cancel_reason_in => id_cancel_reason_in,
                      handle_error_in     => handle_error_in,
                      rows_out            => rows_out);
    END del_ppm_cr_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_diagnosis = del_ppm_diag_fk.id_diagnosis_in
           AND id_diag_inst_owner = del_ppm_diag_fk.id_diag_inst_owner_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_diag_fk(id_diagnosis_in       => id_diagnosis_in,
                        id_diag_inst_owner_in => id_diag_inst_owner_in,
                        handle_error_in       => handle_error_in,
                        rows_out              => rows_out);
    END del_ppm_diag_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_epis_diagnosis = del_ppm_eds_fk.id_epis_diagnosis_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_eds_fk(id_epis_diagnosis_in => id_epis_diagnosis_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_ppm_eds_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_episode = del_ppm_epis_fk.id_episode_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ppm_epis_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_habit = del_ppm_hat_fk.id_habit_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_hat_fk(id_habit_in => id_habit_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ppm_hat_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_institution = del_ppm_inst_fk.id_institution_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_inst_fk(id_institution_in => id_institution_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_ppm_inst_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_patient = del_ppm_pat_fk.id_patient_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ppm_pat_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_professional_ins = del_ppm_prof_ins_fk.id_professional_ins_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_prof_ins_fk(id_professional_ins_in => id_professional_ins_in,
                            handle_error_in        => handle_error_in,
                            rows_out               => rows_out);
    END del_ppm_prof_ins_fk;
    ...
    BEGIN
        DELETE FROM pat_problem
         WHERE id_pat_habit = del_ppm_ptnot_fk.id_pat_habit_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ppm_ptnot_fk(id_pat_habit_in => id_pat_habit_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ppm_ptnot_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM PAT_PROBLEM';
        ELSE
            RETURN 'DELETE FROM PAT_PROBLEM WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(pat_problem_inout IN OUT pat_problem%ROWTYPE) IS
    BEGIN
        pat_problem_inout.id_pat_problem            := NULL;
        pat_problem_inout.id_patient                := NULL;
        pat_problem_inout.id_diagnosis              := NULL;
        pat_problem_inout.id_professional_ins       := NULL;
        pat_problem_inout.desc_pat_problem          := NULL;
        pat_problem_inout.notes                     := NULL;
        pat_problem_inout.flg_age                   := NULL;
        pat_problem_inout.year_begin                := NULL;
        pat_problem_inout.month_begin               := NULL;
        pat_problem_inout.day_begin                 := NULL;
        pat_problem_inout.year_end                  := NULL;
        pat_problem_inout.month_end                 := NULL;
        pat_problem_inout.day_end                   := NULL;
        pat_problem_inout.pct_incapacity            := NULL;
        pat_problem_inout.flg_surgery               := NULL;
        pat_problem_inout.notes_support             := NULL;
        pat_problem_inout.rank                      := NULL;
        pat_problem_inout.flg_status                := NULL;
        pat_problem_inout.id_epis_diagnosis         := NULL;
        pat_problem_inout.flg_aproved               := NULL;
        pat_problem_inout.id_institution            := NULL;
        pat_problem_inout.id_pat_habit              := NULL;
        pat_problem_inout.id_habit                  := NULL;
        pat_problem_inout.id_episode                := NULL;
        pat_problem_inout.id_epis_anamnesis         := NULL;
        pat_problem_inout.flg_nature                := NULL;
        pat_problem_inout.id_alert_diagnosis        := NULL;
        pat_problem_inout.dt_pat_problem_tstz       := NULL;
        pat_problem_inout.dt_confirm_tstz           := NULL;
        pat_problem_inout.id_cancel_reason          := NULL;
        pat_problem_inout.cancel_notes              := NULL;
        pat_problem_inout.create_user               := NULL;
        pat_problem_inout.create_time               := NULL;
        pat_problem_inout.create_institution        := NULL;
        pat_problem_inout.update_user               := NULL;
        pat_problem_inout.update_time               := NULL;
        pat_problem_inout.update_institution        := NULL;
        pat_problem_inout.dt_resolution             := NULL;
        pat_problem_inout.id_adiag_inst_owner       := NULL;
        pat_problem_inout.id_diag_inst_owner        := NULL;
        pat_problem_inout.id_habit_characterization := NULL;
    END initrec;

    FUNCTION initrec RETURN pat_problem%ROWTYPE IS
        l_pat_problem pat_problem%ROWTYPE;
    BEGIN
        RETURN l_pat_problem;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN pat_problem_tc IS
        data pat_problem_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN pat_problem_tc IS
