/*-- Last Change Revision: $Rev: 2028269 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:46 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY TS_NURSE_TEA_DET_COMPO
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Maio 4, 2011 19:19:5
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO NURSE_TEA_DET_COMPO (
         ID_NURSE_TEA_DET_COMPO,
         ID_NURSE_TEA_DET,
         ID_COMPOSITION,
         CREATE_USER,
         CREATE_TIME,
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'NURSE_TEA_DET_COMPO');
           IF l_name = 'NTC_ICN_FK'
           THEN
   ...
   BEGIN
     ...
     ins (
      id_nurse_tea_det_compo_in => id_nurse_tea_det_compo_in
      ,
   ...
   IS
      l_rec NURSE_TEA_DET_COMPO%ROWTYPE := rec_in;
   BEGIN
      IF gen_pky_in THEN
         l_rec.ID_NURSE_TEA_DET_COMPO := next_key (sequence_in);
      END IF;
      ins (
         id_nurse_tea_det_compo_in => l_rec.ID_NURSE_TEA_DET_COMPO
         ,
  ...
  ins (
   ...
   IS
     retval NURSE_TEA_DET_COMPO.ID_NURSE_TEA_DET_COMPO%TYPE;

   BEGIN
      IF sequence_in IS NULL
      THEN
         SELECT seq_NURSE_TEA_DET_COMPO.NEXTVAL INTO retval FROM dual;
      ELSE
         EXECUTE IMMEDIATE
   ...
   EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
           ...
           ,name1_in => 'SEQUENCE'
           ,value1_in => NVL (sequence_in, 'seq_NURSE_TEA_DET_COMPO')
           );
   END next_key;
   ...
   IS
        l_pky NURSE_TEA_DET_COMPO.ID_NURSE_TEA_DET_COMPO%TYPE := next_key;
   BEGIN
      ins (
         id_nurse_tea_det_compo_in => l_pky,
         id_nurse_tea_det_in => id_nurse_tea_det_in,
         id_composition_in => id_composition_in,
         create_user_in => create_user_in,
         create_time_in => create_time_in,
      ...
      id_nurse_tea_det_compo_out := l_pky;
   END ins;
   ...
   BEGIN
      ...
      update_time_in => update_time_in,
      update_institution_in => update_institution_in,
      id_nurse_tea_det_compo_out => id_nurse_tea_det_compo_out
      ,handle_error_in => handle_error_in
      , rows_out => rows_out
   );
   END ins;
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO NURSE_TEA_DET_COMPO VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
       ...
       ELSE
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                   err_instance_id_in => l_err_instance_id
                  ,NAME_IN => 'ID_NURSE_TEA_DET_COMPO _' || indx
                  ,value_in => rows_in(indx).ID_NURSE_TEA_DET_COMPO
                  ,validate_in => FALSE
                );
...
PROCEDURE upd (
   ...
   l_UPDATE_INSTITUTION_n := sys.diutil.bool_to_int(UPDATE_INSTITUTION_nin);
         ...
         UPDATE NURSE_TEA_DET_COMPO SET
     ...
     UPDATE_INSTITUTION = decode (l_UPDATE_INSTITUTION_n,0,update_institution_in, NVL (update_institution_in, UPDATE_INSTITUTION))
          WHERE
             ID_NURSE_TEA_DET_COMPO = id_nurse_tea_det_compo_in
...
PROCEDURE upd (
   ...
   l_UPDATE_TIME_n NUMBER(1);
   l_UPDATE_INSTITUTION_n NUMBER(1);
      id_nurse_tea_det_compo_in NURSE_TEA_DET_COMPO.ID_NURSE_TEA_DET_COMPO%TYPE;
   BEGIN
...
l_sql := 'UPDATE NURSE_TEA_DET_COMPO SET '
     || ' ID_NURSE_TEA_DET = decode (' || l_ID_NURSE_TEA_DET_n || ',0,:id_nurse_tea_det_in, NVL (:id_nurse_tea_det_in, ID_NURSE_TEA_DET)) '|| ','
     || ' ID_COMPOSITION = decode (' || l_ID_COMPOSITION_n || ',0,:id_composition_in, NVL (:id_composition_in, ID_COMPOSITION)) '|| ','
     || ' CREATE_USER = decode (' || l_CREATE_USER_n || ',0,:create_user_in, NVL (:create_user_in, CREATE_USER)) '|| ','
     || ' CREATE_TIME = decode (' || l_CREATE_TIME_n || ',0,:create_time_in, NVL (:create_time_in, CREATE_TIME)) '|| ','
...
PROCEDURE upd (
   ...
   BEGIN
      upd (
         id_nurse_tea_det_compo_in => rec_in.ID_NURSE_TEA_DET_COMPO,
   ...
   IS
      l_ID_NURSE_TEA_DET_COMPO ID_NURSE_TEA_DET_COMPO_cc;
   ...
   BEGIN
      FOR i IN col_in.FIRST .. col_in.LAST loop
         l_ID_NURSE_TEA_DET_COMPO(i) := col_in(i).ID_NURSE_TEA_DET_COMPO;
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE NURSE_TEA_DET_COMPO SET
             ...
             WHERE
                ID_NURSE_TEA_DET_COMPO = l_ID_NURSE_TEA_DET_COMPO(i)
          returning rowid bulk collect into rows_out;
      ELSE
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE NURSE_TEA_DET_COMPO SET
   ...
   BEGIN
      RETURN
         'BEGIN UPDATE NURSE_TEA_DET_COMPO
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE NURSE_TEA_DET_COMPO set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE NURSE_TEA_DET_COMPO set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
   ...
   IS
   BEGIN
      DELETE FROM NURSE_TEA_DET_COMPO
       WHERE
          ID_NURSE_TEA_DET_COMPO = id_nurse_tea_det_compo_in
       RETURNING ROWID BULK COLLECT INTO rows_out
         ;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM NURSE_TEA_DET_COMPO
       WHERE ID_NURSE_TEA_DET_COMPO = id_nurse_tea_det_compo_in
      RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
      ...
      THEN
        ...
        END;
        END IF;
   END del_ID_NURSE_TEA_DET_COMPO;
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM NURSE_TEA_DET_COMPO
       WHERE
          ID_COMPOSITION = del_NTC_ICN_FK.id_composition_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_NTC_ICN_FK (
   ...
   BEGIN
      DELETE FROM NURSE_TEA_DET_COMPO
       WHERE
          ID_NURSE_TEA_DET = del_NTC_NTD_FK.id_nurse_tea_det_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_NTC_NTD_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM NURSE_TEA_DET_COMPO';
      ELSE
         RETURN
            'DELETE FROM NURSE_TEA_DET_COMPO WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      nurse_tea_det_compo_inout.ID_NURSE_TEA_DET_COMPO := NULL;
      nurse_tea_det_compo_inout.ID_NURSE_TEA_DET := NULL;
      nurse_tea_det_compo_inout.ID_COMPOSITION := NULL;
      nurse_tea_det_compo_inout.CREATE_USER := NULL;
      nurse_tea_det_compo_inout.CREATE_TIME := NULL;
      nurse_tea_det_compo_inout.CREATE_INSTITUTION := NULL;
      nurse_tea_det_compo_inout.UPDATE_USER := NULL;
      nurse_tea_det_compo_inout.UPDATE_TIME := NULL;
      nurse_tea_det_compo_inout.UPDATE_INSTITUTION := NULL;
   END initrec;

   FUNCTION initrec RETURN NURSE_TEA_DET_COMPO%ROWTYPE
   IS
      l_nurse_tea_det_compo NURSE_TEA_DET_COMPO%ROWTYPE;
   BEGIN
      RETURN l_nurse_tea_det_compo;
   END initrec;
   ...
   IS
        data NURSE_TEA_DET_COMPO_tc;
   BEGIN
        select * bulk collect into data from NURSE_TEA_DET_COMPO where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
