...
CREATE OR REPLACE PACKAGE BODY ts_epis_prob_group
/*
| Generated by or retrieved - DO NOT MODIFY!
| Created On: 2017-12-21 09:52:02
| Created By: ALERT
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_prob_group.id_epis_prob_group%TYPE IS
        retval epis_prob_group.id_epis_prob_group%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_epis_prob_group.nextval;
        ELSE
    ...
    PROCEDURE ins
    (
        id_episode_in              IN epis_prob_group.id_episode%TYPE DEFAULT NULL,
        prob_group_in              IN epis_prob_group.prob_group%TYPE DEFAULT NULL,
        create_user_in             IN epis_prob_group.create_user%TYPE DEFAULT NULL,
        create_time_in             IN epis_prob_group.create_time%TYPE DEFAULT NULL,
        create_institution_in      IN epis_prob_group.create_institution%TYPE DEFAULT NULL,
        update_user_in             IN epis_prob_group.update_user%TYPE DEFAULT NULL,
        update_time_in             IN epis_prob_group.update_time%TYPE DEFAULT NULL,
        update_institution_in      IN epis_prob_group.update_institution%TYPE DEFAULT NULL,
        id_professional_in         IN epis_prob_group.id_professional%TYPE DEFAULT NULL,
        dt_epis_prob_group_tstz_in IN epis_prob_group.dt_epis_prob_group_tstz%TYPE DEFAULT NULL,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_pky epis_prob_group.id_epis_prob_group%TYPE := next_key;
    BEGIN
        ins(id_epis_prob_group_in      => l_pky,
    ...
    (
        ...
        id_professional_in         IN epis_prob_group.id_professional%TYPE DEFAULT NULL,
        dt_epis_prob_group_tstz_in IN epis_prob_group.dt_epis_prob_group_tstz%TYPE DEFAULT NULL,
        id_epis_prob_group_out     IN OUT epis_prob_group.id_epis_prob_group%TYPE,
        -- Pass false if you want errors to propagate out unhandled
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    ...
    BEGIN
        ins(id_episode_in              => id_episode_in,
            ...
            id_professional_in         => id_professional_in,
            dt_epis_prob_group_tstz_in => dt_epis_prob_group_tstz_in,
            id_epis_prob_group_out     => id_epis_prob_group_out,
            handle_error_in            => handle_error_in,
            rows_out                   => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN epis_prob_group.id_epis_prob_group%TYPE IS
        l_pky epis_prob_group.id_epis_prob_group%TYPE := next_key;
    BEGIN
        ins(id_epis_prob_group_in      => l_pky,
            id_episode_in              => id_episode_in,
    ...
    PROCEDURE ins
    (
        id_epis_prob_group_in      IN epis_prob_group.id_epis_prob_group%TYPE,
        id_episode_in              IN epis_prob_group.id_episode%TYPE DEFAULT NULL,
        prob_group_in              IN epis_prob_group.prob_group%TYPE DEFAULT NULL,
        create_user_in             IN epis_prob_group.create_user%TYPE DEFAULT NULL,
        create_time_in             IN epis_prob_group.create_time%TYPE DEFAULT NULL,
    ...
    PROCEDURE ins
    (
        rec_in          IN epis_prob_group%ROWTYPE,
        gen_pky_in      IN BOOLEAN DEFAULT FALSE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec epis_prob_group%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_prob_group := next_key(sequence_in);
        END IF;
    
        ins(id_epis_prob_group_in      => l_rec.id_epis_prob_group,
    ...
    BEGIN
        ...
        l_sql                       := 'UPDATE epis_prob_group SET' || ' ID_EPISODE = decode (' || l_id_episode_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_episode_in, prob_group_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_professional_in, dt_epis_prob_group_tstz_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        upd(id_epis_prob_group_in      => rec_in.id_epis_prob_group,
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prob_group
                 ...
                 WHERE id_epis_prob_group = l_id_epis_prob_group(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_prob_group
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_prob_group
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_prob_group
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_prob_group
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_prob_group_in => id_epis_prob_group_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del;

    -- Delete for unique value of EPBG_EPIS_GRP_UNI
    PROCEDURE del_epbg_epis_grp_uni
    (
        id_episode_in   IN epis_prob_group.id_episode%TYPE,
        prob_group_in   IN epis_prob_group.prob_group%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epbg_epis_grp_uni(id_episode_in   => id_episode_in,
                              prob_group_in   => prob_group_in,
                              handle_error_in => handle_error_in,
                              rows_out        => rows_out);
    END del_epbg_epis_grp_uni;

    -- Delete all rows for this EPBG_EPIS_FK foreign key value
    PROCEDURE del_epbg_epis_fk
    (
        id_episode_in   IN epis_prob_group.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ...
    END del_epbg_epis_fk;

    -- Delete all rows for this EPBG_PROF_FK foreign key value
    PROCEDURE del_epbg_prof_fk
    (
        id_professional_in IN epis_prob_group.id_professional%TYPE,
        handle_error_in    IN BOOLEAN := TRUE,
        rows_out           OUT table_varchar
    ) IS
    BEGIN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epbg_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_epbg_epis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_epbg_prof_fk(id_professional_in => id_professional_in,
                         handle_error_in    => handle_error_in,
                         rows_out           => rows_out);
    END del_epbg_prof_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_prob_group';
        ELSE
            RETURN 'DELETE FROM epis_prob_group WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_prob_group_inout IN OUT epis_prob_group%ROWTYPE) IS
    BEGIN
        epis_prob_group_inout.id_epis_prob_group      := NULL;
        epis_prob_group_inout.id_episode              := NULL;
        epis_prob_group_inout.prob_group              := NULL;
        epis_prob_group_inout.create_user             := NULL;
        epis_prob_group_inout.create_time             := NULL;
        epis_prob_group_inout.create_institution      := NULL;
        epis_prob_group_inout.update_user             := NULL;
        epis_prob_group_inout.update_time             := NULL;
        epis_prob_group_inout.update_institution      := NULL;
        epis_prob_group_inout.id_professional         := NULL;
        epis_prob_group_inout.dt_epis_prob_group_tstz := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_prob_group%ROWTYPE IS
        l_epis_prob_group epis_prob_group%ROWTYPE;
    BEGIN
        RETURN l_epis_prob_group;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_prob_group_tc IS
        data epis_prob_group_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM epis_prob_group
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_prob_group_tc IS
        data epis_prob_group_tc;
