/*-- Last Change Revision: $Rev: 2027924 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:43:42 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_analysis_req_det
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN analysis_req_det.id_analysis_req_det%TYPE IS
        retval analysis_req_det.id_analysis_req_det%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_analysis_req_det.nextval;
        ELSE
    ...
    (
        ...
        l_pky analysis_req_det.id_analysis_req_det%TYPE := next_key;
    BEGIN
        ins(id_analysis_req_det_in      => l_pky,
    ...
    BEGIN
        ins(id_analysis_in              => id_analysis_in,
            ...
            id_clinical_purpose_in      => id_clinical_purpose_in,
            diagnosis_notes_in          => diagnosis_notes_in,
            id_analysis_req_det_out     => id_analysis_req_det_out,
            handle_error_in             => handle_error_in,
            rows_out                    => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN analysis_req_det.id_analysis_req_det%TYPE IS
        l_pky analysis_req_det.id_analysis_req_det%TYPE := next_key;
    BEGIN
        ins(id_analysis_req_det_in      => l_pky,
            id_analysis_in              => id_analysis_in,
    ...
    (
        ...
        l_rec analysis_req_det%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_analysis_req_det := next_key(sequence_in);
        END IF;
    ...
    BEGIN
        ...
        l_sql                        := 'UPDATE analysis_req_det SET' || ' ID_ANALYSIS = decode (' || l_id_analysis_n ||
                                        ',0,:ID_ANALYSIS_in, NVL (:ID_ANALYSIS_in, ID_ANALYSIS)) ' || ',' ||
                                        ' ID_ANALYSIS_REQ = decode (' || l_id_analysis_req_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_analysis_in, id_analysis_req_in, id_ard_parent_in, flg_status_in, notes_in, id_movement_in, flg_pre_req_in, id_prof_cancel_in, notes_cancel_in, id_room_in, notes_tech_in, barcode_in, dt_target_tstz_in, dt_final_target_tstz_in, dt_final_result_tstz_in, dt_cancel_tstz_in, notes_justify_in, flg_time_harvest_in, dt_begin_harvest_in, flg_exec_result_in, dt_begin_result_in, flg_urgency_in, flg_fasting_in, flg_col_inst_in, id_exam_cat_in, id_episode_origin_in, id_episode_destination_in, dt_pend_req_tstz_in, id_room_req_in, id_analysis_group_in, flg_referral_in, id_prof_last_update_in, dt_last_update_tstz_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, id_cancel_reason_in, id_analysis_codification_in, id_exec_institution_in, id_task_dependency_in, flg_req_origin_module_in, flg_clinical_purpose_in, notes_patient_in, dt_schedule_in, id_order_recurrence_in, flg_prn_in, notes_prn_in, id_pat_health_plan_in, id_cdr_in, id_sample_type_in, clinical_purpose_notes_in, id_pat_exemption_in, id_co_sign_order_in, id_co_sign_cancel_in, notes_scheduler_in, id_clinical_purpose_in, diagnosis_notes_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    BEGIN
        RETURN 'BEGIN UPDATE analysis_req_det
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE analysis_req_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE analysis_req_det
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_analysis_group = id_analysis_group_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_analysis = id_analysis_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_ard_parent = id_ard_parent_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_analysis = id_analysis_in
           AND id_sample_type = id_sample_type_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_episode_destination = id_episode_destination_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    END del_ard_id_order_recurrence_fk;
    ...
    BEGIN
        DELETE FROM analysis_req_det
         WHERE id_room_req = id_room_req_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_agp_fk(id_analysis_group_in => id_analysis_group_in,
                       handle_error_in      => handle_error_in,
                       rows_out             => rows_out);
    END del_ard_agp_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_analy_fk(id_analysis_in => id_analysis_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_analy_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_ard_fk(id_ard_parent_in => id_ard_parent_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_ard_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_art_fk(id_analysis_req_in => id_analysis_req_in,
                       handle_error_in    => handle_error_in,
                       rows_out           => rows_out);
    END del_ard_art_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_ase_fk(id_analysis_in    => id_analysis_in,
                       id_sample_type_in => id_sample_type_in,
                       handle_error_in   => handle_error_in,
                       rows_out          => rows_out);
    END del_ard_ase_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_cre_fk(id_cancel_reason_in => id_cancel_reason_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ard_cre_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_epis_dest_fk(id_episode_destination_in => id_episode_destination_in,
                             handle_error_in           => handle_error_in,
                             rows_out                  => rows_out);
    END del_ard_epis_dest_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_epis_origin_fk(id_episode_origin_in => id_episode_origin_in,
                               handle_error_in      => handle_error_in,
                               rows_out             => rows_out);
    END del_ard_epis_origin_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_exam_cat_fk(id_exam_cat_in => id_exam_cat_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_exam_cat_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_id_cdr_fk(id_cdr_in => id_cdr_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_id_cdr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_id_order_recurrence_fk(id_order_recurrence_in => id_order_recurrence_in,
                                       handle_error_in        => handle_error_in,
                                       rows_out               => rows_out);
    END del_ard_id_order_recurrence_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_inn_fk(id_exec_institution_in => id_exec_institution_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ard_inn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_mop_fk(id_clinical_purpose_in => id_clinical_purpose_in,
                       handle_error_in        => handle_error_in,
                       rows_out               => rows_out);
    END del_ard_mop_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_mov_fk(id_movement_in => id_movement_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_mov_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_phn_fk(id_pat_health_plan_in => id_pat_health_plan_in,
                       handle_error_in       => handle_error_in,
                       rows_out              => rows_out);
    END del_ard_phn_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_pio_fk(id_pat_exemption_in => id_pat_exemption_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_ard_pio_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_prof_fk(id_prof_cancel_in => id_prof_cancel_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_ard_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_room_fk(id_room_in => id_room_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_room_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_room_req_fk(id_room_req_in => id_room_req_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_ard_room_req_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_ard_tdetd_fk(id_task_dependency_in => id_task_dependency_in,
                         handle_error_in       => handle_error_in,
                         rows_out              => rows_out);
    END del_ard_tdetd_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM analysis_req_det';
        ELSE
            RETURN 'DELETE FROM analysis_req_det WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(analysis_req_det_inout IN OUT analysis_req_det%ROWTYPE) IS
    BEGIN
        analysis_req_det_inout.id_analysis_req_det      := NULL;
        analysis_req_det_inout.id_analysis              := NULL;
        analysis_req_det_inout.id_analysis_req          := NULL;
        analysis_req_det_inout.id_ard_parent            := NULL;
        analysis_req_det_inout.flg_status               := NULL;
        analysis_req_det_inout.notes                    := NULL;
        analysis_req_det_inout.id_movement              := NULL;
        analysis_req_det_inout.flg_pre_req              := NULL;
        analysis_req_det_inout.id_prof_cancel           := NULL;
        analysis_req_det_inout.notes_cancel             := NULL;
        analysis_req_det_inout.id_room                  := NULL;
        analysis_req_det_inout.notes_tech               := NULL;
        analysis_req_det_inout.barcode                  := NULL;
        analysis_req_det_inout.dt_target_tstz           := NULL;
        analysis_req_det_inout.dt_final_target_tstz     := NULL;
        analysis_req_det_inout.dt_final_result_tstz     := NULL;
        analysis_req_det_inout.dt_cancel_tstz           := NULL;
        analysis_req_det_inout.notes_justify            := NULL;
        analysis_req_det_inout.flg_time_harvest         := NULL;
        analysis_req_det_inout.dt_begin_harvest         := NULL;
        analysis_req_det_inout.flg_exec_result          := NULL;
        analysis_req_det_inout.dt_begin_result          := NULL;
        analysis_req_det_inout.flg_urgency              := NULL;
        analysis_req_det_inout.flg_fasting              := NULL;
        analysis_req_det_inout.flg_col_inst             := NULL;
        analysis_req_det_inout.id_exam_cat              := NULL;
        analysis_req_det_inout.id_episode_origin        := NULL;
        analysis_req_det_inout.id_episode_destination   := NULL;
        analysis_req_det_inout.dt_pend_req_tstz         := NULL;
        analysis_req_det_inout.id_room_req              := NULL;
        analysis_req_det_inout.id_analysis_group        := NULL;
        analysis_req_det_inout.flg_referral             := NULL;
        analysis_req_det_inout.id_prof_last_update      := NULL;
        analysis_req_det_inout.dt_last_update_tstz      := NULL;
        analysis_req_det_inout.create_user              := NULL;
        analysis_req_det_inout.create_time              := NULL;
        analysis_req_det_inout.create_institution       := NULL;
        analysis_req_det_inout.update_user              := NULL;
        analysis_req_det_inout.update_time              := NULL;
        analysis_req_det_inout.update_institution       := NULL;
        analysis_req_det_inout.id_cancel_reason         := NULL;
        analysis_req_det_inout.id_analysis_codification := NULL;
        analysis_req_det_inout.id_exec_institution      := NULL;
        analysis_req_det_inout.id_task_dependency       := NULL;
        analysis_req_det_inout.flg_req_origin_module    := NULL;
        analysis_req_det_inout.flg_clinical_purpose     := NULL;
        analysis_req_det_inout.notes_patient            := NULL;
        analysis_req_det_inout.dt_schedule              := NULL;
        analysis_req_det_inout.id_order_recurrence      := NULL;
        analysis_req_det_inout.flg_prn                  := NULL;
        analysis_req_det_inout.notes_prn                := NULL;
        analysis_req_det_inout.id_pat_health_plan       := NULL;
        analysis_req_det_inout.id_cdr                   := NULL;
        analysis_req_det_inout.id_sample_type           := NULL;
        analysis_req_det_inout.clinical_purpose_notes   := NULL;
        analysis_req_det_inout.id_pat_exemption         := NULL;
        analysis_req_det_inout.id_co_sign_order         := NULL;
        analysis_req_det_inout.id_co_sign_cancel        := NULL;
        analysis_req_det_inout.notes_scheduler          := NULL;
        analysis_req_det_inout.id_clinical_purpose      := NULL;
        analysis_req_det_inout.diagnosis_notes          := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN analysis_req_det%ROWTYPE IS
    ...
    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN analysis_req_det_tc IS
        data analysis_req_det_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN analysis_req_det_tc IS
        data analysis_req_det_tc;
