/*-- Last Change Revision: $Rev: 2028057 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:04 +0100 (ter, 02 ago 2022) $*/
CREATE OR REPLACE PACKAGE BODY TS_EPIS_DIAG_TUMORS_HIST
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: Março 14, 2012 14:9:24
| Created By: ALERT
*/
IS
   ...
   BEGIN
     ...
     INSERT INTO EPIS_DIAG_TUMORS_HIST (
        ...
        BEGIN
           ...
           ELSE
              pk_alert_exceptions.raise_error (
                    ...
                    ,value2_in => l_name
                    ,name3_in => 'TABLE_NAME'
                    ,value3_in => 'EPIS_DIAG_TUMORS_HIST');
           END IF;
        END;
        END IF;
      ...
      THEN
        ...
        BEGIN
           ...
           pk_alert_exceptions.register_error (
             ...
             ,name3_in => 'TABLE_NAME', value3_in => 'EPIS_DIAG_TUMORS_HIST');
           IF l_name = 'EDTMRSH_CNCPTTR1_FK'
           THEN
   ...
   IS
      l_rec EPIS_DIAG_TUMORS_HIST%ROWTYPE := rec_in;
   BEGIN
      ins (
   ...
   BEGIN
      ...
      ELSE
         FORALL indx IN rows_in.FIRST .. rows_in.LAST
            SAVE EXCEPTIONS
            INSERT INTO EPIS_DIAG_TUMORS_HIST VALUES rows_in (indx) RETURNING ROWID BULK COLLECT INTO rows_out;
      END IF;
   EXCEPTION
     WHEN e_forall_error
     THEN
          ...
          BEGIN
             ...
             LOOP
                ...
                pk_alert_exceptions.add_context (
                  ...
                  ,value_in => rows_in(SQL%BULK_EXCEPTIONS (indx).ERROR_INDEX).ID_EPIS_DIAGNOSIS_HIST
                  ,validate_in => FALSE
                );
     ...
     THEN
       ...
       pk_alert_exceptions.raise_error(
          error_name_in => 'FORALL-INSERT-FAILURE'
          ,name1_in => 'TABLE_NAME'
          ,value1_in => 'EPIS_DIAG_TUMORS_HIST'
          ,name2_in => 'ROW_COUNT'
...
PROCEDURE upd (
   ...
   l_UPDATE_INSTITUTION_n := sys.diutil.bool_to_int(UPDATE_INSTITUTION_nin);
         ...
         UPDATE EPIS_DIAG_TUMORS_HIST SET
     ...
     UPDATE_INSTITUTION = decode (l_UPDATE_INSTITUTION_n,0,update_institution_in, NVL (update_institution_in, UPDATE_INSTITUTION))
          WHERE
             ID_EPIS_DIAGNOSIS_HIST = id_epis_diagnosis_hist_in AND
...
PROCEDURE upd (
   ...
   l_UPDATE_TIME_n NUMBER(1);
   l_UPDATE_INSTITUTION_n NUMBER(1);
      id_epis_diagnosis_hist_in EPIS_DIAG_TUMORS_HIST.ID_EPIS_DIAGNOSIS_HIST%TYPE;
      id_epis_diagnosis_in EPIS_DIAG_TUMORS_HIST.ID_EPIS_DIAGNOSIS%TYPE;
      tumor_num_in EPIS_DIAG_TUMORS_HIST.TUMOR_NUM%TYPE;
   BEGIN
...
l_sql := 'UPDATE EPIS_DIAG_TUMORS_HIST SET '
     || ' ID_TOPOGRAPHY = decode (' || l_ID_TOPOGRAPHY_n || ',0,:id_topography_in, NVL (:id_topography_in, ID_TOPOGRAPHY)) '|| ','
     || ' ID_TOPOG_INST_OWNER = decode (' || l_ID_TOPOG_INST_OWNER_n || ',0,:id_topog_inst_owner_in, NVL (:id_topog_inst_owner_in, ID_TOPOG_INST_OWNER)) '|| ','
     || ' ID_LATERALITY = decode (' || l_ID_LATERALITY_n || ',0,:id_laterality_in, NVL (:id_laterality_in, ID_LATERALITY)) '|| ','
     || ' ID_LAT_INST_OWNER = decode (' || l_ID_LAT_INST_OWNER_n || ',0,:id_lat_inst_owner_in, NVL (:id_lat_inst_owner_in, ID_LAT_INST_OWNER)) '|| ','
...
PROCEDURE upd (
      ...
      THEN
         ...
         FORALL i IN col_in.FIRST .. col_in.LAST
            UPDATE EPIS_DIAG_TUMORS_HIST SET
             ...
             WHERE
                ID_EPIS_DIAGNOSIS_HIST = l_ID_EPIS_DIAGNOSIS_HIST(i) AND
   ...
   BEGIN
      RETURN
         'BEGIN UPDATE EPIS_DIAG_TUMORS_HIST
  ...
  PROCEDURE increment_onecol (
   ...
   IS
   BEGIN
      EXECUTE IMMEDIATE 'BEGIN UPDATE EPIS_DIAG_TUMORS_HIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;'
      USING OUT rows_out;
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
   ...
   rows_out table_varchar;
   BEGIN
      EXECUTE IMMEDIATE 'UPDATE EPIS_DIAG_TUMORS_HIST set ' || colname_in || '=' || colname_in || ' + ' || nvl(increment_value_in,1) || ' WHERE ' || NVL (where_in, '1=1');
   EXCEPTION
      WHEN DUP_VAL_ON_INDEX
      THEN
        IF NOT handle_error_in THEN RAISE;
   ...
   IS
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_EPIS_DIAGNOSIS_HIST = id_epis_diagnosis_hist_in AND
          ID_EPIS_DIAGNOSIS = id_epis_diagnosis_in AND
          TUMOR_NUM = tumor_num_in
...
, rows_out => rows_out
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_TOPOGRAPHY = del_EDTMRSH_CNCPTTR1_FK.id_topography_in AND
          ID_TOPOG_INST_OWNER = del_EDTMRSH_CNCPTTR1_FK.id_topog_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR1_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_LATERALITY = del_EDTMRSH_CNCPTTR2_FK.id_laterality_in AND
          ID_LAT_INST_OWNER = del_EDTMRSH_CNCPTTR2_FK.id_lat_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR2_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_MORPHOLOGY = del_EDTMRSH_CNCPTTR3_FK.id_morphology_in AND
          ID_MORPH_INST_OWNER = del_EDTMRSH_CNCPTTR3_FK.id_morph_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR3_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_BEHAVIOR = del_EDTMRSH_CNCPTTR4_FK.id_behavior_in AND
          ID_BEHAV_INST_OWNER = del_EDTMRSH_CNCPTTR4_FK.id_behav_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR4_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_HISTOLOGICAL_GRADE = del_EDTMRSH_CNCPTTR5_FK.id_histological_grade_in AND
          ID_HGRADE_INST_OWNER = del_EDTMRSH_CNCPTTR5_FK.id_hgrade_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR5_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_OTHER_GRADING_SYS = del_EDTMRSH_CNCPTTR6_FK.id_other_grading_sys_in AND
          ID_OGRADSYS_INST_OWNER = del_EDTMRSH_CNCPTTR6_FK.id_ogradsys_inst_owner_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_CNCPTTR6_FK (
   ...
   BEGIN
      DELETE FROM EPIS_DIAG_TUMORS_HIST
       WHERE
          ID_EPIS_DIAGNOSIS_HIST = del_EDTMRSH_EDH_FK.id_epis_diagnosis_hist_in
       RETURNING ROWID BULK COLLECT INTO rows_out;
   EXCEPTION
      WHEN e_check_constraint_failure
      THEN
...
del_EDTMRSH_EDH_FK (
   ...
   BEGIN
      IF where_in IS NULL
      THEN
         RETURN 'DELETE FROM EPIS_DIAG_TUMORS_HIST';
      ELSE
         RETURN
            'DELETE FROM EPIS_DIAG_TUMORS_HIST WHERE ' || where_in;
      END IF;
   END dyndelstr;
   ...
   IS
   BEGIN
      epis_diag_tumors_hist_inout.ID_EPIS_DIAGNOSIS_HIST := NULL;
      epis_diag_tumors_hist_inout.ID_EPIS_DIAGNOSIS := NULL;
      epis_diag_tumors_hist_inout.TUMOR_NUM := NULL;
      epis_diag_tumors_hist_inout.ID_TOPOGRAPHY := NULL;
      epis_diag_tumors_hist_inout.ID_TOPOG_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.ID_LATERALITY := NULL;
      epis_diag_tumors_hist_inout.ID_LAT_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.ID_MORPHOLOGY := NULL;
      epis_diag_tumors_hist_inout.ID_MORPH_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.ID_BEHAVIOR := NULL;
      epis_diag_tumors_hist_inout.ID_BEHAV_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.ID_HISTOLOGICAL_GRADE := NULL;
      epis_diag_tumors_hist_inout.ID_HGRADE_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.ID_OTHER_GRADING_SYS := NULL;
      epis_diag_tumors_hist_inout.ID_OGRADSYS_INST_OWNER := NULL;
      epis_diag_tumors_hist_inout.FLG_UNKNOWN_DIMENSION := NULL;
      epis_diag_tumors_hist_inout.NUM_DIMENSION := NULL;
      epis_diag_tumors_hist_inout.DESC_DIMENSION := NULL;
      epis_diag_tumors_hist_inout.ADDITIONAL_PATHOL_INFO := NULL;
      epis_diag_tumors_hist_inout.DT_EPIS_DIAGNOSIS_TUMORS := NULL;
      epis_diag_tumors_hist_inout.CREATE_USER := NULL;
      epis_diag_tumors_hist_inout.CREATE_TIME := NULL;
      epis_diag_tumors_hist_inout.CREATE_INSTITUTION := NULL;
      epis_diag_tumors_hist_inout.UPDATE_USER := NULL;
      epis_diag_tumors_hist_inout.UPDATE_TIME := NULL;
      epis_diag_tumors_hist_inout.UPDATE_INSTITUTION := NULL;
   END initrec;

   FUNCTION initrec RETURN EPIS_DIAG_TUMORS_HIST%ROWTYPE
   IS
      l_epis_diag_tumors_hist EPIS_DIAG_TUMORS_HIST%ROWTYPE;
   BEGIN
      RETURN l_epis_diag_tumors_hist;
   END initrec;
   ...
   IS
        data EPIS_DIAG_TUMORS_HIST_tc;
   BEGIN
        select * bulk collect into data from EPIS_DIAG_TUMORS_HIST where rowid in (select /*+opt_estimate(table,t,scale_rows=0.0000001))*/ * from table(rows_in) t);
        return data;
        EXCEPTION
      WHEN OTHERS THEN
        pk_alert_exceptions.raise_error (
