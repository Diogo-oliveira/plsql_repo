CREATE OR REPLACE PACKAGE BODY ts_epis_multi_profresp_hist
/*
...
*/
 IS
    ...
    FUNCTION next_key(sequence_in IN VARCHAR2 := NULL) RETURN epis_multi_profresp_hist.id_epis_multi_profresp_hist%TYPE IS
        retval epis_multi_profresp_hist.id_epis_multi_profresp_hist%TYPE;
    BEGIN
        IF sequence_in IS NULL
        THEN
            retval := seq_epis_multi_profresp_hist.nextval;
        ELSE
    ...
    (
        ...
        l_pky epis_multi_profresp_hist.id_epis_multi_profresp_hist%TYPE := next_key;
    BEGIN
        ins(id_epis_multi_profresp_hist_in => l_pky,
            id_epis_multi_prof_resp_in     => id_epis_multi_prof_resp_in,
    ...
    BEGIN
        ins(id_epis_multi_profresp_hist_in => l_pky,
            ...
            handle_error_in                => handle_error_in,
            rows_out                       => rows_out);
        id_epis_multi_profresp_hist_ou := l_pky;
    END ins;
    ...
    BEGIN
        ins(id_epis_multi_prof_resp_in      => id_epis_multi_prof_resp_in,
            ...
            priority_in                     => priority_in,
            dt_update_in                    => dt_update_in,
            id_epis_multi_profresp_hist_ou => id_epis_multi_profresp_hist_ou,
            handle_error_in                 => handle_error_in,
            rows_out                        => rows_out);
    END ins;
    ...
    (
        ...
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) RETURN epis_multi_profresp_hist.id_epis_multi_profresp_hist%TYPE IS
        l_pky epis_multi_profresp_hist.id_epis_multi_profresp_hist%TYPE := next_key;
    BEGIN
        ins(id_epis_multi_profresp_hist_in => l_pky,
            id_epis_multi_prof_resp_in     => id_epis_multi_prof_resp_in,
    ...
    BEGIN
        INSERT INTO epis_multi_profresp_hist
            (id_epis_multi_profresp_hist,
             ...
             dt_update)
        VALUES
            (id_epis_multi_profresp_hist_in,
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        ins(id_epis_multi_profresp_hist_in => id_epis_multi_profresp_hist_in,
            id_epis_multi_prof_resp_in     => id_epis_multi_prof_resp_in,
            id_episode_in                  => id_episode_in,
            flg_status_in                  => flg_status_in,
            id_professional_in             => id_professional_in,
    ...
    (
        ...
        l_rec epis_multi_profresp_hist%ROWTYPE := rec_in;
    BEGIN
        IF gen_pky_in
        THEN
            l_rec.id_epis_multi_profresp_hist := next_key(sequence_in);
        END IF;

        ins(id_epis_multi_profresp_hist_in => l_rec.id_epis_multi_profresp_hist,
            id_epis_multi_prof_resp_in     => l_rec.id_epis_multi_prof_resp,
    ...
    (
        ...
        l_id_epis_multi_prof_resp_n NUMBER(1) := sys.diutil.bool_to_int(id_epis_multi_prof_resp_nin);
    ...
    BEGIN
        ...
        UPDATE epis_multi_profresp_hist
           SET id_epis_multi_prof_resp = decode(l_id_epis_multi_prof_resp_n,
                                                0,
                                                id_epis_multi_prof_resp_in,
                                                nvl(id_epis_multi_prof_resp_in, id_epis_multi_prof_resp)),
         ...
         WHERE id_epis_multi_profresp_hist = id_epis_multi_profresp_hist_in
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd(id_epis_multi_profresp_hist_in => id_epis_multi_profresp_hist_in,
            id_epis_multi_prof_resp_in     => id_epis_multi_prof_resp_in,
            id_epis_multi_prof_resp_nin    => id_epis_multi_prof_resp_nin,
            id_episode_in                  => id_episode_in,
    ...
    (
        ...
        l_dt_update_n               NUMBER(1) := sys.diutil.bool_to_int(dt_update_nin);
    BEGIN
        l_id_epis_multi_prof_resp_n := sys.diutil.bool_to_int(id_epis_multi_prof_resp_nin);
        ...
        l_sql                       := 'UPDATE epis_multi_profresp_hist SET' || ' ID_EPIS_MULTI_PROF_RESP = decode (' ||
                                       l_id_epis_multi_prof_resp_n ||
                                       ',0,:ID_EPIS_MULTI_PROF_RESP_in, NVL (:ID_EPIS_MULTI_PROF_RESP_in, ID_EPIS_MULTI_PROF_RESP)) ' || ',' ||
                                       ...
                                       ',0,:PRIORITY_in, NVL (:PRIORITY_in, PRIORITY)) ' || ',' ||
                                       ' DT_UPDATE = decode (' || l_dt_update_n ||
                                       ',0,:DT_UPDATE_in, NVL (:DT_UPDATE_in, DT_UPDATE)) ' || ' where ' ||
                                       nvl(where_in, '(1=1)') || ' RETURNING ROWID BULK COLLECT INTO :l_rows_out';
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_epis_multi_prof_resp_in, id_episode_in, flg_status_in, id_professional_in, flg_profile_in, dt_create_in, id_epis_prof_resp_in, create_user_in, create_time_in, create_institution_in, update_user_in, update_time_in, update_institution_in, flg_main_responsible_in, id_speciality_in, flg_resp_type_in, priority_in, dt_update_in, OUT l_rows_out;
        IF (rows_out IS NULL)
        THEN
            rows_out := table_varchar();
        END IF;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        upd_ins(id_epis_multi_profresp_hist_in,
                id_epis_multi_prof_resp_in,
                id_episode_in,
                flg_status_in,
                id_professional_in,
    ...
    BEGIN
        upd(id_epis_multi_profresp_hist_in => rec_in.id_epis_multi_profresp_hist,
            id_epis_multi_prof_resp_in     => rec_in.id_epis_multi_prof_resp,
    ...
    (
        ...
        l_id_epis_multi_profresp_hist id_epis_multi_profresp_hist_cc;
    ...
    BEGIN
        ...
        LOOP
            l_id_epis_multi_profresp_hist(i) := col_in(i).id_epis_multi_profresp_hist;
        ...
        THEN
            ...
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_multi_profresp_hist
                   SET id_epis_multi_prof_resp = nvl(l_id_epis_multi_prof_resp(i), id_epis_multi_prof_resp),
                 ...
                 WHERE id_epis_multi_profresp_hist = l_id_epis_multi_profresp_hist(i)
                RETURNING ROWID BULK COLLECT INTO rows_out;
        ELSE
            FORALL i IN col_in.first .. col_in.last
                UPDATE epis_multi_profresp_hist
                   SET id_epis_multi_prof_resp = l_id_epis_multi_prof_resp(i),
    ...
    BEGIN
        RETURN 'BEGIN UPDATE epis_multi_profresp_hist
SET ' || colname_in || ' = :value
 WHERE ' || nvl(where_in, '1=1') || ' RETURNING ROWID BULK COLLECT INTO :rows_out; END;';
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE epis_multi_profresp_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE epis_multi_profresp_hist
SET ' || colname_in || '=' || colname_in || '+' || nvl(increment_value_in, 1) || ' WHERE ' ||
                          nvl(where_in, '1=1');
    END increment_onecol;
    ...
    BEGIN
        DELETE FROM epis_multi_profresp_hist
         WHERE id_epis_multi_profresp_hist = id_epis_multi_profresp_hist_in
        RETURNING ROWID BULK COLLECT INTO rows_out;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del(id_epis_multi_profresp_hist_in => id_epis_multi_profresp_hist_in,
            handle_error_in                => handle_error_in,
            rows_out                       => rows_out);
    END del;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_emprh_empr_fk(id_epis_multi_prof_resp_in => id_epis_multi_prof_resp_in,
                          handle_error_in            => handle_error_in,
                          rows_out                   => rows_out);
    END del_emprh_empr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_emprh_epis_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_emprh_epis_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_emprh_epr_fk(id_epis_prof_resp_in => id_epis_prof_resp_in,
                         handle_error_in      => handle_error_in,
                         rows_out             => rows_out);
    END del_emprh_epr_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_emprh_prof_fk(id_professional_in => id_professional_in,
                          handle_error_in    => handle_error_in,
                          rows_out           => rows_out);
    END del_emprh_prof_fk;
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_emprh_spy_fk(id_speciality_in => id_speciality_in,
                         handle_error_in  => handle_error_in,
                         rows_out         => rows_out);
    END del_emprh_spy_fk;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM epis_multi_profresp_hist';
        ELSE
            RETURN 'DELETE FROM epis_multi_profresp_hist WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(epis_multi_profresp_hist_inout IN OUT epis_multi_profresp_hist%ROWTYPE) IS
    BEGIN
        epis_multi_profresp_hist_inout.id_epis_multi_profresp_hist := NULL;
        epis_multi_profresp_hist_inout.id_epis_multi_prof_resp     := NULL;
        epis_multi_profresp_hist_inout.id_episode                  := NULL;
        epis_multi_profresp_hist_inout.flg_status                  := NULL;
        epis_multi_profresp_hist_inout.id_professional             := NULL;
        epis_multi_profresp_hist_inout.flg_profile                 := NULL;
        epis_multi_profresp_hist_inout.dt_create                   := NULL;
        epis_multi_profresp_hist_inout.id_epis_prof_resp           := NULL;
        epis_multi_profresp_hist_inout.create_user                 := NULL;
        epis_multi_profresp_hist_inout.create_time                 := NULL;
        epis_multi_profresp_hist_inout.create_institution          := NULL;
        epis_multi_profresp_hist_inout.update_user                 := NULL;
        epis_multi_profresp_hist_inout.update_time                 := NULL;
        epis_multi_profresp_hist_inout.update_institution          := NULL;
        epis_multi_profresp_hist_inout.flg_main_responsible        := NULL;
        epis_multi_profresp_hist_inout.id_speciality               := NULL;
        epis_multi_profresp_hist_inout.flg_resp_type               := NULL;
        epis_multi_profresp_hist_inout.priority                    := NULL;
        epis_multi_profresp_hist_inout.dt_update                   := NULL;
    END initrec;

    -- Initialize a record with default values for columns in the table (fnc)
    FUNCTION initrec RETURN epis_multi_profresp_hist%ROWTYPE IS
        l_epis_multi_profresp_hist epis_multi_profresp_hist%ROWTYPE;
    BEGIN
        RETURN l_epis_multi_profresp_hist;
    END initrec;

    --get data from rowid
    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN epis_multi_profresp_hist_tc IS
        data epis_multi_profresp_hist_tc;
    BEGIN
        SELECT *
          BULK COLLECT
          INTO data
          FROM epis_multi_profresp_hist
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN epis_multi_profresp_hist_tc IS
        data epis_multi_profresp_hist_tc;
