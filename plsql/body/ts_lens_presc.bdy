/*-- Last Change Revision: $Rev: 2028251 $*/
/*-- Last Change by: $Author: mario.fernandes $*/
/*-- Date of last change: $Date: 2022-08-02 18:44:40 +0100 (ter, 02 ago 2022) $*/

CREATE OR REPLACE PACKAGE BODY ts_lens_presc
/*
| Generated by or retrieved from QCGU - DO NOT MODIFY!
| QCGU - "Get it right, do it fast" - www.ToadWorld.com
| QCGU Universal ID: {657BD35E-2E48-4CD4-B14E-41420B8433B3}
| Created On: January 22, 2009 20:1:34
| Created By: ALERT
*/
 IS
    ...
    PROCEDURE ins
    (
        id_lens_presc_in      IN lens_presc.id_lens_presc%TYPE,
        id_lens_in            IN lens_presc.id_lens%TYPE DEFAULT NULL,
        id_episode_in         IN lens_presc.id_episode%TYPE DEFAULT NULL,
        id_patient_in         IN lens_presc.id_patient%TYPE DEFAULT NULL,
        id_prof_presc_in      IN lens_presc.id_prof_presc%TYPE DEFAULT NULL,
        dt_lens_presc_tstz_in IN lens_presc.dt_lens_presc_tstz%TYPE DEFAULT NULL,
        id_prof_cancel_in     IN lens_presc.id_prof_cancel%TYPE DEFAULT NULL,
        dt_cancel_tstz_in     IN lens_presc.dt_cancel_tstz%TYPE DEFAULT NULL,
        id_prof_print_in      IN lens_presc.id_prof_print%TYPE DEFAULT NULL,
        dt_print_tstz_in      IN lens_presc.dt_print_tstz%TYPE DEFAULT NULL,
        flg_status_in         IN lens_presc.flg_status%TYPE DEFAULT NULL,
        notes_in              IN lens_presc.notes%TYPE DEFAULT NULL,
        notes_cancel_in       IN lens_presc.notes_cancel%TYPE DEFAULT NULL,
        id_cancel_reason_in   IN lens_presc.id_cancel_reason%TYPE DEFAULT NULL,
        handle_error_in       IN BOOLEAN := TRUE,
        rows_out              OUT table_varchar
    ) IS
    BEGIN
    
        INSERT INTO lens_presc
            (id_lens_presc,
             id_lens,
             id_episode,
             id_patient,
    ...
    PROCEDURE ins
    (
        rec_in          IN lens_presc%ROWTYPE,
        sequence_in     IN VARCHAR2 := NULL,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
        l_rec lens_presc%ROWTYPE := rec_in;
    BEGIN
    ...
    BEGIN
        ...
        UPDATE lens_presc
           SET id_lens            = decode(l_id_lens_n, 0, id_lens_in, nvl(id_lens_in, id_lens)),
         ...
         WHERE id_lens_presc = id_lens_presc_in RETURNING ROWID BULK COLLECT INTO l_rows_out;
    ...
    (
        ...
        l_notes_cancel_n       NUMBER(1);
        l_id_cancel_reason_n   NUMBER(1);
        id_lens_presc_in       lens_presc.id_lens_presc%TYPE;
    BEGIN
        ...
        l_sql := 'UPDATE LENS_PRESC SET ' || ' ID_LENS = decode (' || l_id_lens_n ||
                 ',0,:id_lens_in, NVL (:id_lens_in, ID_LENS)) ' || ',' || ' ID_EPISODE = decode (' || l_id_episode_n ||
        ...
        EXECUTE IMMEDIATE 'BEGIN ' || l_sql || '; END;'
            USING IN id_lens_in, id_episode_in, id_patient_in, id_prof_presc_in, dt_lens_presc_tstz_in, id_prof_cancel_in, dt_cancel_tstz_in, id_prof_print_in, dt_print_tstz_in, flg_status_in, notes_in, notes_cancel_in, id_cancel_reason_in, OUT l_rows_out;
    ...
    BEGIN
        ...
        THEN
            ...
            FORALL i IN col_in.FIRST .. col_in.LAST
                UPDATE lens_presc
                   SET id_lens            = nvl(l_id_lens(i), id_lens),
    ...
    (
     ...
     RETURN VARCHAR2 IS
    BEGIN
        RETURN 'BEGIN UPDATE LENS_PRESC
    ...
    BEGIN
        EXECUTE IMMEDIATE 'BEGIN UPDATE LENS_PRESC set ' || colname_in || '=' || colname_in || ' + ' ||
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        EXECUTE IMMEDIATE 'UPDATE LENS_PRESC set ' || colname_in || '=' || colname_in || ' + ' ||
                          nvl(increment_value_in, 1) || ' WHERE ' || nvl(where_in, '1=1');
    EXCEPTION
        WHEN dup_val_on_index THEN
            IF NOT handle_error_in
    ...
    BEGIN
        DELETE FROM lens_presc
         WHERE id_lens_presc = id_lens_presc_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    BEGIN
        ...
        del(id_lens_presc_in => id_lens_presc_in, handle_error_in => handle_error_in, rows_out => rows_out);
    ...
    PROCEDURE del_lpc_cre_fk
    (
        id_cancel_reason_in IN lens_presc.id_cancel_reason%TYPE,
        handle_error_in     IN BOOLEAN := TRUE,
        rows_out            OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_cancel_reason = del_lpc_cre_fk.id_cancel_reason_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_cre_fk(id_cancel_reason_in => id_cancel_reason_in,
                       handle_error_in     => handle_error_in,
                       rows_out            => rows_out);
    END del_lpc_cre_fk;

    PROCEDURE del_lpc_epe_fk
    (
        id_episode_in   IN lens_presc.id_episode%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_episode = del_lpc_epe_fk.id_episode_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_epe_fk(id_episode_in => id_episode_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_lpc_epe_fk;

    PROCEDURE del_lpc_len_fk
    (
        id_lens_in      IN lens_presc.id_lens%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_lens = del_lpc_len_fk.id_lens_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_len_fk(id_lens_in => id_lens_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_lpc_len_fk;

    PROCEDURE del_lpc_pat_fk
    (
        id_patient_in   IN lens_presc.id_patient%TYPE,
        handle_error_in IN BOOLEAN := TRUE,
        rows_out        OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_patient = del_lpc_pat_fk.id_patient_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_pat_fk(id_patient_in => id_patient_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_lpc_pat_fk;

    PROCEDURE del_lpc_prl_fk
    (
        id_prof_presc_in IN lens_presc.id_prof_presc%TYPE,
        handle_error_in  IN BOOLEAN := TRUE,
        rows_out         OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_prof_presc = del_lpc_prl_fk.id_prof_presc_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_prl_fk(id_prof_presc_in => id_prof_presc_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_lpc_prl_fk;

    PROCEDURE del_lpc_prl_fk2
    (
        id_prof_print_in IN lens_presc.id_prof_print%TYPE,
        handle_error_in  IN BOOLEAN := TRUE,
        rows_out         OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_prof_print = del_lpc_prl_fk2.id_prof_print_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_prl_fk2(id_prof_print_in => id_prof_print_in, handle_error_in => handle_error_in, rows_out => rows_out);
    END del_lpc_prl_fk2;

    PROCEDURE del_lpc_prl_fk3
    (
        id_prof_cancel_in IN lens_presc.id_prof_cancel%TYPE,
        handle_error_in   IN BOOLEAN := TRUE,
        rows_out          OUT table_varchar
    ) IS
    BEGIN
        DELETE FROM lens_presc
         WHERE id_prof_cancel = del_lpc_prl_fk3.id_prof_cancel_in RETURNING ROWID BULK COLLECT INTO rows_out;
    EXCEPTION
        WHEN e_check_constraint_failure THEN
            IF NOT handle_error_in
            THEN
    ...
    (
        ...
        rows_out table_varchar;
    BEGIN
        del_lpc_prl_fk3(id_prof_cancel_in => id_prof_cancel_in,
                        handle_error_in   => handle_error_in,
                        rows_out          => rows_out);
    END del_lpc_prl_fk3;
    ...
    BEGIN
        IF where_in IS NULL
        THEN
            RETURN 'DELETE FROM LENS_PRESC';
        ELSE
            RETURN 'DELETE FROM LENS_PRESC WHERE ' || where_in;
        END IF;
    END dyndelstr;
    ...
    PROCEDURE initrec(lens_presc_inout IN OUT lens_presc%ROWTYPE) IS
    BEGIN
        lens_presc_inout.id_lens_presc      := NULL;
        lens_presc_inout.id_lens            := NULL;
        lens_presc_inout.id_episode         := NULL;
        lens_presc_inout.id_patient         := NULL;
        lens_presc_inout.id_prof_presc      := NULL;
        lens_presc_inout.dt_lens_presc_tstz := NULL;
        lens_presc_inout.id_prof_cancel     := NULL;
        lens_presc_inout.dt_cancel_tstz     := NULL;
        lens_presc_inout.id_prof_print      := NULL;
        lens_presc_inout.dt_print_tstz      := NULL;
        lens_presc_inout.flg_status         := NULL;
        lens_presc_inout.notes              := NULL;
        lens_presc_inout.notes_cancel       := NULL;
        lens_presc_inout.id_cancel_reason   := NULL;
    END initrec;

    FUNCTION initrec RETURN lens_presc%ROWTYPE IS
        l_lens_presc lens_presc%ROWTYPE;
    BEGIN
        RETURN l_lens_presc;
    END initrec;

    FUNCTION get_data_rowid(rows_in IN table_varchar) RETURN lens_presc_tc IS
        data lens_presc_tc;
    BEGIN
        SELECT * BULK COLLECT
          INTO data
    ...
    FUNCTION get_data_rowid_pat(rows_in IN table_varchar) RETURN lens_presc_tc IS
