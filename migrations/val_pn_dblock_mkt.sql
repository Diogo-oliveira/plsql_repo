 ...
 order by 2 desc, 3 desc, 1 desc;');
    ...
    EXCEPTION
        ...
        WHEN e_has_findings THEN
            log_error('BAD VALUE: Nr of records of Data Block MKT without flg_mandatory to ''Y'' l_count_flg_mandatory: ' || l_count_flg_mandatory);
