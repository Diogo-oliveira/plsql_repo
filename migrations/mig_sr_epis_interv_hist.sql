...
BEGIN
    ...
    SELECT COUNT(1)
     ...
     WHERE d.table_name = 'SR_EPIS_INTERV_HIST'
...
BEGIN
    ...
    LOOP
        ...
        THEN
            UPDATE sr_epis_interv_hist sei
               SET sei.id_epis_diagnosis = l_id_epis_diagnosis
             WHERE sei.id_sr_epis_interv = rec.id_sr_epis_interv;
        END IF;
    END LOOP;
END';
    ...
    ELSE
        dbms_output.put_line('Column ID_diagnosis already dropped. Table: sr_epis_interv_hist');
    END IF;
