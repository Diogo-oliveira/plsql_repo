...
select *
 ...
 order by 2 desc, 3 desc, 1 desc;');
    ...
    PROCEDURE do_my_validation IS
        ...
        l_id_language         language.id_language%TYPE := 2;
        l_prof                profissional;
            ...
            SELECT sid.session_id,
              ...
              FROM (SELECT a.session_id,
                           ...
                           pk_date_utils.trunc_insttimezone(profissional(a.id_professional,
                                                            ...
                                                            NULL) session_day,
                           pk_date_utils.dt_chr_hour_tsz(l_id_language,
                                                         MAX(a.dt_epis_recomend_tstz),
                                                         profissional(a.id_professional, a.id_institution, l_id_software)) highest_time,
                           a.id_language,
                           MAX(a.dt_epis_recomend_tstz) dt_epis_recomend_tstz_max
                      FROM (SELECT i.id_institution, il.id_language, er.*
                              FROM epis_recomend er
                             INNER JOIN (SELECT id_notes_config
                                          FROM notes_config cfg
                                         WHERE cfg.notes_code NOT IN ('BGN', 'END')) nc ON (er.id_notes_config =
                                                                                           nc.id_notes_config)
                             INNER JOIN episode e ON er.id_episode = e.id_episode
        ...
        (
            ...
            CURSOR c_erd IS
                SELECT erd.id_epis_recomend,
                  ...
                  JOIN notes_grp_cfg ngc ON erd.id_notes_config = ngc.id_notes_config
                  JOIN notes_group ngp ON ngp.id_notes_group = ngc.id_notes_group
                  JOIN notes_config ncg ON ncg.id_notes_config = ngc.id_notes_config
