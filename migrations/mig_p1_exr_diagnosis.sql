...
BEGIN
    ...
    BEGIN
        SELECT degree
          INTO l_aux
          FROM user_tables
         WHERE table_name = 'P1_EXR_DIAGNOSIS';
    EXCEPTION
    ...
    -- alterar a tabela
    EXECUTE IMMEDIATE 'ALTER TABLE P1_EXR_DIAGNOSIS PARALLEL (DEGREE ' || l_count || ')';
    ...
    EXECUTE IMMEDIATE 'ALTER TABLE P1_EXR_DIAGNOSIS PARALLEL (DEGREE ' || l_aux || ')';
