DECLARE
    ...
    l_profiles    table_number := table_number(33,
                                               38,
                                               44,
                                               71,
                                               75,
...
BEGIN
    ...
    LOOP
        ...
        IF (rec.id_profile_template IN (33, 38, 44, 71, 75, 89, 90, 93, 98, 151, 154, 926, 927, 938, 939, 950))
        THEN
            l_id_profile_template := 951;
            --
        ELSIF (rec.id_profile_template IN (144, 145))
        THEN
            l_id_profile_template := 952;
            --
        ELSIF (rec.id_profile_template IN (146, 147, 928, 940))
        THEN
            l_id_profile_template := 953;
        END IF;
