...
DECLARE
    ...
    l_id_doc_area epis_documentation.id_doc_area%TYPE := 1092;
        ...
        LOOP
            ...
            THEN
                ...
                THEN
                    ...
                    VALUES
                        (l_id_epis_pn_signoff, l_id_epis_pn, 17, l_desc);
            ...
            IF (l_get_records(i).flg_status IN ('O', 'I', 'C'))
            THEN
                --cancel the note
                ...
                THEN
                    raise_application_error(-20001,
                                            'cancel_progress_note l_id_epis_pn: ' || l_id_epis_pn || chr(13) || SQLERRM);
                END IF;
            END IF;
...
EXCEPTION
    WHEN OTHERS THEN
        raise_application_error(-20001,
                                'mig_edis_progress_notes_to_recheck l_id_epis_pn: ' || l_id_epis_pn || chr(13) ||
                                SQLERRM);
END;
/
