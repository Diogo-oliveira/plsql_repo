 ...
 order by 2 desc, 3 desc, 1 desc;');
    ...
    BEGIN
        ...
        SELECT COUNT(*)
         ...
         WHERE s.flg_type = 'M' and sw.total_avail_quantity is null;
    ...
    EXCEPTION
        ...
        WHEN e_has_findings THEN
            log_error('BAD VALUE: Nr of registries in supply_worflow table without total_avail_quantity: ' || l_aux_count_no_qtt || '. ');
