...
-- CHANGE DATE: 02/05/2011 16:41
-- CHANGE REASON: [ALERT-173626] 
...
BEGIN
    SELECT CASE
                ...
                WHEN old_id IN (3170) THEN
                 2944
            
                WHEN old_id IN (3171) THEN
                 3025
            
                WHEN old_id IN (3173) THEN
                 3056
            
                WHEN old_id IN (3174) THEN
                 2915
