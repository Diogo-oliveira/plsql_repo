    ...
    THEN
        ...
        LOOP
            ...
            THEN
                ...
                SELECT e.id_institution, ei.id_software, il.id_language
                  INTO l_id_institution, l_id_software, l_id_language
                  FROM episode e
                ...
                IF NOT pk_prog_notes_core.set_save_def_note(i_lang                => l_id_language,
                                                            ...
                                                            i_pn_flg_status       => 'M',
                                                            i_id_pn_note_type     => 3,
                                                            i_dt_pn_date             => l_tab_epis_recommend(indx)
                                                            ...
                                                            i_id_professional     => l_tab_epis_recommend(indx).id_professional,
                                                            i_dt_last_update      => l_tab_epis_recommend(indx).dt_epis_recomend_tstz,
                                                            i_dt_create           => l_tab_epis_recommend(indx).dt_epis_recomend_tstz,
                                                            i_dt_sent_to_hist     => l_tab_epis_recommend(indx).dt_epis_recomend_tstz,
                                                            i_id_prof_sign_off    => l_tab_epis_recommend(indx).id_professional,
                                                            i_dt_sign_off         => l_tab_epis_recommend(indx).dt_epis_recomend_tstz,
                ...
                THEN
					...
					raise_application_error(-20001,
                                            'ERROR. id_episode: ' || l_tab_epis_recommend(indx).id_episode || ' text: ' || l_tab_epis_recommend(indx)
                                  .desc_epis_recomend || ' id_complete_history: ' || l_tab_epis_recommend(indx)
                                  .id_epis_recomend);
                END IF;
            END IF;
