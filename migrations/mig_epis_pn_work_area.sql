...
BEGIN
    ...
    FOR item IN (SELECT epnw.id_pn_note_type, --
                        epnw.id_epis_pn,
                        epnw.id_professional, --
                        ei.id_dep_clin_serv, --
                        e.id_episode, --
                        e.id_institution, --
                        ei.id_software, --
                  ...
                  INNER JOIN episode e
                     ON epnw.id_episode = e.id_episode
                  INNER JOIN epis_info ei
                     ON e.id_episode = ei.id_episode
                  INNER JOIN pn_note_type pnnt
                     ON epnw.id_pn_note_type = pnnt.id_pn_note_type
                  WHERE epnw.id_pn_area IS NULL)
    LOOP
    
        l_pn_area := get_pn_area(i_prof                => profissional(item.id_professional,
                                                                       item.id_institution,
                                                                       item.id_software),
        ...
        UPDATE epis_pn_work epnw
           SET epnw.id_pn_area = l_pn_area
         WHERE epnw.id_pn_area IS NULL
           AND epnw.id_epis_pn = item.id_epis_pn;
    END LOOP;
