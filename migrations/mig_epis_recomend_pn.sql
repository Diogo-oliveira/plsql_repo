    ...
    CURSOR c_get_records IS
        SELECT sid.session_id,
          ...
          FROM (SELECT a.session_id,
                       ...
                       a.id_institution,
                       a.id_episode,
                       pk_date_utils.trunc_insttimezone(profissional(a.id_professional, a.id_institution, l_id_software),
    ...
    LOOP
        ...
        THEN
            ...
            IF NOT pk_prog_notes_core.set_save_def_note(i_lang                => l_id_language,
                                                        ...
                                                        i_pn_date             => c.dt_epis_recomend_tstz_max,
            ...
            THEN
                raise_application_error(-20001,
                                        ...
                                        ' id_episode: ' || c.id_episode || chr(13) || l_error.log_id || ' -> ' ||
                                        l_error.err_desc);
            END IF;
