 ...
 order by 2 desc, 3 desc, 1 desc;');
    ...
    BEGIN
        ...
        BEGIN
            SELECT COUNT(1)
             ...
             WHERE ep.dt_epis_positioning IS NULL;
        EXCEPTION
    ...
    EXCEPTION
        WHEN e_has_findings THEN
            log_error('ERROR ON EPIS_POSITIONING MIGRATION. NOT migrated ' || l_num_not_migrated || ' IDs.');
