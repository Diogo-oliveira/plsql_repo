 ...
 order by 2 desc, 3 desc, 1 desc;');
    ...
    BEGIN
        ...
        BEGIN
            SELECT COUNT(1)
             ...
             WHERE pdi.flg_ref_line IS NOT NULL
               AND (rdis.flg_ref_line IS NULL OR rdis.flg_ref_line != pdi.flg_ref_line);
    ...
    EXCEPTION
        WHEN e_has_findings THEN
            log_error('ERROR ON REF_DEST_INSTITUTION_SPEC MIGRATION of FLG_REF_LINE. NOT migrated ' ||
