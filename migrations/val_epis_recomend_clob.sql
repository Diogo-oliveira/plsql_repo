...
DECLARE
    ...
    BEGIN
        ...
        /* Data validation */
        BEGIN
        SELECT COUNT(1) into l_num_not_migrated
          FROM epis_recomend er
         WHERE dbms_lob.substr(desc_epis_recomend_clob, 4000, 1) <> desc_epis_recomend
           AND flg_type IN ('M', 'N');
        EXCEPTION
    ...
    EXCEPTION
        WHEN e_has_findings THEN
            log_error('ERROR ON EPIS_RECOMEND.DESC_EPIS_RECOMEND_CLOB. NOT migrated ' || l_num_not_migrated || ' IDs.');
