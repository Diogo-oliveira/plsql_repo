...
BEGIN
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'd3_8alr_is_mkr', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy_inst_soft_market', 'TABLE', 'TRS', 'N', '', 'N','','MEDICATION');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'd3_8allergy', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy', 'TABLE', 'TRS', 'N', '', 'N','','MEDICATION');


PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'd3_8translation_17', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
END;
/
--CREATE--
create table d3_8translation_17
(
  ...
  (
    ...
    location ('d3_8translation_17.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table d3_8alr_is_mkr
(
  FLG_FREQ VARCHAR2(1), 
  ...
  (
    ...
    location ('d3_8alr_is_mkr.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table d3_8allergy
(
