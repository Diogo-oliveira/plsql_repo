BEGIN
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_21alr_is_mkr', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy_inst_soft_market', 'TABLE', 'TRS', 'N', '', 'N','','MEDICATION');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_21allergy', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy', 'TABLE', 'TRS', 'N', '', 'N','','MEDICATION');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_21unit_measure', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_21translation_6', 'TABLE', 'DPC', 'N', '', 'N','','MEDICATION');
END;
/
--CREATE--
create table e1_21translation_6
(
  ...
  (
    ...
    location ('e1_21translation_6.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table e1_21alr_is_mkr
(
  FLG_FREQ VARCHAR2(1), 
  ...
  (
    ...
    location ('e1_21alr_is_mkr.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table e1_21allergy
(
  ...
  (
    ...
    location ('e1_21allergy.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table e1_21unit_measure
(
  ...
  (
    ...
    location ('e1_21unit_measure.csv')
  )
REJECT LIMIT 0;
