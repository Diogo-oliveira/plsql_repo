BEGIN
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'a_ms_alr_is_mkr', 'TABLE', 'DPC', 'N', '', 'N');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy_inst_soft_market', 'TABLE', 'TRS', 'N', '', 'N');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'a_ms_allergy', 'TABLE', 'DPC', 'N', '', 'N');
...
(
  ...
  (
    ...
    location ('A_MS_alr_is_mkr.csv')
  )
REJECT LIMIT 0;


--CREATE--
create table a_ms_allergy
(
