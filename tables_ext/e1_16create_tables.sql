BEGIN
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_16alr_is_mkr', 'TABLE', 'DPC', 'N', '', 'N');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy_inst_soft_market', 'TABLE', 'TRS', 'N', '', 'N');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_16allergy', 'TABLE', 'DPC', 'N', '', 'N');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy', 'TABLE', 'TRS', 'N', '', 'N');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'e1_16translation_6', 'TABLE', 'DPC', 'N', '', 'N');
END;
/
--CREATE--
create table e1_16translation_6
(
  ...
  (
    ...
    location ('e1_16translation_6.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table e1_16alr_is_mkr
(
  FLG_FREQ VARCHAR2(1), 
  ...
  (
    ...
    location ('e1_16alr_is_mkr.csv')
  )
REJECT LIMIT 0;

--CREATE--
create table e1_16allergy
(
