BEGIN
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'a01_alr_is_mkr', 'TABLE', 'DPC', 'N', '', 'N');
PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'ERR$_allergy_inst_soft_market', 'TABLE', 'TRS', 'N', '', 'N');

PK_FRMW_OBJECTS.insert_into_frmw_objects('ALERT', 'a01_allergy', 'TABLE', 'DPC', 'N', '', 'N');
...
(
  ...
  (
    ...
    location ('a01_alr_is_mkr.csv')
  )
REJECT LIMIT 0;


--CREATE--
create table a01_allergy
(
