CREATE OR REPLACE VIEW V_SYS_ALERT_91 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M091'), '@1', v.replace1) message,
 ei.id_room,
 v.id_patient,
