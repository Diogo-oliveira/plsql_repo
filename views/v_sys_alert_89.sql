CREATE OR REPLACE   VIEW V_SYS_ALERT_89 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M089') message,
 NULL id_room,
 p.id_patient,
 ...
 id_prof_order
  FROM sys_alert_event v, episode e, patient p, epis_info ei, room r, prof_cat pc
 WHERE v.id_sys_alert = 89
   ...
   AND pc.id_professional = sys_context('ALERT_CONTEXT', 'i_prof')
   AND pc.id_institution = sys_context('ALERT_CONTEXT', 'i_institution')
   AND pc.id_category IN (2, 4, 25)
