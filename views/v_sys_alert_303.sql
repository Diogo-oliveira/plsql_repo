CREATE OR REPLACE VIEW v_sys_alert_303 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), v.replace1) ||
 REPLACE(v.replace2,
         '@1',
         chr(10) || pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'REF_MARK_REQ_T007')) message,
 NULL id_room,
 v.id_patient,
 ...
 WHERE v.id_sys_alert = 303
   AND v.id_institution = per.id_inst_dest
   AND v.flg_visible = 'Y'
   AND per.flg_status IN ('X', 'H')
   ...
   AND per.id_prof_requested = sys_context('ALERT_CONTEXT', 'i_prof');
