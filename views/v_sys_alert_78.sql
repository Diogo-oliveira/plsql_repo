CREATE OR REPLACE VIEW V_SYS_ALERT_78 AS
...
v.id_sys_alert_event id_sys_alert_det,
       ...
       REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'CP_ALERT_078'), '@', v.replace1) message,
       NULL id_room,
       p.id_patient,
