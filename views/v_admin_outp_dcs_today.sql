create or replace view v_admin_outp_dcs_today as
select
v00.view_id view_id
...
,v00.SP_FLG_SCHED
,v00.SP_ID_SOFTWARE
,NVL(RGA.re_flg_status, v00.S_FLG_STATUS) S_FLG_STATUS
,v00.SE_ID_SCH_EVENT
,v00.SG_ID_PATIENT
,v00.SYS_INSTITUTION
,v00.SYS_LANG
...
--join V_REHAB_GRID_ALL_PAT_TODAY rga on rga.id_episode = v00.ei_id_episode;
join V_REHAB_GRID_ALL_PAT_TODAY rga on rga.id_schedule = v00.S_ID_SCHEDULE
;
