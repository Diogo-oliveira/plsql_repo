CREATE OR REPLACE VIEW V_SYS_ALERT_17 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M019'), '@1', v.replace1) message,
 NULL id_room,
 e.id_patient,
 ...
 id_prof_order
  FROM sys_alert_event v, episode e, epis_info ei, room r
 WHERE v.id_sys_alert = 17
   ...
   AND v.dt_record <
       pk_date_utils.add_days_to_tstz(current_timestamp,
                                      - (pk_sysconfig.get_config('ALERT_NURSE_ACT_EXEC_TIMEOUT',
                                                                v.id_institution,
                                                                v.id_software) / (24 * 60)))
