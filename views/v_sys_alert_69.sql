CREATE OR REPLACE   VIEW V_SYS_ALERT_69 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 v.id_sys_alert_event id_sys_alert_det,
       ...
       REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'CP_ALERT_069'), '@', v.replace1) message,
       NULL id_room,
       p.id_patient,
