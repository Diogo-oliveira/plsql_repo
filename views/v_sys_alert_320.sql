CREATE OR REPLACE VIEW v_sys_alert_320 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'CPOE_M038') message,
 ei.id_room,
 sae.id_patient,
 ...
 WHERE sae.id_sys_alert = 320
   ...
   AND sae.id_professional = sys_context('ALERT_CONTEXT', 'i_prof')
