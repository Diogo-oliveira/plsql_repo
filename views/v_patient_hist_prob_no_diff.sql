CREATE OR REPLACE VIEW V_PATIENT_HIST_PROB_NO_DIFF AS
SELECT t.id_diagnosis,
       ...
       10                        views_rank,
       t.id_tvr_msi
  FROM TABLE(pk_terminology_search.tf_patient_hist_prob('N')) t
