CREATE OR REPLACE FORCE VIEW ALERT.V_CMT_QUESTION_RESPONSE AS
SELECT "DESC_CLINICAL_QUESTION","ID_CNT_CLINICAL_QUESTION","DESC_RESP","ID_CNT_RESPONSE","ID_CNT_QUESTION_RESPONSE","RANK","DESC_QUEST_PARENT","DESC_RESP_PARENT","ID_CNT_QUESTION_RESPONSE_PRT"
