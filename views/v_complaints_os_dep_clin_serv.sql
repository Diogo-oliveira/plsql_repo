CREATE OR REPLACE VIEW V_COMPLAINTS_OS_DEP_CLIN_SERV AS 
SELECT a.*,
       row_number() over(PARTITION BY a.id_complaint, id_complaint_alias, a.id_clinical_service ORDER BY a.id_complaint) rid --,    
