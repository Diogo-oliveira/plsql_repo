CREATE OR REPLACE VIEW V_SYS_ALERT_104 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'CPLAN_M001') message,
 NULL id_room,
 s.id_patient,
 ...
 id_prof_order
  FROM sys_alert_event v, episode e, epis_info ei, visit s, room r
 WHERE v.id_sys_alert = 104
