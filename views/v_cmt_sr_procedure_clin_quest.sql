CREATE OR REPLACE FORCE VIEW ALERT.V_CMT_SR_PROCEDURE_CLIN_QUEST AS
WITH temp AS
 (SELECT /*+ MATERIALIZED */
  DISTINCT avlb.id_sr_procedure AS id_intervention, avlb.id_cnt_sr_procedure, avlb.desc_sr_procedure
    FROM v_cmt_sr_procedure_available avlb)
