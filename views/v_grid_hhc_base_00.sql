...
FROM
  ...
  join sch_prof_outp spo on spo.id_schedule_outp = sp.id_schedule_outp
  join sch_resource ps on  ps.id_schedule = s.id_schedule
    ...
    left join professional prof_ps      on prof_ps.id_professional = spo.id_professional
