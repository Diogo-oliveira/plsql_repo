CREATE OR REPLACE   VIEW V_SYS_ALERT_87 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M087') message,
 NULL id_room,
 p.id_patient,
 ...
 id_prof_order
  FROM sys_alert_event v, episode e, patient p, epis_info ei, room r
 WHERE v.id_sys_alert = 87
