CREATE OR REPLACE VIEW V_SYS_ALERT_7 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M010'),
         '@1',
         nvl(pk_translation.get_translation(sys_context('ALERT_CONTEXT', 'i_lang'), v.replace1), v.replace1)) message,
 NULL id_room,
 e.id_patient,
