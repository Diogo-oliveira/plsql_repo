CREATE OR REPLACE   VIEW V_SYS_ALERT_22 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
       ...
       REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M024'), '@1', v.replace1) message,
       NULL id_room,
       s.id_patient,
