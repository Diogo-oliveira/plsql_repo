CREATE OR REPLACE VIEW V_PROCEDURES_FAVORIT_LIST AS
SELECT DISTINCT i.id_intervention,
  ...
  FROM intervention i
	JOIN interv_favorites if on i.id_intervention = if.id_intervention 
	                            and if.id_professional = alert_context('i_prof_id')
