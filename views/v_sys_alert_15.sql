CREATE OR REPLACE VIEW V_SYS_ALERT_15 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 decode(v.replace2,
        'N',
        REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M041'),
                '@1',
                pk_lab_tests_api_db.get_alias_translation(sys_context('ALERT_CONTEXT', 'i_lang'),
                                                          ...
                                                          v.replace1,
                                                          NULL)),
        REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M103'),
                '@1',
                pk_lab_tests_api_db.get_alias_translation(sys_context('ALERT_CONTEXT', 'i_lang'),
                                                          profissional(sys_context('ALERT_CONTEXT', 'i_prof'),
                                                                       sys_context('ALERT_CONTEXT', 'i_institution'),
