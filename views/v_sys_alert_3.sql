CREATE OR REPLACE VIEW V_SYS_ALERT_3 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 decode(v.replace2,
        'N',
        REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M003'),
                '@1',
                pk_exams_api_db.get_alias_translation(sys_context('ALERT_CONTEXT', 'i_lang'),
                                                      ...
                                                      v.replace1,
                                                      NULL)),
        REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M102'),
                '@1',
                pk_exams_api_db.get_alias_translation(sys_context('ALERT_CONTEXT', 'i_lang'),
                                                      profissional(sys_context('ALERT_CONTEXT', 'i_prof'),
                                                                   sys_context('ALERT_CONTEXT', 'i_institution'),
 ...
 id_prof_order
  FROM sys_alert_event v, patient p, episode e, epis_info ei, room r, exam x
 WHERE v.id_sys_alert = 3
