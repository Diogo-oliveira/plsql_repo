CREATE OR REPLACE VIEW v_cmt_img_exam_complaint AS
WITH temp AS
 (SELECT /*+ materialized */
...
SELECT desc_img_exam, id_cnt_img_exam, desc_complaint, id_cnt_complaint
  FROM (SELECT DISTINCT tmp.desc_img_exam, tmp.id_cnt_img_exam, tmp2.desc_complaint, tmp2.id_content id_cnt_complaint
