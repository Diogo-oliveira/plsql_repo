CREATE OR REPLACE VIEW v_sys_alert_327 AS
WITH aux AS
 (SELECT xint.id_sys_alert,
         ...
         pk_message.get_message(xint.sys_lang, 'V_ALERT_M327') sys_msg_alert_v00,
...
SELECT /*+ opt_param('_optimizer_use_feedback', 'false') */
 ...
 WHERE sae.id_sys_alert = 327
   ...
   AND eh.flg_status = sys_hhc_rejected
