CREATE OR REPLACE   VIEW V_SYS_ALERT_107 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'SIS_PRE_NATAL_M002') message,
 NULL id_room,
 NULL id_patient,
 ...
 WHERE v.id_sys_alert = 107
   AND v.id_institution = sys_context('ALERT_CONTEXT', 'i_institution')
   AND v.id_professional = sys_context('ALERT_CONTEXT', 'i_prof')
