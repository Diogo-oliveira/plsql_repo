CREATE OR REPLACE VIEW V_SYS_ALERT_103 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 decode(instr(pk_date_utils.get_elapsed_sysdate_tsz(sys_context('ALERT_CONTEXT', 'i_lang'), v.dt_record), ':'),
        ...
        (SELECT pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'ALERT_LIST_T003')
           FROM dual)) TIME,
 REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'SCH_T822'),
         '@1',
 ...
 id_prof_order
  FROM sys_alert_event v, patient p, schedule s, room r
 WHERE v.id_sys_alert = 103
