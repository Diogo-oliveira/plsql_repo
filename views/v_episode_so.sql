CREATE OR REPLACE VIEW v_episode_so AS -- episode de SO 
SELECT id_episode id_episode_alert_so,
       ...
       (SELECT pk_prof_utils.get_prof_num_order(language_id, profissional(id_prof_med_discharge, id_institution, 0))
          FROM dual) med_order_number_discharge_so,
