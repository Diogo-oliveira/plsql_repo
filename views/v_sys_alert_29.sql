CREATE OR REPLACE   VIEW V_SYS_ALERT_29 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M030'),
                 '@1',
 ...
 WHERE v.id_sys_alert = 29
   ...
   AND pk_date_utils.add_days_to_tstz(pk_date_utils.trunc_insttimezone(profissional(NULL, v.id_institution, NULL),
                                                                       current_timestamp,
                                                                       NULL),
                                      -pk_sysconfig.get_config('ALERT_EXPIRE_TRANSFER_ACC',
                                                               v.id_institution,
                                                               v.id_software)) <
