CREATE OR REPLACE VIEW V_SYS_ALERT_315 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M108'), '@1', v.replace1),
         '@2',
         v.replace2) message,
 r.id_room,
 p.id_patient,
