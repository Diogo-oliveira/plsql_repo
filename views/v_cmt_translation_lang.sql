CREATE OR REPLACE FORCE VIEW ALERT.V_CMT_TRANSLATION_LANG AS
SELECT code_translation, desc_translation
  FROM (SELECT code_translation, desc_translation
