CREATE OR REPLACE VIEW V_SYS_ALERT_16 AS
SELECT /*+ opt_param('_OPTIMIZER_USE_FEEDBACK', 'FALSE') */
 ...
 REPLACE(pk_message.get_message(sys_context('ALERT_CONTEXT', 'i_lang'), 'V_ALERT_M018'), '@1', v.replace1) message,
 NULL id_room,
 e.id_patient,
 ...
 WHERE v.id_sys_alert = 16
   ...
   AND v.dt_record <
       pk_date_utils.add_days_to_tstz(current_timestamp,
                                      - (pk_sysconfig.get_config('ALERT_NURSE_ACT_TIMEOUT',
                                                                v.id_institution,
                                                                v.id_software) / (24 * 60)))
