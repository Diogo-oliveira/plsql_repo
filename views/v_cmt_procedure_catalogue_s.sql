CREATE OR REPLACE FORCE VIEW ALERT.V_CMT_PROCEDURE_CATALOGUE_S AS
SELECT "DESC_PROCEDURE","DESC_ALIAS","ID_CNT_PROCEDURE","GENDER","AGE_MIN","AGE_MAX","CPT_CODE","FLG_MOV_PAT","DURATION","PREV_RECOVERY_TIME","REF_FORM_CODE","BARCODE","MDM_CODING","FLG_TECHNICAL","ID_PROCEDURE","CREATE_TIME"
