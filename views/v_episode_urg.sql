CREATE OR REPLACE VIEW V_EPISODE_URG AS 
SELECT id_episode,
       institution,
       dt_episode_begin,
  ...
  FROM (SELECT (SELECT pk_date_utils.date_send_tsz(language_id, dt_episode_begin, profissional(0, id_institution, 0))
               ...
               num_mecan,
               num_order,
               (SELECT pk_translation.get_translation(language_id, 'INSTITUTION.CODE_INSTITUTION.' || id_institution)
                  FROM dual) AS institution,
          ...
          FROM (WITH epis AS (SELECT /*+ materialize */
                   ...
                   SELECT /* + index (e epi_supp1_idx) index (pi1 prins_supp1_idx)*/
                    ...
                    in_inst.id_person, -- EMR-805
                    disch.id_dest -- EMR-805
                     FROM epis e
                    ...
                    LEFT OUTER JOIN (SELECT e.id_episode, pk_utils.get_institution_name(1,i.id_institution) Initial_Institution, p.id_person
                   ...
                   -- diagnosticos finais confirmados e o primário
                     ...
                     LEFT outer JOIN alert.epis_ext_sys ees -- EMR-806
