CREATE OR REPLACE VIEW v_sys_alert_46 AS
SELECT /*+ opt_param('_optimizer_use_feedback', 'false') */
 ...
 pk_alerts.get_alert_message(sys_context('ALERT_CONTEXT', 'i_lang'),
                             ...
                             v.id_sys_alert,
                             v.replace1,
                             (SELECT pk_sysconfig.get_config('ALERT_TRIAGE_TIMEOUT', v.id_institution, v.id_software)
                                FROM dual)) message,
 NULL id_room,
 e.id_patient,
 ...
 WHERE v.id_sys_alert = 46
   ...
   AND v.dt_record <
       pk_date_utils.add_days_to_tstz(current_timestamp,
                                      - (pk_sysconfig.get_config('ALERT_TRIAGE_TIMEOUT', v.id_institution, v.id_software) /
                                        (24 * 60)))
