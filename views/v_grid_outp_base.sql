create or replace view v_grid_outp_base as
select
VIEW_TYPE view_id
...
from
  (
    ...
    ,SYS_SOFTWARE
    ,SYS_PROF_ID
    , pk_date_utils.get_string_tstz(i_lang => sys_lang, i_prof => sys_lprof, i_timestamp => alert_context('l_dt_min'), i_timezone  => '') SYS_DT_MIN
    ,pk_date_utils.add_to_ltstz(i_timestamp =>
    ...
    and v0.flg_leader = decode( alert_context( 'filter_leader'), 'Y','Y',v0.flg_leader)
  ) v00
