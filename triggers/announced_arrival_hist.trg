CREATE OR REPLACE TRIGGER B_IU_ANN_ARRH_AUDIT 
BEFORE INSERT OR UPDATE ON ANNOUNCED_ARRIVAL_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_ANN_ARRH_AUDIT-'||sqlerrm);
END B_IU_ANN_ARRH_AUDIT;
/