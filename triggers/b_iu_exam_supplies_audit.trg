  ...
  CREATE OR REPLACE TRIGGER "ALERT"."B_IU_EXAM_SUPPLIES_AUDIT"
BEFORE INSERT OR UPDATE ON EXAM_SUPPLIES
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_EXAM_SUPPLIES_AUDIT-'||sqlerrm);
END B_IU_EXAM_SUPPLIES_AUDIT;

/
ALTER TRIGGER "ALERT"."B_IU_EXAM_SUPPLIES_AUDIT" ENABLE;
