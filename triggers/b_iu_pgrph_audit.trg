  ...
  CREATE OR REPLACE TRIGGER B_IU_PGRPH_AUDIT
BEFORE INSERT OR UPDATE ON PROF_GROUPS_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PGRPH_AUDIT-'||sqlerrm);
END B_IU_PGRPH_AUDIT;

/
ALTER TRIGGER B_IU_PGRPH_AUDIT ENABLE;
