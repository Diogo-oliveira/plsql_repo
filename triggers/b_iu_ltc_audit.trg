  ...
  CREATE OR REPLACE TRIGGER "ALERT"."B_IU_LTC_AUDIT"
BEFORE INSERT OR UPDATE ON LAB_TEST_PARAMETER_LOINC
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_LTC_AUDIT-'||sqlerrm);
END B_IU_LTC_AUDIT;

/
ALTER TRIGGER "ALERT"."B_IU_LTC_AUDIT" ENABLE;
