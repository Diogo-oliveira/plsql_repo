  ...
  CREATE OR REPLACE TRIGGER "B_IU_RRT_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_COMPLETION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_RRT_AUDIT-'||sqlerrm);
END B_IU_RRT_AUDIT;


/
ALTER TRIGGER "B_IU_RRT_AUDIT" ENABLE;
