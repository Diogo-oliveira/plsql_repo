CREATE OR REPLACE TRIGGER ALERT.B_IU_PCIT_AUDIT 
BEFORE INSERT OR UPDATE ON PAT_CIT
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PCIT_AUDIT-'||sqlerrm);
END B_IU_PCIT_AUDIT;
/
ALTER TRIGGER ALERT.B_IU_PCIT_AUDIT ENABLE;