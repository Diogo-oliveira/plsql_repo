  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_DPPN_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.DRUG_PRESC_PLAN_STOCK
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_DPPN_AUDIT-'||sqlerrm);
END B_IU_DPPN_AUDIT;

/
ALTER TRIGGER ALERT.B_IU_DPPN_AUDIT ENABLE;
