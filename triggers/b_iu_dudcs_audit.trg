CREATE OR REPLACE TRIGGER B_IU_DUDCLS_AUDIT 
BEFORE INSERT OR UPDATE ON DRUG_UNIT_DEP_CLIN_SERV
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_DRUG_UNIT_DEP_CLIN_SERV_AUDIT-'||sqlerrm);
END B_IU_DUDCLS_AUDIT;
