CREATE OR REPLACE TRIGGER B_IU_AIDCS_AUDIT 
BEFORE INSERT OR UPDATE ON ADM_IND_DEP_CLIN_SERV
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_AIDCS_AUDIT-'||sqlerrm);
END B_IU_AIDCS_AUDIT;
/
