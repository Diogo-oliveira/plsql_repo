CREATE OR REPLACE TRIGGER b_iu_interv_codification_audit
    BEFORE INSERT OR UPDATE ON interv_codification
    FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        pk_alertlog.log_error('B_IU_INTERV_CODIFICATION_AUDIT-' || SQLERRM);
END b_iu_interv_codification_audit;