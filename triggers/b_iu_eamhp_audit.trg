CREATE OR REPLACE TRIGGER B_IU_EAMHP_AUDIT 
BEFORE INSERT OR UPDATE ON EPIS_ABCDE_METH_PARAM
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        pk_alertlog.log_error('B_IU_EAMHP_AUDIT-' || SQLERRM);
END b_iu_eamhp_audit;
/
