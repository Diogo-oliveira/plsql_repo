CREATE OR REPLACE TRIGGER B_IU_PR_HSP_VSR_AUDIT 
BEFORE INSERT OR UPDATE ON PRE_HOSP_VS_READ
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PR_HSP_VSR_AUDIT-'||sqlerrm);
END B_IU_PR_HSP_VSR_AUDIT;
/