CREATE OR REPLACE TRIGGER B_IU_SSV_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.SR_SURGERY_VALIDATION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        alertlog.pk_alertlog.log_error('B_IU_SSV_AUDIT-' || SQLERRM);
END b_iu_ssv_audit;

drop TRIGGER b_iu_ssv_audit;
/
