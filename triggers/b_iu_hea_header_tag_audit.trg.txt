CREATE OR REPLACE TRIGGER B_IU_HEA_HEADER_TAG_AUDIT 
BEFORE INSERT OR UPDATE ON HEA_HEADER_TAG
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_HEA_HEADER_TAG_AUDIT-'||sqlerrm);
END B_IU_HEA_HEADER_TAG_AUDIT;
/
