CREATE OR REPLACE TRIGGER B_IU_PR_HSP_ACC_AUDIT 
BEFORE INSERT OR UPDATE ON PRE_HOSP_ACCIDENT
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PR_HSP_ACC_AUDIT-'||sqlerrm);
END B_IU_PR_HSP_ACC_AUDIT;
/