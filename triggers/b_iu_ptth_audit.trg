CREATE OR REPLACE TRIGGER B_IU_PTTH_AUDIT 
BEFORE INSERT OR UPDATE ON PRODUCTION_TARGET_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PTTH_AUDIT-'||sqlerrm);
END B_IU_PTTH_AUDIT;IT;