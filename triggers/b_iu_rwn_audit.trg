  ...
  CREATE OR REPLACE TRIGGER "B_IU_RWN_AUDIT"
BEFORE INSERT OR UPDATE ON REF_WF_ACTIONS
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_RWN_AUDIT-'||sqlerrm);
END B_IU_RWN_AUDIT;

/
ALTER TRIGGER "B_IU_RWN_AUDIT" ENABLE;
