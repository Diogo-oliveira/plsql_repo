CREATE OR REPLACE TRIGGER B_IU_AREQH_AUDIT 
BEFORE INSERT OR UPDATE ON ADM_REQUEST_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_AREQH_AUDIT-'||sqlerrm);
END B_IU_AREQH_AUDIT;
/
