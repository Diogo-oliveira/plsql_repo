  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_MOG_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.MED_ORIGIN
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_MOG_AUDIT-'||sqlerrm);
END B_IU_MOG_AUDIT;

/
ALTER TRIGGER ALERT.B_IU_MOG_AUDIT ENABLE;
