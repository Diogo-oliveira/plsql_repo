  ...
  CREATE OR REPLACE TRIGGER "B_IU_WSU_AUDIT"
BEFORE INSERT OR UPDATE ON WF_STATUS
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_WSU_AUDIT-'||sqlerrm);
END B_IU_WSU_AUDIT;

/
ALTER TRIGGER "B_IU_WSU_AUDIT" ENABLE;
