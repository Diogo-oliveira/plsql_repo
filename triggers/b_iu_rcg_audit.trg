  ...
  CREATE OR REPLACE TRIGGER "B_IU_RCG_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_COMPLETION_CFG
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_RCG_AUDIT-'||sqlerrm);
END B_IU_RCG_AUDIT;


/
ALTER TRIGGER "B_IU_RCG_AUDIT" ENABLE;
