CREATE OR REPLACE TRIGGER B_IU_ANN_ARR_AUDIT 
BEFORE INSERT OR UPDATE ON ANNOUNCED_ARRIVAL
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_ANN_ARR_AUDIT-'||sqlerrm);
END B_IU_ANN_ARR_AUDIT;
/