...
CREATE OR REPLACE TRIGGER B_IU_SR_POS_PHARM_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.SR_POS_PHARM
FOR EACH ROW
BEGIN
...
EXCEPTION
    WHEN OTHERS THEN
        alertlog.pk_alertlog.log_error('B_IU_SR_POS_PHARM_AUDIT-' || SQLERRM);
END b_iu_sr_pos_pharm_audit;

drop TRIGGER b_iu_sr_pos_pharm_audit;
/
************************************************
