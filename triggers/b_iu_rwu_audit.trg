  ...
  CREATE OR REPLACE TRIGGER "B_IU_RWU_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_WF_STATUS
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_RWU_AUDIT-'||sqlerrm);
END B_IU_RWU_AUDIT;

/
ALTER TRIGGER "B_IU_RWU_AUDIT" ENABLE;
