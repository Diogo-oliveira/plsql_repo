...
-- CHANGE DATE: 28-08-2009
-- CHANGE REASON: [ALERT-40905] 
CREATE OR REPLACE TRIGGER B_IU_SAL_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.SCH_ALLOCATION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_SAL_AUDIT-'||sqlerrm);
END B_IU_SAL_AUDIT;
