  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_MOD_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.MED_ORIGIN_DCS
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_MOD_AUDIT-'||sqlerrm);
END B_IU_MOD_AUDIT;

/
ALTER TRIGGER ALERT.B_IU_MOD_AUDIT ENABLE;
