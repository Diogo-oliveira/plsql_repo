  ...
  CREATE OR REPLACE TRIGGER "ALERT"."B_IU_ECN_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.EXAM_CODIFICATION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_ECN_AUDIT-'||sqlerrm);
END B_IU_ECN_AUDIT;


/
ALTER TRIGGER "ALERT"."B_IU_ECN_AUDIT" ENABLE;
