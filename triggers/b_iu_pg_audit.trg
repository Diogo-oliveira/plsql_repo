  ...
  CREATE OR REPLACE TRIGGER B_IU_PG_AUDIT
BEFORE INSERT OR UPDATE ON PROF_GROUPS
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PG_AUDIT-'||sqlerrm);
END B_IU_PG_AUDIT;

/
ALTER TRIGGER B_IU_PG_AUDIT ENABLE;
