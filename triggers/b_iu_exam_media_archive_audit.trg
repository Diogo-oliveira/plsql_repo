  ...
  CREATE OR REPLACE TRIGGER "ALERT"."B_IU_EXAM_MEDIA_ARCHIVE_AUDIT"
BEFORE INSERT OR UPDATE ON EXAM_MEDIA_ARCHIVE
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_EXAM_MEDIA_ARCHIVE_AUDIT-'||sqlerrm);
END B_IU_EXAM_MEDIA_ARCHIVE_AUDIT;

/
ALTER TRIGGER "ALERT"."B_IU_EXAM_MEDIA_ARCHIVE_AUDIT" ENABLE;
