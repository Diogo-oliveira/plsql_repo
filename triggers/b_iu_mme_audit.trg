  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_MME_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.MI_MED_DOSAGE
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_MME_AUDIT-'||sqlerrm);
END B_IU_MME_AUDIT;

/
ALTER TRIGGER ALERT.B_IU_MME_AUDIT ENABLE;
