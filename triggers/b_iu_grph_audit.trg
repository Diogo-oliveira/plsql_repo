  ...
  CREATE OR REPLACE TRIGGER B_IU_GRPH_AUDIT
BEFORE INSERT OR UPDATE ON GROUPS_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_GRPH_AUDIT-'||sqlerrm);
END B_IU_GRPH_AUDIT;

/
ALTER TRIGGER B_IU_GRPH_AUDIT ENABLE;
