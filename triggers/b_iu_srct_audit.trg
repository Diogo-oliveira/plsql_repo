CREATE OR REPLACE TRIGGER B_IU_SRCT_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.SR_CONSENT
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        alertlog.pk_alertlog.log_error('B_IU_SRCT_AUDIT-' || SQLERRM);
END b_iu_srct_audit;

drop TRIGGER b_iu_srct_audit;
/
