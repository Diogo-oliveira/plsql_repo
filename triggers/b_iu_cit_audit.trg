CREATE OR REPLACE TRIGGER "B_IU_CIT_AUDIT" 
BEFORE INSERT OR UPDATE ON ALERT.CODIFICATION_INSTIT_SOFT
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_CIT_AUDIT-'||sqlerrm);
END B_IU_CIT_AUDIT;

/
ALTER TRIGGER "ALERT"."B_IU_CIT_AUDIT" ENABLE;