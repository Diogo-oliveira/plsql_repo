CREATE OR REPLACE TRIGGER B_IU_APREP_AUDIT 
BEFORE INSERT OR UPDATE ON ADM_PREPARATION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_APREP_AUDIT-'||sqlerrm);
END B_IU_APREP_AUDIT;
/
