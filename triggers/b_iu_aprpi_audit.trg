CREATE OR REPLACE TRIGGER B_IU_APRPI_AUDIT 
BEFORE INSERT OR UPDATE ON ADM_PREPARATION_INST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_APRPI_AUDIT-'||sqlerrm);
END B_IU_APRPI_AUDIT;
/
