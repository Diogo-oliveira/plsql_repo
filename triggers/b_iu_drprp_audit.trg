  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_DRPRP_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.DRUG_PRESC_PLAN
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_DRPRP_AUDIT-'||sqlerrm);
END B_IU_DRPRP_AUDIT;


/
ALTER TRIGGER ALERT.B_IU_DRPRP_AUDIT ENABLE;
