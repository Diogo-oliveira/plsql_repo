  ...
  CREATE OR REPLACE TRIGGER "B_IU_WTC_AUDIT"
BEFORE INSERT OR UPDATE ON WF_TRANSITION_CONFIG
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_WTC_AUDIT-'||sqlerrm);
END B_IU_WTC_AUDIT;

/
ALTER TRIGGER "B_IU_WTC_AUDIT" ENABLE;
