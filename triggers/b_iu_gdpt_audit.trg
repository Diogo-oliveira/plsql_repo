  ...
  CREATE OR REPLACE TRIGGER B_IU_GDPT_AUDIT
BEFORE INSERT OR UPDATE ON GROUPS_DEPT
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_GDPT_AUDIT-'||sqlerrm);
END B_IU_GDPT_AUDIT;

/
ALTER TRIGGER B_IU_GDPT_AUDIT ENABLE;
