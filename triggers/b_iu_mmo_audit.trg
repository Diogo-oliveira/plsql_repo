  ...
  CREATE OR REPLACE TRIGGER ALERT.B_IU_MMO_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.MI_MED_STOCK_INFO
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_MMO_AUDIT-'||sqlerrm);
END B_IU_MMO_AUDIT;

/
ALTER TRIGGER ALERT.B_IU_MMO_AUDIT ENABLE;
