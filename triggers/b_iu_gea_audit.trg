CREATE OR REPLACE TRIGGER B_IU_GEA_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.GRIDS_EA
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_GEA_AUDIT-'||sqlerrm);
END B_IU_GEA_AUDIT;

/
ALTER TRIGGER B_IU_GEA_AUDIT ENABLE;
