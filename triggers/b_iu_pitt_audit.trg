  ...
  CREATE OR REPLACE TRIGGER B_IU_PITT_AUDIT
BEFORE INSERT OR UPDATE ON PENDING_ISSUE_TITLE
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PITT_AUDIT-'||sqlerrm);
END B_IU_PITT_AUDIT;

/
ALTER TRIGGER B_IU_PITT_AUDIT ENABLE;
