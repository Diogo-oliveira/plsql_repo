  ...
  CREATE OR REPLACE TRIGGER "B_IU_REY_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_EXAM_ORIG_DEST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_REY_AUDIT-'||sqlerrm);
END B_IU_REY_AUDIT;


/
ALTER TRIGGER "B_IU_REY_AUDIT" ENABLE;
