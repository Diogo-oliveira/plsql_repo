CREATE OR REPLACE TRIGGER "B_IU_ACN_AUDIT" 
BEFORE INSERT OR UPDATE ON ALERT.ANALYSIS_CODIFICATION
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_ACN_AUDIT-'||sqlerrm);
END B_IU_ACN_AUDIT;

/
ALTER TRIGGER "ALERT"."B_IU_ACN_AUDIT" ENABLE;