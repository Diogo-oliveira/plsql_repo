CREATE OR REPLACE TRIGGER B_IU_PHPH_PK_AUDIT
BEFORE INSERT OR UPDATE ON PAT_HEALTH_PROGRAM_HIST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_PHPH_PK_AUDIT-'||sqlerrm);
END B_IU_PHPH_PK_AUDIT;
/
