CREATE OR REPLACE TRIGGER B_IU_EPIS_POSIT_HIST_AUDIT
BEFORE INSERT OR UPDATE ON ALERT.EPIS_POSITIONING_HIST
FOR EACH ROW
BEGIN
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_EPIS_POSIT_HIST_AUDIT-'||sqlerrm);
END B_IU_EPIS_POSIT_HIST_AUDIT;
/