CREATE OR REPLACE TRIGGER B_IU_HEADER_CFG_AUDIT 
BEFORE INSERT OR UPDATE ON HEADER_CFG
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_HEADER_CFG_AUDIT-'||sqlerrm);
END B_IU_HEADER_CFG_AUDIT;
/
