  ...
  CREATE OR REPLACE TRIGGER "B_IU_WSC_AUDIT"
BEFORE INSERT OR UPDATE ON WF_STATUS_CONFIG
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_WSC_AUDIT-'||sqlerrm);
END B_IU_WSC_AUDIT;

/
ALTER TRIGGER "B_IU_WSC_AUDIT" ENABLE;
