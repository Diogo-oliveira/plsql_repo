  ...
  CREATE OR REPLACE TRIGGER "B_IU_WWE_AUDIT"
BEFORE INSERT OR UPDATE ON WF_WORKFLOW_SOFTWARE
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_WWE_AUDIT-'||sqlerrm);
END B_IU_WWE_AUDIT;

/
ALTER TRIGGER "B_IU_WWE_AUDIT" ENABLE;
