  ...
  CREATE OR REPLACE TRIGGER "B_IU_RIY_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_INTERV_ORIG_DEST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_RIY_AUDIT-'||sqlerrm);
END B_IU_RIY_AUDIT;


/
ALTER TRIGGER "B_IU_RIY_AUDIT" ENABLE;
