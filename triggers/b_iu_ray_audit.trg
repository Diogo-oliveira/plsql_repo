  ...
  CREATE OR REPLACE TRIGGER "B_IU_RAY_AUDIT"
BEFORE INSERT OR UPDATE ON ALERT.REF_ANALYSIS_ORIG_DEST
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        ALERTLOG.PK_ALERTLOG.log_error('B_IU_RAY_AUDIT-'||sqlerrm);
END B_IU_RAY_AUDIT;


/
ALTER TRIGGER "B_IU_RAY_AUDIT" ENABLE;
