  ...
  CREATE OR REPLACE TRIGGER "B_IU_WWW_AUDIT"
BEFORE INSERT OR UPDATE ON WF_WORKFLOW
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_WWW_AUDIT-'||sqlerrm);
END B_IU_WWW_AUDIT;

/
ALTER TRIGGER "B_IU_WWW_AUDIT" ENABLE;
