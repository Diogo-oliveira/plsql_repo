CREATE OR REPLACE TRIGGER B_IU_INST_GRP_AUDIT 
BEFORE INSERT OR UPDATE ON INSTITUTION_GROUP
FOR EACH ROW
DECLARE
...
EXCEPTION
    WHEN OTHERS THEN
        PK_ALERTLOG.log_error('B_IU_INST_GRP_AUDIT-'||sqlerrm);
END B_IU_INST_GRP_AUDIT;
/