CREATE OR REPLACE TYPE t_obj_nnn_epis_outcome_eval UNDER t_obj_temporal_record
(
-- Author  : ARIEL.MACHADO
-- Created : 1/31/2014 4:25:06 PM
-- Purpose : NANDA, NIC, NOC development: Object type to represent an Evaluation of a NOC Outcome

-- Attributes
    id_nnn_epis_outcome_eval NUMBER(24),
    ...
    outcome_value            t_obj_likert_scale_level,
...
-- Default constructor
    CONSTRUCTOR FUNCTION t_obj_nnn_epis_outcome_eval
    (
        SELF                       IN OUT NOCOPY t_obj_nnn_epis_outcome_eval,
        i_id_nnn_epis_outcome_eval IN NUMBER DEFAULT NULL,
        ...
        i_outcome_value            IN t_obj_likert_scale_level DEFAULT NULL,
...
FINAL;
/
CREATE OR REPLACE TYPE BODY t_obj_nnn_epis_outcome_eval AS
    ...
    BEGIN
        self.id_nnn_epis_outcome_eval := i_id_nnn_epis_outcome_eval;
        ...
        self.outcome_value            := i_outcome_value;
        ...
        RETURN;
    END t_obj_nnn_epis_outcome_eval;
    ...
    BEGIN
        ...
        l_json.put('ID_NNN_EPIS_OUTCOME_EVAL', self.id_nnn_epis_outcome_eval);
        ...
        IF self.outcome_value IS NOT NULL
        THEN
            l_json.put('OUTCOME_VALUE', self.outcome_value.to_json());
        ELSE
            l_json.put('OUTCOME_VALUE', json_object_t());
        END IF;
