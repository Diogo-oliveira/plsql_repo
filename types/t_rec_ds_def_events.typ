...
BEGIN
  EXECUTE IMMEDIATE 'DROP TYPE t_table_ds_def_events'; 
EXCEPTION 
...
CREATE OR REPLACE TYPE t_rec_ds_def_events AS OBJECT
(
    id_ds_cmpt_mkt_rel        NUMBER(24),
    id_def_event              NUMBER(24),
    flg_event_type            VARCHAR2(1 CHAR)
);
/


CREATE OR REPLACE TYPE t_table_ds_def_events IS TABLE OF t_rec_ds_def_events;
/
