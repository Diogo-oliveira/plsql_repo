CREATE OR REPLACE TYPE t_obj_nnn_epis_indicator UNDER t_obj_temporal_record
(
-- Author  : ARIEL.MACHADO
-- Created : 2/27/2014 10:52:35 AM
-- Purpose : NANDA, NIC, NOC development: Object type to represent a NOC Indicator in a patient's care plan
...
-- Default constructor
    CONSTRUCTOR FUNCTION t_obj_nnn_epis_indicator
    (
        SELF                     IN OUT NOCOPY t_obj_nnn_epis_indicator,
        i_id_nnn_epis_indicator  IN NUMBER DEFAULT NULL,
        i_id_noc_indicator       IN NUMBER DEFAULT NULL,
        i_id_noc_othr_ind_vrsn   IN NUMBER DEFAULT NULL,
...
FINAL;
/
CREATE OR REPLACE TYPE BODY t_obj_nnn_epis_indicator AS
    ...
    BEGIN
        ...
        self.id_noc_othr_ind_vrsn   := i_id_noc_othr_ind_vrsn;
    ...
    BEGIN
        ...
        l_json.put('ID_NOC_OTHR_IND_VRSN', self.id_noc_othr_ind_vrsn);
