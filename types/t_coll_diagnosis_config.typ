DROP TYPE t_coll_diagnosis_config;
/
CREATE OR REPLACE TYPE t_rec_diagnosis_config AS OBJECT
(
...
END;
/
CREATE OR REPLACE TYPE t_coll_diagnosis_config AS TABLE OF t_rec_diagnosis_config;
/
